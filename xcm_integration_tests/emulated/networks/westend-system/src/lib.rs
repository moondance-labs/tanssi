...
parameter_types! {
    ...
    pub WestendEmptyReceiver: cumulus_primitives_core::relay_chain::AccountId = WestendRelay::account_id_of(tanssi_emulated_integration_tests_common::accounts::RANDOM);

    // Dancebox
    pub DanceboxSender: dancebox_runtime::AccountId = Sr25519Keyring::Alice.to_account_id();
    pub DanceboxReceiver: dancebox_runtime::AccountId = Sr25519Keyring::Bob.to_account_id();
    pub DanceboxEmptyReceiver: dancebox_runtime::AccountId = DanceboxPara::account_id_of(tanssi_emulated_integration_tests_common::accounts::RANDOM);
