...
// raw.json
// --output
// ./pallets/xcm-core-buyer/src/pallet_xcm_core_buyer.rs
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: `AuthorityMapping::AuthorityIdMapping` (r:1 w:0)
	/// Proof: `AuthorityMapping::AuthorityIdMapping` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(56_000_000, 5524)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(44_000_000, 4999)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(13_000_000, 3684)
			...
			.saturating_add(Weight::from_parts(4_132_633, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_000_000, 3627)
			...
			.saturating_add(Weight::from_parts(2_655_233, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
