...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: `XcmCoreBuyer::XcmWeights` (r:1 w:0)
	...
	fn force_buy_core(x: u32, ) -> Weight {
		...
		//  Measured:  `665 + x * (4 ±0)`
		//  Estimated: `4129 + x * (4 ±0)`
		// Minimum execution time: 30_726_000 picoseconds.
		Weight::from_parts(33_061_964, 4129)
			// Standard Error: 1_369
			.saturating_add(Weight::from_parts(28_154, 0).saturating_mul(x.into()))
