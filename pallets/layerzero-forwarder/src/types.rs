...
use frame_support::{CloneNoBound, DebugNoBound, Deserialize, EqNoBound, PartialEqNoBound, Serialize};
...
pub struct MessageForwardingConfig<T: Config> {
    ...
    pub whitelisted_senders: BoundedVec<(LayerZeroEndpoint, LayerZeroAddress), T::MaxWhitelistedSenders>,
