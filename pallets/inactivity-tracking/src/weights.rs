...
//! HOSTNAME: `192.168.1.107`, CPU: `<UNKNOWN>`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	/// Storage: `InactivityTracking::EnableInactivityTracking` (r:0 w:1)
	/// Proof: `InactivityTracking::EnableInactivityTracking` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	fn set_inactivity_tracking_status() -> Weight {
