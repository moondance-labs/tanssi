...
async function logSessionAssignment(polkadotJs) {
    ...
    testCases: ({ it, context }) => {
        ...
        it({
            ...
            test: async function () {
                ...
                expect(filteredEvents[0].randomSeed.toHex()).to.deep.eq("0xf497424c947d1b548a64ce4697f8fa8f84c6d73b7ceedf4d4f9cb65665fb9cc1");
