...
describeSuite({
    ...
    testCases: ({ context, it, log }) => {
        ...
        // (Account Code Size (112) + Length of the bytecode (550)) * Storage Growth Gas Ratio (1464)
        // The length of the bytecode is in the generate Fibonacci.json
        // file at 'contract.evm.deployedBytecode.object'
        const EXPECTED_STORAGE_GROWTH_GAS = 969168;
        for (const txnType of TransactionTypes) {
            ...
            it({
                ...
                test: async () => {
                    ...
                    expect(estimatedGas).toBe(1013235n);
                },
            });
