...
contract_dir="$artifacts_dir/tanssi-symbiotic" deploy_script="DeployTanssiEcosystem.s.sol" pnpm generateContracts "$output_dir/symbiotic_contracts.json" > /dev/null
popd > /dev/null
