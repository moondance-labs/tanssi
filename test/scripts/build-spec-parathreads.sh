...
../target/release/tanssi-node build-spec --chain dancebox_local --parachain-id 1000 --invulnerable "Collator-01" --invulnerable "Collator-02" --invulnerable "Collator-03" --invulnerable "Collator-04" > specs/parathreads-tanssi-1000.json
