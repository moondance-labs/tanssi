...
export const ASSET_HUB_CHANNEL_ID = "0x87c2676d3f8c7a46182b6a0793a8575bf4200c61469824052a7150c4de48f8d0";
export const ASSET_HUB_AGENT_ID = "0x9ba4d8cfc1cdf812338aa6457aa5510348526d933108b4106162474231b4cbe5";
export const ASSET_HUB_PARA_ID = 1;
...
export const STARLIGHT_ERA_INFLATION_PERBILL = 105679n;

export const DANCELIGHT_BLOCK_INFLATION_PERBILL = 9n;
export const STARLIGHT_BLOCK_INFLATION_PERBILL = 6n;

export const DANCELIGHT_REWARDS_PORTION_PER_BILL_RATIO = [7n, 10n];
export const STARLIGHT_REWARDS_PORTION_PER_BILL_RATIO = [4n, 7n];
...
export const STARLIGHT_GENESIS_HASH = "0xdd6d086f75ec041b66e20c4186d327b23c8af244c534a2418de6574e8c041a60";
