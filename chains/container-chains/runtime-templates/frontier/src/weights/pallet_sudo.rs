...
impl<T: frame_system::Config> pallet_sudo::WeightInfo for SubstrateWeight<T> {
	...
	fn set_key() -> Weight {
		...
		Weight::from_parts(11_764_000, 1505)
	...
	fn sudo() -> Weight {
		...
		Weight::from_parts(13_173_000, 1505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Sudo::Key` (r:1 w:0)
	/// Proof: `Sudo::Key` (`max_values`: Some(1), `max_size`: Some(20), added: 515, mode: `MaxEncodedLen`)
	fn sudo_as() -> Weight {
		...
		Weight::from_parts(11_787_000, 1505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Sudo::Key` (r:1 w:1)
	/// Proof: `Sudo::Key` (`max_values`: Some(1), `max_size`: Some(20), added: 515, mode: `MaxEncodedLen`)
	fn remove_key() -> Weight {
		...
		Weight::from_parts(20_907_000, 1505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Sudo::Key` (r:1 w:0)
	...
	fn check_only_sudo_account() -> Weight {
		...
		Weight::from_parts(3_085_000, 1505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}