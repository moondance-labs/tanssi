...
// --output=tmp/frontier_template_weights/pallet_foreign_asset_creator.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_foreign_asset_creator::WeightInfo for SubstrateWeight<T> {
	...
	fn create_foreign_asset() -> Weight {
		...
		Weight::from_parts(59_541_000, 4299)
	...
	fn change_existing_asset_type() -> Weight {
		...
		Weight::from_parts(14_777_000, 3710)
	...
	fn remove_existing_asset_type() -> Weight {
		...
		Weight::from_parts(12_914_000, 3710)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn destroy_foreign_asset() -> Weight {
		...
		Weight::from_parts(31_058_000, 4213)
