...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(14_676_032, 4310)
			// Standard Error: 1_041
			.saturating_add(Weight::from_parts(20_145, 0).saturating_mul(p.into()))
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(34_870_414, 5302)
			// Standard Error: 2_167
			.saturating_add(Weight::from_parts(153_044, 0).saturating_mul(a.into()))
			// Standard Error: 2_239
			.saturating_add(Weight::from_parts(12_004, 0).saturating_mul(p.into()))
	...
	fn remove_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(20_335_744, 5302)
			// Standard Error: 1_033
			.saturating_add(Weight::from_parts(147_257, 0).saturating_mul(a.into()))
			// Standard Error: 1_068
			.saturating_add(Weight::from_parts(1_310, 0).saturating_mul(p.into()))
	...
	fn reject_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(16_706_109, 5302)
			// Standard Error: 12_758
			.saturating_add(Weight::from_parts(248_177, 0).saturating_mul(a.into()))
			// Standard Error: 13_181
			.saturating_add(Weight::from_parts(86_523, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:0)
	...
	fn announce(a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(39_598_088, 5302)
			// Standard Error: 39_686
			.saturating_add(Weight::from_parts(56_911, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn add_proxy(_p: u32, ) -> Weight {
		...
		Weight::from_parts(34_559_233, 4310)
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(20_558_331, 4310)
			// Standard Error: 804
			.saturating_add(Weight::from_parts(19_188, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn remove_proxies(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_421_553, 4310)
			// Standard Error: 1_165
			.saturating_add(Weight::from_parts(23_295, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(21_706_271, 4310)
			// Standard Error: 801
			.saturating_add(Weight::from_parts(8_442, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(20_695_885, 4310)
			// Standard Error: 797
			.saturating_add(Weight::from_parts(17_496, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(37_099_000, 5302)
			.saturating_add(T::DbWeight::get().reads(3_u64))
