...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(13_684_064, 4310)
			// Standard Error: 860
			.saturating_add(Weight::from_parts(30_138, 0).saturating_mul(p.into()))
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(43_242_247, 5302)
	...
	fn remove_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(15_488_530, 5302)
			// Standard Error: 11_249
			.saturating_add(Weight::from_parts(219_768, 0).saturating_mul(a.into()))
			// Standard Error: 11_622
			.saturating_add(Weight::from_parts(72_554, 0).saturating_mul(p.into()))
	...
	fn reject_announcement(_a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(25_118_240, 5302)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:0)
	...
	fn announce(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(24_107_559, 5302)
			// Standard Error: 1_263
			.saturating_add(Weight::from_parts(138_763, 0).saturating_mul(a.into()))
			// Standard Error: 1_305
			.saturating_add(Weight::from_parts(8_630, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn add_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_439_219, 4310)
			// Standard Error: 711
			.saturating_add(Weight::from_parts(30_635, 0).saturating_mul(p.into()))
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_364_658, 4310)
			// Standard Error: 931
			.saturating_add(Weight::from_parts(37_420, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn remove_proxies(p: u32, ) -> Weight {
		...
		Weight::from_parts(16_749_768, 4310)
			// Standard Error: 716
			.saturating_add(Weight::from_parts(21_843, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(19_685_722, 4310)
			// Standard Error: 807
			.saturating_add(Weight::from_parts(10_554, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(17_228_632, 4310)
			// Standard Error: 1_855
			.saturating_add(Weight::from_parts(37_611, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(33_963_000, 5302)
			.saturating_add(T::DbWeight::get().reads(3_u64))
