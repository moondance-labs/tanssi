...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(14_916_193, 4310)
			// Standard Error: 968
			.saturating_add(Weight::from_parts(23_403, 0).saturating_mul(p.into()))
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(36_560_239, 5302)
			// Standard Error: 2_119
			.saturating_add(Weight::from_parts(154_160, 0).saturating_mul(a.into()))
			// Standard Error: 2_189
			.saturating_add(Weight::from_parts(1_533, 0).saturating_mul(p.into()))
	...
	fn remove_announcement(a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(21_160_727, 5302)
			// Standard Error: 980
			.saturating_add(Weight::from_parts(150_600, 0).saturating_mul(a.into()))
	...
	fn reject_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(20_722_631, 5302)
			// Standard Error: 1_507
			.saturating_add(Weight::from_parts(160_661, 0).saturating_mul(a.into()))
			// Standard Error: 1_557
			.saturating_add(Weight::from_parts(6_475, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:0)
	...
	fn announce(a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(29_207_842, 5302)
			// Standard Error: 39_226
			.saturating_add(Weight::from_parts(394_175, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn add_proxy(_p: u32, ) -> Weight {
		...
		Weight::from_parts(28_543_317, 4310)
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(21_721_469, 4310)
			// Standard Error: 35_736
			.saturating_add(Weight::from_parts(201_717, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn remove_proxies(_p: u32, ) -> Weight {
		...
		Weight::from_parts(27_732_603, 4310)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_916_029, 4310)
			// Standard Error: 25_029
			.saturating_add(Weight::from_parts(339_453, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(_p: u32, ) -> Weight {
		...
		Weight::from_parts(38_434_357, 4310)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(38_533_000, 5302)
			.saturating_add(T::DbWeight::get().reads(3_u64))
