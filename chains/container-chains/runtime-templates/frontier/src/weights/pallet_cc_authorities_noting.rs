...
// --pallet=pallet_cc_authorities_noting
// --extrinsic=*
// --wasm-execution=compiled
// --steps=50
// --repeat=20
// --template=benchmarking/frame-weight-runtime-template.hbs
// --output=tmp/frontier_template_weights/pallet_cc_authorities_noting.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_cc_authorities_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_authorities_data() -> Weight {
		...
		Weight::from_parts(22_523_000, 1626)
	...
	fn set_authorities(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_127_773, 0)
			// Standard Error: 27_208
			.saturating_add(Weight::from_parts(358_444, 0).saturating_mul(x.into()))
