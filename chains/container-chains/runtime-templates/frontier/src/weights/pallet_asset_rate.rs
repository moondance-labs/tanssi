...
// --output=tmp/frontier_template_weights/pallet_asset_rate.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_asset_rate::WeightInfo for SubstrateWeight<T> {
	...
	fn create() -> Weight {
		...
		Weight::from_parts(7_484_000, 3499)
	...
	fn update() -> Weight {
		...
		Weight::from_parts(7_785_000, 3499)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `AssetRate::ConversionRateToNative` (r:1 w:1)
	...
	fn remove() -> Weight {
		...
		Weight::from_parts(8_366_000, 3499)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}