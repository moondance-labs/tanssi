...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(15_483_437, 3997)
			// Standard Error: 1
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(27_272_055, 5587)
			// Standard Error: 707
			.saturating_add(Weight::from_parts(68_226, 0).saturating_mul(s.into()))
			// Standard Error: 6
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(15_956_043, 5587)
			// Standard Error: 9_097
			.saturating_add(Weight::from_parts(31_002, 0).saturating_mul(s.into()))
			// Standard Error: 89
			.saturating_add(Weight::from_parts(2_155, 0).saturating_mul(z.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(68_873_701, 5587)
			// Standard Error: 131
			.saturating_add(Weight::from_parts(353, 0).saturating_mul(z.into()))
	...
	fn approve_as_multi_create(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(26_477_926, 5587)
			// Standard Error: 717
			.saturating_add(Weight::from_parts(73_303, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(16_880_262, 5587)
			// Standard Error: 3_045
			.saturating_add(Weight::from_parts(44_536, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(22_300_638, 5587)
			// Standard Error: 5_625
			.saturating_add(Weight::from_parts(84_299, 0).saturating_mul(s.into()))
			// Standard Error: 55
