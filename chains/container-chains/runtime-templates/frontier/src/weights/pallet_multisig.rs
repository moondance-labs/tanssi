...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(14_117_827, 3997)
			// Standard Error: 131
	...
	fn as_multi_create(_s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(41_073_086, 5587)
			// Standard Error: 221
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(15_117_776, 5587)
			// Standard Error: 11_159
			.saturating_add(Weight::from_parts(23_989, 0).saturating_mul(s.into()))
			// Standard Error: 109
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(36_814_374, 5587)
			// Standard Error: 1_858
			.saturating_add(Weight::from_parts(52_429, 0).saturating_mul(s.into()))
			// Standard Error: 18
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(26_108_449, 5587)
			// Standard Error: 457
			.saturating_add(Weight::from_parts(66_037, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(12_967_021, 5587)
			// Standard Error: 354
			.saturating_add(Weight::from_parts(56_614, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(26_068_858, 5587)
			// Standard Error: 606
			.saturating_add(Weight::from_parts(61_559, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_465_826, 5587)
			// Standard Error: 477
			.saturating_add(Weight::from_parts(63_582, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}