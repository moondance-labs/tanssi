...
impl<T: frame_system::Config> pallet_multiblock_migrations::WeightInfo for SubstrateWeight<T> {
	...
	fn exec_migration_completed() -> Weight {
		...
		Weight::from_parts(4_528_000, 3494)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_complete() -> Weight {
		...
		Weight::from_parts(9_999_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(19_758_000, 3731)
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(32_157_452, 3834)
			// Standard Error: 15_321
			.saturating_add(Weight::from_parts(944_362, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		...
		Weight::from_parts(15_330_613, 720)
			// Standard Error: 1_870
			.saturating_add(Weight::from_parts(625_759, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
