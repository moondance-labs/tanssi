...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(18_067_118, 3997)
			// Standard Error: 5
	...
	fn as_multi_create(_s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(53_486_531, 6811)
			// Standard Error: 97
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(13_262_769, 6811)
			// Standard Error: 259
			.saturating_add(Weight::from_parts(59_195, 0).saturating_mul(s.into()))
			// Standard Error: 2
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(11_218_757, 6811)
			// Standard Error: 15_578
			.saturating_add(Weight::from_parts(272_310, 0).saturating_mul(s.into()))
			// Standard Error: 152
			.saturating_add(Weight::from_parts(2_487, 0).saturating_mul(z.into()))
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(25_138_578, 6811)
			// Standard Error: 2_156
			.saturating_add(Weight::from_parts(53_513, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(10_815_971, 6811)
			// Standard Error: 6_191
			.saturating_add(Weight::from_parts(115_051, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(28_649_264, 6811)
			// Standard Error: 15_369
			.saturating_add(Weight::from_parts(117_320, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(_s: u32, ) -> Weight {
		...
		Weight::from_parts(28_037_876, 6811)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}