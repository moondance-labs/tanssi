...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(16_875_693, 3997)
			// Standard Error: 2
			.saturating_add(Weight::from_parts(218, 0).saturating_mul(z.into()))
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(31_772_110, 6811)
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(16_646_668, 6811)
			// Standard Error: 8_827
			.saturating_add(Weight::from_parts(94_433, 0).saturating_mul(s.into()))
			// Standard Error: 86
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(20_217_856, 6811)
			// Standard Error: 12_874
			.saturating_add(Weight::from_parts(183_887, 0).saturating_mul(s.into()))
			// Standard Error: 126
			.saturating_add(Weight::from_parts(2_603, 0).saturating_mul(z.into()))
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_460_239, 6811)
			// Standard Error: 455
			.saturating_add(Weight::from_parts(86_636, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(12_391_236, 6811)
			// Standard Error: 292
			.saturating_add(Weight::from_parts(83_918, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_747_295, 6811)
			// Standard Error: 418
			.saturating_add(Weight::from_parts(86_782, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_387_415, 6811)
			// Standard Error: 436
			.saturating_add(Weight::from_parts(86_694, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}