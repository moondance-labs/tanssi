...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(18_460_296, 3997)
			// Standard Error: 3
	...
	fn as_multi_create(_s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(35_614_163, 6811)
			// Standard Error: 110
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(13_386_215, 6811)
			// Standard Error: 307
			.saturating_add(Weight::from_parts(58_525, 0).saturating_mul(s.into()))
			// Standard Error: 3
	...
	fn as_multi_complete(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(57_004_801, 6811)
			// Standard Error: 13_458
			.saturating_add(Weight::from_parts(65_628, 0).saturating_mul(s.into()))
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_634_005, 6811)
			// Standard Error: 11_974
			.saturating_add(Weight::from_parts(185_821, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(15_365_324, 6811)
			// Standard Error: 8_973
			.saturating_add(Weight::from_parts(69_817, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_582_454, 6811)
			// Standard Error: 756
			.saturating_add(Weight::from_parts(66_972, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_779_342, 6811)
			// Standard Error: 8_133
			.saturating_add(Weight::from_parts(158_337, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}