...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(15_623_687, 3997)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(273, 0).saturating_mul(z.into()))
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(25_285_100, 6811)
			// Standard Error: 353
			.saturating_add(Weight::from_parts(81_542, 0).saturating_mul(s.into()))
			// Standard Error: 3
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(13_566_775, 6811)
			// Standard Error: 223
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(30_079_019, 6811)
			// Standard Error: 6_170
			.saturating_add(Weight::from_parts(128_671, 0).saturating_mul(s.into()))
			// Standard Error: 60
			.saturating_add(Weight::from_parts(1_328, 0).saturating_mul(z.into()))
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_525_252, 6811)
			// Standard Error: 510
			.saturating_add(Weight::from_parts(83_133, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(11_668_921, 6811)
			// Standard Error: 7_096
			.saturating_add(Weight::from_parts(136_634, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(_s: u32, ) -> Weight {
		...
		Weight::from_parts(37_017_410, 6811)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_307_863, 6811)
			// Standard Error: 533
			.saturating_add(Weight::from_parts(77_062, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}