...
impl<T: frame_system::Config> pallet_message_queue::WeightInfo for SubstrateWeight<T> {
	...
	fn ready_ring_knit() -> Weight {
		...
		Weight::from_parts(17_022_000, 6044)
	...
	fn ready_ring_unknit() -> Weight {
		...
		Weight::from_parts(15_159_000, 6044)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn service_queue_base() -> Weight {
		...
		Weight::from_parts(8_526_000, 3517)
	...
	fn service_page_base_completion() -> Weight {
		...
		Weight::from_parts(8_887_000, 69050)
	...
	fn service_page_base_no_completion() -> Weight {
		...
		Weight::from_parts(9_117_000, 69050)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_page_item() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 185_157_000 picoseconds.
		Weight::from_parts(192_229_000, 0)
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::ServiceHead` (r:1 w:1)
	/// Proof: `MessageQueue::ServiceHead` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
	...
	fn bump_service_head() -> Weight {
		...
		Weight::from_parts(9_558_000, 3517)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:0)
	...
	fn set_service_head() -> Weight {
		...
		Weight::from_parts(8_235_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn reap_page() -> Weight {
		...
		Weight::from_parts(72_526_000, 69050)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn execute_overweight_page_removed() -> Weight {
		...
		//  Measured:  `65709`
		//  Estimated: `69050`
		// Minimum execution time: 99_797_000 picoseconds.
		Weight::from_parts(104_175_000, 69050)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn execute_overweight_page_updated() -> Weight {
		...
		//  Measured:  `65709`
		//  Estimated: `69050`
		// Minimum execution time: 94_867_000 picoseconds.
		Weight::from_parts(97_292_000, 69050)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}