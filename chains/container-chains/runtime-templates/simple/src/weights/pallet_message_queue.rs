...
impl<T: frame_system::Config> pallet_message_queue::WeightInfo for SubstrateWeight<T> {
	...
	fn ready_ring_knit() -> Weight {
		...
		Weight::from_parts(11_481_000, 6044)
	...
	fn ready_ring_unknit() -> Weight {
		...
		Weight::from_parts(9_829_000, 6044)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn service_queue_base() -> Weight {
		...
		Weight::from_parts(5_952_000, 3517)
	...
	fn service_page_base_completion() -> Weight {
		...
		Weight::from_parts(6_122_000, 69050)
	...
	fn service_page_base_no_completion() -> Weight {
		...
		Weight::from_parts(6_312_000, 69050)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_page_item() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 131_486_000 picoseconds.
		Weight::from_parts(132_759_000, 0)
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::ServiceHead` (r:1 w:1)
	/// Proof: `MessageQueue::ServiceHead` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
	...
	fn bump_service_head() -> Weight {
		...
		Weight::from_parts(6_432_000, 3517)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:0)
	...
	fn set_service_head() -> Weight {
		...
		Weight::from_parts(5_500_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn reap_page() -> Weight {
		...
		Weight::from_parts(74_279_000, 69050)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn execute_overweight_page_removed() -> Weight {
		...
		//  Measured:  `65709`
		//  Estimated: `69050`
		// Minimum execution time: 105_939_000 picoseconds.
		Weight::from_parts(113_923_000, 69050)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn execute_overweight_page_updated() -> Weight {
		...
		Weight::from_parts(167_594_000, 69050)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}