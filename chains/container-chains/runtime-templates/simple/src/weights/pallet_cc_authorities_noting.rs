...
// --output=tmp/simple_template_weights/pallet_cc_authorities_noting.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_cc_authorities_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_authorities_data() -> Weight {
		...
		Weight::from_parts(23_204_000, 1663)
	...
	fn set_authorities(x: u32, ) -> Weight {
		...
		Weight::from_parts(4_321_880, 0)
			// Standard Error: 1_041
			.saturating_add(Weight::from_parts(16_533, 0).saturating_mul(x.into()))
