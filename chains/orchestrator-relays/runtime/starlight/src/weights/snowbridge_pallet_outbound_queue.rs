...
// raw.json
// --output
// tmp/starlight_weights/snowbridge_pallet_outbound_queue.rs
...
impl<T: frame_system::Config> snowbridge_pallet_outbound_queue::WeightInfo for SubstrateWeight<T> {
	...
	fn do_process_message() -> Weight {
		...
		Weight::from_parts(31_629_000, 3513)
	...
	fn commit() -> Weight {
		...
		Weight::from_parts(26_239_000, 2679)
	...
	fn commit_single() -> Weight {
		...
		Weight::from_parts(11_501_000, 1686)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}