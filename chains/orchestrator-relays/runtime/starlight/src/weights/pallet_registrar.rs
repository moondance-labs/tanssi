...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, z: u32, ) -> Weight {
		...
		//  Measured:  `544`
		//  Estimated: `4009`
		// Minimum execution time: 99_406_000 picoseconds.
		Weight::from_parts(117_813_484, 4009)
			// Standard Error: 0
			.saturating_add(Weight::from_parts(727, 0).saturating_mul(x.into()))
			// Standard Error: 149_062
			.saturating_add(Weight::from_parts(621_672, 0).saturating_mul(z.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(136_626_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(67_066_000, 5251)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6803`
		//  Estimated: `10268`
		// Minimum execution time: 156_012_000 picoseconds.
		Weight::from_parts(160_942_000, 10268)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(47_138_000, 2755)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, z: u32, ) -> Weight {
		...
		//  Measured:  `544`
		//  Estimated: `4009`
		// Minimum execution time: 103_454_000 picoseconds.
		Weight::from_parts(104_937_000, 4009)
			// Standard Error: 5
			.saturating_add(Weight::from_parts(824, 0).saturating_mul(x.into()))
			// Standard Error: 1_765_768
			.saturating_add(Weight::from_parts(405_611, 0).saturating_mul(z.into()))
			.saturating_add(T::DbWeight::get().reads(11_u64))
			.saturating_add(T::DbWeight::get().writes(15_u64))
	}
	/// Storage: `ContainerRegistrar::ParathreadParams` (r:1 w:0)
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(52_839_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(22_713_000, 3533)
