...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(108_135_573, 4009)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(819, 0).saturating_mul(x.into()))
			// Standard Error: 437_900
			.saturating_add(Weight::from_parts(1_103_207, 0).saturating_mul(z.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(111_408_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(67_937_000, 5251)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6803`
		//  Estimated: `10268`
		// Minimum execution time: 143_328_000 picoseconds.
		Weight::from_parts(149_199_000, 10268)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(46_037_000, 2755)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(46_326_000, 2755)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(73_169_104, 4009)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(824, 0).saturating_mul(x.into()))
			// Standard Error: 433_393
			.saturating_add(Weight::from_parts(3_548_564, 0).saturating_mul(z.into()))
			.saturating_add(T::DbWeight::get().reads(11_u64))
			.saturating_add(T::DbWeight::get().writes(15_u64))
	}
	/// Storage: `ContainerRegistrar::ParathreadParams` (r:1 w:0)
