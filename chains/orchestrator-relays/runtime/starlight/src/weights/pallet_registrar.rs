...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(144_620_933, 4009)
			// Standard Error: 0
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(113_032_000, 6196)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6803`
		//  Estimated: `10268`
		// Minimum execution time: 155_592_000 picoseconds.
		Weight::from_parts(160_881_000, 10268)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(46_608_000, 2755)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(47_980_000, 2755)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(101_260_000, 4009)
			// Standard Error: 4
			.saturating_add(Weight::from_parts(754, 0).saturating_mul(x.into()))
			// Standard Error: 1_473_188
			.saturating_add(Weight::from_parts(3_654_850, 0).saturating_mul(z.into()))
			.saturating_add(T::DbWeight::get().reads(11_u64))
			.saturating_add(T::DbWeight::get().writes(15_u64))
	}
	/// Storage: `ContainerRegistrar::ParathreadParams` (r:1 w:0)
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(47_830_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(12_614_000, 3533)
