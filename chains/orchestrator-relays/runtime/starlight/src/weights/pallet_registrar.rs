...
// --output=tmp/starlight_weights/pallet_registrar.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, z: u32, ) -> Weight {
		...
		//  Measured:  `544`
		//  Estimated: `4009`
		// Minimum execution time: 92_043_000 picoseconds.
		Weight::from_parts(1_797_856, 4009)
			// Standard Error: 4
			.saturating_add(Weight::from_parts(793, 0).saturating_mul(x.into()))
			// Standard Error: 1_438_710
			.saturating_add(Weight::from_parts(1_292_207, 0).saturating_mul(z.into()))
	...
	fn poke_deposit() -> Weight {
		...
		//  Measured:  `5000529`
		//  Estimated: `5003994`
		// Minimum execution time: 2_271_590_000 picoseconds.
		Weight::from_parts(2_593_343_000, 5003994)
	...
	fn deregister_immediate() -> Weight {
		...
		//  Measured:  `2995`
		//  Estimated: `6196`
		// Minimum execution time: 116_849_000 picoseconds.
		Weight::from_parts(123_532_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(72_826_000, 5251)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		Weight::from_parts(158_637_000, 10272)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(49_613_000, 2755)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(51_156_000, 2755)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaGenesisData` (r:1 w:1)
	...
	fn register_parathread(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(25_991_932, 4009)
			// Standard Error: 3
			.saturating_add(Weight::from_parts(833, 0).saturating_mul(x.into()))
			// Standard Error: 1_084_255
			.saturating_add(Weight::from_parts(802_360, 0).saturating_mul(z.into()))
			.saturating_add(T::DbWeight::get().reads(11_u64))
			.saturating_add(T::DbWeight::get().writes(15_u64))
	}
	/// Storage: `ContainerRegistrar::ParathreadParams` (r:1 w:0)
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(52_769_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
