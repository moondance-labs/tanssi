...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(33_846_696, 1527)
			// Standard Error: 8_777
			.saturating_add(Weight::from_parts(2_787_268, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(5_841_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `MaintenanceMode::MaintenanceMode` (r:1 w:0)
	/// Proof: `MaintenanceMode::MaintenanceMode` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_342_148, 1527)
			// Standard Error: 1_926
			.saturating_add(Weight::from_parts(3_026_466, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		//  Estimated: `1527`
		// Minimum execution time: 3_386_000 picoseconds.
		Weight::from_parts(3_323_182, 1527)
			// Standard Error: 1_599
			.saturating_add(Weight::from_parts(2_812_575, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn if_else() -> Weight {
		...
		Weight::from_parts(9_007_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}