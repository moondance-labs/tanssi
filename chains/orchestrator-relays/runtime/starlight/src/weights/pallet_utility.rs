...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_127_360, 1527)
			// Standard Error: 8_836
			.saturating_add(Weight::from_parts(3_257_564, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(6_633_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `MaintenanceMode::MaintenanceMode` (r:1 w:0)
	/// Proof: `MaintenanceMode::MaintenanceMode` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(23_080_680, 1527)
			// Standard Error: 3_323
			.saturating_add(Weight::from_parts(3_399_827, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		//  Estimated: `1527`
		// Minimum execution time: 3_677_000 picoseconds.
		Weight::from_parts(10_080_004, 1527)
			// Standard Error: 2_758
			.saturating_add(Weight::from_parts(3_149_493, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn if_else() -> Weight {
		...
		Weight::from_parts(10_018_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}