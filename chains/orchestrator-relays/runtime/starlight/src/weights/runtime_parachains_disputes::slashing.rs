...
// --output=tmp/starlight_weights/runtime_parachains_disputes::slashing.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for SubstrateWeight<T> {
	...
	fn report_dispute_lost(n: u32, ) -> Weight {
		...
		//  Measured:  `1116`
		//  Estimated: `4687`
		// Minimum execution time: 100_153_000 picoseconds.
		Weight::from_parts(117_601_963, 4687)
			// Standard Error: 5_764
			.saturating_add(Weight::from_parts(136_377, 0).saturating_mul(n.into()))
