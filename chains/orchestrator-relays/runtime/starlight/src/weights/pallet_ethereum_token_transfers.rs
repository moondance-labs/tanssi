...
// --output=tmp/starlight_weights/pallet_ethereum_token_transfers.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_ethereum_token_transfers::WeightInfo for SubstrateWeight<T> {
	...
	fn set_token_transfer_channel() -> Weight {
		...
		Weight::from_parts(25_658_000, 3541)
	...
	fn transfer_native_token() -> Weight {
		...
		//  Measured:  `1145`
		//  Estimated: `8799`
		// Minimum execution time: 162_555_000 picoseconds.
		Weight::from_parts(171_922_000, 8799)
