...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(38_612_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(11_411_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(12_027_068, 990)
			// Standard Error: 55_888
			.saturating_add(Weight::from_parts(13_583_267, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(30_527_000, 3593)
