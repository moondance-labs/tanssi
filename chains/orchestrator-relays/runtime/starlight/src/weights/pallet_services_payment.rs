...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(62_654_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(20_004_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_878_903, 990)
			// Standard Error: 13_338
			.saturating_add(Weight::from_parts(21_495_891, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(52_016_000, 3593)
