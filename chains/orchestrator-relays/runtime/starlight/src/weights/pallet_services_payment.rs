...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `162 + n * (133 ±0)`
		//  Estimated: `990 + n * (2603 ±0)`
		// Minimum execution time: 17_343_000 picoseconds.
		Weight::from_parts(7_627_856, 990)
			// Standard Error: 9_713
			.saturating_add(Weight::from_parts(13_387_622, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(32_060_000, 3593)
