...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(38_273_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_640_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(2_585_123, 990)
			// Standard Error: 5_650
			.saturating_add(Weight::from_parts(13_476_884, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(30_457_000, 3593)
