...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(39_434_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(11_231_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(3_577_486, 990)
			// Standard Error: 8_500
			.saturating_add(Weight::from_parts(13_933_842, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(31_108_000, 3593)
