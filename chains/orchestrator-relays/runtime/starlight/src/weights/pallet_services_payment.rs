...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(40_186_000, 6196)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_215_327, 990)
			// Standard Error: 19_321
			.saturating_add(Weight::from_parts(13_546_036, 0).saturating_mul(n.into()))
