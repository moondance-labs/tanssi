...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(38_292_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(11_251_000, 3517)
	...
	fn set_max_core_price() -> Weight {
		...
		Weight::from_parts(10_791_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(44_686_771, 990)
			// Standard Error: 293_244
			.saturating_add(Weight::from_parts(13_970_856, 0).saturating_mul(n.into()))
