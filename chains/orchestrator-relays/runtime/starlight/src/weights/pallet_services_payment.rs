...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(39_825_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(11_582_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(3_486_821, 990)
			// Standard Error: 6_639
			.saturating_add(Weight::from_parts(14_169_005, 0).saturating_mul(n.into()))
