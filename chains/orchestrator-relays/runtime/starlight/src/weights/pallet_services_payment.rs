...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(39_945_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(11_332_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(3_855_473, 990)
			// Standard Error: 9_611
			.saturating_add(Weight::from_parts(14_036_735, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(31_239_000, 3593)
