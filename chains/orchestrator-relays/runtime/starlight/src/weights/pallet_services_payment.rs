...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		//  Measured:  `192`
		//  Estimated: `6196`
		// Minimum execution time: 60_307_000 picoseconds.
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(19_462_000, 3517)
	...
	fn set_max_core_price() -> Weight {
		...
		Weight::from_parts(19_340_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_776_159, 990)
			// Standard Error: 13_060
			.saturating_add(Weight::from_parts(21_177_859, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(50_983_000, 3593)
