...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 254_238_000 picoseconds.
		Weight::from_parts(34_212_172, 26163213698918536)
			// Standard Error: 442_187
			.saturating_add(Weight::from_parts(94_590_564, 0).saturating_mul(u.into()))
			// Standard Error: 442_187
			.saturating_add(Weight::from_parts(105_840_502, 0).saturating_mul(h.into()))
			// Standard Error: 732_756
			.saturating_add(Weight::from_parts(35_800_117, 0).saturating_mul(c.into()))
