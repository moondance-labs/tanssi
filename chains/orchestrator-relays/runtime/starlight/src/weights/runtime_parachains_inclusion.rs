...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 248_997_000 picoseconds.
		Weight::from_parts(21_275_647, 26163213698918536)
			// Standard Error: 333_127
			.saturating_add(Weight::from_parts(93_254_586, 0).saturating_mul(u.into()))
			// Standard Error: 333_127
			.saturating_add(Weight::from_parts(103_668_043, 0).saturating_mul(h.into()))
			// Standard Error: 552_031
			.saturating_add(Weight::from_parts(47_252_721, 0).saturating_mul(c.into()))
