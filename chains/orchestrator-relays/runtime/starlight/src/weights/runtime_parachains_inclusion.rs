...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 268_573_000 picoseconds.
		Weight::from_parts(10_473_025, 26163213704008592)
			// Standard Error: 384_262
			.saturating_add(Weight::from_parts(102_600_073, 0).saturating_mul(u.into()))
			// Standard Error: 384_262
			.saturating_add(Weight::from_parts(113_438_397, 0).saturating_mul(h.into()))
			// Standard Error: 636_768
			.saturating_add(Weight::from_parts(56_988_540, 0).saturating_mul(c.into()))
