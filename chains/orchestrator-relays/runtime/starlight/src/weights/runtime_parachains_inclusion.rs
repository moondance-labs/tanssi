...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 246_862_000 picoseconds.
		Weight::from_parts(26_155_031, 36310)
			// Standard Error: 365_919
			.saturating_add(Weight::from_parts(90_374_516, 0).saturating_mul(u.into()))
			// Standard Error: 365_919
			.saturating_add(Weight::from_parts(101_102_635, 0).saturating_mul(h.into()))
			// Standard Error: 606_371
			.saturating_add(Weight::from_parts(48_013_482, 0).saturating_mul(c.into()))
