...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(19_009_580, 26163213698918536)
			// Standard Error: 360_790
			.saturating_add(Weight::from_parts(97_448_012, 0).saturating_mul(u.into()))
			// Standard Error: 360_790
			.saturating_add(Weight::from_parts(108_902_793, 0).saturating_mul(h.into()))
			// Standard Error: 597_873
			.saturating_add(Weight::from_parts(51_752_673, 0).saturating_mul(c.into()))
