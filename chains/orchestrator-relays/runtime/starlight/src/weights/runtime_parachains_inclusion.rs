...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(25_025_070, 36310)
			// Standard Error: 359_018
			.saturating_add(Weight::from_parts(95_650_488, 0).saturating_mul(u.into()))
			// Standard Error: 359_018
			.saturating_add(Weight::from_parts(108_016_299, 0).saturating_mul(h.into()))
			// Standard Error: 594_935
			.saturating_add(Weight::from_parts(52_480_840, 0).saturating_mul(c.into()))
