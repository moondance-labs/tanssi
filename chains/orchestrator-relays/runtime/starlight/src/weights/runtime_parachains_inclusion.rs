...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 259_767_000 picoseconds.
		Weight::from_parts(22_492_031, 36310)
			// Standard Error: 420_757
			.saturating_add(Weight::from_parts(94_900_370, 0).saturating_mul(u.into()))
			// Standard Error: 420_757
			.saturating_add(Weight::from_parts(107_342_769, 0).saturating_mul(h.into()))
			// Standard Error: 697_245
			.saturating_add(Weight::from_parts(52_810_086, 0).saturating_mul(c.into()))
