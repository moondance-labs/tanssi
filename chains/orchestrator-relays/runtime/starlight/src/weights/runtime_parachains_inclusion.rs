...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 251_221_000 picoseconds.
		Weight::from_parts(21_802_906, 26163213698918536)
			// Standard Error: 354_731
			.saturating_add(Weight::from_parts(94_075_415, 0).saturating_mul(u.into()))
			// Standard Error: 354_731
			.saturating_add(Weight::from_parts(105_057_685, 0).saturating_mul(h.into()))
			// Standard Error: 587_832
			.saturating_add(Weight::from_parts(45_896_740, 0).saturating_mul(c.into()))
