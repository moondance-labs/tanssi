...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 256_039_000 picoseconds.
		Weight::from_parts(21_129_362, 26163213698918536)
			// Standard Error: 357_198
			.saturating_add(Weight::from_parts(95_411_462, 0).saturating_mul(u.into()))
			// Standard Error: 357_198
			.saturating_add(Weight::from_parts(106_558_643, 0).saturating_mul(h.into()))
			// Standard Error: 591_921
			.saturating_add(Weight::from_parts(48_537_171, 0).saturating_mul(c.into()))
