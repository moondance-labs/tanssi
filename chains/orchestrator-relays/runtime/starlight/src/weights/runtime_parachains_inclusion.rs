...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±271) + h * (7630 ±347) + u * (20830 ±346)`
		// Minimum execution time: 260_920_000 picoseconds.
		Weight::from_parts(18_043_827, 26163213698918536)
			// Standard Error: 355_583
			.saturating_add(Weight::from_parts(97_044_938, 0).saturating_mul(u.into()))
			// Standard Error: 355_583
			.saturating_add(Weight::from_parts(108_995_858, 0).saturating_mul(h.into()))
			// Standard Error: 589_243
			.saturating_add(Weight::from_parts(53_092_887, 0).saturating_mul(c.into()))
