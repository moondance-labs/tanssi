...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 440_927_000 picoseconds.
		Weight::from_parts(57_687_712, 36310)
			// Standard Error: 626_070
			.saturating_add(Weight::from_parts(153_263_418, 0).saturating_mul(u.into()))
			// Standard Error: 626_070
			.saturating_add(Weight::from_parts(169_648_365, 0).saturating_mul(h.into()))
			// Standard Error: 1_037_473
			.saturating_add(Weight::from_parts(87_031_018, 0).saturating_mul(c.into()))
