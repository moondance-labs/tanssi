...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213704008592 + c * (16000 ±271) + h * (7630 ±0) + u * (20830 ±147)`
		// Minimum execution time: 274_393_000 picoseconds.
		Weight::from_parts(38_584_451, 26163213704008592)
			// Standard Error: 204_254
			.saturating_add(Weight::from_parts(100_564_496, 0).saturating_mul(u.into()))
			// Standard Error: 204_254
			.saturating_add(Weight::from_parts(112_915_254, 0).saturating_mul(h.into()))
			// Standard Error: 338_474
			.saturating_add(Weight::from_parts(41_248_153, 0).saturating_mul(c.into()))
