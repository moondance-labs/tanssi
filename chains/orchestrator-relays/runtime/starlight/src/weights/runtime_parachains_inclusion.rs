...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213704008592 + c * (16000 ±370) + h * (7630 ±350) + u * (20830 ±214)`
		// Minimum execution time: 269_766_000 picoseconds.
		Weight::from_parts(27_532_673, 26163213704008592)
			// Standard Error: 358_391
			.saturating_add(Weight::from_parts(100_115_594, 0).saturating_mul(u.into()))
			// Standard Error: 358_391
			.saturating_add(Weight::from_parts(112_058_697, 0).saturating_mul(h.into()))
			// Standard Error: 593_897
			.saturating_add(Weight::from_parts(46_881_616, 0).saturating_mul(c.into()))
