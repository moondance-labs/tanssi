...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 270_889_000 picoseconds.
		Weight::from_parts(21_432_393, 26163213698918536)
			// Standard Error: 373_914
			.saturating_add(Weight::from_parts(101_963_311, 0).saturating_mul(u.into()))
			// Standard Error: 373_914
			.saturating_add(Weight::from_parts(113_215_566, 0).saturating_mul(h.into()))
			// Standard Error: 619_620
			.saturating_add(Weight::from_parts(50_693_348, 0).saturating_mul(c.into()))
