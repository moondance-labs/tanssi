...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 267_312_000 picoseconds.
		Weight::from_parts(43_678_033, 26163213704008592)
			// Standard Error: 147_257
			.saturating_add(Weight::from_parts(94_913_282, 0).saturating_mul(u.into()))
			// Standard Error: 147_257
			.saturating_add(Weight::from_parts(108_288_763, 0).saturating_mul(h.into()))
			// Standard Error: 244_023
			.saturating_add(Weight::from_parts(40_034_006, 0).saturating_mul(c.into()))
