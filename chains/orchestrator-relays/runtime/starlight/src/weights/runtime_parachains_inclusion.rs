...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 266_017_000 picoseconds.
		Weight::from_parts(39_538_642, 26163213704008592)
			// Standard Error: 293_046
			.saturating_add(Weight::from_parts(99_728_642, 0).saturating_mul(u.into()))
			// Standard Error: 293_046
			.saturating_add(Weight::from_parts(104_696_499, 0).saturating_mul(h.into()))
			// Standard Error: 485_613
			.saturating_add(Weight::from_parts(39_617_388, 0).saturating_mul(c.into()))
