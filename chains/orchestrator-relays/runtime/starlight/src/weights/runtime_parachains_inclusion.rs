...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(24_171_230, 36310)
			// Standard Error: 387_765
			.saturating_add(Weight::from_parts(95_074_561, 0).saturating_mul(u.into()))
			// Standard Error: 387_765
			.saturating_add(Weight::from_parts(106_052_760, 0).saturating_mul(h.into()))
			// Standard Error: 642_572
			.saturating_add(Weight::from_parts(53_301_969, 0).saturating_mul(c.into()))
