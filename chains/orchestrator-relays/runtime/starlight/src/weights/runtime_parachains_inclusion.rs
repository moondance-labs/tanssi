...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(22_361_708, 26163213698918536)
			// Standard Error: 347_209
			.saturating_add(Weight::from_parts(94_512_104, 0).saturating_mul(u.into()))
			// Standard Error: 347_209
			.saturating_add(Weight::from_parts(106_683_081, 0).saturating_mul(h.into()))
			// Standard Error: 575_367
			.saturating_add(Weight::from_parts(52_469_140, 0).saturating_mul(c.into()))
