...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 245_042_000 picoseconds.
		Weight::from_parts(21_986_566, 26163213698918536)
			// Standard Error: 359_912
			.saturating_add(Weight::from_parts(92_907_035, 0).saturating_mul(u.into()))
			// Standard Error: 359_912
			.saturating_add(Weight::from_parts(102_857_767, 0).saturating_mul(h.into()))
			// Standard Error: 596_418
			.saturating_add(Weight::from_parts(46_527_128, 0).saturating_mul(c.into()))
