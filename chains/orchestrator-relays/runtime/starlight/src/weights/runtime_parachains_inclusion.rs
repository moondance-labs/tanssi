...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 259_055_000 picoseconds.
		Weight::from_parts(21_480_033, 26163213704008592)
			// Standard Error: 364_620
			.saturating_add(Weight::from_parts(93_160_583, 0).saturating_mul(u.into()))
			// Standard Error: 364_620
			.saturating_add(Weight::from_parts(105_233_326, 0).saturating_mul(h.into()))
			// Standard Error: 604_219
			.saturating_add(Weight::from_parts(54_343_038, 0).saturating_mul(c.into()))
