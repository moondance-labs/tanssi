...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213704008592 + c * (16000 ±271) + h * (7630 ±350) + u * (20830 ±349)`
		// Minimum execution time: 273_172_000 picoseconds.
		Weight::from_parts(22_964_210, 26163213704008592)
			// Standard Error: 382_467
			.saturating_add(Weight::from_parts(102_205_527, 0).saturating_mul(u.into()))
			// Standard Error: 382_467
			.saturating_add(Weight::from_parts(114_059_472, 0).saturating_mul(h.into()))
			// Standard Error: 633_794
			.saturating_add(Weight::from_parts(52_100_219, 0).saturating_mul(c.into()))
