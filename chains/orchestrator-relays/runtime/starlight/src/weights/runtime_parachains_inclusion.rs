...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 442_438_000 picoseconds.
		Weight::from_parts(59_304_678, 26163213698918536)
			// Standard Error: 609_350
			.saturating_add(Weight::from_parts(153_554_136, 0).saturating_mul(u.into()))
			// Standard Error: 609_350
			.saturating_add(Weight::from_parts(168_078_114, 0).saturating_mul(h.into()))
			// Standard Error: 1_009_766
			.saturating_add(Weight::from_parts(85_947_783, 0).saturating_mul(c.into()))
