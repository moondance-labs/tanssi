...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213704008592 + c * (16000 ±370) + h * (7630 ±0) + u * (20830 ±214)`
		// Minimum execution time: 252_534_000 picoseconds.
		Weight::from_parts(23_099_669, 26163213704008592)
			// Standard Error: 398_509
			.saturating_add(Weight::from_parts(93_233_722, 0).saturating_mul(u.into()))
			// Standard Error: 398_509
			.saturating_add(Weight::from_parts(104_901_566, 0).saturating_mul(h.into()))
			// Standard Error: 660_377
			.saturating_add(Weight::from_parts(48_190_523, 0).saturating_mul(c.into()))
