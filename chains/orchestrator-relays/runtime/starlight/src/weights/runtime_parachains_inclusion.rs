...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 250_289_000 picoseconds.
		Weight::from_parts(18_516_799, 26163213698918536)
			// Standard Error: 364_214
			.saturating_add(Weight::from_parts(96_520_503, 0).saturating_mul(u.into()))
			// Standard Error: 364_214
			.saturating_add(Weight::from_parts(106_560_372, 0).saturating_mul(h.into()))
			// Standard Error: 603_547
			.saturating_add(Weight::from_parts(48_149_838, 0).saturating_mul(c.into()))
