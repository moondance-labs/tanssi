...
// --output=tmp/starlight_weights/runtime_parachains_inclusion.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 265_258_000 picoseconds.
		Weight::from_parts(22_970_256, 36310)
			// Standard Error: 343_482
			.saturating_add(Weight::from_parts(98_415_638, 0).saturating_mul(u.into()))
			// Standard Error: 343_482
			.saturating_add(Weight::from_parts(109_280_299, 0).saturating_mul(h.into()))
			// Standard Error: 569_192
			.saturating_add(Weight::from_parts(48_703_639, 0).saturating_mul(c.into()))
