...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(25_347_888, 36310)
			// Standard Error: 345_872
			.saturating_add(Weight::from_parts(93_263_059, 0).saturating_mul(u.into()))
			// Standard Error: 345_872
			.saturating_add(Weight::from_parts(104_723_000, 0).saturating_mul(h.into()))
			// Standard Error: 573_152
			.saturating_add(Weight::from_parts(49_615_925, 0).saturating_mul(c.into()))
