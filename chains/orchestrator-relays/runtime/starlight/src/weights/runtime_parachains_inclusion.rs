...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 246_481_000 picoseconds.
		Weight::from_parts(22_948_751, 36310)
			// Standard Error: 384_035
			.saturating_add(Weight::from_parts(90_607_866, 0).saturating_mul(u.into()))
			// Standard Error: 384_035
			.saturating_add(Weight::from_parts(101_699_484, 0).saturating_mul(h.into()))
			// Standard Error: 636_392
			.saturating_add(Weight::from_parts(50_511_315, 0).saturating_mul(c.into()))
