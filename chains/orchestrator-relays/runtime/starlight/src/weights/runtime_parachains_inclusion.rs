...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 246_131_000 picoseconds.
		Weight::from_parts(19_596_894, 36310)
			// Standard Error: 359_738
			.saturating_add(Weight::from_parts(91_834_716, 0).saturating_mul(u.into()))
			// Standard Error: 359_738
			.saturating_add(Weight::from_parts(102_417_804, 0).saturating_mul(h.into()))
			// Standard Error: 596_129
			.saturating_add(Weight::from_parts(50_381_261, 0).saturating_mul(c.into()))
