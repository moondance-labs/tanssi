...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(21_879_383, 36310)
			// Standard Error: 361_287
			.saturating_add(Weight::from_parts(93_936_607, 0).saturating_mul(u.into()))
			// Standard Error: 361_287
			.saturating_add(Weight::from_parts(104_903_336, 0).saturating_mul(h.into()))
			// Standard Error: 598_697
			.saturating_add(Weight::from_parts(51_540_136, 0).saturating_mul(c.into()))
