...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213704008592 + c * (16000 ±271) + h * (7630 ±353) + u * (20830 ±352)`
		// Minimum execution time: 256_089_000 picoseconds.
		Weight::from_parts(44_836_614, 26163213704008592)
			// Standard Error: 148_937
			.saturating_add(Weight::from_parts(91_338_903, 0).saturating_mul(u.into()))
			// Standard Error: 148_937
			.saturating_add(Weight::from_parts(105_484_843, 0).saturating_mul(h.into()))
			// Standard Error: 246_806
			.saturating_add(Weight::from_parts(37_615_118, 0).saturating_mul(c.into()))
