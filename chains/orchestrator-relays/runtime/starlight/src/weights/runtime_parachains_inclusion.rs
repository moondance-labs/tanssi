...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 259_116_000 picoseconds.
		Weight::from_parts(21_933_189, 26163213698918536)
			// Standard Error: 371_115
			.saturating_add(Weight::from_parts(97_644_128, 0).saturating_mul(u.into()))
			// Standard Error: 371_115
			.saturating_add(Weight::from_parts(108_646_275, 0).saturating_mul(h.into()))
			// Standard Error: 614_982
			.saturating_add(Weight::from_parts(47_912_872, 0).saturating_mul(c.into()))
