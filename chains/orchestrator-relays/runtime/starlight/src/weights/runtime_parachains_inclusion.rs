...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 264_224_000 picoseconds.
		Weight::from_parts(27_158_332, 26163213704008592)
			// Standard Error: 361_211
			.saturating_add(Weight::from_parts(97_178_307, 0).saturating_mul(u.into()))
			// Standard Error: 361_211
			.saturating_add(Weight::from_parts(107_936_737, 0).saturating_mul(h.into()))
			// Standard Error: 598_571
			.saturating_add(Weight::from_parts(47_553_825, 0).saturating_mul(c.into()))
