...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 439_748_000 picoseconds.
		Weight::from_parts(79_230_314, 26163213704008592)
			// Standard Error: 382_993
			.saturating_add(Weight::from_parts(149_982_315, 0).saturating_mul(u.into()))
			// Standard Error: 382_993
			.saturating_add(Weight::from_parts(164_248_181, 0).saturating_mul(h.into()))
			// Standard Error: 634_665
			.saturating_add(Weight::from_parts(75_547_818, 0).saturating_mul(c.into()))
