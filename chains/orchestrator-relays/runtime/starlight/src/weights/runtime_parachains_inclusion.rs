...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213704008592 + c * (16000 ±0) + h * (7630 ±350) + u * (20830 ±349)`
		// Minimum execution time: 266_599_000 picoseconds.
		Weight::from_parts(40_728_201, 26163213704008592)
			// Standard Error: 179_814
			.saturating_add(Weight::from_parts(96_358_420, 0).saturating_mul(u.into()))
			// Standard Error: 179_814
			.saturating_add(Weight::from_parts(110_318_554, 0).saturating_mul(h.into()))
			// Standard Error: 297_973
			.saturating_add(Weight::from_parts(43_193_785, 0).saturating_mul(c.into()))
