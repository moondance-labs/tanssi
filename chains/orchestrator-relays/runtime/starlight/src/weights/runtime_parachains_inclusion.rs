...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±288) + h * (7630 ±363) + u * (20830 ±156)`
		// Minimum execution time: 246_983_000 picoseconds.
		Weight::from_parts(22_590_612, 26163213698918536)
			// Standard Error: 344_760
			.saturating_add(Weight::from_parts(90_308_514, 0).saturating_mul(u.into()))
			// Standard Error: 344_760
			.saturating_add(Weight::from_parts(101_132_605, 0).saturating_mul(h.into()))
			// Standard Error: 571_309
			.saturating_add(Weight::from_parts(48_721_477, 0).saturating_mul(c.into()))
