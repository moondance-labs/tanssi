...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 444_737_000 picoseconds.
		Weight::from_parts(49_736_766, 26163213704008592)
			// Standard Error: 628_881
			.saturating_add(Weight::from_parts(155_513_423, 0).saturating_mul(u.into()))
			// Standard Error: 628_881
			.saturating_add(Weight::from_parts(169_507_399, 0).saturating_mul(h.into()))
			// Standard Error: 1_042_131
			.saturating_add(Weight::from_parts(98_006_988, 0).saturating_mul(c.into()))
