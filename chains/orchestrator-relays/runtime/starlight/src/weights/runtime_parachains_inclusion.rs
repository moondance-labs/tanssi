...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 246_251_000 picoseconds.
		Weight::from_parts(19_623_842, 36310)
			// Standard Error: 358_678
			.saturating_add(Weight::from_parts(90_313_430, 0).saturating_mul(u.into()))
			// Standard Error: 358_678
			.saturating_add(Weight::from_parts(101_310_198, 0).saturating_mul(h.into()))
			// Standard Error: 594_372
			.saturating_add(Weight::from_parts(51_385_859, 0).saturating_mul(c.into()))
