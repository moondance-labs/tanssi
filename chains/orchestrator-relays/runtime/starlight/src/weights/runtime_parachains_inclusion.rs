...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 269_435_000 picoseconds.
		Weight::from_parts(20_695_473, 26163213704008592)
			// Standard Error: 377_449
			.saturating_add(Weight::from_parts(99_711_797, 0).saturating_mul(u.into()))
			// Standard Error: 377_449
			.saturating_add(Weight::from_parts(111_436_393, 0).saturating_mul(h.into()))
			// Standard Error: 625_478
			.saturating_add(Weight::from_parts(53_623_250, 0).saturating_mul(c.into()))
