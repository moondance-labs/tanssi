...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 262_524_000 picoseconds.
		Weight::from_parts(42_315_630, 26163213704008592)
			// Standard Error: 167_680
			.saturating_add(Weight::from_parts(94_372_850, 0).saturating_mul(u.into()))
			// Standard Error: 167_680
			.saturating_add(Weight::from_parts(107_084_438, 0).saturating_mul(h.into()))
			// Standard Error: 277_866
			.saturating_add(Weight::from_parts(41_484_375, 0).saturating_mul(c.into()))
