...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 260_679_000 picoseconds.
		Weight::from_parts(24_517_477, 36310)
			// Standard Error: 355_933
			.saturating_add(Weight::from_parts(94_886_619, 0).saturating_mul(u.into()))
			// Standard Error: 355_933
			.saturating_add(Weight::from_parts(106_807_860, 0).saturating_mul(h.into()))
			// Standard Error: 589_824
			.saturating_add(Weight::from_parts(50_679_761, 0).saturating_mul(c.into()))
