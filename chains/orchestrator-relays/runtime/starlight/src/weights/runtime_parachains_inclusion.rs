...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(23_924_469, 26163213704008592)
			// Standard Error: 382_836
			.saturating_add(Weight::from_parts(100_567_148, 0).saturating_mul(u.into()))
			// Standard Error: 382_836
			.saturating_add(Weight::from_parts(112_216_829, 0).saturating_mul(h.into()))
			// Standard Error: 634_405
			.saturating_add(Weight::from_parts(50_367_830, 0).saturating_mul(c.into()))
