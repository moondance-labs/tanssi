...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(26_848_220, 36310)
			// Standard Error: 365_238
			.saturating_add(Weight::from_parts(89_661_635, 0).saturating_mul(u.into()))
			// Standard Error: 365_238
			.saturating_add(Weight::from_parts(100_265_115, 0).saturating_mul(h.into()))
			// Standard Error: 605_243
			.saturating_add(Weight::from_parts(47_583_116, 0).saturating_mul(c.into()))
