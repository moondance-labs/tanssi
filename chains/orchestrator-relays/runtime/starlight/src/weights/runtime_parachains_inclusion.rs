...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 260_248_000 picoseconds.
		Weight::from_parts(22_580_952, 36310)
			// Standard Error: 359_159
			.saturating_add(Weight::from_parts(95_467_805, 0).saturating_mul(u.into()))
			// Standard Error: 359_159
			.saturating_add(Weight::from_parts(107_387_696, 0).saturating_mul(h.into()))
			// Standard Error: 595_170
			.saturating_add(Weight::from_parts(51_524_805, 0).saturating_mul(c.into()))
