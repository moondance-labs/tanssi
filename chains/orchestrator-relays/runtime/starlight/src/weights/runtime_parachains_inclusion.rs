...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(24_324_437, 26163213704008592)
			// Standard Error: 357_567
			.saturating_add(Weight::from_parts(101_562_440, 0).saturating_mul(u.into()))
			// Standard Error: 357_567
			.saturating_add(Weight::from_parts(113_071_527, 0).saturating_mul(h.into()))
			// Standard Error: 592_531
			.saturating_add(Weight::from_parts(50_139_717, 0).saturating_mul(c.into()))
