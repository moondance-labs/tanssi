...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 438_504_000 picoseconds.
		Weight::from_parts(52_128_385, 26163213704008592)
			// Standard Error: 602_095
			.saturating_add(Weight::from_parts(153_955_815, 0).saturating_mul(u.into()))
			// Standard Error: 602_095
			.saturating_add(Weight::from_parts(167_205_307, 0).saturating_mul(h.into()))
			// Standard Error: 997_744
			.saturating_add(Weight::from_parts(89_340_951, 0).saturating_mul(c.into()))
