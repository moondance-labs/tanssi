...
impl<T: frame_system::Config> pallet_balances::WeightInfo for SubstrateWeight<T> {
	...
	fn transfer_allow_death() -> Weight {
		...
		Weight::from_parts(40_967_000, 3593)
	...
	fn transfer_keep_alive() -> Weight {
		...
		Weight::from_parts(32_271_000, 3593)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn force_set_balance_creating() -> Weight {
		...
		Weight::from_parts(12_223_000, 3593)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn force_set_balance_killing() -> Weight {
		...
		Weight::from_parts(17_833_000, 3593)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn force_transfer() -> Weight {
		...
		Weight::from_parts(42_951_000, 6196)
	...
	fn transfer_all() -> Weight {
		...
		Weight::from_parts(40_627_000, 3593)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn force_unreserve() -> Weight {
		...
		Weight::from_parts(14_697_000, 3593)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn upgrade_accounts(u: u32, ) -> Weight {
		...
		Weight::from_parts(14_557_000, 990)
			...
			.saturating_add(Weight::from_parts(11_902_837, 0).saturating_mul(u.into()))
