...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(12_603_531, 1527)
			// Standard Error: 25
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(26_725_163, 6811)
			// Standard Error: 2_366
			.saturating_add(Weight::from_parts(57_825, 0).saturating_mul(s.into()))
			// Standard Error: 23
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(14_455_858, 6811)
			// Standard Error: 1_745
			.saturating_add(Weight::from_parts(61_272, 0).saturating_mul(s.into()))
			// Standard Error: 17
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(28_117_555, 6811)
			// Standard Error: 4_366
			.saturating_add(Weight::from_parts(103_076, 0).saturating_mul(s.into()))
			// Standard Error: 42
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_272_529, 6811)
			// Standard Error: 1_658
			.saturating_add(Weight::from_parts(70_414, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(12_963_783, 6811)
			// Standard Error: 708
			.saturating_add(Weight::from_parts(59_943, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_940_293, 6811)
			// Standard Error: 1_575
			.saturating_add(Weight::from_parts(69_791, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_499_061, 6811)
