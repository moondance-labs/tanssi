...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(12_157_794, 1527)
			// Standard Error: 9
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(25_971_350, 6811)
			// Standard Error: 2_254
			.saturating_add(Weight::from_parts(72_371, 0).saturating_mul(s.into()))
			// Standard Error: 22
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(14_226_321, 6811)
			// Standard Error: 1_133
			.saturating_add(Weight::from_parts(60_992, 0).saturating_mul(s.into()))
			// Standard Error: 11
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(27_706_024, 6811)
			// Standard Error: 5_337
			.saturating_add(Weight::from_parts(108_620, 0).saturating_mul(s.into()))
			// Standard Error: 52
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(25_219_918, 6811)
			// Standard Error: 607
			.saturating_add(Weight::from_parts(65_585, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_330_009, 6811)
			// Standard Error: 409
			.saturating_add(Weight::from_parts(57_303, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_943_187, 6811)
			// Standard Error: 553
			.saturating_add(Weight::from_parts(64_249, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_398_978, 6811)
			// Standard Error: 415
			.saturating_add(Weight::from_parts(63_153, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}