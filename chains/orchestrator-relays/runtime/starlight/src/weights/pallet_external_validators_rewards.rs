...
// --output=tmp/starlight_weights/pallet_external_validators_rewards.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_external_validators_rewards::WeightInfo for SubstrateWeight<T> {
	...
	fn on_era_end() -> Weight {
		...
		//  Measured:  `37690`
		//  Estimated: `41155`
		// Minimum execution time: 1_073_896_000 picoseconds.
		Weight::from_parts(1_090_809_000, 41155)
