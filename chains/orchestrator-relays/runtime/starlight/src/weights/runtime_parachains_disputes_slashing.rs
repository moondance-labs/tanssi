...
// raw.json
// --output
// tmp/starlight_weights/runtime_parachains_disputes::slashing.rs
...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for SubstrateWeight<T> {
	...
	fn report_dispute_lost(n: u32, ) -> Weight {
		...
		//  Measured:  `1046`
		//  Estimated: `4687`
		// Minimum execution time: 91_908_000 picoseconds.
		Weight::from_parts(123_932_279, 4687)
			// Standard Error: 27_800
			.saturating_add(Weight::from_parts(367_504, 0).saturating_mul(n.into()))
