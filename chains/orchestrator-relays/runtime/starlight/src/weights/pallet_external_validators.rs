...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_144_475, 4687)
			// Standard Error: 966
			.saturating_add(Weight::from_parts(51_815, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_726_021, 4687)
			// Standard Error: 551
			.saturating_add(Weight::from_parts(37_546, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_151_106, 4687)
			// Standard Error: 671
			.saturating_add(Weight::from_parts(129_242, 0).saturating_mul(r.into()))
