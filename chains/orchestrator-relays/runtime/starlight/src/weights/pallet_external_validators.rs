...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1027 + b * (36 ±0)`
		//  Estimated: `4687 + b * (37 ±0)`
		// Minimum execution time: 16_962_000 picoseconds.
		Weight::from_parts(19_975_387, 4687)
			// Standard Error: 4_117
			.saturating_add(Weight::from_parts(66_050, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_548_665, 4687)
			// Standard Error: 3_886
			.saturating_add(Weight::from_parts(51_029, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(17_851_557, 4687)
			// Standard Error: 3_237
			.saturating_add(Weight::from_parts(151_773, 0).saturating_mul(r.into()))
