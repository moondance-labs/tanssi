...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_103_319, 4687)
			// Standard Error: 13_130
			.saturating_add(Weight::from_parts(185_442, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_143_880, 4687)
			// Standard Error: 5_643
			.saturating_add(Weight::from_parts(205_831, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_077_185, 4687)
			// Standard Error: 4_754
			.saturating_add(Weight::from_parts(287_232, 0).saturating_mul(r.into()))
