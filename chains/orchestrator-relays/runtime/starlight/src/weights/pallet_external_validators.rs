...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(31_782_840, 4687)
			// Standard Error: 1_958
			.saturating_add(Weight::from_parts(111_289, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_655_822, 4687)
			// Standard Error: 1_308
			.saturating_add(Weight::from_parts(78_292, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(29_531_941, 4687)
			// Standard Error: 1_614
			.saturating_add(Weight::from_parts(222_075, 0).saturating_mul(r.into()))
