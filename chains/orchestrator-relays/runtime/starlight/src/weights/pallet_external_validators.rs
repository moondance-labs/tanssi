...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_143_978, 4687)
			// Standard Error: 8_507
			.saturating_add(Weight::from_parts(217_162, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_297_924, 4687)
			// Standard Error: 6_482
			.saturating_add(Weight::from_parts(184_867, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_350_247, 4687)
			// Standard Error: 7_066
			.saturating_add(Weight::from_parts(268_963, 0).saturating_mul(r.into()))
