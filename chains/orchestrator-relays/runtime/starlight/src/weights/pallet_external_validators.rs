...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_343_714, 4687)
			// Standard Error: 12_975
			.saturating_add(Weight::from_parts(255_998, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_451_681, 4687)
			// Standard Error: 6_766
			.saturating_add(Weight::from_parts(183_585, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_091_301, 4687)
			// Standard Error: 6_033
			.saturating_add(Weight::from_parts(245_445, 0).saturating_mul(r.into()))
