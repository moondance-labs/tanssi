...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_131_489, 4687)
			// Standard Error: 7_585
			.saturating_add(Weight::from_parts(192_049, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_731_144, 4687)
			// Standard Error: 6_994
			.saturating_add(Weight::from_parts(138_144, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(11_693_883, 4687)
			// Standard Error: 8_039
			.saturating_add(Weight::from_parts(324_957, 0).saturating_mul(r.into()))
