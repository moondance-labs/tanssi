...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_357_291, 4687)
			// Standard Error: 6_262
			.saturating_add(Weight::from_parts(217_450, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_295_094, 4687)
			// Standard Error: 7_132
			.saturating_add(Weight::from_parts(160_758, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_417_848, 4687)
			// Standard Error: 6_580
			.saturating_add(Weight::from_parts(263_417, 0).saturating_mul(r.into()))
