...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_236_747, 4687)
			// Standard Error: 7_309
			.saturating_add(Weight::from_parts(105_633, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_042_248, 4687)
			// Standard Error: 4_803
			.saturating_add(Weight::from_parts(106_351, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_400_214, 4687)
			// Standard Error: 1_754
			.saturating_add(Weight::from_parts(172_456, 0).saturating_mul(r.into()))
