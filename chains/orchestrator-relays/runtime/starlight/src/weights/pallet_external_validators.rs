...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_196_876, 4687)
			// Standard Error: 1_066
			.saturating_add(Weight::from_parts(57_404, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_989_885, 4687)
			// Standard Error: 578
			.saturating_add(Weight::from_parts(42_099, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_885_336, 4687)
			// Standard Error: 1_072
			.saturating_add(Weight::from_parts(154_471, 0).saturating_mul(r.into()))
