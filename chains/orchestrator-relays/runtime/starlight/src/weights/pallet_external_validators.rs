...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_570_298, 4687)
			// Standard Error: 1_754
			.saturating_add(Weight::from_parts(97_433, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_216_537, 4687)
			// Standard Error: 1_528
			.saturating_add(Weight::from_parts(78_916, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_742_742, 4687)
			// Standard Error: 4_429
			.saturating_add(Weight::from_parts(169_477, 0).saturating_mul(r.into()))
