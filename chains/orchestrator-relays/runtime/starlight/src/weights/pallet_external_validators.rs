...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(31_783_934, 4687)
			// Standard Error: 3_035
			.saturating_add(Weight::from_parts(154_260, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_249_407, 4687)
			// Standard Error: 1_608
			.saturating_add(Weight::from_parts(125_744, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(29_190_664, 4687)
			// Standard Error: 2_962
			.saturating_add(Weight::from_parts(261_790, 0).saturating_mul(r.into()))
