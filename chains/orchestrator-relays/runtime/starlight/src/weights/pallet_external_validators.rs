...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_836_750, 4687)
			// Standard Error: 1_085
			.saturating_add(Weight::from_parts(54_838, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_644_184, 4687)
			// Standard Error: 700
			.saturating_add(Weight::from_parts(41_401, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_797_018, 4687)
			// Standard Error: 704
			.saturating_add(Weight::from_parts(135_563, 0).saturating_mul(r.into()))
