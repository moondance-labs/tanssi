...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_040_033, 4687)
			// Standard Error: 13_945
			.saturating_add(Weight::from_parts(257_561, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_578_313, 4687)
			// Standard Error: 5_817
			.saturating_add(Weight::from_parts(181_247, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_862_334, 4687)
			// Standard Error: 7_397
			.saturating_add(Weight::from_parts(284_884, 0).saturating_mul(r.into()))
