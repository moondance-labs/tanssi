...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_864_575, 4687)
			// Standard Error: 1_094
			.saturating_add(Weight::from_parts(58_836, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_913_991, 4687)
			// Standard Error: 650
			.saturating_add(Weight::from_parts(41_371, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(18_008_189, 4687)
			// Standard Error: 624
			.saturating_add(Weight::from_parts(146_908, 0).saturating_mul(r.into()))
