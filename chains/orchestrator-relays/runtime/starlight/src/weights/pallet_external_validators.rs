...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(30_600_834, 4687)
			// Standard Error: 2_594
			.saturating_add(Weight::from_parts(168_118, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_714_674, 4687)
			// Standard Error: 2_210
			.saturating_add(Weight::from_parts(135_538, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(26_498_891, 4687)
			// Standard Error: 10_388
			.saturating_add(Weight::from_parts(324_995, 0).saturating_mul(r.into()))
