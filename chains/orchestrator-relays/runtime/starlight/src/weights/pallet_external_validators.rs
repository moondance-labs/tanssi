...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_937_524, 4687)
			// Standard Error: 8_746
			.saturating_add(Weight::from_parts(182_555, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_046_176, 4687)
			// Standard Error: 6_928
			.saturating_add(Weight::from_parts(180_989, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_355_214, 4687)
			// Standard Error: 5_318
			.saturating_add(Weight::from_parts(245_926, 0).saturating_mul(r.into()))
