...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_952_377, 4687)
			// Standard Error: 973
			.saturating_add(Weight::from_parts(56_335, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_659_936, 4687)
			// Standard Error: 6_234
			.saturating_add(Weight::from_parts(38_641, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_707_696, 4687)
			// Standard Error: 697
			.saturating_add(Weight::from_parts(132_165, 0).saturating_mul(r.into()))
