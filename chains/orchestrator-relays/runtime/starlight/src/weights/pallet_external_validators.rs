...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_041_342, 4687)
			// Standard Error: 5_123
			.saturating_add(Weight::from_parts(89_462, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_955_242, 4687)
			// Standard Error: 4_777
			.saturating_add(Weight::from_parts(80_488, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_273_922, 4687)
			// Standard Error: 4_825
			.saturating_add(Weight::from_parts(170_306, 0).saturating_mul(r.into()))
