...
// --output=tmp/starlight_weights/pallet_external_validators.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_091_349, 4687)
			// Standard Error: 10_214
			.saturating_add(Weight::from_parts(218_869, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_335_161, 4687)
			// Standard Error: 7_585
			.saturating_add(Weight::from_parts(160_661, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_452_991, 4687)
			// Standard Error: 5_894
			.saturating_add(Weight::from_parts(261_220, 0).saturating_mul(r.into()))
