...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_518_334, 4687)
			// Standard Error: 4_829
			.saturating_add(Weight::from_parts(112_845, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_824_616, 4687)
			// Standard Error: 8_789
			.saturating_add(Weight::from_parts(79_804, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(17_086_601, 4687)
			// Standard Error: 4_551
			.saturating_add(Weight::from_parts(166_592, 0).saturating_mul(r.into()))
