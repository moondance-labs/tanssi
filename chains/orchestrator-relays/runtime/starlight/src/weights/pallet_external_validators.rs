...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_151_764, 4687)
			// Standard Error: 12_142
			.saturating_add(Weight::from_parts(257_881, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_723_480, 4687)
			// Standard Error: 5_764
			.saturating_add(Weight::from_parts(163_590, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_111_291, 4687)
			// Standard Error: 3_650
			.saturating_add(Weight::from_parts(233_030, 0).saturating_mul(r.into()))
