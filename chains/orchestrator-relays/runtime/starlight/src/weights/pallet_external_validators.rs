...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_056_024, 4687)
			// Standard Error: 4_438
			.saturating_add(Weight::from_parts(91_364, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_506_065, 4687)
			// Standard Error: 5_101
			.saturating_add(Weight::from_parts(102_576, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_776_987, 4687)
			// Standard Error: 1_584
			.saturating_add(Weight::from_parts(182_291, 0).saturating_mul(r.into()))
