...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_281_854, 4687)
			// Standard Error: 1_122
			.saturating_add(Weight::from_parts(56_017, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_053_945, 4687)
			// Standard Error: 697
			.saturating_add(Weight::from_parts(40_797, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_958_472, 4687)
