...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(31_768_959, 4687)
			// Standard Error: 2_149
			.saturating_add(Weight::from_parts(124_852, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_626_483, 4687)
			// Standard Error: 1_463
			.saturating_add(Weight::from_parts(93_963, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(29_095_868, 4687)
			// Standard Error: 1_508
			.saturating_add(Weight::from_parts(233_777, 0).saturating_mul(r.into()))
