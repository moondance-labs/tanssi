...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_550_494, 4687)
			// Standard Error: 6_328
			.saturating_add(Weight::from_parts(118_317, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_407_477, 4687)
			// Standard Error: 4_538
			.saturating_add(Weight::from_parts(78_278, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_295_474, 4687)
			// Standard Error: 7_498
			.saturating_add(Weight::from_parts(191_818, 0).saturating_mul(r.into()))
