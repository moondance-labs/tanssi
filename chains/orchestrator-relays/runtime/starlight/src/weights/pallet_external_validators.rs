...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_407_577, 4687)
			// Standard Error: 5_021
			.saturating_add(Weight::from_parts(255_367, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_711_756, 4687)
			// Standard Error: 4_671
			.saturating_add(Weight::from_parts(220_402, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_646_138, 4687)
			// Standard Error: 4_922
			.saturating_add(Weight::from_parts(285_077, 0).saturating_mul(r.into()))
