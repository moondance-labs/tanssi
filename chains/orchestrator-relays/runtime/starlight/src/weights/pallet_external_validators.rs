...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(13_905_644, 4687)
			// Standard Error: 7_994
			.saturating_add(Weight::from_parts(259_388, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_297_872, 4687)
			// Standard Error: 3_750
			.saturating_add(Weight::from_parts(184_341, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_674_085, 4687)
			// Standard Error: 3_350
			.saturating_add(Weight::from_parts(245_795, 0).saturating_mul(r.into()))
