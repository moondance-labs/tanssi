...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_334_220, 4687)
			// Standard Error: 8_532
			.saturating_add(Weight::from_parts(249_251, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_922_592, 4687)
			// Standard Error: 3_828
			.saturating_add(Weight::from_parts(151_050, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		//  Estimated: `4687`
		// Minimum execution time: 14_778_000 picoseconds.
		Weight::from_parts(13_111_603, 4687)
			// Standard Error: 6_307
			.saturating_add(Weight::from_parts(317_598, 0).saturating_mul(r.into()))
