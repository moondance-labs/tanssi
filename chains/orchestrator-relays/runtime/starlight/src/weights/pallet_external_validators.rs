...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_925_512, 4687)
			// Standard Error: 5_025
			.saturating_add(Weight::from_parts(198_716, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_847_718, 4687)
			// Standard Error: 4_276
			.saturating_add(Weight::from_parts(159_528, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_251_868, 4687)
			// Standard Error: 6_730
			.saturating_add(Weight::from_parts(245_662, 0).saturating_mul(r.into()))
