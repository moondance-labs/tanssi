...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_189_529, 4687)
			// Standard Error: 4_681
			.saturating_add(Weight::from_parts(241_533, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(7_559_222, 4687)
			// Standard Error: 5_408
			.saturating_add(Weight::from_parts(224_902, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_297_855, 4687)
			// Standard Error: 2_466
			.saturating_add(Weight::from_parts(241_442, 0).saturating_mul(r.into()))
