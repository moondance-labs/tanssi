...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(32_345_166, 4687)
			// Standard Error: 2_172
			.saturating_add(Weight::from_parts(118_517, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(21_052_937, 4687)
			// Standard Error: 1_385
			.saturating_add(Weight::from_parts(82_372, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(29_917_271, 4687)
			// Standard Error: 1_475
			.saturating_add(Weight::from_parts(232_139, 0).saturating_mul(r.into()))
