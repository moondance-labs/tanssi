...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_923_726, 4687)
			// Standard Error: 15_459
			.saturating_add(Weight::from_parts(266_028, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_836_959, 4687)
			// Standard Error: 5_378
			.saturating_add(Weight::from_parts(190_083, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(12_958_129, 4687)
			// Standard Error: 3_882
			.saturating_add(Weight::from_parts(283_371, 0).saturating_mul(r.into()))
