...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_376_465, 4687)
			// Standard Error: 3_675
			.saturating_add(Weight::from_parts(79_653, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_894_639, 4687)
			// Standard Error: 8_479
			.saturating_add(Weight::from_parts(64_196, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_454_833, 4687)
			// Standard Error: 1_596
			.saturating_add(Weight::from_parts(182_613, 0).saturating_mul(r.into()))
