...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_855_533, 4687)
			// Standard Error: 5_021
			.saturating_add(Weight::from_parts(81_040, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_315_892, 4687)
			// Standard Error: 634
			.saturating_add(Weight::from_parts(44_249, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_271_073, 4687)
			// Standard Error: 2_981
			.saturating_add(Weight::from_parts(154_259, 0).saturating_mul(r.into()))
