...
// raw.json
// --output
// tmp/starlight_weights/pallet_external_validators.rs
...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_509_978, 4687)
			// Standard Error: 14_310
			.saturating_add(Weight::from_parts(112_271, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_203_436, 4687)
			// Standard Error: 5_831
			.saturating_add(Weight::from_parts(75_636, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_112_508, 4687)
			// Standard Error: 11_604
			.saturating_add(Weight::from_parts(285_159, 0).saturating_mul(r.into()))
