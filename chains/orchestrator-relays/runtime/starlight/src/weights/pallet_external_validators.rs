...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_440_101, 4687)
			// Standard Error: 6_196
			.saturating_add(Weight::from_parts(222_848, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_422_078, 4687)
			// Standard Error: 7_880
			.saturating_add(Weight::from_parts(216_691, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_052_944, 4687)
			// Standard Error: 2_793
			.saturating_add(Weight::from_parts(230_500, 0).saturating_mul(r.into()))
