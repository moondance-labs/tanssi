...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_000_181, 4687)
			// Standard Error: 886
			.saturating_add(Weight::from_parts(58_795, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_159_954, 4687)
			// Standard Error: 605
			.saturating_add(Weight::from_parts(44_634, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_050_605, 4687)
			// Standard Error: 725
			.saturating_add(Weight::from_parts(143_213, 0).saturating_mul(r.into()))
