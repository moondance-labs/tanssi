...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_010_817, 4687)
			// Standard Error: 15_827
			.saturating_add(Weight::from_parts(288_684, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_619_413, 4687)
			// Standard Error: 5_573
			.saturating_add(Weight::from_parts(192_408, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_285_642, 4687)
			// Standard Error: 5_731
			.saturating_add(Weight::from_parts(277_889, 0).saturating_mul(r.into()))
