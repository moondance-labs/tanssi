...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_721_814, 4687)
			// Standard Error: 8_125
			.saturating_add(Weight::from_parts(211_368, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_406_497, 4687)
			// Standard Error: 5_680
			.saturating_add(Weight::from_parts(187_358, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_147_981, 4687)
			// Standard Error: 10_822
			.saturating_add(Weight::from_parts(341_946, 0).saturating_mul(r.into()))
