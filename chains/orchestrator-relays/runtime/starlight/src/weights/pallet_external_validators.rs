...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_053_851, 4687)
			// Standard Error: 6_255
			.saturating_add(Weight::from_parts(110_945, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_205_249, 4687)
			// Standard Error: 3_703
			.saturating_add(Weight::from_parts(121_017, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_037_611, 4687)
			// Standard Error: 6_173
			.saturating_add(Weight::from_parts(281_737, 0).saturating_mul(r.into()))
