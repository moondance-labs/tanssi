...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_014_969, 4687)
			// Standard Error: 7_361
			.saturating_add(Weight::from_parts(192_172, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_171_783, 4687)
			// Standard Error: 6_955
			.saturating_add(Weight::from_parts(165_157, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_226_321, 4687)
			// Standard Error: 8_267
			.saturating_add(Weight::from_parts(254_139, 0).saturating_mul(r.into()))
