...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_079_515, 4687)
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_600_086, 4687)
			// Standard Error: 11_483
			.saturating_add(Weight::from_parts(118_987, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_020_316, 4687)
			// Standard Error: 5_960
			.saturating_add(Weight::from_parts(172_773, 0).saturating_mul(r.into()))
