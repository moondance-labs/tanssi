...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(36_778_477, 4687)
			// Standard Error: 1_915
			.saturating_add(Weight::from_parts(107_504, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(23_474_610, 4687)
			// Standard Error: 1_277
			.saturating_add(Weight::from_parts(77_562, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(32_256_825, 4687)
			// Standard Error: 1_356
			.saturating_add(Weight::from_parts(224_972, 0).saturating_mul(r.into()))
