...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_717_620, 4687)
			// Standard Error: 9_228
			.saturating_add(Weight::from_parts(193_438, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_449_778, 4687)
			// Standard Error: 6_757
			.saturating_add(Weight::from_parts(201_286, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_566_006, 4687)
			// Standard Error: 2_687
			.saturating_add(Weight::from_parts(292_918, 0).saturating_mul(r.into()))
