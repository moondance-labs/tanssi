...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(21_127_519, 4687)
			// Standard Error: 1_267
			.saturating_add(Weight::from_parts(58_004, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_488_406, 4687)
			// Standard Error: 633
			.saturating_add(Weight::from_parts(45_423, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(18_484_126, 4687)
			// Standard Error: 707
			.saturating_add(Weight::from_parts(149_300, 0).saturating_mul(r.into()))
