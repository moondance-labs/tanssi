...
impl<T: frame_system::Config> pallet_multiblock_migrations::WeightInfo for SubstrateWeight<T> {
	...
	fn onboard_new_mbms() -> Weight {
		...
		Weight::from_parts(6_803_000, 67035)
	...
	fn progress_mbms_none() -> Weight {
		...
		Weight::from_parts(1_523_000, 67035)
	...
	fn exec_migration_complete() -> Weight {
		...
		Weight::from_parts(10_169_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(15_909_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn force_onboard_mbms() -> Weight {
		...
		Weight::from_parts(5_010_000, 67035)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(10_926_465, 3834)
			// Standard Error: 6_141
			.saturating_add(Weight::from_parts(945_486, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		...
		Weight::from_parts(16_809_287, 853)
			// Standard Error: 1_657
			.saturating_add(Weight::from_parts(583_918, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
