...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(12_713_223, 4706)
			// Standard Error: 739
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(30_754_848, 5698)
			// Standard Error: 1_304
			.saturating_add(Weight::from_parts(148_014, 0).saturating_mul(a.into()))
	...
	fn remove_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(20_042_680, 5698)
			// Standard Error: 908
			.saturating_add(Weight::from_parts(146_737, 0).saturating_mul(a.into()))
			// Standard Error: 938
	...
	fn reject_announcement(a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(20_414_666, 5698)
			// Standard Error: 944
			.saturating_add(Weight::from_parts(136_344, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:0)
	...
	fn announce(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(25_943_154, 5698)
			// Standard Error: 973
			.saturating_add(Weight::from_parts(143_915, 0).saturating_mul(a.into()))
			// Standard Error: 1_006
			.saturating_add(Weight::from_parts(28_279, 0).saturating_mul(p.into()))
	...
	fn add_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_932_272, 4706)
			// Standard Error: 839
			.saturating_add(Weight::from_parts(36_655, 0).saturating_mul(p.into()))
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(19_022_533, 4706)
			// Standard Error: 856
			.saturating_add(Weight::from_parts(39_584, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn remove_proxies(p: u32, ) -> Weight {
		...
		Weight::from_parts(17_375_247, 4706)
			// Standard Error: 690
			.saturating_add(Weight::from_parts(26_210, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(20_586_011, 4706)
			// Standard Error: 850
			.saturating_add(Weight::from_parts(12_177, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_148_606, 4706)
			// Standard Error: 786
