...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(12_038_961, 4706)
			// Standard Error: 846
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(29_973_767, 5698)
			// Standard Error: 35_532
			.saturating_add(Weight::from_parts(386_408, 0).saturating_mul(a.into()))
	...
	fn remove_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(19_046_710, 5698)
			// Standard Error: 873
			.saturating_add(Weight::from_parts(137_531, 0).saturating_mul(a.into()))
			// Standard Error: 902
			.saturating_add(Weight::from_parts(2_820, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Announcements` (r:1 w:1)
	...
	fn reject_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(18_797_541, 5698)
			// Standard Error: 1_496
			.saturating_add(Weight::from_parts(140_474, 0).saturating_mul(a.into()))
	...
	fn announce(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(24_385_669, 5698)
			// Standard Error: 999
			.saturating_add(Weight::from_parts(139_305, 0).saturating_mul(a.into()))
			// Standard Error: 1_032
			.saturating_add(Weight::from_parts(22_487, 0).saturating_mul(p.into()))
	...
	fn add_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_346_103, 4706)
			// Standard Error: 776
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_352_220, 4706)
			// Standard Error: 856
			.saturating_add(Weight::from_parts(31_305, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn remove_proxies(p: u32, ) -> Weight {
		...
		Weight::from_parts(16_498_683, 4706)
			// Standard Error: 774
			.saturating_add(Weight::from_parts(21_062, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(19_614_235, 4706)
			// Standard Error: 1_017
			.saturating_add(Weight::from_parts(12_117, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(17_094_111, 4706)
			// Standard Error: 719
			.saturating_add(Weight::from_parts(24_213, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(34_184_000, 5698)
			.saturating_add(T::DbWeight::get().reads(3_u64))
