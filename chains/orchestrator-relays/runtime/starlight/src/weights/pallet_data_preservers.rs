...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `216`
		//  Estimated: `4209`
		// Minimum execution time: 66_101_000 picoseconds.
		Weight::from_parts(67_787_385, 4209)
			// Standard Error: 285
			.saturating_add(Weight::from_parts(742, 0).saturating_mul(x.into()))
			// Standard Error: 5_955
			.saturating_add(Weight::from_parts(90_739, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(18_863_167, 4209)
			// Standard Error: 138
			.saturating_add(Weight::from_parts(1_411, 0).saturating_mul(x.into()))
			// Standard Error: 2_891
			.saturating_add(Weight::from_parts(87_450, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(72_879_572, 4209)
			// Standard Error: 243
			.saturating_add(Weight::from_parts(1_260, 0).saturating_mul(x.into()))
			// Standard Error: 5_085
			.saturating_add(Weight::from_parts(103_092, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(_x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `423`
		//  Estimated: `4209`
		// Minimum execution time: 58_799_000 picoseconds.
		Weight::from_parts(60_928_697, 4209)
			// Standard Error: 5_028
			.saturating_add(Weight::from_parts(77_237, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(59_747_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(59_335_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		//  Measured:  `544`
		//  Estimated: `4209`
		// Minimum execution time: 33_585_000 picoseconds.
		Weight::from_parts(34_824_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(37_549_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(25_687_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(48_000_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}