...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(43_575_815, 4209)
			// Standard Error: 5_484
			.saturating_add(Weight::from_parts(44_664, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_666_708, 4209)
			// Standard Error: 92
			.saturating_add(Weight::from_parts(272, 0).saturating_mul(x.into()))
			// Standard Error: 1_933
			.saturating_add(Weight::from_parts(50_816, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(45_420_220, 4209)
			// Standard Error: 190
			.saturating_add(Weight::from_parts(1_023, 0).saturating_mul(x.into()))
			// Standard Error: 3_981
			.saturating_add(Weight::from_parts(87_529, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(37_774_387, 4209)
			// Standard Error: 230
			.saturating_add(Weight::from_parts(1_144, 0).saturating_mul(x.into()))
			// Standard Error: 4_811
			.saturating_add(Weight::from_parts(60_462, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(37_059_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(21_481_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(15_068_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}