...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(40_846_916, 4209)
			// Standard Error: 3_506
			.saturating_add(Weight::from_parts(42_628, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_052_469, 4209)
			// Standard Error: 75
			.saturating_add(Weight::from_parts(353, 0).saturating_mul(x.into()))
			// Standard Error: 1_572
			.saturating_add(Weight::from_parts(43_670, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(42_765_234, 4209)
			// Standard Error: 213
			.saturating_add(Weight::from_parts(70, 0).saturating_mul(x.into()))
			// Standard Error: 4_454
			.saturating_add(Weight::from_parts(62_391, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(35_152_679, 4209)
			// Standard Error: 133
			.saturating_add(Weight::from_parts(310, 0).saturating_mul(x.into()))
			// Standard Error: 2_788
			.saturating_add(Weight::from_parts(44_171, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(34_445_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(34_084_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(20_639_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
