...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(41_083_965, 4209)
			// Standard Error: 4_427
			.saturating_add(Weight::from_parts(47_250, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_280_312, 4209)
			// Standard Error: 1_617
			.saturating_add(Weight::from_parts(46_071, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(43_644_374, 4209)
			// Standard Error: 211
			.saturating_add(Weight::from_parts(830, 0).saturating_mul(x.into()))
			// Standard Error: 4_401
			.saturating_add(Weight::from_parts(54_935, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(36_296_214, 4209)
			// Standard Error: 4_193
			.saturating_add(Weight::from_parts(38_364, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(34_996_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(35_015_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(19_476_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(20_920_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
