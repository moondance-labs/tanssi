...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_412_000, 7595)
			// Standard Error: 118_047
			.saturating_add(Weight::from_parts(15_873_487, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 77_415_000 picoseconds.
		Weight::from_parts(65_154_731, 8799)
			// Standard Error: 14_932
			.saturating_add(Weight::from_parts(14_024_017, 0).saturating_mul(x.into()))
