...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_699_000, 2013)
			// Standard Error: 861_976
			.saturating_add(Weight::from_parts(25_633_673, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 176_701_000 picoseconds.
		Weight::from_parts(201_356_689, 6287)
			// Standard Error: 1_930_325
			.saturating_add(Weight::from_parts(135_836_043, 0).saturating_mul(x.into()))
