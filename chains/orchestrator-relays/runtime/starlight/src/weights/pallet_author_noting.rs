...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_539_000, 2013)
			// Standard Error: 151_770
			.saturating_add(Weight::from_parts(18_240_189, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 262_953_000 picoseconds.
		Weight::from_parts(119_500_687, 6287)
			// Standard Error: 2_104_796
			.saturating_add(Weight::from_parts(136_984_874, 0).saturating_mul(x.into()))
