...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_408_000, 2013)
			// Standard Error: 152_057
			.saturating_add(Weight::from_parts(18_128_829, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(135_473_298, 6287)
			// Standard Error: 2_383_190
			.saturating_add(Weight::from_parts(135_535_729, 0).saturating_mul(x.into()))
