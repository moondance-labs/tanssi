...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_192_000, 7595)
			// Standard Error: 138_604
			.saturating_add(Weight::from_parts(16_894_902, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_012_089, 8799)
			// Standard Error: 7_177
			.saturating_add(Weight::from_parts(14_216_856, 0).saturating_mul(x.into()))
