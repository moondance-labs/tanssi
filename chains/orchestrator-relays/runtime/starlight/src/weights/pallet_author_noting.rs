...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_753_000, 7595)
			// Standard Error: 121_146
			.saturating_add(Weight::from_parts(16_388_042, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(79_649_000, 8799)
			// Standard Error: 578_197
			.saturating_add(Weight::from_parts(16_832_405, 0).saturating_mul(x.into()))
