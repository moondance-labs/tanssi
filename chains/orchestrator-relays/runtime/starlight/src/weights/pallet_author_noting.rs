...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(10_981_000, 7595)
			// Standard Error: 116_256
			.saturating_add(Weight::from_parts(15_768_217, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(66_258_316, 8799)
			// Standard Error: 13_746
			.saturating_add(Weight::from_parts(13_653_964, 0).saturating_mul(x.into()))
