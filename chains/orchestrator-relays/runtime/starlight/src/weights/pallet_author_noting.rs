...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_803_000, 7595)
			// Standard Error: 106_381
			.saturating_add(Weight::from_parts(15_189_925, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(65_128_078, 8799)
			// Standard Error: 21_059
			.saturating_add(Weight::from_parts(13_137_187, 0).saturating_mul(x.into()))
