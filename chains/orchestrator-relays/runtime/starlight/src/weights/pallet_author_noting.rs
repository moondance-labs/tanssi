...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(10_259_000, 7298)
			// Standard Error: 118_311
			.saturating_add(Weight::from_parts(16_063_376, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_111_575, 8799)
			// Standard Error: 24_099
			.saturating_add(Weight::from_parts(14_309_933, 0).saturating_mul(x.into()))
