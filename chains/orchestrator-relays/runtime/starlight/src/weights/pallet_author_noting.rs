...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_563_000, 6738)
			// Standard Error: 116_660
			.saturating_add(Weight::from_parts(15_652_351, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(55_570_130, 8799)
			// Standard Error: 10_335
			.saturating_add(Weight::from_parts(13_513_985, 0).saturating_mul(x.into()))
