...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_592_000, 7298)
			// Standard Error: 230_997
			.saturating_add(Weight::from_parts(18_289_320, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(95_741_768, 8799)
			// Standard Error: 241_334
			.saturating_add(Weight::from_parts(14_119_756, 0).saturating_mul(x.into()))
