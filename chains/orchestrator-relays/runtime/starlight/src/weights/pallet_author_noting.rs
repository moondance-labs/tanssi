...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_683_000, 7595)
			// Standard Error: 121_607
			.saturating_add(Weight::from_parts(16_411_353, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_012_842, 8799)
			// Standard Error: 6_927
			.saturating_add(Weight::from_parts(14_219_059, 0).saturating_mul(x.into()))
