...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_406_000, 6738)
			// Standard Error: 136_033
			.saturating_add(Weight::from_parts(20_918_230, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(102_438_444, 8799)
			// Standard Error: 16_701
			.saturating_add(Weight::from_parts(21_423_036, 0).saturating_mul(x.into()))
