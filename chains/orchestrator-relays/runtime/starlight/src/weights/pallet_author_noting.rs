...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_883_000, 7298)
			// Standard Error: 108_291
			.saturating_add(Weight::from_parts(16_388_320, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_108_824, 8799)
			// Standard Error: 6_322
			.saturating_add(Weight::from_parts(14_524_601, 0).saturating_mul(x.into()))
