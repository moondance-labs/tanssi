...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_906_000, 7595)
			// Standard Error: 187_294
			.saturating_add(Weight::from_parts(25_393_173, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 128_983_000 picoseconds.
		Weight::from_parts(114_799_958, 8799)
			// Standard Error: 15_192
			.saturating_add(Weight::from_parts(21_352_896, 0).saturating_mul(x.into()))
