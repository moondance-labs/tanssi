...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_663_000, 7595)
			// Standard Error: 112_979
			.saturating_add(Weight::from_parts(16_774_081, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(75_981_226, 8799)
			// Standard Error: 18_381
			.saturating_add(Weight::from_parts(14_316_338, 0).saturating_mul(x.into()))
