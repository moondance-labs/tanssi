...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_474_000, 7298)
			// Standard Error: 168_362
			.saturating_add(Weight::from_parts(17_824_989, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(69_154_733, 8799)
			// Standard Error: 10_084
			.saturating_add(Weight::from_parts(14_542_145, 0).saturating_mul(x.into()))
