...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_038_000, 2013)
			// Standard Error: 115_545
			.saturating_add(Weight::from_parts(17_378_887, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 166_932_000 picoseconds.
		Weight::from_parts(202_540_281, 6287)
			// Standard Error: 2_026_191
			.saturating_add(Weight::from_parts(132_323_859, 0).saturating_mul(x.into()))
