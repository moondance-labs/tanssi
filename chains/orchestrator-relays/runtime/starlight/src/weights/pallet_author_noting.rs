...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_123_000, 7595)
			// Standard Error: 117_635
			.saturating_add(Weight::from_parts(17_311_592, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(70_901_513, 8799)
			// Standard Error: 8_208
			.saturating_add(Weight::from_parts(14_659_621, 0).saturating_mul(x.into()))
