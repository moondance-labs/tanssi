...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_145_000, 6738)
			// Standard Error: 180_197
			.saturating_add(Weight::from_parts(17_594_661, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(60_488_173, 8799)
			// Standard Error: 9_864
			.saturating_add(Weight::from_parts(13_738_195, 0).saturating_mul(x.into()))
