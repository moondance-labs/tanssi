...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_432_000, 7595)
			// Standard Error: 108_480
			.saturating_add(Weight::from_parts(16_204_000, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(67_083_839, 8799)
			// Standard Error: 7_154
			.saturating_add(Weight::from_parts(13_697_726, 0).saturating_mul(x.into()))
