...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_288_000, 2013)
			// Standard Error: 260_167
			.saturating_add(Weight::from_parts(19_171_734, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(212_122_243, 6287)
			// Standard Error: 2_026_607
			.saturating_add(Weight::from_parts(126_316_987, 0).saturating_mul(x.into()))
