...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_572_000, 7298)
			// Standard Error: 187_936
			.saturating_add(Weight::from_parts(26_792_334, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 137_650_000 picoseconds.
		Weight::from_parts(120_062_653, 8799)
			// Standard Error: 18_297
			.saturating_add(Weight::from_parts(23_944_510, 0).saturating_mul(x.into()))
