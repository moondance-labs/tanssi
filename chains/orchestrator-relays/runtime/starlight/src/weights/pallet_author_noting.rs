...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_821_000, 6738)
			// Standard Error: 146_559
			.saturating_add(Weight::from_parts(21_558_533, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 112_096_000 picoseconds.
		Weight::from_parts(97_445_951, 8799)
			// Standard Error: 16_755
			.saturating_add(Weight::from_parts(21_109_197, 0).saturating_mul(x.into()))
