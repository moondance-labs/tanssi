...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_553_000, 7595)
			// Standard Error: 118_683
			.saturating_add(Weight::from_parts(16_128_311, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(67_134_014, 8799)
			// Standard Error: 11_124
			.saturating_add(Weight::from_parts(13_912_661, 0).saturating_mul(x.into()))
