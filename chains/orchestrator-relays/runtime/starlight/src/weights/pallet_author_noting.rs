...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_532_000, 7595)
			// Standard Error: 115_882
			.saturating_add(Weight::from_parts(15_760_968, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(61_001_209, 8799)
			// Standard Error: 15_642
			.saturating_add(Weight::from_parts(13_969_751, 0).saturating_mul(x.into()))
