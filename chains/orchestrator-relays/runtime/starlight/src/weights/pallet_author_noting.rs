...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_254_000, 7595)
			// Standard Error: 120_856
			.saturating_add(Weight::from_parts(16_777_771, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1596 + x * (133 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 83_837_000 picoseconds.
		Weight::from_parts(75_941_812, 8799)
			// Standard Error: 13_481
			.saturating_add(Weight::from_parts(14_750_021, 0).saturating_mul(x.into()))
