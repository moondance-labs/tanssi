...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_609_000, 2013)
			// Standard Error: 323_642
			.saturating_add(Weight::from_parts(21_001_711, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 184_727_000 picoseconds.
		Weight::from_parts(258_860_734, 6287)
			// Standard Error: 2_643_937
			.saturating_add(Weight::from_parts(129_688_711, 0).saturating_mul(x.into()))
