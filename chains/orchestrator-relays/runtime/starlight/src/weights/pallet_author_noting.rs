...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_296_000, 6738)
			// Standard Error: 164_146
			.saturating_add(Weight::from_parts(17_432_434, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(60_974_173, 8799)
			// Standard Error: 11_588
			.saturating_add(Weight::from_parts(13_829_035, 0).saturating_mul(x.into()))
