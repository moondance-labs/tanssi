...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_726_000, 6738)
			// Standard Error: 157_246
			.saturating_add(Weight::from_parts(22_612_407, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 113_560_000 picoseconds.
		Weight::from_parts(98_849_615, 8799)
			// Standard Error: 16_261
			.saturating_add(Weight::from_parts(21_419_996, 0).saturating_mul(x.into()))
