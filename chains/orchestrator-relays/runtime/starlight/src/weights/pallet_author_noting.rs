...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_095_000, 6738)
			// Standard Error: 148_587
			.saturating_add(Weight::from_parts(17_410_735, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(60_989_828, 8799)
			// Standard Error: 7_585
			.saturating_add(Weight::from_parts(13_688_791, 0).saturating_mul(x.into()))
