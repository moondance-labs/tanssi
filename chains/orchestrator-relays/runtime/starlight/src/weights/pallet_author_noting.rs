...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_623_000, 6738)
			// Standard Error: 107_909
			.saturating_add(Weight::from_parts(15_352_325, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(58_698_070, 8799)
			// Standard Error: 12_419
			.saturating_add(Weight::from_parts(12_991_563, 0).saturating_mul(x.into()))
