...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_543_000, 7595)
			// Standard Error: 116_756
			.saturating_add(Weight::from_parts(15_834_107, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(23_984_802, 8799)
			// Standard Error: 303_305
			.saturating_add(Weight::from_parts(15_923_501, 0).saturating_mul(x.into()))
