...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_045_000, 6738)
			// Standard Error: 119_763
			.saturating_add(Weight::from_parts(16_388_810, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(62_731_760, 8799)
			// Standard Error: 7_409
			.saturating_add(Weight::from_parts(14_422_038, 0).saturating_mul(x.into()))
