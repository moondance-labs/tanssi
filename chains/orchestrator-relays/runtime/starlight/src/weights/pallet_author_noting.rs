...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(19_607_000, 2013)
			// Standard Error: 192_533
			.saturating_add(Weight::from_parts(17_079_185, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 246_962_000 picoseconds.
		Weight::from_parts(214_994_149, 6287)
			// Standard Error: 1_673_734
			.saturating_add(Weight::from_parts(127_445_139, 0).saturating_mul(x.into()))
