...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_256_000, 6738)
			// Standard Error: 115_702
			.saturating_add(Weight::from_parts(15_664_007, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(58_751_864, 8799)
			// Standard Error: 8_666
			.saturating_add(Weight::from_parts(13_654_988, 0).saturating_mul(x.into()))
