...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_053_000, 7595)
			// Standard Error: 128_487
			.saturating_add(Weight::from_parts(17_292_487, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(73_271_393, 8799)
			// Standard Error: 10_709
			.saturating_add(Weight::from_parts(14_961_256, 0).saturating_mul(x.into()))
