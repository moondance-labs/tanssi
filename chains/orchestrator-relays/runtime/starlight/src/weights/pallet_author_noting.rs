...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_432_000, 7595)
			// Standard Error: 124_633
			.saturating_add(Weight::from_parts(16_070_193, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(64_213_739, 8799)
			// Standard Error: 30_862
			.saturating_add(Weight::from_parts(14_202_098, 0).saturating_mul(x.into()))
