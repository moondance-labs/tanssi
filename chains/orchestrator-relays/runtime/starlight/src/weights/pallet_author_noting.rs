...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Measured:  `847 + x * (170 ±0)`
		//  Estimated: `7298 + x * (2527 ±0)`
		// Minimum execution time: 6_612_000 picoseconds.
		Weight::from_parts(6_742_000, 7298)
			// Standard Error: 158_446
			.saturating_add(Weight::from_parts(16_935_055, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1167 + x * (133 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 79_921_000 picoseconds.
		Weight::from_parts(26_954_464, 8799)
			// Standard Error: 335_500
			.saturating_add(Weight::from_parts(17_680_079, 0).saturating_mul(x.into()))
