...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_582_000, 6738)
			// Standard Error: 120_737
			.saturating_add(Weight::from_parts(16_044_027, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(52_705_042, 8799)
			// Standard Error: 13_769
			.saturating_add(Weight::from_parts(14_051_585, 0).saturating_mul(x.into()))
