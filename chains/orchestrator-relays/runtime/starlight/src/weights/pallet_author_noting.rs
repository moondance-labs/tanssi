...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_273_000, 7595)
			// Standard Error: 120_738
			.saturating_add(Weight::from_parts(18_063_122, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(73_065_048, 8799)
			// Standard Error: 7_113
			.saturating_add(Weight::from_parts(15_227_371, 0).saturating_mul(x.into()))
