...
// --output=tmp/starlight_weights/pallet_author_noting.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Measured:  `527 + x * (170 ±0)`
		//  Estimated: `2013 + x * (2646 ±0)`
		// Minimum execution time: 35_707_000 picoseconds.
		Weight::from_parts(36_749_000, 2013)
			// Standard Error: 267_980
			.saturating_add(Weight::from_parts(19_299_475, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1060 + x * (861 ±0)`
		//  Estimated: `6287 + x * (23292 ±0)`
		// Minimum execution time: 175_369_000 picoseconds.
		Weight::from_parts(193_320_339, 6287)
			// Standard Error: 2_123_862
			.saturating_add(Weight::from_parts(135_171_835, 0).saturating_mul(x.into()))
