...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_103_000, 7595)
			// Standard Error: 121_686
			.saturating_add(Weight::from_parts(16_798_446, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(71_765_249, 8799)
			// Standard Error: 10_682
			.saturating_add(Weight::from_parts(15_145_245, 0).saturating_mul(x.into()))
