...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_713_000, 6738)
			// Standard Error: 122_342
			.saturating_add(Weight::from_parts(15_946_871, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(56_813_122, 8799)
			// Standard Error: 10_083
			.saturating_add(Weight::from_parts(14_051_520, 0).saturating_mul(x.into()))
