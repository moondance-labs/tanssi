...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_387_000, 6738)
			// Standard Error: 119_739
			.saturating_add(Weight::from_parts(16_616_828, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(65_028_912, 8799)
			// Standard Error: 11_416
			.saturating_add(Weight::from_parts(14_390_706, 0).saturating_mul(x.into()))
