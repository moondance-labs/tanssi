...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_976_615, 4687)
			// Standard Error: 14_140
			.saturating_add(Weight::from_parts(208_215, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_989_881, 4687)
			// Standard Error: 3_724
			.saturating_add(Weight::from_parts(123_160, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(17_762_487, 4687)
			// Standard Error: 17_970
			.saturating_add(Weight::from_parts(198_837, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `TanssiInvulnerables::Invulnerables` (r:1 w:0)
	/// Proof: `TanssiInvulnerables::Invulnerables` (`max_values`: Some(1), `max_size`: Some(3202), added: 3697, mode: `MaxEncodedLen`)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_638_729, 4687)
			// Standard Error: 7_856
			.saturating_add(Weight::from_parts(129_943, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}