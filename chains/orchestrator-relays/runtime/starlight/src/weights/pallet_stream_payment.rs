...
// --output=tmp/starlight_weights/pallet_stream_payment.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_stream_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn open_stream() -> Weight {
		...
		Weight::from_parts(119_352_000, 3640)
	...
	fn close_stream() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 187_081_000 picoseconds.
		Weight::from_parts(189_775_000, 6196)
	...
	fn perform_payment() -> Weight {
		...
		Weight::from_parts(112_306_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn request_change_immediate() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 157_211_000 picoseconds.
		Weight::from_parts(159_878_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn request_change_delayed() -> Weight {
		...
		Weight::from_parts(20_026_000, 3742)
	...
	fn accept_requested_change() -> Weight {
		...
		//  Measured:  `806`
		//  Estimated: `6196`
		// Minimum execution time: 148_442_000 picoseconds.
		Weight::from_parts(149_556_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn cancel_change_request() -> Weight {
		...
		Weight::from_parts(15_146_000, 3742)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn immediately_change_deposit() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 148_380_000 picoseconds.
