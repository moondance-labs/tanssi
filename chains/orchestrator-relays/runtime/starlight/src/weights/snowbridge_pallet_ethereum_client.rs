...
// --output=tmp/starlight_weights/snowbridge_pallet_ethereum_client.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> snowbridge_pallet_ethereum_client::WeightInfo for SubstrateWeight<T> {
	...
	fn force_checkpoint() -> Weight {
		...
		//  Measured:  `109`
		//  Estimated: `3501`
		// Minimum execution time: 67_381_907_000 picoseconds.
		Weight::from_parts(67_464_461_000, 3501)
	...
	fn submit() -> Weight {
		...
		//  Measured:  `92805`
		//  Estimated: `93857`
		// Minimum execution time: 17_033_739_000 picoseconds.
		Weight::from_parts(17_044_559_000, 93857)
	...
	fn submit_with_sync_committee() -> Weight {
		...
		//  Measured:  `92805`
		//  Estimated: `93857`
		// Minimum execution time: 84_437_958_000 picoseconds.
		Weight::from_parts(84_524_840_000, 93857)
			.saturating_add(T::DbWeight::get().reads(7_u64))
