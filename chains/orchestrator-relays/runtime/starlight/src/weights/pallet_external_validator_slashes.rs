...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		//  Measured:  `50477`
		//  Estimated: `53942`
		// Minimum execution time: 49_914_000 picoseconds.
		Weight::from_parts(1_090_074_397, 53942)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(15_699_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 3_792_928_000 picoseconds.
		Weight::from_parts(3_811_603_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_605_480, 3601)
			// Standard Error: 3_986
			.saturating_add(Weight::from_parts(1_821_617, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
