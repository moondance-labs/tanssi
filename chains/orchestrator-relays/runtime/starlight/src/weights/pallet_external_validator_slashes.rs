...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		//  Measured:  `50444`
		//  Estimated: `53909`
		// Minimum execution time: 57_608_000 picoseconds.
		Weight::from_parts(1_170_467_676, 53909)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(17_984_000, 3873)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 4_327_540_000 picoseconds.
		Weight::from_parts(4_351_976_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(25_672_985, 3601)
			// Standard Error: 4_596
			.saturating_add(Weight::from_parts(1_978_121, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
