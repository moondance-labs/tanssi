...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_140_382_684, 53942)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(16_351_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 3_797_972_000 picoseconds.
		Weight::from_parts(3_818_771_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_602_593, 3601)
			// Standard Error: 3_957
			.saturating_add(Weight::from_parts(1_829_998, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
