...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		//  Measured:  `50444`
		//  Estimated: `53909`
		// Minimum execution time: 72_972_000 picoseconds.
		Weight::from_parts(1_604_054_929, 53909)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(26_712_000, 3873)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 5_742_467_000 picoseconds.
		Weight::from_parts(5_774_909_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(42_748_252, 3601)
			// Standard Error: 6_541
			.saturating_add(Weight::from_parts(2_220_938, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
