...
// --output=tmp/starlight_weights/pallet_external_validator_slashes.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(s: u32, ) -> Weight {
		...
		Weight::from_parts(1_027_089_339, 53909)
			// Standard Error: 73_869
			.saturating_add(Weight::from_parts(399_248, 0).saturating_mul(s.into()))
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(17_092_000, 3873)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 3_937_794_000 picoseconds.
		Weight::from_parts(3_988_689_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `460 + s * (50 ±0)`
		//  Estimated: `3601 + s * (49 ±0)`
		// Minimum execution time: 33_643_000 picoseconds.
		Weight::from_parts(34_164_000, 3601)
			// Standard Error: 33_577
			.saturating_add(Weight::from_parts(2_454_051, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
