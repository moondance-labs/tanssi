...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_329_619_497, 53909)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(16_171_000, 3873)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 3_897_416_000 picoseconds.
		Weight::from_parts(6_209_929_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(51_430_224, 3601)
			// Standard Error: 46_069
			.saturating_add(Weight::from_parts(2_126_548, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
