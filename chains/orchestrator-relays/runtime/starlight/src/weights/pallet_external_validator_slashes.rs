...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(757_529_885, 53909)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(16_350_000, 3873)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 3_698_993_000 picoseconds.
		Weight::from_parts(3_715_314_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_536_401, 3601)
			// Standard Error: 3_451
			.saturating_add(Weight::from_parts(1_820_171, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
