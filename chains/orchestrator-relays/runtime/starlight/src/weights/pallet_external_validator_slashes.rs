...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_157_111_201, 53909)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(16_731_000, 3873)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 3_875_047_000 picoseconds.
		Weight::from_parts(3_898_981_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(80_852_733, 3601)
			// Standard Error: 52_942
			.saturating_add(Weight::from_parts(1_955_047, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
