...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_257_246_090, 53909)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(15_940_000, 3873)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 3_770_346_000 picoseconds.
		Weight::from_parts(3_788_019_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(69_345_329, 3601)
			// Standard Error: 49_688
			.saturating_add(Weight::from_parts(1_888_772, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
