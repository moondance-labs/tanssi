...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		//  Measured:  `50444`
		//  Estimated: `53909`
		// Minimum execution time: 75_878_000 picoseconds.
		Weight::from_parts(1_606_298_361, 53909)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(27_662_000, 3873)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 5_943_445_000 picoseconds.
		Weight::from_parts(5_962_740_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(40_736_095, 3601)
			// Standard Error: 7_449
			.saturating_add(Weight::from_parts(2_239_661, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
