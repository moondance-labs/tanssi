...
impl<T: frame_system::Config> pallet_inactivity_tracking::WeightInfo for SubstrateWeight<T> {
	...
	fn set_inactivity_tracking_status() -> Weight {
		...
		Weight::from_parts(22_125_000, 1905)
	...
	fn set_offline() -> Weight {
		...
		Weight::from_parts(96_420_000, 16518)
	...
	fn set_online() -> Weight {
		...
		Weight::from_parts(90_915_000, 16518)
	...
	fn notify_inactive_collator() -> Weight {
		...
		//  Measured:  `1949`
		//  Estimated: `29435`
		// Minimum execution time: 126_620_000 picoseconds.
		Weight::from_parts(128_400_000, 29435)
