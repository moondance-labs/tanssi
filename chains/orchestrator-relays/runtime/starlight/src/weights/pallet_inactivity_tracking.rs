...
impl<T: frame_system::Config> pallet_inactivity_tracking::WeightInfo for SubstrateWeight<T> {
	...
	fn set_inactivity_tracking_status() -> Weight {
		...
		Weight::from_parts(12_964_000, 1905)
	...
	fn set_offline() -> Weight {
		...
		Weight::from_parts(65_002_000, 16518)
	...
	fn set_online() -> Weight {
		...
		Weight::from_parts(63_539_000, 16518)
	...
	fn notify_inactive_collator() -> Weight {
		...
		//  Measured:  `1949`
		//  Estimated: `29435`
		// Minimum execution time: 80_921_000 picoseconds.
		Weight::from_parts(84_278_000, 29435)
