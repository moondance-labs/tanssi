...
impl<T: frame_system::Config> pallet_beefy_mmr::WeightInfo for SubstrateWeight<T> {
	...
	fn read_peak() -> Weight {
		...
		Weight::from_parts(4_388_000, 3505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn n_items_proof_is_non_canonical(n: u32, ) -> Weight {
		...
		Weight::from_parts(9_187_000, 1517)
			// Standard Error: 8_913
			.saturating_add(Weight::from_parts(1_002_021, 0).saturating_mul(n.into()))
