...
impl<T: frame_system::Config> pallet_beefy_mmr::WeightInfo for SubstrateWeight<T> {
	...
	fn extract_validation_context() -> Weight {
		...
		Weight::from_parts(4_538_000, 3509)
	...
	fn read_peak() -> Weight {
		...
		Weight::from_parts(4_217_000, 3505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn n_items_proof_is_non_canonical(n: u32, ) -> Weight {
		...
		Weight::from_parts(9_218_000, 1517)
			// Standard Error: 10_581
			.saturating_add(Weight::from_parts(1_175_605, 0).saturating_mul(n.into()))
