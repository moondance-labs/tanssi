...
// --output=tmp/starlight_weights/pallet_mmr.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_mmr::WeightInfo for SubstrateWeight<T> {
	...
	/// Proof: `OutboundMessageCommitmentRecorder::RecordedCommitment` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	/// Storage: `OutboundMessageCommitmentRecorder::RecordedCommitmentV2` (r:1 w:0)
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		Weight::from_parts(43_036_309, 9242)
			// Standard Error: 1_913
			.saturating_add(Weight::from_parts(14_653, 0).saturating_mul(x.into()))
