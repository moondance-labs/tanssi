...
// --pallet=pallet_configuration
// --extrinsic=*
// --wasm-execution=compiled
// --steps=50
// --repeat=20
// --template=benchmarking/frame-weight-runtime-template.hbs
// --output=tmp/starlight_weights/pallet_configuration.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_configuration::WeightInfo for SubstrateWeight<T> {
	/// Storage: `CollatorConfiguration::PendingConfigs` (r:1 w:1)
	...
	/// Storage: `CollatorConfiguration::BypassConsistencyCheck` (r:1 w:0)
	/// Proof: `CollatorConfiguration::BypassConsistencyCheck` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	...
	fn set_config_with_u32() -> Weight {
		...
		Weight::from_parts(9_207_000, 2066)
