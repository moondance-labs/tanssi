...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(38_322_848, 8131)
			// Standard Error: 93_857
			.saturating_add(Weight::from_parts(110_278, 0).saturating_mul(x.into()))
			// Standard Error: 955_652
			.saturating_add(Weight::from_parts(23_543_694, 0).saturating_mul(y.into()))
