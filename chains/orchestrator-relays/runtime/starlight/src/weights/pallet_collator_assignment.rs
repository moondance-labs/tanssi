...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 80_651_000 picoseconds.
		Weight::from_parts(5_613_792, 7867)
			// Standard Error: 48_144
			.saturating_add(Weight::from_parts(189_938, 0).saturating_mul(x.into()))
			// Standard Error: 490_206
			.saturating_add(Weight::from_parts(20_584_695, 0).saturating_mul(y.into()))
