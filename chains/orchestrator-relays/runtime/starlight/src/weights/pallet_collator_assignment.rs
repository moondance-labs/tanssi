...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `4633 + y * (384 ±0)`
		//  Estimated: `8098 + y * (2511 ±0)`
		// Minimum execution time: 243_790_000 picoseconds.
		Weight::from_parts(150_216_737, 8098)
			// Standard Error: 31_282
			.saturating_add(Weight::from_parts(413_755, 0).saturating_mul(x.into()))
			// Standard Error: 320_683
			.saturating_add(Weight::from_parts(30_560_214, 0).saturating_mul(y.into()))
