...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 142_277_000 picoseconds.
		Weight::from_parts(151_545_000, 8131)
			// Standard Error: 68_607
			.saturating_add(Weight::from_parts(234_744, 0).saturating_mul(x.into()))
			// Standard Error: 687_648
			.saturating_add(Weight::from_parts(15_704_156, 0).saturating_mul(y.into()))
