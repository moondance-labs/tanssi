...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(_x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 182_182_000 picoseconds.
		Weight::from_parts(238_441_703, 8131)
			// Standard Error: 842_659
			.saturating_add(Weight::from_parts(15_986_110, 0).saturating_mul(y.into()))
