...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(57_330_941, 7834)
			// Standard Error: 41_736
			.saturating_add(Weight::from_parts(459_403, 0).saturating_mul(x.into()))
			// Standard Error: 424_956
			.saturating_add(Weight::from_parts(15_359_881, 0).saturating_mul(y.into()))
