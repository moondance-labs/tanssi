...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(96_932_000, 8131)
			// Standard Error: 23_507
			.saturating_add(Weight::from_parts(189_820, 0).saturating_mul(x.into()))
			// Standard Error: 235_618
			.saturating_add(Weight::from_parts(15_770_609, 0).saturating_mul(y.into()))
