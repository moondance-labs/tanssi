...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 161_248_000 picoseconds.
		Weight::from_parts(103_018_058, 7834)
			// Standard Error: 3_908
			.saturating_add(Weight::from_parts(251_098, 0).saturating_mul(x.into()))
			// Standard Error: 39_793
			.saturating_add(Weight::from_parts(25_969_073, 0).saturating_mul(y.into()))
