...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 95_209_000 picoseconds.
		Weight::from_parts(97_263_000, 8131)
			// Standard Error: 25_020
			.saturating_add(Weight::from_parts(199_629, 0).saturating_mul(x.into()))
			// Standard Error: 250_783
			.saturating_add(Weight::from_parts(15_657_462, 0).saturating_mul(y.into()))
