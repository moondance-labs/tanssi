...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(88_125_000, 7829)
			// Standard Error: 26_608
			.saturating_add(Weight::from_parts(100_538, 0).saturating_mul(x.into()))
			// Standard Error: 266_692
			.saturating_add(Weight::from_parts(17_870_994, 0).saturating_mul(y.into()))
