...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 82_415_000 picoseconds.
		Weight::from_parts(53_598_255, 7867)
			// Standard Error: 2_000
			.saturating_add(Weight::from_parts(117_165, 0).saturating_mul(x.into()))
			// Standard Error: 20_371
			.saturating_add(Weight::from_parts(16_138_844, 0).saturating_mul(y.into()))
