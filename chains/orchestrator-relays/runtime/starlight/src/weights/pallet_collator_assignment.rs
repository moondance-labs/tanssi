...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(57_628_369, 5984)
			// Standard Error: 1_871
			.saturating_add(Weight::from_parts(167_509, 0).saturating_mul(x.into()))
			// Standard Error: 19_058
			.saturating_add(Weight::from_parts(15_917_602, 0).saturating_mul(y.into()))
