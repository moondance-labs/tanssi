...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(87_159_498, 8098)
			// Standard Error: 3_486
			.saturating_add(Weight::from_parts(266_743, 0).saturating_mul(x.into()))
			// Standard Error: 35_494
			.saturating_add(Weight::from_parts(23_244_100, 0).saturating_mul(y.into()))
