...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(88_577_000, 8131)
			// Standard Error: 16_923
			.saturating_add(Weight::from_parts(119_708, 0).saturating_mul(x.into()))
			// Standard Error: 169_626
			.saturating_add(Weight::from_parts(14_315_126, 0).saturating_mul(y.into()))
