...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(42_804_652, 5984)
			// Standard Error: 6_553
			.saturating_add(Weight::from_parts(237_937, 0).saturating_mul(x.into()))
			// Standard Error: 66_726
			.saturating_add(Weight::from_parts(16_252_498, 0).saturating_mul(y.into()))
