...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(53_915_322, 7834)
			// Standard Error: 53_219
			.saturating_add(Weight::from_parts(162_015, 0).saturating_mul(x.into()))
			// Standard Error: 541_877
			.saturating_add(Weight::from_parts(18_884_226, 0).saturating_mul(y.into()))
