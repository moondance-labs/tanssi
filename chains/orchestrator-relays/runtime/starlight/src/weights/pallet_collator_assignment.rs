...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(52_783_540, 8131)
			// Standard Error: 1_827
			.saturating_add(Weight::from_parts(156_962, 0).saturating_mul(x.into()))
			// Standard Error: 18_605
			.saturating_add(Weight::from_parts(15_786_599, 0).saturating_mul(y.into()))
