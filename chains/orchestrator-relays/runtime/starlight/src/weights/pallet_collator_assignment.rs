...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 92_263_000 picoseconds.
		Weight::from_parts(53_842_010, 5984)
			// Standard Error: 1_897
			.saturating_add(Weight::from_parts(168_270, 0).saturating_mul(x.into()))
			// Standard Error: 19_317
			.saturating_add(Weight::from_parts(15_751_567, 0).saturating_mul(y.into()))
