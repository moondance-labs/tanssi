...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `4632 + y * (385 ±0)`
		//  Estimated: `8098 + y * (2511 ±0)`
		// Minimum execution time: 146_224_000 picoseconds.
		Weight::from_parts(50_551_047, 8098)
			// Standard Error: 36_720
			.saturating_add(Weight::from_parts(457_331, 0).saturating_mul(x.into()))
			// Standard Error: 373_884
			.saturating_add(Weight::from_parts(14_424_615, 0).saturating_mul(y.into()))
