...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(81_673_544, 8131)
			// Standard Error: 45_415
			.saturating_add(Weight::from_parts(8_132, 0).saturating_mul(x.into()))
			// Standard Error: 462_420
			.saturating_add(Weight::from_parts(17_487_637, 0).saturating_mul(y.into()))
