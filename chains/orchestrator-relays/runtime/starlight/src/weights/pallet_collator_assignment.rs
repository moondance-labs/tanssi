...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(7_718_895, 7867)
			// Standard Error: 31_913
			.saturating_add(Weight::from_parts(401_078, 0).saturating_mul(x.into()))
			// Standard Error: 324_944
			.saturating_add(Weight::from_parts(16_639_604, 0).saturating_mul(y.into()))
