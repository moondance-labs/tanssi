...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 85_771_000 picoseconds.
		Weight::from_parts(55_053_670, 8098)
			// Standard Error: 2_067
			.saturating_add(Weight::from_parts(129_773, 0).saturating_mul(x.into()))
			// Standard Error: 21_055
			.saturating_add(Weight::from_parts(15_528_689, 0).saturating_mul(y.into()))
