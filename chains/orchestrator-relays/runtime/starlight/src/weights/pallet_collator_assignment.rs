...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(55_794_052, 5984)
			// Standard Error: 2_694
			.saturating_add(Weight::from_parts(174_759, 0).saturating_mul(x.into()))
			// Standard Error: 27_434
			.saturating_add(Weight::from_parts(16_522_231, 0).saturating_mul(y.into()))
