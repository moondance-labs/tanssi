...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(51_824_894, 8098)
			// Standard Error: 1_766
			.saturating_add(Weight::from_parts(121_881, 0).saturating_mul(x.into()))
			// Standard Error: 17_983
			.saturating_add(Weight::from_parts(15_160_511, 0).saturating_mul(y.into()))
