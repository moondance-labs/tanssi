...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(87_254_000, 7829)
			// Standard Error: 31_139
			.saturating_add(Weight::from_parts(107_883, 0).saturating_mul(x.into()))
			// Standard Error: 312_106
			.saturating_add(Weight::from_parts(18_783_657, 0).saturating_mul(y.into()))
