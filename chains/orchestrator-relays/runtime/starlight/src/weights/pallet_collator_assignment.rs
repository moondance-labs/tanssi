...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `4368 + y * (385 ±0)`
		//  Estimated: `7834 + y * (2511 ±0)`
		// Minimum execution time: 157_687_000 picoseconds.
		Weight::from_parts(80_200_675, 7834)
			// Standard Error: 52_723
			.saturating_add(Weight::from_parts(286_977, 0).saturating_mul(x.into()))
			// Standard Error: 536_827
			.saturating_add(Weight::from_parts(16_599_848, 0).saturating_mul(y.into()))
