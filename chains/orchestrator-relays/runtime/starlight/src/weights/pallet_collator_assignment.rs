...
// --output=tmp/starlight_weights/pallet_collator_assignment.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `4363 + y * (385 ±0)`
		//  Estimated: `7829 + y * (2511 ±0)`
		// Minimum execution time: 115_617_000 picoseconds.
		Weight::from_parts(121_118_000, 7829)
			// Standard Error: 31_811
			.saturating_add(Weight::from_parts(111_649, 0).saturating_mul(x.into()))
			// Standard Error: 318_842
			.saturating_add(Weight::from_parts(17_317_704, 0).saturating_mul(y.into()))
