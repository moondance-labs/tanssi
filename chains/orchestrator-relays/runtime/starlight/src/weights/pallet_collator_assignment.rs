...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `4401 + y * (385 ±0)`
		//  Estimated: `7867 + y * (2511 ±0)`
		// Minimum execution time: 138_920_000 picoseconds.
		Weight::from_parts(64_541_545, 7867)
			// Standard Error: 44_587
			.saturating_add(Weight::from_parts(135_792, 0).saturating_mul(x.into()))
			// Standard Error: 453_988
			.saturating_add(Weight::from_parts(17_179_082, 0).saturating_mul(y.into()))
