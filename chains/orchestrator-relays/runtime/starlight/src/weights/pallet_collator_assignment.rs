...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 92_162_000 picoseconds.
		Weight::from_parts(58_560_040, 8098)
			// Standard Error: 1_851
			.saturating_add(Weight::from_parts(138_657, 0).saturating_mul(x.into()))
			// Standard Error: 18_854
			.saturating_add(Weight::from_parts(15_571_120, 0).saturating_mul(y.into()))
