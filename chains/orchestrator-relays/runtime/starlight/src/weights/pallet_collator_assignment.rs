...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(85_851_000, 7829)
			// Standard Error: 24_795
			.saturating_add(Weight::from_parts(220_686, 0).saturating_mul(x.into()))
			// Standard Error: 248_523
			.saturating_add(Weight::from_parts(15_999_920, 0).saturating_mul(y.into()))
