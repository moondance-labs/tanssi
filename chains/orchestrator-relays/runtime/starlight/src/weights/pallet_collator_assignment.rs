...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(54_866_222, 8131)
			// Standard Error: 1_865
			.saturating_add(Weight::from_parts(139_976, 0).saturating_mul(x.into()))
			// Standard Error: 18_991
			.saturating_add(Weight::from_parts(15_341_234, 0).saturating_mul(y.into()))
