...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(32_453_038, 8131)
			// Standard Error: 14_306
			.saturating_add(Weight::from_parts(222_371, 0).saturating_mul(x.into()))
			// Standard Error: 145_667
			.saturating_add(Weight::from_parts(16_696_754, 0).saturating_mul(y.into()))
