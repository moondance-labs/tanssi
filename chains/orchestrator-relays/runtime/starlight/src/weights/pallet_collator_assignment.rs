...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 144_316_000 picoseconds.
		Weight::from_parts(87_061_318, 8131)
			// Standard Error: 3_468
			.saturating_add(Weight::from_parts(258_592, 0).saturating_mul(x.into()))
			// Standard Error: 35_314
			.saturating_add(Weight::from_parts(23_903_731, 0).saturating_mul(y.into()))
