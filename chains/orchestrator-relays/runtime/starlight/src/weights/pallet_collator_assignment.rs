...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(57_600_059, 8098)
			// Standard Error: 1_957
			.saturating_add(Weight::from_parts(151_672, 0).saturating_mul(x.into()))
			// Standard Error: 19_930
			.saturating_add(Weight::from_parts(16_272_421, 0).saturating_mul(y.into()))
