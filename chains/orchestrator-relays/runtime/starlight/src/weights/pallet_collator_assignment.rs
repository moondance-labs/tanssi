...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 144_947_000 picoseconds.
		Weight::from_parts(147_240_000, 8098)
			// Standard Error: 40_866
			.saturating_add(Weight::from_parts(605_116, 0).saturating_mul(x.into()))
			// Standard Error: 409_605
			.saturating_add(Weight::from_parts(21_730_903, 0).saturating_mul(y.into()))
