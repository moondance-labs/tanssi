...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(90_670_000, 8131)
			// Standard Error: 20_168
			.saturating_add(Weight::from_parts(222_066, 0).saturating_mul(x.into()))
			// Standard Error: 202_143
			.saturating_add(Weight::from_parts(14_543_542, 0).saturating_mul(y.into()))
