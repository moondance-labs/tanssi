...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(91_830_286, 5984)
			// Standard Error: 3_762
			.saturating_add(Weight::from_parts(267_423, 0).saturating_mul(x.into()))
			// Standard Error: 38_314
			.saturating_add(Weight::from_parts(23_915_673, 0).saturating_mul(y.into()))
