...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(48_170_723, 8131)
			// Standard Error: 2_668
			.saturating_add(Weight::from_parts(158_675, 0).saturating_mul(x.into()))
			// Standard Error: 27_171
			.saturating_add(Weight::from_parts(15_770_590, 0).saturating_mul(y.into()))
