...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 149_556_000 picoseconds.
		Weight::from_parts(91_557_255, 5984)
			// Standard Error: 4_237
			.saturating_add(Weight::from_parts(269_095, 0).saturating_mul(x.into()))
			// Standard Error: 43_148
			.saturating_add(Weight::from_parts(24_191_575, 0).saturating_mul(y.into()))
