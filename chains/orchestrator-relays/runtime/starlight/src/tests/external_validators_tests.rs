...
fn test_message_decoding() {
    use tp_bridge::Message as bridgeMessage;

    let expected = hex!(
        "" // offset of era_index
    );
    println!("decoded {:?}", bridgeMessage::<Runtime>::decode(expected));
}
