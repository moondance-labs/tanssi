...
#[test]
fn receive_erc20_tokens_fails_if_below_ED() {
    ExtBuilder::default()
        .with_balances(vec![
            (EthereumSovereignAccount::get(), 100_000 * UNIT),
            (SnowbridgeFeesAccount::get(), 100_000 * UNIT),
...
#[test]
fn receive_erc20_tokens_fails_if_not_sufficient_and_random_address() {
    ExtBuilder::default()
        .with_balances(vec![
            (EthereumSovereignAccount::get(), 100_000 * UNIT),
            (SnowbridgeFeesAccount::get(), 100_000 * UNIT),
        ...
        .execute_with(|| {
            ...
            assert_noop!(
                EthereumInboundQueue::submit(relayer, message),
                sp_runtime::DispatchError::Other("LocalExecutionIncomplete")
            );
        });
}
