...
//! Autogenerated weights for pallet_services_payment_price_oracle
//!
...
// benchmark
// pallet
// --runtime=target/release/wbuild/dancelight-runtime/dancelight_runtime.compact.wasm
// --pallet=pallet_services_payment_price_oracle
// --extrinsic=*
// --output=tmp/dancelight_weights
...
impl<T: frame_system::Config> pallet_services_payment_price_oracle::WeightInfo for SubstrateWeight<T> {
