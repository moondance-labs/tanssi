...
// benchmark
// pallet
// --runtime=target/release/wbuild/dancelight-runtime/dancelight_runtime.compact.compressed.wasm
...
// --output=tmp/snowbridge_pallet_inbound_queue_v2.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
/// Weights for snowbridge_pallet_inbound_queue_v2 using the Substrate node and recommended hardware.
pub struct SubstrateWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> snowbridge_pallet_inbound_queue_v2::WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: `ForeignAssetsCreator::ForeignAssetToAssetId` (r:2 w:0)
	...
	fn submit() -> Weight {
		...
		Weight::from_parts(164_000_000, 7099)
