...
impl<T: frame_system::Config> runtime_parachains::on_demand::WeightInfo for SubstrateWeight<T> {
	...
	fn place_order_keep_alive(s: u32, ) -> Weight {
		...
		Weight::from_parts(49_078_533, 3766)
			// Standard Error: 177
			.saturating_add(Weight::from_parts(24_617, 0).saturating_mul(s.into()))
	...
	fn place_order_allow_death(s: u32, ) -> Weight {
		...
		//  Measured:  `303 + s * (8 ±0)`
		//  Estimated: `3766 + s * (8 ±0)`
		// Minimum execution time: 58_457_000 picoseconds.
		Weight::from_parts(51_231_091, 3766)
			// Standard Error: 161
			.saturating_add(Weight::from_parts(24_377, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
	...
	fn place_order_with_credits(s: u32, ) -> Weight {
		...
		Weight::from_parts(20_624_725, 3800)
			// Standard Error: 152
			.saturating_add(Weight::from_parts(23_694, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
