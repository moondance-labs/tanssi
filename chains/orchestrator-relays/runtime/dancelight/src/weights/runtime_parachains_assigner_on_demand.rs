...
impl<T: frame_system::Config> runtime_parachains::on_demand::WeightInfo for SubstrateWeight<T> {
	...
	fn place_order_keep_alive(s: u32, ) -> Weight {
		...
		Weight::from_parts(20_695_631, 3766)
			// Standard Error: 164
			.saturating_add(Weight::from_parts(18_139, 0).saturating_mul(s.into()))
	...
	fn place_order_allow_death(s: u32, ) -> Weight {
		...
		Weight::from_parts(39_731_892, 3766)
			// Standard Error: 206
			.saturating_add(Weight::from_parts(15_345, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
	...
	fn place_order_with_credits(s: u32, ) -> Weight {
		...
		Weight::from_parts(9_710_886, 3800)
			// Standard Error: 125
			.saturating_add(Weight::from_parts(14_462, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
