...
impl<T: frame_system::Config> runtime_parachains::on_demand::WeightInfo for SubstrateWeight<T> {
	...
	fn place_order_keep_alive(s: u32, ) -> Weight {
		...
		// Minimum execution time: 55_125_000 picoseconds.
		Weight::from_parts(42_380_711, 3766)
			// Standard Error: 161
			.saturating_add(Weight::from_parts(25_655, 0).saturating_mul(s.into()))
	...
	fn place_order_allow_death(s: u32, ) -> Weight {
		...
		//  Measured:  `303 + s * (8 ±0)`
		//  Estimated: `3766 + s * (8 ±0)`
		// Minimum execution time: 55_292_000 picoseconds.
		Weight::from_parts(42_865_510, 3766)
			// Standard Error: 184
			.saturating_add(Weight::from_parts(25_342, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
	...
	fn place_order_with_credits(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_307_380, 3800)
			// Standard Error: 159
			.saturating_add(Weight::from_parts(25_021, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
