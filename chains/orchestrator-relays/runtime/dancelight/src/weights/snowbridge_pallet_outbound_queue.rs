...
// --output=tmp/dancelight_weights/snowbridge_pallet_outbound_queue.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> snowbridge_pallet_outbound_queue::WeightInfo for SubstrateWeight<T> {
	...
	fn do_process_message() -> Weight {
		...
		Weight::from_parts(31_178_000, 3513)
	...
	fn commit() -> Weight {
		...
		Weight::from_parts(29_956_000, 2712)
	...
	fn commit_single() -> Weight {
		...
		Weight::from_parts(11_572_000, 1719)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}