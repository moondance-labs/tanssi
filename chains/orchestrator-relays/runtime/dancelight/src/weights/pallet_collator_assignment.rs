...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 98_835_000 picoseconds.
		Weight::from_parts(39_098_482, 8131)
			// Standard Error: 16_096
			.saturating_add(Weight::from_parts(236_139, 0).saturating_mul(x.into()))
			// Standard Error: 163_898
			.saturating_add(Weight::from_parts(18_827_878, 0).saturating_mul(y.into()))
