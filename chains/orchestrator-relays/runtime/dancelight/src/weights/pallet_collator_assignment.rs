...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(62_141_728, 6017)
			// Standard Error: 2_236
			.saturating_add(Weight::from_parts(145_805, 0).saturating_mul(x.into()))
			// Standard Error: 22_775
			.saturating_add(Weight::from_parts(16_096_908, 0).saturating_mul(y.into()))
