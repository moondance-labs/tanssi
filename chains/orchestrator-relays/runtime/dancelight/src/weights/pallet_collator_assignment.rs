...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 81_814_000 picoseconds.
		Weight::from_parts(5_055_595, 7867)
			// Standard Error: 35_148
			.saturating_add(Weight::from_parts(466_074, 0).saturating_mul(x.into()))
			// Standard Error: 357_879
			.saturating_add(Weight::from_parts(17_594_346, 0).saturating_mul(y.into()))
