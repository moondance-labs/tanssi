...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 86_291_000 picoseconds.
		Weight::from_parts(50_632_429, 8131)
			// Standard Error: 2_161
			.saturating_add(Weight::from_parts(146_695, 0).saturating_mul(x.into()))
			// Standard Error: 22_006
			.saturating_add(Weight::from_parts(15_830_955, 0).saturating_mul(y.into()))
