...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 145_638_000 picoseconds.
		Weight::from_parts(133_592_688, 8131)
			// Standard Error: 120_143
			.saturating_add(Weight::from_parts(101_017, 0).saturating_mul(x.into()))
			// Standard Error: 1_223_293
			.saturating_add(Weight::from_parts(36_892_814, 0).saturating_mul(y.into()))
