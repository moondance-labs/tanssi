...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(87_604_664, 8131)
			// Standard Error: 3_536
			.saturating_add(Weight::from_parts(252_183, 0).saturating_mul(x.into()))
			// Standard Error: 36_013
			.saturating_add(Weight::from_parts(23_700_530, 0).saturating_mul(y.into()))
