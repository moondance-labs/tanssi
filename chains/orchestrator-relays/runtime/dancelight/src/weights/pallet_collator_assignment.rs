...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(87_975_000, 8164)
			// Standard Error: 24_392
			.saturating_add(Weight::from_parts(290_710, 0).saturating_mul(x.into()))
			// Standard Error: 244_489
			.saturating_add(Weight::from_parts(14_452_785, 0).saturating_mul(y.into()))
