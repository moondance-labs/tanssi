...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(53_098_563, 6017)
			// Standard Error: 1_960
			.saturating_add(Weight::from_parts(170_197, 0).saturating_mul(x.into()))
			// Standard Error: 19_964
			.saturating_add(Weight::from_parts(15_767_948, 0).saturating_mul(y.into()))
