...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(80_201_279, 8131)
			// Standard Error: 53_227
			.saturating_add(Weight::from_parts(117_763, 0).saturating_mul(x.into()))
			// Standard Error: 541_959
			.saturating_add(Weight::from_parts(18_263_801, 0).saturating_mul(y.into()))
