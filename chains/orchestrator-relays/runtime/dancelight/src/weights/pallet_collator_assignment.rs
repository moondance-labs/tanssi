...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(85_891_000, 7905)
			// Standard Error: 20_898
			.saturating_add(Weight::from_parts(217_579, 0).saturating_mul(x.into()))
			// Standard Error: 209_466
			.saturating_add(Weight::from_parts(15_332_365, 0).saturating_mul(y.into()))
