...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(56_332_023, 6017)
			// Standard Error: 2_042
			.saturating_add(Weight::from_parts(159_727, 0).saturating_mul(x.into()))
			// Standard Error: 20_799
			.saturating_add(Weight::from_parts(15_952_189, 0).saturating_mul(y.into()))
