...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 124_453_000 picoseconds.
		Weight::from_parts(31_793_040, 8131)
			// Standard Error: 51_939
			.saturating_add(Weight::from_parts(406_291, 0).saturating_mul(x.into()))
			// Standard Error: 528_850
			.saturating_add(Weight::from_parts(18_748_412, 0).saturating_mul(y.into()))
