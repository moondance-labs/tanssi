...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_151_144, 8164)
			// Standard Error: 65_449
			.saturating_add(Weight::from_parts(427_828, 0).saturating_mul(x.into()))
			// Standard Error: 666_402
			.saturating_add(Weight::from_parts(21_306_008, 0).saturating_mul(y.into()))
