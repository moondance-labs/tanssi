...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 85_471_000 picoseconds.
		Weight::from_parts(12_065_857, 7867)
			// Standard Error: 58_467
			.saturating_add(Weight::from_parts(167_782, 0).saturating_mul(x.into()))
			// Standard Error: 595_310
			.saturating_add(Weight::from_parts(21_813_188, 0).saturating_mul(y.into()))
