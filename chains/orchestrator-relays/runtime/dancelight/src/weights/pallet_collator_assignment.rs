...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(233_087, 8131)
			// Standard Error: 23_724
			.saturating_add(Weight::from_parts(347_161, 0).saturating_mul(x.into()))
			// Standard Error: 241_562
			.saturating_add(Weight::from_parts(17_069_419, 0).saturating_mul(y.into()))
