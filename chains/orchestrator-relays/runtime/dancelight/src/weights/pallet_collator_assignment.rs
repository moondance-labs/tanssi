...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `4531 + y * (385 ±0)`
		//  Estimated: `6017 + y * (2511 ±0)`
		// Minimum execution time: 91_310_000 picoseconds.
		Weight::from_parts(53_394_857, 6017)
			// Standard Error: 2_077
			.saturating_add(Weight::from_parts(167_885, 0).saturating_mul(x.into()))
			// Standard Error: 21_153
			.saturating_add(Weight::from_parts(15_269_769, 0).saturating_mul(y.into()))
