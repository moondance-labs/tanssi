...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(_x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 87_786_000 picoseconds.
		Weight::from_parts(168_550_694, 8164)
			// Standard Error: 344_309
			.saturating_add(Weight::from_parts(13_925_616, 0).saturating_mul(y.into()))
