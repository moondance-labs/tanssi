...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 160_578_000 picoseconds.
		Weight::from_parts(101_079_689, 7867)
			// Standard Error: 3_731
			.saturating_add(Weight::from_parts(261_498, 0).saturating_mul(x.into()))
			// Standard Error: 37_991
			.saturating_add(Weight::from_parts(26_808_659, 0).saturating_mul(y.into()))
