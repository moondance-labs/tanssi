...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 82_024_000 picoseconds.
		Weight::from_parts(51_734_448, 7905)
			// Standard Error: 1_900
			.saturating_add(Weight::from_parts(126_863, 0).saturating_mul(x.into()))
			// Standard Error: 19_351
			.saturating_add(Weight::from_parts(15_903_018, 0).saturating_mul(y.into()))
