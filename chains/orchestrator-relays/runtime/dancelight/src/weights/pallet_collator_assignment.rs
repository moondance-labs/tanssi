...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(97_973_000, 8131)
			// Standard Error: 19_881
			.saturating_add(Weight::from_parts(282_946, 0).saturating_mul(x.into()))
			// Standard Error: 199_268
			.saturating_add(Weight::from_parts(14_240_011, 0).saturating_mul(y.into()))
