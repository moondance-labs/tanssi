...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 87_294_000 picoseconds.
		Weight::from_parts(53_635_556, 8131)
			// Standard Error: 62_651
			.saturating_add(Weight::from_parts(344_200, 0).saturating_mul(x.into()))
			// Standard Error: 637_911
			.saturating_add(Weight::from_parts(18_437_129, 0).saturating_mul(y.into()))
