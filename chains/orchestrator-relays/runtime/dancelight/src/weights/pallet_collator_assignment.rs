...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `4698 + y * (385 ±0)`
		//  Estimated: `8164 + y * (2511 ±0)`
		// Minimum execution time: 111_038_000 picoseconds.
		Weight::from_parts(122_270_000, 8164)
			// Standard Error: 52_465
			.saturating_add(Weight::from_parts(177_459, 0).saturating_mul(x.into()))
			// Standard Error: 525_858
			.saturating_add(Weight::from_parts(19_713_243, 0).saturating_mul(y.into()))
