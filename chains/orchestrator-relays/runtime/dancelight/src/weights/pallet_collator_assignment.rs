...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(52_704_440, 7867)
			// Standard Error: 1_871
			.saturating_add(Weight::from_parts(128_891, 0).saturating_mul(x.into()))
			// Standard Error: 19_053
			.saturating_add(Weight::from_parts(16_428_745, 0).saturating_mul(y.into()))
