...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(58_883_627, 6017)
			// Standard Error: 2_221
			.saturating_add(Weight::from_parts(174_329, 0).saturating_mul(x.into()))
			// Standard Error: 22_622
			.saturating_add(Weight::from_parts(16_133_519, 0).saturating_mul(y.into()))
