...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 150_201_000 picoseconds.
		Weight::from_parts(93_138_744, 6017)
			// Standard Error: 3_730
			.saturating_add(Weight::from_parts(262_878, 0).saturating_mul(x.into()))
			// Standard Error: 37_985
			.saturating_add(Weight::from_parts(24_401_015, 0).saturating_mul(y.into()))
