...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(57_901_299, 8131)
			// Standard Error: 1_977
			.saturating_add(Weight::from_parts(162_851, 0).saturating_mul(x.into()))
			// Standard Error: 20_138
			.saturating_add(Weight::from_parts(16_344_272, 0).saturating_mul(y.into()))
