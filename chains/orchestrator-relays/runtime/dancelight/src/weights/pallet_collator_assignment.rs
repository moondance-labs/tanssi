...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_413_268, 8131)
			// Standard Error: 55_481
			.saturating_add(Weight::from_parts(252_754, 0).saturating_mul(x.into()))
			// Standard Error: 564_909
			.saturating_add(Weight::from_parts(20_973_461, 0).saturating_mul(y.into()))
