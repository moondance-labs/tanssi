...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(_x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 87_183_000 picoseconds.
		Weight::from_parts(171_675_764, 8131)
			// Standard Error: 385_304
			.saturating_add(Weight::from_parts(15_333_798, 0).saturating_mul(y.into()))
