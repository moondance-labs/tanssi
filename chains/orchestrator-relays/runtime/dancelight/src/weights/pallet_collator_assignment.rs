...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 145_600_000 picoseconds.
		Weight::from_parts(87_965_377, 8131)
			// Standard Error: 3_403
			.saturating_add(Weight::from_parts(261_372, 0).saturating_mul(x.into()))
			// Standard Error: 34_650
			.saturating_add(Weight::from_parts(23_458_796, 0).saturating_mul(y.into()))
