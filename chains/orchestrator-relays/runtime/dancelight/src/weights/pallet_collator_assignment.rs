...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(51_554_127, 8164)
			// Standard Error: 2_197
			.saturating_add(Weight::from_parts(142_522, 0).saturating_mul(x.into()))
			// Standard Error: 22_375
			.saturating_add(Weight::from_parts(15_845_921, 0).saturating_mul(y.into()))
