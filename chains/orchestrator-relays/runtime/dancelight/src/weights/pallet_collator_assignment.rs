...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(101_476_738, 7905)
			// Standard Error: 54_045
			.saturating_add(Weight::from_parts(45_389, 0).saturating_mul(x.into()))
			// Standard Error: 550_285
			.saturating_add(Weight::from_parts(17_773_360, 0).saturating_mul(y.into()))
