...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(58_259_292, 8131)
			// Standard Error: 1_959
			.saturating_add(Weight::from_parts(150_014, 0).saturating_mul(x.into()))
			// Standard Error: 19_955
			.saturating_add(Weight::from_parts(15_660_520, 0).saturating_mul(y.into()))
