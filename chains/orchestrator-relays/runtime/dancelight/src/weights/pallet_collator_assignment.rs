...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(100_603_644, 7867)
			// Standard Error: 3_584
			.saturating_add(Weight::from_parts(259_327, 0).saturating_mul(x.into()))
			// Standard Error: 36_498
			.saturating_add(Weight::from_parts(26_144_966, 0).saturating_mul(y.into()))
