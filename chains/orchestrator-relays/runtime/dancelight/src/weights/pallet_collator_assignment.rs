...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(84_778_000, 7905)
			// Standard Error: 22_302
			.saturating_add(Weight::from_parts(200_090, 0).saturating_mul(x.into()))
			// Standard Error: 223_539
			.saturating_add(Weight::from_parts(15_491_081, 0).saturating_mul(y.into()))
