...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_904_000, 7595)
			// Standard Error: 389_121
			.saturating_add(Weight::from_parts(23_866_506, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(256_532_191, 8799)
			// Standard Error: 498_896
			.saturating_add(Weight::from_parts(22_021_264, 0).saturating_mul(x.into()))
