...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Measured:  `420 + x * (206 ±0)`
		//  Estimated: `6977 + x * (2561 ±2)`
		// Minimum execution time: 11_085_000 picoseconds.
		Weight::from_parts(11_264_000, 6977)
			// Standard Error: 152_927
			.saturating_add(Weight::from_parts(22_125_869, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `751 + x * (133 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 114_845_000 picoseconds.
		Weight::from_parts(97_543_472, 8799)
			// Standard Error: 15_189
			.saturating_add(Weight::from_parts(21_463_328, 0).saturating_mul(x.into()))
