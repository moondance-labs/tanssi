...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_080_000, 2051)
			// Standard Error: 193_511
			.saturating_add(Weight::from_parts(20_113_587, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 166_793_000 picoseconds.
		Weight::from_parts(121_970_661, 6287)
			// Standard Error: 1_914_234
			.saturating_add(Weight::from_parts(131_680_850, 0).saturating_mul(x.into()))
