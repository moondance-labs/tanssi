...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_442_000, 7595)
			// Standard Error: 104_495
			.saturating_add(Weight::from_parts(15_642_460, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 77_055_000 picoseconds.
		Weight::from_parts(66_682_666, 8799)
			// Standard Error: 9_913
			.saturating_add(Weight::from_parts(13_507_754, 0).saturating_mul(x.into()))
