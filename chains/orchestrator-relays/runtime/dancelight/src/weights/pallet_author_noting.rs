...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_923_000, 7595)
			// Standard Error: 225_441
			.saturating_add(Weight::from_parts(17_814_592, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(152_479_176, 8799)
			// Standard Error: 181_043
			.saturating_add(Weight::from_parts(12_465_920, 0).saturating_mul(x.into()))
