...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Estimated: `7574 + x * (2527 ±2)`
		// Minimum execution time: 8_045_000 picoseconds.
		Weight::from_parts(8_446_000, 7574)
			// Standard Error: 123_517
			.saturating_add(Weight::from_parts(16_855_052, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 79_038_000 picoseconds.
		Weight::from_parts(69_952_898, 8799)
			// Standard Error: 9_692
			.saturating_add(Weight::from_parts(14_693_641, 0).saturating_mul(x.into()))
