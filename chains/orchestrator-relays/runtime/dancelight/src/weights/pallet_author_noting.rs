...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_856_000, 7595)
			// Standard Error: 138_292
			.saturating_add(Weight::from_parts(21_104_398, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 124_944_000 picoseconds.
		Weight::from_parts(99_590_923, 8799)
			// Standard Error: 18_079
			.saturating_add(Weight::from_parts(24_982_749, 0).saturating_mul(x.into()))
