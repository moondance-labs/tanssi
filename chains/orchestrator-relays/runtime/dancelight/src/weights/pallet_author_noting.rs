...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_332_000, 7595)
			// Standard Error: 110_158
			.saturating_add(Weight::from_parts(15_196_305, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 74_800_000 picoseconds.
		Weight::from_parts(63_900_035, 8799)
			// Standard Error: 21_430
			.saturating_add(Weight::from_parts(13_210_698, 0).saturating_mul(x.into()))
