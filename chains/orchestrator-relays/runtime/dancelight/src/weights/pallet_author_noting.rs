...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_093_000, 7595)
			// Standard Error: 126_836
			.saturating_add(Weight::from_parts(17_106_057, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(75_585_008, 8799)
			// Standard Error: 9_952
			.saturating_add(Weight::from_parts(15_204_591, 0).saturating_mul(x.into()))
