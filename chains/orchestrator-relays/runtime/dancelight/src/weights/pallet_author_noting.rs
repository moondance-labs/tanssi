...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_510_000, 2051)
			// Standard Error: 335_290
			.saturating_add(Weight::from_parts(20_697_134, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 215_093_000 picoseconds.
		Weight::from_parts(149_988_869, 6287)
			// Standard Error: 2_200_330
			.saturating_add(Weight::from_parts(137_259_542, 0).saturating_mul(x.into()))
