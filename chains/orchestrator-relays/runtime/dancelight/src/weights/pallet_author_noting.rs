...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_274_000, 7336)
			// Standard Error: 122_638
			.saturating_add(Weight::from_parts(16_986_670, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(18_241_022, 8799)
			// Standard Error: 305_595
			.saturating_add(Weight::from_parts(17_110_044, 0).saturating_mul(x.into()))
