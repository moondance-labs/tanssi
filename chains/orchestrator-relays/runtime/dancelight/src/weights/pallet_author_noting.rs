...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_663_000, 7595)
			// Standard Error: 113_568
			.saturating_add(Weight::from_parts(16_461_997, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_796_500, 8799)
			// Standard Error: 7_281
			.saturating_add(Weight::from_parts(14_097_606, 0).saturating_mul(x.into()))
