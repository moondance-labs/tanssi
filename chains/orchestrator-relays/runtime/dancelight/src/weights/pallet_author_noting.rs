...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_502_000, 7595)
			// Standard Error: 123_619
			.saturating_add(Weight::from_parts(16_386_525, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_968_905, 8799)
			// Standard Error: 375_478
			.saturating_add(Weight::from_parts(19_464_298, 0).saturating_mul(x.into()))
