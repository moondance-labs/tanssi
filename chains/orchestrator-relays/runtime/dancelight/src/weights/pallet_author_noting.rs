...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_673_000, 7595)
			// Standard Error: 199_781
			.saturating_add(Weight::from_parts(17_475_410, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(96_116_413, 8799)
			// Standard Error: 428_596
			.saturating_add(Weight::from_parts(16_524_484, 0).saturating_mul(x.into()))
