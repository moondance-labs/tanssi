...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Measured:  `1144 + x * (170 ±0)`
		//  Estimated: `7595 + x * (2527 ±2)`
		// Minimum execution time: 6_623_000 picoseconds.
		Weight::from_parts(6_693_000, 7595)
			// Standard Error: 128_184
			.saturating_add(Weight::from_parts(16_414_403, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1649 + x * (132 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 78_346_000 picoseconds.
		Weight::from_parts(66_353_930, 8799)
			// Standard Error: 13_713
			.saturating_add(Weight::from_parts(14_271_391, 0).saturating_mul(x.into()))
