...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_566_000, 7595)
			// Standard Error: 122_294
			.saturating_add(Weight::from_parts(16_586_964, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(63_392_438, 8799)
			// Standard Error: 10_291
			.saturating_add(Weight::from_parts(16_572_363, 0).saturating_mul(x.into()))
