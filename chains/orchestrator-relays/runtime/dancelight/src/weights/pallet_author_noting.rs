...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_155_000, 7574)
			// Standard Error: 133_376
			.saturating_add(Weight::from_parts(21_120_405, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(117_481_880, 8799)
			// Standard Error: 18_343
			.saturating_add(Weight::from_parts(22_562_230, 0).saturating_mul(x.into()))
