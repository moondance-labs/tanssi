...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Measured:  `885 + x * (170 ±0)`
		//  Estimated: `7336 + x * (2527 ±2)`
		// Minimum execution time: 6_973_000 picoseconds.
		Weight::from_parts(7_113_000, 7336)
			// Standard Error: 155_495
			.saturating_add(Weight::from_parts(16_726_587, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1253 + x * (132 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 76_613_000 picoseconds.
		Weight::from_parts(122_579_855, 8799)
			// Standard Error: 187_457
			.saturating_add(Weight::from_parts(12_678_504, 0).saturating_mul(x.into()))
