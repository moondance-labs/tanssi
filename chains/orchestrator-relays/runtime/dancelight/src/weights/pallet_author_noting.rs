...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_275_000, 7595)
			// Standard Error: 124_440
			.saturating_add(Weight::from_parts(17_005_870, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(62_366_194, 8799)
			// Standard Error: 29_820
			.saturating_add(Weight::from_parts(17_026_483, 0).saturating_mul(x.into()))
