...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_215_000, 7595)
			// Standard Error: 114_260
			.saturating_add(Weight::from_parts(15_796_263, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(62_261_225, 8799)
			// Standard Error: 11_346
			.saturating_add(Weight::from_parts(16_095_885, 0).saturating_mul(x.into()))
