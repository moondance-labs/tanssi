...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_204_000, 7336)
			// Standard Error: 121_440
			.saturating_add(Weight::from_parts(16_320_950, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(26_681_949, 8799)
			// Standard Error: 276_354
			.saturating_add(Weight::from_parts(16_941_872, 0).saturating_mul(x.into()))
