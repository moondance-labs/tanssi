...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_793_000, 7595)
			// Standard Error: 124_990
			.saturating_add(Weight::from_parts(16_528_754, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 84_428_000 picoseconds.
		Weight::from_parts(16_274_756, 8799)
			// Standard Error: 364_905
			.saturating_add(Weight::from_parts(18_203_960, 0).saturating_mul(x.into()))
