...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_063_000, 7595)
			// Standard Error: 222_179
			.saturating_add(Weight::from_parts(17_842_901, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(137_749_236, 8799)
			// Standard Error: 162_940
			.saturating_add(Weight::from_parts(13_341_755, 0).saturating_mul(x.into()))
