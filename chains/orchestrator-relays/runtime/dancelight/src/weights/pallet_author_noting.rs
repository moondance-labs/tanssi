...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(33_603_000, 2051)
			// Standard Error: 121_915
			.saturating_add(Weight::from_parts(17_169_440, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 169_126_000 picoseconds.
		Weight::from_parts(89_171_928, 6287)
			// Standard Error: 1_861_501
			.saturating_add(Weight::from_parts(137_373_193, 0).saturating_mul(x.into()))
