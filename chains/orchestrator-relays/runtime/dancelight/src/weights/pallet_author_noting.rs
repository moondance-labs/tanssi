...
//! DATE: 2025-12-17, STEPS: `16`, REPEAT: `1`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Measured:  `507 + x * (170 ±0)`
		//  Estimated: `1992 + x * (2645 ±0)`
		// Minimum execution time: 50_990_000 picoseconds.
		Weight::from_parts(50_990_000, 1992)
			// Standard Error: 1_091_091
			.saturating_add(Weight::from_parts(29_072_064, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(141_461_543, 6287)
			// Standard Error: 540_627
			.saturating_add(Weight::from_parts(233_559_267, 0).saturating_mul(x.into()))
