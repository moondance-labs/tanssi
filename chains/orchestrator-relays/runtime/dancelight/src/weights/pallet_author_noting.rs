...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_898_000, 7595)
			// Standard Error: 142_345
			.saturating_add(Weight::from_parts(22_139_372, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 129_223_000 picoseconds.
		Weight::from_parts(115_213_744, 8799)
			// Standard Error: 14_652
			.saturating_add(Weight::from_parts(21_387_546, 0).saturating_mul(x.into()))
