...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Estimated: `7336 + x * (2527 ±0)`
		// Minimum execution time: 7_343_000 picoseconds.
		Weight::from_parts(7_494_000, 7336)
			// Standard Error: 123_391
			.saturating_add(Weight::from_parts(16_727_056, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(78_663_003, 8799)
			// Standard Error: 380_907
			.saturating_add(Weight::from_parts(16_253_327, 0).saturating_mul(x.into()))
