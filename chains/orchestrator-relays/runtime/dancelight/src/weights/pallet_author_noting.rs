...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_543_000, 7595)
			// Standard Error: 181_142
			.saturating_add(Weight::from_parts(17_267_008, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 79_119_000 picoseconds.
		Weight::from_parts(20_911_247, 8799)
			// Standard Error: 410_164
			.saturating_add(Weight::from_parts(17_911_512, 0).saturating_mul(x.into()))
