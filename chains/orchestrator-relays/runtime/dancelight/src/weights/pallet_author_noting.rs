...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_971_000, 2051)
			// Standard Error: 151_151
			.saturating_add(Weight::from_parts(18_861_799, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 171_431_000 picoseconds.
		Weight::from_parts(86_572_352, 6287)
			// Standard Error: 1_746_724
			.saturating_add(Weight::from_parts(136_306_455, 0).saturating_mul(x.into()))
