...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_160_000, 2051)
			// Standard Error: 267_366
			.saturating_add(Weight::from_parts(19_873_299, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 171_391_000 picoseconds.
		Weight::from_parts(89_354_770, 6287)
			// Standard Error: 1_386_234
			.saturating_add(Weight::from_parts(133_047_553, 0).saturating_mul(x.into()))
