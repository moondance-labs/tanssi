...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Estimated: `7298 + x * (2527 ±2)`
		// Minimum execution time: 12_261_000 picoseconds.
		Weight::from_parts(12_382_000, 7298)
			// Standard Error: 187_248
			.saturating_add(Weight::from_parts(26_317_301, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1220 + x * (132 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 134_831_000 picoseconds.
		Weight::from_parts(118_810_366, 8799)
			// Standard Error: 18_559
			.saturating_add(Weight::from_parts(23_639_998, 0).saturating_mul(x.into()))
