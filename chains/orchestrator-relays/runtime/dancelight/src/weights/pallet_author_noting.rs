...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_833_000, 7595)
			// Standard Error: 116_077
			.saturating_add(Weight::from_parts(15_738_487, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(66_767_245, 8799)
			// Standard Error: 16_418
			.saturating_add(Weight::from_parts(13_786_161, 0).saturating_mul(x.into()))
