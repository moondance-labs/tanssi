...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(34_976_000, 2051)
			// Standard Error: 221_126
			.saturating_add(Weight::from_parts(18_364_085, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 253_718_000 picoseconds.
		Weight::from_parts(164_146_796, 6287)
			// Standard Error: 1_782_271
			.saturating_add(Weight::from_parts(129_406_256, 0).saturating_mul(x.into()))
