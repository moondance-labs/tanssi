...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_833_000, 7595)
			// Standard Error: 120_304
			.saturating_add(Weight::from_parts(16_118_870, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(66_897_992, 8799)
			// Standard Error: 6_559
			.saturating_add(Weight::from_parts(13_854_397, 0).saturating_mul(x.into()))
