...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_861_000, 2051)
			// Standard Error: 435_394
			.saturating_add(Weight::from_parts(20_531_980, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 269_625_000 picoseconds.
		Weight::from_parts(280_737_000, 6287)
			// Standard Error: 1_428_598
			.saturating_add(Weight::from_parts(138_112_025, 0).saturating_mul(x.into()))
