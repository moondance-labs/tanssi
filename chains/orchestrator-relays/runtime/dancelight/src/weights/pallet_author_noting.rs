...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_993_000, 7595)
			// Standard Error: 124_480
			.saturating_add(Weight::from_parts(16_585_662, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(106_765_452, 8799)
			// Standard Error: 365_570
			.saturating_add(Weight::from_parts(17_198_327, 0).saturating_mul(x.into()))
