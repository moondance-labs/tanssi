...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_305_000, 7595)
			// Standard Error: 117_209
			.saturating_add(Weight::from_parts(16_426_167, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(63_230_585, 8799)
			// Standard Error: 9_362
			.saturating_add(Weight::from_parts(16_762_967, 0).saturating_mul(x.into()))
