...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_692_000, 7595)
			// Standard Error: 119_770
			.saturating_add(Weight::from_parts(15_973_770, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_239_012, 8799)
			// Standard Error: 10_018
			.saturating_add(Weight::from_parts(13_569_672, 0).saturating_mul(x.into()))
