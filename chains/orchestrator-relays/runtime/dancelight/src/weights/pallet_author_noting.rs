...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_512_000, 7595)
			// Standard Error: 120_504
			.saturating_add(Weight::from_parts(16_193_694, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(67_892_987, 8799)
			// Standard Error: 7_124
			.saturating_add(Weight::from_parts(14_124_697, 0).saturating_mul(x.into()))
