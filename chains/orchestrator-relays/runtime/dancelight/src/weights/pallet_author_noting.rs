...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_416_000, 7574)
			// Standard Error: 130_786
			.saturating_add(Weight::from_parts(17_570_376, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(67_369_580, 8799)
			// Standard Error: 32_754
			.saturating_add(Weight::from_parts(15_593_048, 0).saturating_mul(x.into()))
