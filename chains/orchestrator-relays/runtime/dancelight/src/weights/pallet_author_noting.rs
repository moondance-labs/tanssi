...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_442_000, 7595)
			// Standard Error: 114_497
			.saturating_add(Weight::from_parts(15_435_422, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(66_421_650, 8799)
			// Standard Error: 8_378
			.saturating_add(Weight::from_parts(13_667_635, 0).saturating_mul(x.into()))
