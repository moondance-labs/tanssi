...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Estimated: `7595 + x * (2527 ±0)`
		// Minimum execution time: 7_233_000 picoseconds.
		Weight::from_parts(7_384_000, 7595)
			// Standard Error: 131_771
			.saturating_add(Weight::from_parts(17_985_624, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1682 + x * (132 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 86_462_000 picoseconds.
		Weight::from_parts(19_397_612, 8799)
			// Standard Error: 425_999
			.saturating_add(Weight::from_parts(19_163_827, 0).saturating_mul(x.into()))
