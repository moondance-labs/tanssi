...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_384_000, 7336)
			// Standard Error: 128_223
			.saturating_add(Weight::from_parts(17_139_755, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(161_921_915, 8799)
			// Standard Error: 424_444
			.saturating_add(Weight::from_parts(14_740_506, 0).saturating_mul(x.into()))
