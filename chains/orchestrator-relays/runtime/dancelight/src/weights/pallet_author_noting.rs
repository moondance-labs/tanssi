...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_342_000, 7595)
			// Standard Error: 239_357
			.saturating_add(Weight::from_parts(17_682_491, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 77_425_000 picoseconds.
		Weight::from_parts(78_297_000, 8799)
			// Standard Error: 194_829
			.saturating_add(Weight::from_parts(18_069_167, 0).saturating_mul(x.into()))
