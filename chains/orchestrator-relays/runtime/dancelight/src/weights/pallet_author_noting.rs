...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_073_000, 7595)
			// Standard Error: 123_483
			.saturating_add(Weight::from_parts(16_876_200, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 83_337_000 picoseconds.
		Weight::from_parts(1_672_564, 8799)
			// Standard Error: 473_327
			.saturating_add(Weight::from_parts(19_767_359, 0).saturating_mul(x.into()))
