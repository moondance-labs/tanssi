...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Measured:  `1123 + x * (170 ±0)`
		//  Estimated: `7574 + x * (2527 ±0)`
		// Minimum execution time: 7_914_000 picoseconds.
		Weight::from_parts(8_115_000, 7574)
			// Standard Error: 117_428
			.saturating_add(Weight::from_parts(16_226_882, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1628 + x * (132 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 77_926_000 picoseconds.
		Weight::from_parts(69_112_718, 8799)
			// Standard Error: 8_890
			.saturating_add(Weight::from_parts(14_335_046, 0).saturating_mul(x.into()))
