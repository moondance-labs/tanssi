...
//! DATE: 2026-01-05, STEPS: `16`, REPEAT: `1`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Estimated: `2052 + x * (2646 ±0)`
		// Minimum execution time: 59_592_000 picoseconds.
		Weight::from_parts(59_592_000, 2052)
			// Standard Error: 1_074_037
			.saturating_add(Weight::from_parts(28_608_398, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1327 + x * (863 ±0)`
		//  Estimated: `6287 + x * (23292 ±0)`
		// Minimum execution time: 355_642_000 picoseconds.
		Weight::from_parts(133_071_579, 6287)
			// Standard Error: 489_142
			.saturating_add(Weight::from_parts(233_067_712, 0).saturating_mul(x.into()))
