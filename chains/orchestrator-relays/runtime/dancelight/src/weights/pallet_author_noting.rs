...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_599_000, 7595)
			// Standard Error: 144_440
			.saturating_add(Weight::from_parts(22_487_504, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(117_866_045, 8799)
			// Standard Error: 16_132
			.saturating_add(Weight::from_parts(21_564_880, 0).saturating_mul(x.into()))
