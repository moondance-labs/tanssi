...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_632_000, 7595)
			// Standard Error: 401_629
			.saturating_add(Weight::from_parts(18_179_052, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 82_334_000 picoseconds.
		Weight::from_parts(129_798_957, 8799)
			// Standard Error: 225_185
			.saturating_add(Weight::from_parts(12_795_077, 0).saturating_mul(x.into()))
