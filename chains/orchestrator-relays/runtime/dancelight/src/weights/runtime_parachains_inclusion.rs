...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 243_977_000 picoseconds.
		Weight::from_parts(23_026_722, 26163213698918536)
			// Standard Error: 342_300
			.saturating_add(Weight::from_parts(88_367_859, 0).saturating_mul(u.into()))
			// Standard Error: 342_300
			.saturating_add(Weight::from_parts(100_078_637, 0).saturating_mul(h.into()))
			// Standard Error: 567_232
			.saturating_add(Weight::from_parts(49_891_823, 0).saturating_mul(c.into()))
