...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±370) + h * (7630 ±347) + u * (20830 ±346)`
		// Minimum execution time: 255_427_000 picoseconds.
		Weight::from_parts(46_198_323, 26163213698918536)
			// Standard Error: 177_402
			.saturating_add(Weight::from_parts(89_438_496, 0).saturating_mul(u.into()))
			// Standard Error: 177_402
			.saturating_add(Weight::from_parts(102_419_440, 0).saturating_mul(h.into()))
			// Standard Error: 293_977
			.saturating_add(Weight::from_parts(40_175_550, 0).saturating_mul(c.into()))
