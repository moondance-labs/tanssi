...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 254_558_000 picoseconds.
		Weight::from_parts(11_273_362, 26163213698918536)
			// Standard Error: 419_125
			.saturating_add(Weight::from_parts(95_181_333, 0).saturating_mul(u.into()))
			// Standard Error: 419_125
			.saturating_add(Weight::from_parts(108_013_742, 0).saturating_mul(h.into()))
			// Standard Error: 694_541
			.saturating_add(Weight::from_parts(56_689_347, 0).saturating_mul(c.into()))
