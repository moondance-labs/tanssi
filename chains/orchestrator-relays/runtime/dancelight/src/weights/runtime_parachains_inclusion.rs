...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±271) + h * (7630 ±363) + u * (20830 ±147)`
		// Minimum execution time: 247_153_000 picoseconds.
		Weight::from_parts(23_792_575, 26163213698918536)
			// Standard Error: 316_692
			.saturating_add(Weight::from_parts(89_864_687, 0).saturating_mul(u.into()))
			// Standard Error: 316_692
			.saturating_add(Weight::from_parts(101_721_464, 0).saturating_mul(h.into()))
			// Standard Error: 524_797
			.saturating_add(Weight::from_parts(48_032_799, 0).saturating_mul(c.into()))
