...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36310 + c * (16000 ±0) + h * (7594 ±341) + u * (20798 ±341)`
		// Minimum execution time: 245_961_000 picoseconds.
		Weight::from_parts(22_518_622, 36310)
			// Standard Error: 383_493
			.saturating_add(Weight::from_parts(90_779_362, 0).saturating_mul(u.into()))
			// Standard Error: 383_493
			.saturating_add(Weight::from_parts(101_857_483, 0).saturating_mul(h.into()))
			// Standard Error: 635_495
			.saturating_add(Weight::from_parts(49_605_643, 0).saturating_mul(c.into()))
