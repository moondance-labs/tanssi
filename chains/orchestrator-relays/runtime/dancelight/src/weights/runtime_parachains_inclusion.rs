...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36310 + c * (16000 ±370) + h * (7594 ±0) + u * (20798 ±214)`
		// Minimum execution time: 247_834_000 picoseconds.
		Weight::from_parts(23_330_110, 36310)
			// Standard Error: 385_273
			.saturating_add(Weight::from_parts(91_164_421, 0).saturating_mul(u.into()))
			// Standard Error: 385_273
			.saturating_add(Weight::from_parts(101_884_682, 0).saturating_mul(h.into()))
			// Standard Error: 638_444
			.saturating_add(Weight::from_parts(49_146_724, 0).saturating_mul(c.into()))
