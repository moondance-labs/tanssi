...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(26_698_333, 36310)
			// Standard Error: 352_014
			.saturating_add(Weight::from_parts(92_757_479, 0).saturating_mul(u.into()))
			// Standard Error: 352_014
			.saturating_add(Weight::from_parts(104_520_513, 0).saturating_mul(h.into()))
			// Standard Error: 583_329
			.saturating_add(Weight::from_parts(49_006_137, 0).saturating_mul(c.into()))
