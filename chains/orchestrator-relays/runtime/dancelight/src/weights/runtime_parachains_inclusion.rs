...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 449_821_000 picoseconds.
		Weight::from_parts(66_649_783, 26163213698918536)
			// Standard Error: 670_118
			.saturating_add(Weight::from_parts(153_980_084, 0).saturating_mul(u.into()))
			// Standard Error: 670_118
			.saturating_add(Weight::from_parts(168_063_516, 0).saturating_mul(h.into()))
			// Standard Error: 1_110_466
			.saturating_add(Weight::from_parts(87_896_824, 0).saturating_mul(c.into()))
