...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±271) + h * (7630 ±424) + u * (20830 ±147)`
		// Minimum execution time: 262_493_000 picoseconds.
		Weight::from_parts(17_859_905, 26163213698918536)
			// Standard Error: 433_790
			.saturating_add(Weight::from_parts(97_729_871, 0).saturating_mul(u.into()))
			// Standard Error: 433_790
			.saturating_add(Weight::from_parts(111_054_269, 0).saturating_mul(h.into()))
			// Standard Error: 718_842
			.saturating_add(Weight::from_parts(55_878_415, 0).saturating_mul(c.into()))
