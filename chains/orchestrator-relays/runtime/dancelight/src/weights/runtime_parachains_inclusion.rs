...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 435_089_000 picoseconds.
		Weight::from_parts(52_445_422, 26163213698918536)
			// Standard Error: 588_183
			.saturating_add(Weight::from_parts(153_577_670, 0).saturating_mul(u.into()))
			// Standard Error: 588_183
			.saturating_add(Weight::from_parts(167_587_778, 0).saturating_mul(h.into()))
			// Standard Error: 974_690
			.saturating_add(Weight::from_parts(89_066_040, 0).saturating_mul(c.into()))
