...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 262_202_000 picoseconds.
		Weight::from_parts(22_621_836, 26163213698918536)
			// Standard Error: 410_410
			.saturating_add(Weight::from_parts(95_429_153, 0).saturating_mul(u.into()))
			// Standard Error: 410_410
			.saturating_add(Weight::from_parts(108_284_215, 0).saturating_mul(h.into()))
			// Standard Error: 680_099
			.saturating_add(Weight::from_parts(54_151_729, 0).saturating_mul(c.into()))
