...
// raw.json
// --output
// tmp/dancelight_weights/runtime_parachains_inclusion.rs
...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±271) + h * (7630 ±363) + u * (20830 ±362)`
		// Minimum execution time: 265_427_000 picoseconds.
		Weight::from_parts(43_873_578, 26163213698918536)
			// Standard Error: 160_727
			.saturating_add(Weight::from_parts(95_615_951, 0).saturating_mul(u.into()))
			// Standard Error: 160_727
			.saturating_add(Weight::from_parts(108_210_874, 0).saturating_mul(h.into()))
			// Standard Error: 266_344
			.saturating_add(Weight::from_parts(41_303_658, 0).saturating_mul(c.into()))
