...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±0) + h * (7630 ±347) + u * (20830 ±346)`
		// Minimum execution time: 248_635_000 picoseconds.
		Weight::from_parts(20_679_425, 26163213698918536)
			// Standard Error: 373_746
			.saturating_add(Weight::from_parts(91_199_863, 0).saturating_mul(u.into()))
			// Standard Error: 373_746
			.saturating_add(Weight::from_parts(102_717_018, 0).saturating_mul(h.into()))
			// Standard Error: 619_342
			.saturating_add(Weight::from_parts(51_539_791, 0).saturating_mul(c.into()))
