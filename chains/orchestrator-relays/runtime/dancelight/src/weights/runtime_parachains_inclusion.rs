...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(80_912_462, 36310)
			...
			// Standard Error: 375_291
			.saturating_add(Weight::from_parts(164_432_168, 0).saturating_mul(h.into()))
			// Standard Error: 621_903
			.saturating_add(Weight::from_parts(73_886_005, 0).saturating_mul(c.into()))
