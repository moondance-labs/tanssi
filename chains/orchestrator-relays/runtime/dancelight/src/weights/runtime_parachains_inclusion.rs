...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(23_110_916, 36310)
			// Standard Error: 362_128
			.saturating_add(Weight::from_parts(95_315_155, 0).saturating_mul(u.into()))
			// Standard Error: 362_128
			.saturating_add(Weight::from_parts(106_746_800, 0).saturating_mul(h.into()))
			// Standard Error: 600_090
			.saturating_add(Weight::from_parts(51_134_735, 0).saturating_mul(c.into()))
