...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(59_547_516, 26163213698918536)
			...
			// Standard Error: 662_689
			.saturating_add(Weight::from_parts(165_795_162, 0).saturating_mul(h.into()))
			// Standard Error: 1_098_155
			.saturating_add(Weight::from_parts(87_672_493, 0).saturating_mul(c.into()))
