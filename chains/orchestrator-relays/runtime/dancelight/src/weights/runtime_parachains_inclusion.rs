...
// --output=tmp/dancelight_weights/runtime_parachains_inclusion.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1288 + c * (15992 ±0) + h * (92 ±0) + u * (32955 ±0)`
		//  Estimated: `36310 + c * (16000 ±0) + h * (7594 ±0) + u * (20798 ±0)`
		// Minimum execution time: 248_064_000 picoseconds.
		Weight::from_parts(26_971_101, 36310)
			// Standard Error: 371_144
			.saturating_add(Weight::from_parts(89_457_887, 0).saturating_mul(u.into()))
			// Standard Error: 371_144
			.saturating_add(Weight::from_parts(100_774_864, 0).saturating_mul(h.into()))
			// Standard Error: 615_030
			.saturating_add(Weight::from_parts(47_684_285, 0).saturating_mul(c.into()))
