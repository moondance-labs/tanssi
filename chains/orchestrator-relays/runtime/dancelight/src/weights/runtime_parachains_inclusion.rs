...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36310 + c * (16000 ±370) + h * (7594 ±341) + u * (20798 ±214)`
		// Minimum execution time: 260_799_000 picoseconds.
		Weight::from_parts(24_305_793, 36310)
			// Standard Error: 341_635
			.saturating_add(Weight::from_parts(96_322_695, 0).saturating_mul(u.into()))
			// Standard Error: 341_635
			.saturating_add(Weight::from_parts(107_922_465, 0).saturating_mul(h.into()))
			// Standard Error: 566_130
			.saturating_add(Weight::from_parts(50_594_570, 0).saturating_mul(c.into()))
