...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±0) + h * (7630 ±0) + u * (20830 ±0)`
		// Minimum execution time: 278_592_000 picoseconds.
		Weight::from_parts(26_539_205, 26163213698918536)
			// Standard Error: 376_909
			.saturating_add(Weight::from_parts(102_804_242, 0).saturating_mul(u.into()))
			// Standard Error: 376_909
			.saturating_add(Weight::from_parts(114_685_471, 0).saturating_mul(h.into()))
			// Standard Error: 624_583
			.saturating_add(Weight::from_parts(52_957_997, 0).saturating_mul(c.into()))
