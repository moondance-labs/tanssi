...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 261_200_000 picoseconds.
		Weight::from_parts(19_609_551, 26163213698918536)
			// Standard Error: 336_573
			.saturating_add(Weight::from_parts(97_210_825, 0).saturating_mul(u.into()))
			// Standard Error: 336_573
			.saturating_add(Weight::from_parts(108_381_513, 0).saturating_mul(h.into()))
			// Standard Error: 557_742
			.saturating_add(Weight::from_parts(51_072_727, 0).saturating_mul(c.into()))
