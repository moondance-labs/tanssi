...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(14_985_490, 26163213698918536)
			// Standard Error: 387_466
			.saturating_add(Weight::from_parts(96_655_950, 0).saturating_mul(u.into()))
			// Standard Error: 387_466
			.saturating_add(Weight::from_parts(108_271_107, 0).saturating_mul(h.into()))
			// Standard Error: 642_078
			.saturating_add(Weight::from_parts(56_814_378, 0).saturating_mul(c.into()))
