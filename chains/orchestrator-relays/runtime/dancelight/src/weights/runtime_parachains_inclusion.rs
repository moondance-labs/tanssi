...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 253_145_000 picoseconds.
		Weight::from_parts(24_207_629, 36310)
			// Standard Error: 356_708
			.saturating_add(Weight::from_parts(92_899_908, 0).saturating_mul(u.into()))
			// Standard Error: 356_708
			.saturating_add(Weight::from_parts(104_928_531, 0).saturating_mul(h.into()))
			// Standard Error: 591_107
			.saturating_add(Weight::from_parts(49_476_468, 0).saturating_mul(c.into()))
