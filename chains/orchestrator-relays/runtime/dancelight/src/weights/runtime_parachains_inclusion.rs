...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(23_937_738, 26163213698918536)
			// Standard Error: 332_143
			.saturating_add(Weight::from_parts(92_667_598, 0).saturating_mul(u.into()))
			// Standard Error: 332_143
			.saturating_add(Weight::from_parts(104_643_601, 0).saturating_mul(h.into()))
			// Standard Error: 550_402
			.saturating_add(Weight::from_parts(52_225_231, 0).saturating_mul(c.into()))
