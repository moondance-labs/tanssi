...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36310 + c * (16000 ±288) + h * (7594 ±341) + u * (20798 ±341)`
		// Minimum execution time: 255_400_000 picoseconds.
		Weight::from_parts(23_223_489, 36310)
			// Standard Error: 381_119
			.saturating_add(Weight::from_parts(93_533_769, 0).saturating_mul(u.into()))
			// Standard Error: 381_119
			.saturating_add(Weight::from_parts(104_622_862, 0).saturating_mul(h.into()))
			// Standard Error: 631_560
			.saturating_add(Weight::from_parts(49_394_357, 0).saturating_mul(c.into()))
