...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 252_165_000 picoseconds.
		Weight::from_parts(22_276_902, 26163213698918536)
			// Standard Error: 355_857
			.saturating_add(Weight::from_parts(96_166_346, 0).saturating_mul(u.into()))
			// Standard Error: 355_857
			.saturating_add(Weight::from_parts(106_904_736, 0).saturating_mul(h.into()))
			// Standard Error: 589_697
			.saturating_add(Weight::from_parts(48_467_806, 0).saturating_mul(c.into()))
