...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 262_402_000 picoseconds.
		Weight::from_parts(20_314_493, 36310)
			// Standard Error: 389_872
			.saturating_add(Weight::from_parts(96_824_105, 0).saturating_mul(u.into()))
			// Standard Error: 389_872
			.saturating_add(Weight::from_parts(108_855_730, 0).saturating_mul(h.into()))
			// Standard Error: 646_065
			.saturating_add(Weight::from_parts(52_688_972, 0).saturating_mul(c.into()))
