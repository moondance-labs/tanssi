...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 264_556_000 picoseconds.
		Weight::from_parts(19_345_221, 26163213698918536)
			// Standard Error: 381_052
			.saturating_add(Weight::from_parts(99_633_162, 0).saturating_mul(u.into()))
			// Standard Error: 381_052
			.saturating_add(Weight::from_parts(111_415_840, 0).saturating_mul(h.into()))
			// Standard Error: 631_448
			.saturating_add(Weight::from_parts(52_261_906, 0).saturating_mul(c.into()))
