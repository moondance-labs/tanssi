...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 253_174_000 picoseconds.
		Weight::from_parts(36_538_945, 26163213698918536)
			// Standard Error: 173_700
			.saturating_add(Weight::from_parts(91_009_134, 0).saturating_mul(u.into()))
			// Standard Error: 173_700
			.saturating_add(Weight::from_parts(103_744_528, 0).saturating_mul(h.into()))
			// Standard Error: 287_842
			.saturating_add(Weight::from_parts(41_476_065, 0).saturating_mul(c.into()))
