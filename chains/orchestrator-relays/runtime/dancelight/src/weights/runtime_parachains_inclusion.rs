...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36310 + c * (16000 ±271) + h * (7594 ±341) + u * (20798 ±147)`
		// Minimum execution time: 269_265_000 picoseconds.
		Weight::from_parts(24_213_055, 36310)
			// Standard Error: 348_871
			.saturating_add(Weight::from_parts(99_617_278, 0).saturating_mul(u.into()))
			// Standard Error: 348_871
			.saturating_add(Weight::from_parts(110_817_087, 0).saturating_mul(h.into()))
			// Standard Error: 578_121
			.saturating_add(Weight::from_parts(50_225_210, 0).saturating_mul(c.into()))
