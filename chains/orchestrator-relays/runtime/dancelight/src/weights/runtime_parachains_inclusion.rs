...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±271) + h * (7630 ±347) + u * (20830 ±147)`
		// Minimum execution time: 259_384_000 picoseconds.
		Weight::from_parts(40_567_788, 26163213698918536)
			// Standard Error: 324_401
			.saturating_add(Weight::from_parts(91_529_957, 0).saturating_mul(u.into()))
			// Standard Error: 324_401
			.saturating_add(Weight::from_parts(112_639_860, 0).saturating_mul(h.into()))
			// Standard Error: 537_572
			.saturating_add(Weight::from_parts(40_305_466, 0).saturating_mul(c.into()))
