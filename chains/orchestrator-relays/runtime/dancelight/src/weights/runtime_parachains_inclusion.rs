...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36310 + c * (16000 ±271) + h * (7594 ±0) + u * (20798 ±147)`
		// Minimum execution time: 247_393_000 picoseconds.
		Weight::from_parts(21_931_259, 36310)
			// Standard Error: 398_389
			.saturating_add(Weight::from_parts(91_448_678, 0).saturating_mul(u.into()))
			// Standard Error: 398_389
			.saturating_add(Weight::from_parts(102_076_151, 0).saturating_mul(h.into()))
			// Standard Error: 660_179
			.saturating_add(Weight::from_parts(49_658_257, 0).saturating_mul(c.into()))
