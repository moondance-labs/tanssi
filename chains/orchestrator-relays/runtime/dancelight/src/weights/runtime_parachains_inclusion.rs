...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 263_394_000 picoseconds.
		Weight::from_parts(26_153_917, 26163213698918536)
			// Standard Error: 325_762
			.saturating_add(Weight::from_parts(96_404_967, 0).saturating_mul(u.into()))
			// Standard Error: 325_762
			.saturating_add(Weight::from_parts(107_991_687, 0).saturating_mul(h.into()))
			// Standard Error: 539_827
			.saturating_add(Weight::from_parts(48_445_827, 0).saturating_mul(c.into()))
