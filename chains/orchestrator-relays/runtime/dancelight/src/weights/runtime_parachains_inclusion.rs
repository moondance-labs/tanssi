...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(23_053_029, 26163213698918536)
			// Standard Error: 392_183
			.saturating_add(Weight::from_parts(98_179_220, 0).saturating_mul(u.into()))
			// Standard Error: 392_183
			.saturating_add(Weight::from_parts(109_369_238, 0).saturating_mul(h.into()))
			// Standard Error: 649_894
			.saturating_add(Weight::from_parts(49_066_319, 0).saturating_mul(c.into()))
