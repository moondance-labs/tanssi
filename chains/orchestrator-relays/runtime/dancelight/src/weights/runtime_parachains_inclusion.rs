...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(37_479_064, 26163213698918536)
			// Standard Error: 160_161
			.saturating_add(Weight::from_parts(89_494_357, 0).saturating_mul(u.into()))
			// Standard Error: 160_161
			.saturating_add(Weight::from_parts(102_387_085, 0).saturating_mul(h.into()))
			// Standard Error: 265_406
			.saturating_add(Weight::from_parts(42_404_159, 0).saturating_mul(c.into()))
