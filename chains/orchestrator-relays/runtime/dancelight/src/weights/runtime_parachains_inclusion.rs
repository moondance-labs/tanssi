...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±0) + h * (7630 ±424) + u * (20830 ±423)`
		// Minimum execution time: 250_941_000 picoseconds.
		Weight::from_parts(17_328_578, 26163213698918536)
			// Standard Error: 406_332
			.saturating_add(Weight::from_parts(95_642_074, 0).saturating_mul(u.into()))
			// Standard Error: 406_332
			.saturating_add(Weight::from_parts(106_843_761, 0).saturating_mul(h.into()))
			// Standard Error: 673_340
			.saturating_add(Weight::from_parts(50_261_262, 0).saturating_mul(c.into()))
