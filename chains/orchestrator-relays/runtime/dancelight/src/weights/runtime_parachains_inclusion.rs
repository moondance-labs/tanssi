...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 270_518_000 picoseconds.
		Weight::from_parts(24_081_476, 26163213698918536)
			// Standard Error: 379_803
			.saturating_add(Weight::from_parts(99_859_225, 0).saturating_mul(u.into()))
			// Standard Error: 379_803
			.saturating_add(Weight::from_parts(112_245_948, 0).saturating_mul(h.into()))
			// Standard Error: 629_379
			.saturating_add(Weight::from_parts(51_455_500, 0).saturating_mul(c.into()))
