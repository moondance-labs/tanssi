...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		Weight::from_parts(31_948_481, 26163213698918536)
			// Standard Error: 285_850
			.saturating_add(Weight::from_parts(94_527_970, 0).saturating_mul(u.into()))
			// Standard Error: 285_850
			.saturating_add(Weight::from_parts(107_504_494, 0).saturating_mul(h.into()))
			// Standard Error: 473_688
			.saturating_add(Weight::from_parts(51_216_774, 0).saturating_mul(c.into()))
