...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 256_830_000 picoseconds.
		Weight::from_parts(18_364_407, 26163213698918536)
			// Standard Error: 346_374
			.saturating_add(Weight::from_parts(94_186_883, 0).saturating_mul(u.into()))
			// Standard Error: 346_374
			.saturating_add(Weight::from_parts(105_989_589, 0).saturating_mul(h.into()))
			// Standard Error: 573_983
			.saturating_add(Weight::from_parts(53_034_905, 0).saturating_mul(c.into()))
