...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36310 + c * (16000 ±370) + h * (7594 ±341) + u * (20798 ±341)`
		// Minimum execution time: 440_066_000 picoseconds.
		Weight::from_parts(60_424_967, 36310)
			// Standard Error: 641_795
			.saturating_add(Weight::from_parts(153_241_873, 0).saturating_mul(u.into()))
			// Standard Error: 641_795
			.saturating_add(Weight::from_parts(170_181_022, 0).saturating_mul(h.into()))
			// Standard Error: 1_063_532
			.saturating_add(Weight::from_parts(85_249_799, 0).saturating_mul(c.into()))
