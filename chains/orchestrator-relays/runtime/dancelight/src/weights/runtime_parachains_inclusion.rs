...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±370) + h * (7630 ±363) + u * (20830 ±214)`
		// Minimum execution time: 268_955_000 picoseconds.
		Weight::from_parts(26_632_170, 26163213698918536)
			// Standard Error: 368_405
			.saturating_add(Weight::from_parts(99_804_560, 0).saturating_mul(u.into()))
			// Standard Error: 368_405
			.saturating_add(Weight::from_parts(111_112_019, 0).saturating_mul(h.into()))
			// Standard Error: 610_492
			.saturating_add(Weight::from_parts(50_583_138, 0).saturating_mul(c.into()))
