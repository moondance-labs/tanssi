...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 260_829_000 picoseconds.
		Weight::from_parts(21_881_939, 36310)
			// Standard Error: 376_609
			.saturating_add(Weight::from_parts(96_240_607, 0).saturating_mul(u.into()))
			// Standard Error: 376_609
			.saturating_add(Weight::from_parts(108_014_536, 0).saturating_mul(h.into()))
			// Standard Error: 624_087
			.saturating_add(Weight::from_parts(53_342_426, 0).saturating_mul(c.into()))
