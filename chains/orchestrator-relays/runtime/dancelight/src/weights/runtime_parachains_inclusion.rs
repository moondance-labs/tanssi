...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±271) + h * (7630 ±424) + u * (20830 ±423)`
		// Minimum execution time: 263_003_000 picoseconds.
		Weight::from_parts(22_979_407, 26163213698918536)
			// Standard Error: 366_072
			.saturating_add(Weight::from_parts(98_203_901, 0).saturating_mul(u.into()))
			// Standard Error: 366_072
			.saturating_add(Weight::from_parts(108_717_025, 0).saturating_mul(h.into()))
			// Standard Error: 606_625
			.saturating_add(Weight::from_parts(49_885_582, 0).saturating_mul(c.into()))
