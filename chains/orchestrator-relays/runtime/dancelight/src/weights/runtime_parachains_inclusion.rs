...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `26163213698918536 + c * (16000 ±0) + h * (7630 ±363) + u * (20830 ±362)`
		// Minimum execution time: 248_055_000 picoseconds.
		Weight::from_parts(12_077_069, 26163213698918536)
			// Standard Error: 456_458
			.saturating_add(Weight::from_parts(94_000_896, 0).saturating_mul(u.into()))
			// Standard Error: 456_458
			.saturating_add(Weight::from_parts(105_730_189, 0).saturating_mul(h.into()))
			// Standard Error: 756_406
			.saturating_add(Weight::from_parts(52_352_254, 0).saturating_mul(c.into()))
