...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 256_702_000 picoseconds.
		Weight::from_parts(41_647_722, 26163213698918536)
			// Standard Error: 157_950
			.saturating_add(Weight::from_parts(92_955_935, 0).saturating_mul(u.into()))
			// Standard Error: 157_950
			.saturating_add(Weight::from_parts(106_542_938, 0).saturating_mul(h.into()))
			// Standard Error: 261_742
			.saturating_add(Weight::from_parts(38_207_852, 0).saturating_mul(c.into()))
