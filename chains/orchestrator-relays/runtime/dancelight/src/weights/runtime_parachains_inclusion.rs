...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 434_591_000 picoseconds.
		Weight::from_parts(53_342_604, 26163213698918536)
			// Standard Error: 638_081
			.saturating_add(Weight::from_parts(153_462_625, 0).saturating_mul(u.into()))
			// Standard Error: 638_081
			.saturating_add(Weight::from_parts(166_429_045, 0).saturating_mul(h.into()))
			// Standard Error: 1_057_376
			.saturating_add(Weight::from_parts(88_525_451, 0).saturating_mul(c.into()))
