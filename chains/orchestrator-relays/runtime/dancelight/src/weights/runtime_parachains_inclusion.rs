...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for SubstrateWeight<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 245_229_000 picoseconds.
		Weight::from_parts(18_035_861, 36310)
			// Standard Error: 316_537
			.saturating_add(Weight::from_parts(91_266_510, 0).saturating_mul(u.into()))
			// Standard Error: 316_537
			.saturating_add(Weight::from_parts(101_319_632, 0).saturating_mul(h.into()))
			// Standard Error: 524_541
			.saturating_add(Weight::from_parts(50_141_194, 0).saturating_mul(c.into()))
