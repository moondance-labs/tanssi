...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(101_761_000, 4009)
			// Standard Error: 4
			.saturating_add(Weight::from_parts(669, 0).saturating_mul(x.into()))
			// Standard Error: 1_457_816
			.saturating_add(Weight::from_parts(5_014_470, 0).saturating_mul(z.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		//  Measured:  `3028`
		//  Estimated: `6196`
		// Minimum execution time: 116_148_000 picoseconds.
		Weight::from_parts(117_821_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(66_725_000, 5251)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		Weight::from_parts(163_306_000, 10268)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(48_781_000, 2755)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(48_150_000, 2755)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, _z: u32, ) -> Weight {
		...
		//  Measured:  `544`
		//  Estimated: `4009`
		// Minimum execution time: 97_783_000 picoseconds.
		Weight::from_parts(99_507_000, 4009)
			// Standard Error: 4
			.saturating_add(Weight::from_parts(713, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(11_u64))
			.saturating_add(T::DbWeight::get().writes(15_u64))
	}
	/// Storage: `ContainerRegistrar::ParathreadParams` (r:1 w:0)
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(51_486_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(11_952_000, 3533)
