...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(147_275_319, 4009)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(726, 0).saturating_mul(x.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		//  Measured:  `3028`
		//  Estimated: `6196`
		// Minimum execution time: 107_121_000 picoseconds.
		Weight::from_parts(109_265_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(63_129_000, 5251)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		Weight::from_parts(147_177_000, 10268)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(44_573_000, 2755)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(44_062_000, 2755)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(109_958_342, 4009)
			// Standard Error: 11
			.saturating_add(Weight::from_parts(955, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(11_u64))
			.saturating_add(T::DbWeight::get().writes(15_u64))
	}
	/// Storage: `ContainerRegistrar::ParathreadParams` (r:1 w:0)
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(44_804_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
