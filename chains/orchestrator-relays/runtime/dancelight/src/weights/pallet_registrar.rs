...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(81_558_265, 4009)
			// Standard Error: 29
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(79_000_000, 5251)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6803`
		//  Estimated: `10268`
		// Minimum execution time: 697_000_000 picoseconds.
		Weight::from_parts(697_000_000, 10268)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(47_000_000, 2755)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(57_000_000, 2755)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(41_156_832, 4009)
			// Standard Error: 25
			.saturating_add(Weight::from_parts(769, 0).saturating_mul(x.into()))
			// Standard Error: 8_189_154
			.saturating_add(Weight::from_parts(503_299, 0).saturating_mul(z.into()))
			.saturating_add(T::DbWeight::get().reads(11_u64))
			.saturating_add(T::DbWeight::get().writes(15_u64))
	}
	/// Storage: `ContainerRegistrar::ParathreadParams` (r:1 w:0)
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(51_000_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(15_000_000, 3533)
