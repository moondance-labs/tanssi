...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		//  Measured:  `544`
		//  Estimated: `4009`
		// Minimum execution time: 92_413_000 picoseconds.
		Weight::from_parts(92_416_971, 4009)
			// Standard Error: 11
			.saturating_add(Weight::from_parts(994, 0).saturating_mul(x.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		//  Measured:  `3028`
		//  Estimated: `6196`
		// Minimum execution time: 102_161_000 picoseconds.
		Weight::from_parts(105_087_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(61_986_000, 5251)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		Weight::from_parts(141_675_000, 10268)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(43_622_000, 2755)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(42_811_000, 2755)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(100_818_027, 4009)
			// Standard Error: 10
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(42_550_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(9_718_000, 3533)
