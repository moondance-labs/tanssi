...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(14_026_548, 1527)
			// Standard Error: 3
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(28_786_158, 6811)
			// Standard Error: 554
			.saturating_add(Weight::from_parts(71_503, 0).saturating_mul(s.into()))
			// Standard Error: 5
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(16_375_595, 6811)
			// Standard Error: 459
			.saturating_add(Weight::from_parts(67_364, 0).saturating_mul(s.into()))
			// Standard Error: 4
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(32_651_400, 6811)
			// Standard Error: 1_562
			.saturating_add(Weight::from_parts(92_726, 0).saturating_mul(s.into()))
			// Standard Error: 15
	...
	fn approve_as_multi_create(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(27_113_099, 6811)
			// Standard Error: 494
			.saturating_add(Weight::from_parts(74_398, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(15_302_210, 6811)
			// Standard Error: 382
			.saturating_add(Weight::from_parts(66_564, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(27_272_952, 6811)
			// Standard Error: 426
			.saturating_add(Weight::from_parts(72_517, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}