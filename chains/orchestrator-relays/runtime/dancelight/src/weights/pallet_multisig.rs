...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(12_806_054, 1527)
			// Standard Error: 30
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(27_592_156, 6811)
			// Standard Error: 2_538
			.saturating_add(Weight::from_parts(61_211, 0).saturating_mul(s.into()))
			// Standard Error: 24
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(13_724_410, 6811)
			// Standard Error: 1_044
			.saturating_add(Weight::from_parts(62_945, 0).saturating_mul(s.into()))
			// Standard Error: 10
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(29_685_738, 6811)
			// Standard Error: 4_651
			.saturating_add(Weight::from_parts(94_518, 0).saturating_mul(s.into()))
			// Standard Error: 45
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_920_572, 6811)
			// Standard Error: 2_614
			.saturating_add(Weight::from_parts(80_144, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_151_964, 6811)
			// Standard Error: 461
			.saturating_add(Weight::from_parts(59_556, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_127_911, 6811)
			// Standard Error: 456
			.saturating_add(Weight::from_parts(66_346, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_848_036, 6811)
			// Standard Error: 430
			.saturating_add(Weight::from_parts(64_455, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}