...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(14_106_518, 1527)
			// Standard Error: 1
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(28_222_049, 6811)
			// Standard Error: 546
			.saturating_add(Weight::from_parts(74_278, 0).saturating_mul(s.into()))
			// Standard Error: 5
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(16_822_920, 6811)
			// Standard Error: 452
			.saturating_add(Weight::from_parts(65_957, 0).saturating_mul(s.into()))
			// Standard Error: 4
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(31_907_083, 6811)
			// Standard Error: 647
			.saturating_add(Weight::from_parts(93_628, 0).saturating_mul(s.into()))
			// Standard Error: 6
			.saturating_add(Weight::from_parts(1_633, 0).saturating_mul(z.into()))
	...
	fn approve_as_multi_create(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(27_792_404, 6811)
			// Standard Error: 469
			.saturating_add(Weight::from_parts(71_757, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(15_535_966, 6811)
			// Standard Error: 482
			.saturating_add(Weight::from_parts(66_945, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(27_359_233, 6811)
			// Standard Error: 449
			.saturating_add(Weight::from_parts(71_116, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}