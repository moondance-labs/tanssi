...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(15_687_421, 1527)
			// Standard Error: 39
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(25_734_353, 6811)
			// Standard Error: 4_371
			.saturating_add(Weight::from_parts(77_830, 0).saturating_mul(s.into()))
			// Standard Error: 42
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(12_822_197, 6811)
			// Standard Error: 2_571
			.saturating_add(Weight::from_parts(74_497, 0).saturating_mul(s.into()))
			// Standard Error: 25
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(25_214_358, 6811)
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_559_641, 6811)
			// Standard Error: 4_676
			.saturating_add(Weight::from_parts(114_032, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_650_466, 6811)
			// Standard Error: 1_116
			.saturating_add(Weight::from_parts(54_781, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_336_385, 6811)
			// Standard Error: 2_623
			.saturating_add(Weight::from_parts(75_884, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_234_060, 6811)
			// Standard Error: 1_743
			.saturating_add(Weight::from_parts(66_240, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}