...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(11_644_092, 4706)
			// Standard Error: 636
			.saturating_add(Weight::from_parts(21_588, 0).saturating_mul(p.into()))
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(28_445_283, 5698)
			// Standard Error: 1_311
			.saturating_add(Weight::from_parts(114_365, 0).saturating_mul(a.into()))
			// Standard Error: 1_354
			.saturating_add(Weight::from_parts(19_728, 0).saturating_mul(p.into()))
	...
	fn remove_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(18_365_260, 5698)
			// Standard Error: 1_589
			.saturating_add(Weight::from_parts(121_916, 0).saturating_mul(a.into()))
	...
	fn reject_announcement(a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(18_752_909, 5698)
			// Standard Error: 1_156
			.saturating_add(Weight::from_parts(135_727, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:0)
	...
	fn announce(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(23_965_807, 5698)
			// Standard Error: 1_614
			.saturating_add(Weight::from_parts(117_610, 0).saturating_mul(a.into()))
			// Standard Error: 1_667
			.saturating_add(Weight::from_parts(16_378, 0).saturating_mul(p.into()))
	...
	fn add_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(17_685_455, 4706)
			// Standard Error: 1_179
			.saturating_add(Weight::from_parts(27_828, 0).saturating_mul(p.into()))
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(17_693_621, 4706)
	...
	fn remove_proxies(p: u32, ) -> Weight {
		...
		Weight::from_parts(15_864_590, 4706)
			// Standard Error: 1_073
			.saturating_add(Weight::from_parts(16_873, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_715_428, 4706)
			// Standard Error: 1_431
			.saturating_add(Weight::from_parts(11_547, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(16_250_206, 4706)
			// Standard Error: 1_092
			.saturating_add(Weight::from_parts(29_905, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(33_242_000, 5698)
			.saturating_add(T::DbWeight::get().reads(3_u64))
