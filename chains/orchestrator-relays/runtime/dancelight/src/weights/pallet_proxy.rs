...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(12_025_446, 4706)
			// Standard Error: 624
			.saturating_add(Weight::from_parts(18_843, 0).saturating_mul(p.into()))
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(28_131_718, 5698)
			// Standard Error: 2_441
			.saturating_add(Weight::from_parts(153_862, 0).saturating_mul(a.into()))
	...
	fn remove_announcement(a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(19_299_252, 5698)
			// Standard Error: 1_648
			.saturating_add(Weight::from_parts(128_810, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Announcements` (r:1 w:1)
	...
	fn reject_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(18_954_712, 5698)
			// Standard Error: 1_437
			.saturating_add(Weight::from_parts(131_691, 0).saturating_mul(a.into()))
	...
	fn announce(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(24_750_612, 5698)
			// Standard Error: 1_479
			.saturating_add(Weight::from_parts(126_345, 0).saturating_mul(a.into()))
	...
	fn add_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_101_986, 4706)
			// Standard Error: 1_197
			.saturating_add(Weight::from_parts(28_497, 0).saturating_mul(p.into()))
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_007_511, 4706)
	...
	fn remove_proxies(p: u32, ) -> Weight {
		...
		Weight::from_parts(16_411_242, 4706)
			// Standard Error: 1_095
			.saturating_add(Weight::from_parts(10_360, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(19_065_212, 4706)
			// Standard Error: 1_020
			.saturating_add(Weight::from_parts(25_034, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_434_345, 4706)
			// Standard Error: 1_144
			.saturating_add(Weight::from_parts(28_916, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(33_803_000, 5698)
			.saturating_add(T::DbWeight::get().reads(3_u64))
