...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(12_646_742, 4706)
			// Standard Error: 875
			.saturating_add(Weight::from_parts(29_574, 0).saturating_mul(p.into()))
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(31_097_011, 5698)
			// Standard Error: 1_355
			.saturating_add(Weight::from_parts(153_842, 0).saturating_mul(a.into()))
			// Standard Error: 1_400
			.saturating_add(Weight::from_parts(22_440, 0).saturating_mul(p.into()))
	...
	fn remove_announcement(a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(20_465_681, 5698)
			// Standard Error: 981
			.saturating_add(Weight::from_parts(139_410, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Announcements` (r:1 w:1)
	...
	fn reject_announcement(a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(20_190_606, 5698)
			// Standard Error: 1_090
			.saturating_add(Weight::from_parts(142_574, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:0)
	...
	fn announce(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(25_996_428, 5698)
			// Standard Error: 1_108
			.saturating_add(Weight::from_parts(145_337, 0).saturating_mul(a.into()))
			// Standard Error: 1_145
			.saturating_add(Weight::from_parts(22_891, 0).saturating_mul(p.into()))
	...
	fn add_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_918_457, 4706)
			// Standard Error: 970
			.saturating_add(Weight::from_parts(35_572, 0).saturating_mul(p.into()))
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_843_890, 4706)
			// Standard Error: 846
	...
	fn remove_proxies(p: u32, ) -> Weight {
		...
		Weight::from_parts(17_114_013, 4706)
			// Standard Error: 717
			.saturating_add(Weight::from_parts(31_094, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(20_004_393, 4706)
			// Standard Error: 759
			.saturating_add(Weight::from_parts(15_700, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_010_225, 4706)
			// Standard Error: 877
			.saturating_add(Weight::from_parts(19_998, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}