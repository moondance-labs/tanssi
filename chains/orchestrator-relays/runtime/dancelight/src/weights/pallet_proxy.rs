...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(12_713_005, 4706)
			// Standard Error: 812
			.saturating_add(Weight::from_parts(25_136, 0).saturating_mul(p.into()))
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(30_821_903, 5698)
			// Standard Error: 2_409
			.saturating_add(Weight::from_parts(154_105, 0).saturating_mul(a.into()))
			// Standard Error: 2_489
			.saturating_add(Weight::from_parts(25_005, 0).saturating_mul(p.into()))
	...
	fn remove_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(15_698_365, 5698)
			// Standard Error: 16_531
			.saturating_add(Weight::from_parts(297_209, 0).saturating_mul(a.into()))
			// Standard Error: 17_080
			.saturating_add(Weight::from_parts(98_980, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Announcements` (r:1 w:1)
	...
	fn reject_announcement(_a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(30_877_365, 5698)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:0)
	...
	fn announce(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(25_903_082, 5698)
			// Standard Error: 1_184
			.saturating_add(Weight::from_parts(145_927, 0).saturating_mul(a.into()))
			// Standard Error: 1_223
			.saturating_add(Weight::from_parts(24_614, 0).saturating_mul(p.into()))
	...
	fn add_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(19_157_079, 4706)
			// Standard Error: 772
			.saturating_add(Weight::from_parts(42_536, 0).saturating_mul(p.into()))
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(19_173_799, 4706)
			// Standard Error: 761
			.saturating_add(Weight::from_parts(37_620, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn remove_proxies(p: u32, ) -> Weight {
		...
		Weight::from_parts(17_431_702, 4706)
			// Standard Error: 729
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(20_834_809, 4706)
			// Standard Error: 922
			.saturating_add(Weight::from_parts(17_529, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(17_986_466, 4706)
			// Standard Error: 785
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(36_428_000, 5698)
			.saturating_add(T::DbWeight::get().reads(3_u64))
