...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_963_986_302, 53942)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `427`
		//  Estimated: `3892`
		// Minimum execution time: 4_049_934_000 picoseconds.
		Weight::from_parts(4_097_433_000, 3892)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(26_017_013, 4159)
			// Standard Error: 3_692
			.saturating_add(Weight::from_parts(1_919_454, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
