...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(s: u32, ) -> Weight {
		...
		Weight::from_parts(1_191_199_501, 53942)
			// Standard Error: 108_205
			.saturating_add(Weight::from_parts(89_062, 0).saturating_mul(s.into()))
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(16_000_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 4_194_289_000 picoseconds.
		Weight::from_parts(4_212_344_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_716_757, 3601)
			// Standard Error: 4_245
			.saturating_add(Weight::from_parts(1_854_831, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
