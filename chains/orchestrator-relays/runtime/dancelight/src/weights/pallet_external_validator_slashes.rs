...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_128_011_520, 53975)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `427`
		//  Estimated: `3892`
		// Minimum execution time: 4_100_790_000 picoseconds.
		Weight::from_parts(4_135_474_000, 3892)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(25_842_551, 4192)
			// Standard Error: 3_472
			.saturating_add(Weight::from_parts(1_865_283, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
