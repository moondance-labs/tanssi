...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(753_120_246, 53942)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(15_649_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 3_635_812_000 picoseconds.
		Weight::from_parts(3_749_785_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_507_390, 3601)
			// Standard Error: 3_837
			.saturating_add(Weight::from_parts(1_790_324, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
