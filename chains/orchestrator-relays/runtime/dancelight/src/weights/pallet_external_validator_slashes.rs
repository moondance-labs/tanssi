...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		//  Measured:  `50477`
		//  Estimated: `53942`
		// Minimum execution time: 91_286_000 picoseconds.
		Weight::from_parts(1_238_974_507, 53942)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(27_695_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 6_014_981_000 picoseconds.
		Weight::from_parts(6_046_599_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		// Minimum execution time: 61_308_000 picoseconds.
		Weight::from_parts(43_085_321, 3601)
			// Standard Error: 6_860
			.saturating_add(Weight::from_parts(2_245_857, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
