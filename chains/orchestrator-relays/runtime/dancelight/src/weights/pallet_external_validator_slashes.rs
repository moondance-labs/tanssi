...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		//  Measured:  `50477`
		//  Estimated: `53942`
		// Minimum execution time: 49_282_000 picoseconds.
		Weight::from_parts(755_874_123, 53942)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(15_469_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `427`
		//  Estimated: `3892`
		// Minimum execution time: 3_655_779_000 picoseconds.
		Weight::from_parts(3_706_324_000, 3892)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_419_307, 4159)
			// Standard Error: 4_342
			.saturating_add(Weight::from_parts(1_769_023, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
