...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(s: u32, ) -> Weight {
		...
		Weight::from_parts(1_212_453_612, 53942)
			// Standard Error: 159_305
			.saturating_add(Weight::from_parts(312_539, 0).saturating_mul(s.into()))
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(16_431_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `427`
		//  Estimated: `3892`
		// Minimum execution time: 3_878_922_000 picoseconds.
		Weight::from_parts(3_905_091_000, 3892)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `565 + s * (50 ±0)`
		//  Estimated: `4159 + s * (49 ±0)`
		// Minimum execution time: 34_014_000 picoseconds.
		Weight::from_parts(34_495_000, 4159)
			// Standard Error: 29_409
			.saturating_add(Weight::from_parts(2_510_470, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
