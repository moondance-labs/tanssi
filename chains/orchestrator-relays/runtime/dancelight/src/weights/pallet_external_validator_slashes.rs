...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		//  Measured:  `50477`
		//  Estimated: `53942`
		// Minimum execution time: 73_944_000 picoseconds.
		Weight::from_parts(1_606_823_427, 53942)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(27_142_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 5_816_920_000 picoseconds.
		Weight::from_parts(5_838_969_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(45_616_009, 3601)
			// Standard Error: 5_650
			.saturating_add(Weight::from_parts(2_299_464, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
