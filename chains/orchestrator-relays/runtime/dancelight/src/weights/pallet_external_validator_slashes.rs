...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_108_903_386, 53975)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(16_050_000, 3939)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `427`
		//  Estimated: `3892`
		// Minimum execution time: 3_799_992_000 picoseconds.
		Weight::from_parts(3_818_316_000, 3892)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_626_242, 4192)
			// Standard Error: 3_502
			.saturating_add(Weight::from_parts(1_871_752, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
