...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_156_919_956, 53942)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(16_842_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `427`
		//  Estimated: `3892`
		// Minimum execution time: 3_939_016_000 picoseconds.
		Weight::from_parts(3_960_056_000, 3892)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(29_187_535, 4159)
			// Standard Error: 58_333
			.saturating_add(Weight::from_parts(2_359_312, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
