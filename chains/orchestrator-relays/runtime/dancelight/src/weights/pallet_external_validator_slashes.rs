...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(s: u32, ) -> Weight {
		...
		Weight::from_parts(1_167_452_112, 53942)
			// Standard Error: 121_912
			.saturating_add(Weight::from_parts(370_962, 0).saturating_mul(s.into()))
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(17_052_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 4_363_829_000 picoseconds.
		Weight::from_parts(7_340_358_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(57_213_177, 3601)
			// Standard Error: 41_050
			.saturating_add(Weight::from_parts(1_872_419, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
