...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_622_284_223, 53909)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(26_417_000, 3873)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 1_580_200_000 picoseconds.
		Weight::from_parts(1_605_010_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		// Minimum execution time: 64_116_000 picoseconds.
		Weight::from_parts(42_997_498, 3601)
			// Standard Error: 7_791
			.saturating_add(Weight::from_parts(2_216_204, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
