...
// raw.json
// --output
// tmp/dancelight_weights/pallet_external_validator_slashes.rs
...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(830_014_905, 53975)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(17_663_000, 3939)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 4_296_250_000 picoseconds.
		Weight::from_parts(4_329_722_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_410_837, 3601)
			// Standard Error: 4_004
			.saturating_add(Weight::from_parts(2_082_165, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
