...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		Weight::from_parts(1_589_933_542, 53942)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(16_531_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `427`
		//  Estimated: `3892`
		// Minimum execution time: 4_008_948_000 picoseconds.
		Weight::from_parts(4_042_280_000, 3892)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_310_244, 4159)
			// Standard Error: 13_166
			.saturating_add(Weight::from_parts(1_953_482, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
