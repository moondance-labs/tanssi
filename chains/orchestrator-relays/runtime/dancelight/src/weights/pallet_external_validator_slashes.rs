...
impl<T: frame_system::Config> pallet_external_validator_slashes::WeightInfo for SubstrateWeight<T> {
	...
	fn cancel_deferred_slash(_s: u32, ) -> Weight {
		...
		//  Measured:  `50477`
		//  Estimated: `53942`
		// Minimum execution time: 75_097_000 picoseconds.
		Weight::from_parts(1_229_795_778, 53942)
	...
	fn force_inject_slash() -> Weight {
		...
		Weight::from_parts(27_243_000, 3906)
	...
	fn root_test_send_msg_to_eth() -> Weight {
		...
		//  Measured:  `355`
		//  Estimated: `3601`
		// Minimum execution time: 5_771_183_000 picoseconds.
		Weight::from_parts(5_790_149_000, 3601)
	...
	fn process_slashes_queue(s: u32, ) -> Weight {
		...
		// Minimum execution time: 60_087_000 picoseconds.
		Weight::from_parts(42_487_514, 3601)
			// Standard Error: 6_810
			.saturating_add(Weight::from_parts(2_262_806, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
