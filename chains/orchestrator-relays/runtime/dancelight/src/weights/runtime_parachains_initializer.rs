...
// --output=tmp/dancelight_weights/runtime_parachains_initializer.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> runtime_parachains::initializer::WeightInfo for SubstrateWeight<T> {
	...
	fn force_approve(d: u32, ) -> Weight {
		...
		Weight::from_parts(3_605_421, 0)
			// Standard Error: 6
			.saturating_add(Weight::from_parts(230, 0).saturating_mul(d.into()))
	}
}