...
// raw.json
// --output
// tmp/dancelight_weights/runtime_parachains::initializer.rs
...
impl<T: frame_system::Config> runtime_parachains::initializer::WeightInfo for SubstrateWeight<T> {
	...
	fn force_approve(d: u32, ) -> Weight {
		...
		Weight::from_parts(5_078_000, 1480)
			// Standard Error: 32
			.saturating_add(Weight::from_parts(2_824, 0).saturating_mul(d.into()))
