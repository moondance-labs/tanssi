...
impl<T: frame_system::Config> pallet_bridge_relayers::WeightInfo for SubstrateWeight<T> {
	...
	fn claim_rewards() -> Weight {
		...
		Weight::from_parts(44_253_000, 3593)
	...
	fn claim_rewards_to() -> Weight {
		...
		Weight::from_parts(42_319_000, 6196)
	...
	fn register() -> Weight {
		...
		Weight::from_parts(8_806_000, 3533)
	...
	fn slash_and_deregister() -> Weight {
		...
		Weight::from_parts(6_753_000, 3533)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `BridgeRelayers::RelayerRewards` (r:1 w:1)
	...
	fn register_relayer_reward() -> Weight {
		...
		Weight::from_parts(6_642_000, 3530)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}