...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(6_971_412, 1491)
			// Standard Error: 2_359
			.saturating_add(Weight::from_parts(2_880_030, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(5_039_000, 1491)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `MaintenanceMode::MaintenanceMode` (r:1 w:0)
	/// Proof: `MaintenanceMode::MaintenanceMode` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(19_870_931, 1491)
			// Standard Error: 2_838
			.saturating_add(Weight::from_parts(3_125_032, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(6_198_940, 1491)
			// Standard Error: 1_515
			.saturating_add(Weight::from_parts(2_820_178, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn if_else() -> Weight {
		...
		Weight::from_parts(8_356_000, 1491)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}