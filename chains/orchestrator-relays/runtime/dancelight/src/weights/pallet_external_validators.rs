...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(32_181_626, 4687)
			// Standard Error: 2_170
			.saturating_add(Weight::from_parts(120_203, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_870_698, 4687)
			// Standard Error: 1_529
			.saturating_add(Weight::from_parts(83_974, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(29_713_379, 4687)
			// Standard Error: 1_405
			.saturating_add(Weight::from_parts(240_948, 0).saturating_mul(r.into()))
