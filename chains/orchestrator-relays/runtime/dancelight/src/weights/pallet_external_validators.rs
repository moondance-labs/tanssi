...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_210_000, 4687)
			// Standard Error: 2_463
			.saturating_add(Weight::from_parts(113_705, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_447_176, 4687)
			// Standard Error: 3_808
			.saturating_add(Weight::from_parts(102_823, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_303_514, 4687)
			// Standard Error: 4_414
			.saturating_add(Weight::from_parts(209_750, 0).saturating_mul(r.into()))
