...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_562_936, 4687)
			// Standard Error: 1_053
			.saturating_add(Weight::from_parts(81_562, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_346_820, 4687)
			// Standard Error: 757
			.saturating_add(Weight::from_parts(64_257, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(17_064_631, 4687)
			// Standard Error: 839
			.saturating_add(Weight::from_parts(163_420, 0).saturating_mul(r.into()))
