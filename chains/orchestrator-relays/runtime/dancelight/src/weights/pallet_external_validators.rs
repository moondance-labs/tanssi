...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_295_679, 4687)
			// Standard Error: 9_021
			.saturating_add(Weight::from_parts(111_153, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_212_938, 4687)
			// Standard Error: 6_380
			.saturating_add(Weight::from_parts(76_077, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_008_750, 4687)
			// Standard Error: 5_655
			.saturating_add(Weight::from_parts(200_883, 0).saturating_mul(r.into()))
