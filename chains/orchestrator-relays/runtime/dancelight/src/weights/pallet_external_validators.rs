...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_634_717, 4687)
			// Standard Error: 4_159
			.saturating_add(Weight::from_parts(210_021, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_051_656, 4687)
			// Standard Error: 2_517
			.saturating_add(Weight::from_parts(173_649, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_638_323, 4687)
