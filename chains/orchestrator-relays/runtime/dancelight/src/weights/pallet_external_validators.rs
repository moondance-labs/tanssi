...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_097_490, 4687)
			// Standard Error: 9_717
			.saturating_add(Weight::from_parts(184_738, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_454_700, 4687)
			// Standard Error: 5_669
			.saturating_add(Weight::from_parts(189_490, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_956_773, 4687)
			// Standard Error: 3_229
			.saturating_add(Weight::from_parts(293_873, 0).saturating_mul(r.into()))
