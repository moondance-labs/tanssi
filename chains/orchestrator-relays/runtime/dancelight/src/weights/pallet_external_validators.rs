...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_715_612, 4687)
			// Standard Error: 7_735
			.saturating_add(Weight::from_parts(210_215, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_728_369, 4687)
			// Standard Error: 7_220
			.saturating_add(Weight::from_parts(161_873, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(11_936_624, 4687)
			// Standard Error: 8_736
			.saturating_add(Weight::from_parts(358_446, 0).saturating_mul(r.into()))
