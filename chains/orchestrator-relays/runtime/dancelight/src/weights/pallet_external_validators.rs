...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(31_399_227, 4687)
			// Standard Error: 2_068
			.saturating_add(Weight::from_parts(118_201, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_436_163, 4687)
			// Standard Error: 1_409
			.saturating_add(Weight::from_parts(83_903, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(28_830_773, 4687)
			// Standard Error: 1_576
			.saturating_add(Weight::from_parts(227_549, 0).saturating_mul(r.into()))
