...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_130_226, 4687)
			// Standard Error: 1_154
			.saturating_add(Weight::from_parts(58_096, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_458_186, 4687)
			// Standard Error: 1_264
			.saturating_add(Weight::from_parts(50_172, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(18_147_421, 4687)
			// Standard Error: 702
			.saturating_add(Weight::from_parts(148_508, 0).saturating_mul(r.into()))
