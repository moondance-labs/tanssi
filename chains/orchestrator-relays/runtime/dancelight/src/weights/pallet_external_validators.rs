...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(31_041_578, 4687)
			// Standard Error: 1_922
			.saturating_add(Weight::from_parts(138_239, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_376_687, 4687)
			// Standard Error: 1_474
			.saturating_add(Weight::from_parts(99_827, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(29_014_799, 4687)
			// Standard Error: 1_255
			.saturating_add(Weight::from_parts(245_895, 0).saturating_mul(r.into()))
