...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_167_955, 4687)
			// Standard Error: 1_225
			.saturating_add(Weight::from_parts(58_340, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_545_863, 4687)
			// Standard Error: 620
			.saturating_add(Weight::from_parts(43_452, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(17_759_644, 4687)
			// Standard Error: 609
			.saturating_add(Weight::from_parts(146_585, 0).saturating_mul(r.into()))
