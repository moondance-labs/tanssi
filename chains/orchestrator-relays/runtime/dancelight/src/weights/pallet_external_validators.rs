...
// --output=tmp/dancelight_weights/pallet_external_validators.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1016 + b * (37 ±0)`
		//  Estimated: `4687 + b * (37 ±0)`
		// Minimum execution time: 13_896_000 picoseconds.
		Weight::from_parts(13_822_702, 4687)
			// Standard Error: 4_400
			.saturating_add(Weight::from_parts(240_523, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_085_557, 4687)
			// Standard Error: 5_947
			.saturating_add(Weight::from_parts(140_481, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(11_925_494, 4687)
			// Standard Error: 9_871
			.saturating_add(Weight::from_parts(358_284, 0).saturating_mul(r.into()))
