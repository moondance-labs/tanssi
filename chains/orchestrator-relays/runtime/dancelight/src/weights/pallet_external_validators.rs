...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_015_553, 4687)
			// Standard Error: 7_920
			.saturating_add(Weight::from_parts(124_012, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_023_632, 4687)
			// Standard Error: 4_184
			.saturating_add(Weight::from_parts(66_799, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_125_929, 4687)
			// Standard Error: 7_302
			.saturating_add(Weight::from_parts(198_187, 0).saturating_mul(r.into()))
