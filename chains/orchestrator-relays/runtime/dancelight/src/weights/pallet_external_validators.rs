...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_648_362, 4687)
			// Standard Error: 6_854
			.saturating_add(Weight::from_parts(108_547, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_647_704, 4687)
			// Standard Error: 6_784
			.saturating_add(Weight::from_parts(96_266, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_517_383, 4687)
			// Standard Error: 4_856
			.saturating_add(Weight::from_parts(176_804, 0).saturating_mul(r.into()))
