...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_840_526, 4687)
			// Standard Error: 1_136
			.saturating_add(Weight::from_parts(60_906, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_726_433, 4687)
			// Standard Error: 664
			.saturating_add(Weight::from_parts(43_395, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(18_503_618, 4687)
			// Standard Error: 4_961
			.saturating_add(Weight::from_parts(153_744, 0).saturating_mul(r.into()))
