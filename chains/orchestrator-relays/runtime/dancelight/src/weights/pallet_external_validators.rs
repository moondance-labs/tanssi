...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(32_057_799, 4687)
			// Standard Error: 2_080
			.saturating_add(Weight::from_parts(112_750, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_772_100, 4687)
			// Standard Error: 1_441
			.saturating_add(Weight::from_parts(81_115, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(29_155_033, 4687)
			// Standard Error: 1_675
			.saturating_add(Weight::from_parts(229_468, 0).saturating_mul(r.into()))
