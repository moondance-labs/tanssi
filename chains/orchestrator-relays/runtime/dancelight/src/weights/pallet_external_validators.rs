...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_814_843, 4687)
			// Standard Error: 1_100
			.saturating_add(Weight::from_parts(76_377, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_653_720, 4687)
			// Standard Error: 706
			.saturating_add(Weight::from_parts(57_337, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(17_254_947, 4687)
			// Standard Error: 1_029
			.saturating_add(Weight::from_parts(161_645, 0).saturating_mul(r.into()))
