...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(36_169_345, 4687)
			// Standard Error: 2_805
			.saturating_add(Weight::from_parts(115_251, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_581_584, 4687)
			// Standard Error: 1_103
			.saturating_add(Weight::from_parts(65_531, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(24_682_361, 4687)
			// Standard Error: 4_830
			.saturating_add(Weight::from_parts(289_313, 0).saturating_mul(r.into()))
