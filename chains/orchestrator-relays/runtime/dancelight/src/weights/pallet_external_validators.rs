...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_409_880, 4687)
			// Standard Error: 927
			.saturating_add(Weight::from_parts(77_642, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_753_275, 4687)
			// Standard Error: 615
			.saturating_add(Weight::from_parts(60_040, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_269_440, 4687)
			// Standard Error: 718
			.saturating_add(Weight::from_parts(149_657, 0).saturating_mul(r.into()))
