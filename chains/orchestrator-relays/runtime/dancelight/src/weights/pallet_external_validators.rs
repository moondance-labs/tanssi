...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_001_674, 4687)
			// Standard Error: 3_760
			.saturating_add(Weight::from_parts(96_483, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_775_080, 4687)
			// Standard Error: 7_096
			.saturating_add(Weight::from_parts(124_833, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(12_932_532, 4687)
			// Standard Error: 7_316
			.saturating_add(Weight::from_parts(299_288, 0).saturating_mul(r.into()))
