...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_303_158, 4687)
			// Standard Error: 3_429
			.saturating_add(Weight::from_parts(107_288, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_371_334, 4687)
			// Standard Error: 6_021
			.saturating_add(Weight::from_parts(65_946, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_909_581, 4687)
			// Standard Error: 8_464
			.saturating_add(Weight::from_parts(200_023, 0).saturating_mul(r.into()))
