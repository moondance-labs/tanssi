...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(26_371_778, 4687)
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_124_092, 4687)
			// Standard Error: 620
			.saturating_add(Weight::from_parts(38_749, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_363_291, 4687)
			// Standard Error: 712
			.saturating_add(Weight::from_parts(140_328, 0).saturating_mul(r.into()))
