...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_032_546, 4687)
			// Standard Error: 8_462
			.saturating_add(Weight::from_parts(108_356, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_366_077, 4687)
			// Standard Error: 1_914
			.saturating_add(Weight::from_parts(87_451, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_066_920, 4687)
			// Standard Error: 4_579
			.saturating_add(Weight::from_parts(190_866, 0).saturating_mul(r.into()))
