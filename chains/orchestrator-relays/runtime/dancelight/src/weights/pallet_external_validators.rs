...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(30_263_252, 4687)
			// Standard Error: 2_402
			.saturating_add(Weight::from_parts(245_077, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_157_419, 4687)
			// Standard Error: 1_898
			.saturating_add(Weight::from_parts(201_692, 0).saturating_mul(b.into()))
	...
	fn force_era() -> Weight {
		...
		Weight::from_parts(17_414_000, 0)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(28_040_069, 4687)
			// Standard Error: 1_727
			.saturating_add(Weight::from_parts(334_450, 0).saturating_mul(r.into()))
