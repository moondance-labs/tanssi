...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_153_429, 4687)
			// Standard Error: 945
			.saturating_add(Weight::from_parts(68_924, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_636_189, 4687)
			// Standard Error: 593
			.saturating_add(Weight::from_parts(54_028, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_825_990, 4687)
			// Standard Error: 689
			.saturating_add(Weight::from_parts(140_382, 0).saturating_mul(r.into()))
