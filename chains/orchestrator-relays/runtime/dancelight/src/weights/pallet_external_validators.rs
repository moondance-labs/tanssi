...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_920_820, 4687)
			// Standard Error: 7_600
			.saturating_add(Weight::from_parts(177_837, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_879_480, 4687)
			// Standard Error: 5_118
			.saturating_add(Weight::from_parts(157_307, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(12_309_494, 4687)
			// Standard Error: 6_803
			.saturating_add(Weight::from_parts(305_445, 0).saturating_mul(r.into()))
