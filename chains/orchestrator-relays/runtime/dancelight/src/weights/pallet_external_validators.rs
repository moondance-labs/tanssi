...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(30_913_275, 4687)
			// Standard Error: 2_346
			.saturating_add(Weight::from_parts(225_274, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_359_482, 4687)
			// Standard Error: 2_372
			.saturating_add(Weight::from_parts(163_455, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(27_960_343, 4687)
			// Standard Error: 1_688
			.saturating_add(Weight::from_parts(337_886, 0).saturating_mul(r.into()))
