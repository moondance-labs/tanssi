...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_386_169, 4687)
			// Standard Error: 8_730
			.saturating_add(Weight::from_parts(256_567, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_195_415, 4687)
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(11_422_890, 4687)
			// Standard Error: 12_072
			.saturating_add(Weight::from_parts(399_704, 0).saturating_mul(r.into()))
