...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_913_030, 4687)
			// Standard Error: 987
			.saturating_add(Weight::from_parts(69_379, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_426_303, 4687)
			// Standard Error: 669
			.saturating_add(Weight::from_parts(52_977, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_022_033, 4687)
			// Standard Error: 830
			.saturating_add(Weight::from_parts(151_145, 0).saturating_mul(r.into()))
