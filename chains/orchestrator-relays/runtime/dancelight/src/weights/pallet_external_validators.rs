...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_912_471, 4687)
			// Standard Error: 10_631
			.saturating_add(Weight::from_parts(169_770, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_547_847, 4687)
			// Standard Error: 5_522
			.saturating_add(Weight::from_parts(116_009, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_043_184, 4687)
			// Standard Error: 5_809
			.saturating_add(Weight::from_parts(280_020, 0).saturating_mul(r.into()))
