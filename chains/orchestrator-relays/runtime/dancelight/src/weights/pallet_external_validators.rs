...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_328_765, 4687)
			// Standard Error: 939
			.saturating_add(Weight::from_parts(69_838, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_387_087, 4687)
			// Standard Error: 845
			.saturating_add(Weight::from_parts(42_315, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_213_247, 4687)
			// Standard Error: 691
			.saturating_add(Weight::from_parts(147_394, 0).saturating_mul(r.into()))
