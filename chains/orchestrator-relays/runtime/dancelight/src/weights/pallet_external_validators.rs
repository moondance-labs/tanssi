...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_206_491, 4687)
			// Standard Error: 1_101
			.saturating_add(Weight::from_parts(90_014, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_513_578, 4687)
			// Standard Error: 621
			.saturating_add(Weight::from_parts(56_434, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_900_892, 4687)
			// Standard Error: 665
			.saturating_add(Weight::from_parts(156_561, 0).saturating_mul(r.into()))
