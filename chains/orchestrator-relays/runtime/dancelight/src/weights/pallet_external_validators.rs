...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1093 + b * (36 ±0)`
		//  Estimated: `4687 + b * (37 ±0)`
		// Minimum execution time: 15_910_000 picoseconds.
		Weight::from_parts(17_128_211, 4687)
			// Standard Error: 8_284
			.saturating_add(Weight::from_parts(139_135, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_729_492, 4687)
			// Standard Error: 2_690
			.saturating_add(Weight::from_parts(90_318, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_142_917, 4687)
			// Standard Error: 4_154
			.saturating_add(Weight::from_parts(195_769, 0).saturating_mul(r.into()))
