...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(21_317_153, 4687)
			// Standard Error: 1_198
			.saturating_add(Weight::from_parts(50_990, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_667_793, 4687)
			// Standard Error: 672
			.saturating_add(Weight::from_parts(42_311, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(18_025_445, 4687)
			// Standard Error: 906
			.saturating_add(Weight::from_parts(141_393, 0).saturating_mul(r.into()))
