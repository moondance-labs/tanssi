...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_368_940, 4687)
			// Standard Error: 981
			.saturating_add(Weight::from_parts(70_296, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_957_901, 4687)
			// Standard Error: 631
			.saturating_add(Weight::from_parts(51_531, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_290_876, 4687)
			// Standard Error: 2_318
			.saturating_add(Weight::from_parts(170_264, 0).saturating_mul(r.into()))
