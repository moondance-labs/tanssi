...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_609_974, 4687)
			// Standard Error: 1_978
			.saturating_add(Weight::from_parts(109_948, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(24_035_428, 4687)
			// Standard Error: 1_580
			.saturating_add(Weight::from_parts(81_143, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(32_339_670, 4687)
			// Standard Error: 1_757
			.saturating_add(Weight::from_parts(232_754, 0).saturating_mul(r.into()))
