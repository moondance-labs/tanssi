...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_603_686, 4687)
			// Standard Error: 8_047
			.saturating_add(Weight::from_parts(132_467, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_783_508, 4687)
			// Standard Error: 6_361
			.saturating_add(Weight::from_parts(80_472, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_722_273, 4687)
			// Standard Error: 1_381
			.saturating_add(Weight::from_parts(177_802, 0).saturating_mul(r.into()))
