...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_558_178, 4687)
			// Standard Error: 4_826
			.saturating_add(Weight::from_parts(221_614, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_947_718, 4687)
			// Standard Error: 5_355
			.saturating_add(Weight::from_parts(174_355, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_933_084, 4687)
			// Standard Error: 17_417
			.saturating_add(Weight::from_parts(333_359, 0).saturating_mul(r.into()))
