...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_550_364, 4687)
			// Standard Error: 5_464
			.saturating_add(Weight::from_parts(201_788, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_744_311, 4687)
			// Standard Error: 6_945
			.saturating_add(Weight::from_parts(154_564, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(12_584_674, 4687)
			// Standard Error: 6_189
			.saturating_add(Weight::from_parts(327_663, 0).saturating_mul(r.into()))
