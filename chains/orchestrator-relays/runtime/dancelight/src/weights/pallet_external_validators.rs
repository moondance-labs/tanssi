...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_835_645, 4687)
			// Standard Error: 4_255
			.saturating_add(Weight::from_parts(78_753, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_717_392, 4687)
			// Standard Error: 1_652
			.saturating_add(Weight::from_parts(40_397, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_567_151, 4687)
			// Standard Error: 2_609
			.saturating_add(Weight::from_parts(137_038, 0).saturating_mul(r.into()))
