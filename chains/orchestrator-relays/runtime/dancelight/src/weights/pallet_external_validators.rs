...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1049 + b * (37 ±0)`
		//  Estimated: `4687 + b * (37 ±0)`
		// Minimum execution time: 14_216_000 picoseconds.
		Weight::from_parts(16_522_582, 4687)
			// Standard Error: 3_120
			.saturating_add(Weight::from_parts(90_920, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_610_005, 4687)
			// Standard Error: 8_156
			.saturating_add(Weight::from_parts(161_376, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(12_981_442, 4687)
			// Standard Error: 2_965
			.saturating_add(Weight::from_parts(283_493, 0).saturating_mul(r.into()))
