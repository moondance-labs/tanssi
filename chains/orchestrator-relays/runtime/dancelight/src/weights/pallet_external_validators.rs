...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_285_687, 4687)
			// Standard Error: 1_094
			.saturating_add(Weight::from_parts(61_677, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_593_369, 4687)
			// Standard Error: 655
			.saturating_add(Weight::from_parts(43_005, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_708_166, 4687)
			// Standard Error: 695
			.saturating_add(Weight::from_parts(138_980, 0).saturating_mul(r.into()))
