...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_592_184, 4687)
			// Standard Error: 13_412
			.saturating_add(Weight::from_parts(244_478, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_212_301, 4687)
			// Standard Error: 6_697
			.saturating_add(Weight::from_parts(133_562, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_680_259, 4687)
			// Standard Error: 6_627
			.saturating_add(Weight::from_parts(302_263, 0).saturating_mul(r.into()))
