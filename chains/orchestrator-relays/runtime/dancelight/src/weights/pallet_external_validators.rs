...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(17_415_497, 4687)
			// Standard Error: 965
			.saturating_add(Weight::from_parts(67_587, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_681_423, 4687)
			// Standard Error: 547
			.saturating_add(Weight::from_parts(54_421, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_027_370, 4687)
			// Standard Error: 622
			.saturating_add(Weight::from_parts(149_878, 0).saturating_mul(r.into()))
