...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_390_065, 4687)
			// Standard Error: 1_088
			.saturating_add(Weight::from_parts(51_362, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_282_406, 4687)
			// Standard Error: 618
			.saturating_add(Weight::from_parts(39_704, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_892_838, 4687)
			// Standard Error: 5_507
			.saturating_add(Weight::from_parts(160_955, 0).saturating_mul(r.into()))
