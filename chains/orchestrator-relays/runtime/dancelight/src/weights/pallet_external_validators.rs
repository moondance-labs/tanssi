...
impl<T: frame_system::Config> pallet_external_validators::WeightInfo for SubstrateWeight<T> {
	...
	fn add_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_868_747, 4687)
			// Standard Error: 4_691
			.saturating_add(Weight::from_parts(99_426, 0).saturating_mul(b.into()))
	...
	fn remove_whitelisted(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_435_189, 4687)
			// Standard Error: 8_743
			.saturating_add(Weight::from_parts(96_388, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(14_704_810, 4687)
			// Standard Error: 5_907
			.saturating_add(Weight::from_parts(198_277, 0).saturating_mul(r.into()))
