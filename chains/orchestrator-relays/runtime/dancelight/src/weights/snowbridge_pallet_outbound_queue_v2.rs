...
impl<T: frame_system::Config> snowbridge_pallet_outbound_queue_v2::WeightInfo for SubstrateWeight<T> {
	...
	fn do_process_message() -> Weight {
		...
		Weight::from_parts(17_653_000, 1632)
	...
	fn commit() -> Weight {
		...
		Weight::from_parts(25_939_000, 2718)
	...
	fn commit_single() -> Weight {
		...
		Weight::from_parts(11_021_000, 1725)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn process() -> Weight {
		...
		//  Measured:  `218`
		//  Estimated: `1493`
		// Minimum execution time: 422_956_000 picoseconds.
		Weight::from_parts(426_011_000, 1493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn submit_delivery_receipt() -> Weight {
		...
		Weight::from_parts(52_139_000, 4038)
