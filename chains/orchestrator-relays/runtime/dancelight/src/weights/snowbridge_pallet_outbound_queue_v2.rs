...
impl<T: frame_system::Config> snowbridge_pallet_outbound_queue_v2::WeightInfo for SubstrateWeight<T> {
	...
	fn do_process_message() -> Weight {
		...
		Weight::from_parts(18_755_000, 1632)
	...
	fn commit() -> Weight {
		...
		Weight::from_parts(31_869_000, 2718)
	...
	fn commit_single() -> Weight {
		...
		Weight::from_parts(12_484_000, 1725)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn process() -> Weight {
		...
		//  Measured:  `218`
		//  Estimated: `1493`
		// Minimum execution time: 466_545_000 picoseconds.
		Weight::from_parts(473_698_000, 1493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn submit_delivery_receipt() -> Weight {
		...
		Weight::from_parts(56_336_000, 4038)
