...
impl<T: frame_system::Config> pallet_beefy_mmr::WeightInfo for SubstrateWeight<T> {
	...
	fn extract_validation_context() -> Weight {
		...
		Weight::from_parts(5_100_000, 3509)
	...
	fn read_peak() -> Weight {
		...
		Weight::from_parts(5_010_000, 3505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn n_items_proof_is_non_canonical(n: u32, ) -> Weight {
		...
		Weight::from_parts(20_712_928, 1517)
			// Standard Error: 1_553
			.saturating_add(Weight::from_parts(1_076_150, 0).saturating_mul(n.into()))
