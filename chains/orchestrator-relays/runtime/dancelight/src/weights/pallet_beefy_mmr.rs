...
impl<T: frame_system::Config> pallet_beefy_mmr::WeightInfo for SubstrateWeight<T> {
	...
	fn read_peak() -> Weight {
		...
		Weight::from_parts(4_448_000, 3505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn n_items_proof_is_non_canonical(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_942_155, 1517)
			// Standard Error: 22_254
			.saturating_add(Weight::from_parts(1_142_607, 0).saturating_mul(n.into()))
