...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		...
		Weight::from_parts(10_391_471, 1501)
			// Standard Error: 780
			.saturating_add(Weight::from_parts(9_635, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn spend() -> Weight {
		...
		Weight::from_parts(8_326_000, 1489)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn void_spend() -> Weight {
		...
		Weight::from_parts(8_947_000, 3534)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}