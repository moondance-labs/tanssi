...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(38_773_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_670_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(18_976_477, 990)
			// Standard Error: 291_967
			.saturating_add(Weight::from_parts(15_255_138, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(51_076_000, 3593)
