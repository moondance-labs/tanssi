...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(36_449_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_339_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(2_226_677, 990)
			// Standard Error: 9_428
			.saturating_add(Weight::from_parts(12_859_010, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(28_684_000, 3593)
