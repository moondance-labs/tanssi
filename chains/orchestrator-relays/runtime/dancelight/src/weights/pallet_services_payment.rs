...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		//  Measured:  `192`
		//  Estimated: `6196`
		// Minimum execution time: 60_236_000 picoseconds.
		Weight::from_parts(61_380_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(19_421_000, 3517)
	...
	fn set_max_core_price() -> Weight {
		...
		Weight::from_parts(19_581_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_643_676, 990)
			// Standard Error: 12_985
			.saturating_add(Weight::from_parts(20_921_412, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		//  Measured:  `239`
		//  Estimated: `3593`
		// Minimum execution time: 49_698_000 picoseconds.
		Weight::from_parts(50_780_000, 3593)
