...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		//  Measured:  `243`
		//  Estimated: `6196`
		// Minimum execution time: 60_507_000 picoseconds.
		Weight::from_parts(62_086_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(19_684_000, 3517)
	...
	fn set_max_core_price() -> Weight {
		...
		Weight::from_parts(19_527_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_546_855, 990)
			// Standard Error: 14_702
			.saturating_add(Weight::from_parts(20_859_009, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(50_746_000, 3593)
