...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(37_040_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_741_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(1_065_501, 990)
			// Standard Error: 19_473
			.saturating_add(Weight::from_parts(13_355_775, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(29_686_000, 3593)
