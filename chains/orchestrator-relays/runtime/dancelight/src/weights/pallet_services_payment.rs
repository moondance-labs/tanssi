...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(37_991_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_470_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(16_391_000, 990)
			// Standard Error: 136_971
			.saturating_add(Weight::from_parts(14_739_178, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(30_748_000, 3593)
