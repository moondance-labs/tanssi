...
impl<T: frame_system::Config> pallet_stream_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn open_stream() -> Weight {
		...
		//  Measured:  `144`
		//  Estimated: `3640`
		// Minimum execution time: 66_955_000 picoseconds.
		Weight::from_parts(68_599_000, 3640)
	...
	fn close_stream() -> Weight {
		...
		//  Measured:  `685`
		//  Estimated: `6196`
		// Minimum execution time: 107_982_000 picoseconds.
		Weight::from_parts(109_806_000, 6196)
	...
	fn perform_payment() -> Weight {
		...
		Weight::from_parts(64_140_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn request_change_immediate() -> Weight {
		...
		//  Measured:  `685`
		//  Estimated: `6196`
		// Minimum execution time: 91_531_000 picoseconds.
		Weight::from_parts(92_614_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn request_change_delayed() -> Weight {
		...
		Weight::from_parts(10_159_000, 3742)
	...
	fn accept_requested_change() -> Weight {
		...
		Weight::from_parts(86_823_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn cancel_change_request() -> Weight {
		...
		Weight::from_parts(7_625_000, 3742)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn immediately_change_deposit() -> Weight {
		...
		//  Measured:  `685`
		//  Estimated: `6196`
		// Minimum execution time: 86_843_000 picoseconds.
		Weight::from_parts(87_965_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
}