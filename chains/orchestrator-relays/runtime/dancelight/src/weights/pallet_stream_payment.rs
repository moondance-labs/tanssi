...
impl<T: frame_system::Config> pallet_stream_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn open_stream() -> Weight {
		...
		//  Measured:  `195`
		//  Estimated: `3676`
		// Minimum execution time: 117_611_000 picoseconds.
		Weight::from_parts(119_266_000, 3676)
	...
	fn close_stream() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 185_733_000 picoseconds.
		Weight::from_parts(188_154_000, 6196)
	...
	fn perform_payment() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 109_788_000 picoseconds.
		Weight::from_parts(111_538_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn request_change_immediate() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 159_648_000 picoseconds.
		Weight::from_parts(162_024_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn request_change_delayed() -> Weight {
		...
		Weight::from_parts(19_628_000, 3742)
	...
	fn accept_requested_change() -> Weight {
		...
		//  Measured:  `806`
		//  Estimated: `6196`
		// Minimum execution time: 148_665_000 picoseconds.
		Weight::from_parts(150_607_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn cancel_change_request() -> Weight {
		...
		Weight::from_parts(15_017_000, 3742)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn immediately_change_deposit() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 147_798_000 picoseconds.
		Weight::from_parts(150_088_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
}