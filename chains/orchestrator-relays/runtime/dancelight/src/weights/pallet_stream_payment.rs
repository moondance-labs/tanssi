...
// --output=tmp/dancelight_weights/pallet_stream_payment.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_stream_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn open_stream() -> Weight {
		...
		//  Measured:  `195`
		//  Estimated: `3676`
		// Minimum execution time: 116_600_000 picoseconds.
		Weight::from_parts(118_231_000, 3676)
	...
	fn close_stream() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 186_178_000 picoseconds.
		Weight::from_parts(187_739_000, 6196)
	...
	fn perform_payment() -> Weight {
		...
		Weight::from_parts(111_974_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn request_change_immediate() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 155_953_000 picoseconds.
		Weight::from_parts(157_414_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn request_change_delayed() -> Weight {
		...
		Weight::from_parts(19_853_000, 3742)
	...
	fn accept_requested_change() -> Weight {
		...
		//  Measured:  `806`
		//  Estimated: `6196`
		// Minimum execution time: 146_192_000 picoseconds.
		Weight::from_parts(147_894_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn cancel_change_request() -> Weight {
		...
		Weight::from_parts(15_117_000, 3742)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn immediately_change_deposit() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6196`
		// Minimum execution time: 146_002_000 picoseconds.
		Weight::from_parts(148_131_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
}