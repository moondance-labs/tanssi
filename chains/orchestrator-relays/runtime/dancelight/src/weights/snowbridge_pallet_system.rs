...
impl<T: frame_system::Config> snowbridge_pallet_system::WeightInfo for SubstrateWeight<T> {
	...
	fn upgrade() -> Weight {
		...
		Weight::from_parts(60_174_000, 3601)
	...
	fn set_operating_mode() -> Weight {
		...
		Weight::from_parts(49_242_000, 3601)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(5_u64))
	}
	/// Storage: `EthereumSystem::Channels` (r:1 w:0)
	...
	fn set_pricing_parameters() -> Weight {
		...
		Weight::from_parts(55_211_000, 3601)
	...
	fn force_update_channel() -> Weight {
		...
		Weight::from_parts(56_722_000, 6092)
	...
	fn force_transfer_native_from_agent() -> Weight {
		...
		//  Measured:  `457`
		//  Estimated: `3601`
		// Minimum execution time: 61_901_000 picoseconds.
		Weight::from_parts(63_870_000, 3601)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(5_u64))
	}
	/// Storage: `EthereumSystem::Channels` (r:1 w:0)
	...
	fn set_token_transfer_fees() -> Weight {
		...
		Weight::from_parts(52_648_000, 3601)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(5_u64))
	}
	...
	fn register_token() -> Weight {
		...
		Weight::from_parts(73_328_000, 4115)
