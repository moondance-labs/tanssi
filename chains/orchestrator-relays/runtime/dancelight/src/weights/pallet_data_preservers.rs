...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(49_337_493, 4209)
			// Standard Error: 229_161
			.saturating_add(Weight::from_parts(1_718_570, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(11_814_763, 4209)
			// Standard Error: 4_416
			.saturating_add(Weight::from_parts(41_048, 0).saturating_mul(y.into()))
	...
	fn update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(48_385_353, 4209)
			// Standard Error: 4_508
			.saturating_add(Weight::from_parts(46_340, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(39_348_101, 4209)
			// Standard Error: 3_237
			.saturating_add(Weight::from_parts(46_481, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(38_212_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(21_330_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(22_812_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(15_289_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}