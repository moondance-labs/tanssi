...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `216`
		//  Estimated: `4209`
		// Minimum execution time: 66_683_000 picoseconds.
		Weight::from_parts(68_589_334, 4209)
			// Standard Error: 5_403
			.saturating_add(Weight::from_parts(55_542, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(18_758_310, 4209)
			// Standard Error: 128
			.saturating_add(Weight::from_parts(806, 0).saturating_mul(x.into()))
			// Standard Error: 2_672
			.saturating_add(Weight::from_parts(74_318, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(72_685_389, 4209)
			// Standard Error: 249
			.saturating_add(Weight::from_parts(1_981, 0).saturating_mul(x.into()))
			// Standard Error: 5_205
			.saturating_add(Weight::from_parts(86_388, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(60_901_000, 4209)
			// Standard Error: 223
			.saturating_add(Weight::from_parts(1_278, 0).saturating_mul(x.into()))
			// Standard Error: 4_663
			.saturating_add(Weight::from_parts(86_325, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		//  Measured:  `423`
		//  Estimated: `4209`
		// Minimum execution time: 58_405_000 picoseconds.
		Weight::from_parts(59_562_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(58_859_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(34_052_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(37_224_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(25_492_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(50_000_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}