...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(41_661_477, 4209)
			// Standard Error: 4_099
			.saturating_add(Weight::from_parts(45_999, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_180_866, 4209)
			// Standard Error: 83
			.saturating_add(Weight::from_parts(515, 0).saturating_mul(x.into()))
			// Standard Error: 1_732
			.saturating_add(Weight::from_parts(42_044, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(39_016_949, 4209)
			// Standard Error: 7_466
			.saturating_add(Weight::from_parts(81_243, 0).saturating_mul(x.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(40_909_093, 4209)
			// Standard Error: 7_261
			.saturating_add(Weight::from_parts(15_927, 0).saturating_mul(x.into()))
			// Standard Error: 151_398
			.saturating_add(Weight::from_parts(61_672, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(63_549_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(63_099_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(35_447_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(24_777_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}