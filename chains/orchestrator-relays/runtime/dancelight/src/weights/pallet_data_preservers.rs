...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `216`
		//  Estimated: `4209`
		// Minimum execution time: 66_259_000 picoseconds.
		Weight::from_parts(67_629_846, 4209)
			// Standard Error: 273
			.saturating_add(Weight::from_parts(643, 0).saturating_mul(x.into()))
			// Standard Error: 5_710
			.saturating_add(Weight::from_parts(77_866, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(18_626_963, 4209)
			// Standard Error: 129
			.saturating_add(Weight::from_parts(772, 0).saturating_mul(x.into()))
			// Standard Error: 2_693
			.saturating_add(Weight::from_parts(81_635, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `423`
		//  Estimated: `4209`
		// Minimum execution time: 70_385_000 picoseconds.
		Weight::from_parts(72_107_980, 4209)
			// Standard Error: 249
			.saturating_add(Weight::from_parts(1_234, 0).saturating_mul(x.into()))
			// Standard Error: 5_198
			.saturating_add(Weight::from_parts(80_695, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(60_202_807, 4209)
			// Standard Error: 226
			.saturating_add(Weight::from_parts(574, 0).saturating_mul(x.into()))
			// Standard Error: 4_722
			.saturating_add(Weight::from_parts(88_007, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		//  Measured:  `423`
		//  Estimated: `4209`
		// Minimum execution time: 57_945_000 picoseconds.
		Weight::from_parts(59_057_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(58_622_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(34_230_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(36_878_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(25_202_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}