...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(43_171_000, 4209)
			// Standard Error: 4_318
			.saturating_add(Weight::from_parts(67_030, 0).saturating_mul(x.into()))
			// Standard Error: 86_820
			.saturating_add(Weight::from_parts(959_470, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(23_065_026, 4209)
			// Standard Error: 2_835
			.saturating_add(Weight::from_parts(4_103, 0).saturating_mul(x.into()))
	...
	fn update_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(69_599_819, 4209)
	...
	fn force_update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(37_617_181, 4209)
			// Standard Error: 4_328
			.saturating_add(Weight::from_parts(74_401, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(37_510_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(20_108_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(21_931_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(15_038_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}