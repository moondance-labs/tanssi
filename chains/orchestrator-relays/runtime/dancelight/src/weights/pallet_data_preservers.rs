...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(65_028_370, 4151)
			// Standard Error: 248
			.saturating_add(Weight::from_parts(1_726, 0).saturating_mul(x.into()))
			// Standard Error: 5_182
			.saturating_add(Weight::from_parts(95_317, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(16_485_836, 4151)
			// Standard Error: 118
			.saturating_add(Weight::from_parts(1_653, 0).saturating_mul(x.into()))
			// Standard Error: 2_466
			.saturating_add(Weight::from_parts(106_587, 0).saturating_mul(y.into()))
	...
	fn update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(70_703_235, 4151)
			// Standard Error: 4_672
			.saturating_add(Weight::from_parts(93_720, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `423`
		//  Estimated: `4151`
		// Minimum execution time: 57_141_000 picoseconds.
		Weight::from_parts(58_467_709, 4151)
			// Standard Error: 206
			.saturating_add(Weight::from_parts(1_307, 0).saturating_mul(x.into()))
			// Standard Error: 4_302
			.saturating_add(Weight::from_parts(97_955, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(58_144_000, 4151)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		//  Measured:  `423`
		//  Estimated: `4151`
		// Minimum execution time: 56_316_000 picoseconds.
		Weight::from_parts(57_826_000, 4151)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(33_535_000, 4151)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(36_574_000, 4151)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(23_484_000, 4151)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}