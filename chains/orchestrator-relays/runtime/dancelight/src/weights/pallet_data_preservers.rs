...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(42_000_990, 4209)
			// Standard Error: 3_184
			.saturating_add(Weight::from_parts(58_191, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_047_242, 4209)
			// Standard Error: 71
			.saturating_add(Weight::from_parts(187, 0).saturating_mul(x.into()))
			// Standard Error: 1_496
			.saturating_add(Weight::from_parts(39_793, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(44_519_610, 4209)
			// Standard Error: 228
			.saturating_add(Weight::from_parts(704, 0).saturating_mul(x.into()))
			// Standard Error: 4_770
			.saturating_add(Weight::from_parts(76_964, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(36_500_520, 4209)
			// Standard Error: 148
			.saturating_add(Weight::from_parts(728, 0).saturating_mul(x.into()))
			// Standard Error: 3_094
			.saturating_add(Weight::from_parts(55_896, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(36_178_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(20_749_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(14_016_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}