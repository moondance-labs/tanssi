...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(43_343_585, 6029)
			// Standard Error: 4_121
			.saturating_add(Weight::from_parts(32_836, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_776_927, 6029)
			// Standard Error: 81
			.saturating_add(Weight::from_parts(1_218, 0).saturating_mul(x.into()))
			// Standard Error: 1_708
			.saturating_add(Weight::from_parts(35_631, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(37_080_295, 6029)
			// Standard Error: 1_238
			.saturating_add(Weight::from_parts(13_836, 0).saturating_mul(x.into()))
			// Standard Error: 25_820
			.saturating_add(Weight::from_parts(773_944, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(37_857_169, 6029)
			// Standard Error: 315
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(35_566_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(35_436_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(19_566_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(20_528_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(14_487_000, 6029)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		//  Measured:  `2828`
		//  Estimated: `6029`
		// Minimum execution time: 48_150_000 picoseconds.
		Weight::from_parts(49_162_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}