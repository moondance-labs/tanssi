...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(51_930_954, 4209)
			// Standard Error: 5_804
			.saturating_add(Weight::from_parts(15_041, 0).saturating_mul(x.into()))
	...
	fn force_create_profile(_x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(20_673_530, 4209)
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(27_068_237, 4209)
			// Standard Error: 9_460
			.saturating_add(Weight::from_parts(97_686, 0).saturating_mul(x.into()))
			// Standard Error: 197_249
			.saturating_add(Weight::from_parts(2_222_473, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(_x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(51_865_308, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(62_377_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(34_264_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(28_594_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}