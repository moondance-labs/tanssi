...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(45_045_011, 6029)
			// Standard Error: 201
			.saturating_add(Weight::from_parts(1_684, 0).saturating_mul(x.into()))
			// Standard Error: 4_202
			.saturating_add(Weight::from_parts(60_416, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(924_287, 6029)
			// Standard Error: 2_396
			.saturating_add(Weight::from_parts(46_409, 0).saturating_mul(x.into()))
			// Standard Error: 49_969
			.saturating_add(Weight::from_parts(765_762, 0).saturating_mul(y.into()))
	...
	fn update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(54_262_470, 6029)
			// Standard Error: 221_658
			.saturating_add(Weight::from_parts(1_185_720, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(67_336_746, 6029)
			// Standard Error: 5_347
			.saturating_add(Weight::from_parts(659, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(39_073_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(38_202_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(20_889_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(22_402_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(15_349_000, 6029)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(53_550_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}