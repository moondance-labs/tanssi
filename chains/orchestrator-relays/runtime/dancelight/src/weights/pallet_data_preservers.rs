...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `216`
		//  Estimated: `4209`
		// Minimum execution time: 69_286_000 picoseconds.
		Weight::from_parts(71_436_754, 4209)
			// Standard Error: 334
			.saturating_add(Weight::from_parts(413, 0).saturating_mul(x.into()))
			// Standard Error: 6_982
			.saturating_add(Weight::from_parts(72_985, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(21_068_677, 4209)
			// Standard Error: 148
			.saturating_add(Weight::from_parts(1_204, 0).saturating_mul(x.into()))
			// Standard Error: 3_092
			.saturating_add(Weight::from_parts(81_190, 0).saturating_mul(y.into()))
	...
	fn update_profile(_x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `423`
		//  Estimated: `4209`
		// Minimum execution time: 74_388_000 picoseconds.
		Weight::from_parts(76_479_601, 4209)
			// Standard Error: 6_037
			.saturating_add(Weight::from_parts(106_916, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `423`
		//  Estimated: `4209`
		// Minimum execution time: 62_199_000 picoseconds.
		Weight::from_parts(63_973_724, 4209)
			// Standard Error: 243
			.saturating_add(Weight::from_parts(1_426, 0).saturating_mul(x.into()))
			// Standard Error: 5_086
			.saturating_add(Weight::from_parts(70_870, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(62_762_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(62_248_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(37_851_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(40_715_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(28_059_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}