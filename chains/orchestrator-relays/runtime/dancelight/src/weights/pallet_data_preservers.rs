...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(47_566_857, 4209)
			// Standard Error: 4_646
			.saturating_add(Weight::from_parts(33_517, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(11_214_790, 4209)
			// Standard Error: 91
			.saturating_add(Weight::from_parts(482, 0).saturating_mul(x.into()))
			// Standard Error: 1_906
			.saturating_add(Weight::from_parts(57_002, 0).saturating_mul(y.into()))
	...
	fn update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(49_315_830, 4209)
			// Standard Error: 5_063
			.saturating_add(Weight::from_parts(62_470, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(39_782_846, 4209)
			// Standard Error: 193
			.saturating_add(Weight::from_parts(544, 0).saturating_mul(x.into()))
			// Standard Error: 4_035
			.saturating_add(Weight::from_parts(75_518, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(39_424_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(21_491_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `ContainerRegistrar::ParaManager` (r:1 w:0)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(15_729_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}