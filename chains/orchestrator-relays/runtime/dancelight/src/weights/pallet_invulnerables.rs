...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_528_666, 4687)
			// Standard Error: 1_040
			.saturating_add(Weight::from_parts(54_640, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_902_184, 4687)
			// Standard Error: 572
			.saturating_add(Weight::from_parts(35_383, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(9_776_865, 4687)
			// Standard Error: 535
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_125_758, 4687)
			// Standard Error: 9_988
			.saturating_add(Weight::from_parts(104_749, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}