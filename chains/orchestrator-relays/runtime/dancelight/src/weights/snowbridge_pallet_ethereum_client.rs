...
// --output=tmp/dancelight_weights/snowbridge_pallet_ethereum_client.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> snowbridge_pallet_ethereum_client::WeightInfo for SubstrateWeight<T> {
	...
	fn force_checkpoint() -> Weight {
		...
		//  Measured:  `109`
		//  Estimated: `3501`
		// Minimum execution time: 113_833_506_000 picoseconds.
		Weight::from_parts(113_931_673_000, 3501)
	...
	fn submit() -> Weight {
		...
		//  Measured:  `92805`
		//  Estimated: `93857`
		// Minimum execution time: 28_180_519_000 picoseconds.
		Weight::from_parts(28_213_716_000, 93857)
	...
	fn submit_with_sync_committee() -> Weight {
		...
		//  Measured:  `92805`
		//  Estimated: `93857`
		// Minimum execution time: 142_040_019_000 picoseconds.
		Weight::from_parts(142_195_895_000, 93857)
			.saturating_add(T::DbWeight::get().reads(7_u64))
