...
// raw.json
// --output
// tmp/dancelight_weights/snowbridge_pallet_ethereum_client.rs
...
impl<T: frame_system::Config> snowbridge_pallet_ethereum_client::WeightInfo for SubstrateWeight<T> {
	...
	fn force_checkpoint() -> Weight {
		...
		//  Measured:  `109`
		//  Estimated: `3501`
		// Minimum execution time: 71_869_085_000 picoseconds.
		Weight::from_parts(71_967_880_000, 3501)
	...
	fn submit() -> Weight {
		...
		//  Measured:  `92805`
		//  Estimated: `93857`
		// Minimum execution time: 16_933_431_000 picoseconds.
		Weight::from_parts(16_953_488_000, 93857)
	...
	fn submit_with_sync_committee() -> Weight {
		...
		//  Measured:  `92805`
		//  Estimated: `93857`
		// Minimum execution time: 88_307_187_000 picoseconds.
		Weight::from_parts(88_427_743_000, 93857)
			.saturating_add(T::DbWeight::get().reads(7_u64))
