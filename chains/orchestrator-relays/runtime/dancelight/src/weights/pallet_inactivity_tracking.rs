...
// --output=tmp/dancelight_weights/pallet_inactivity_tracking.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_inactivity_tracking::WeightInfo for SubstrateWeight<T> {
	...
	fn set_inactivity_tracking_status() -> Weight {
		...
		Weight::from_parts(12_955_000, 1905)
	...
	fn set_offline() -> Weight {
		...
		Weight::from_parts(104_687_000, 16518)
	...
	fn set_online() -> Weight {
		...
		Weight::from_parts(61_185_000, 16518)
	...
	fn notify_inactive_collator() -> Weight {
		...
		//  Measured:  `1712`
		//  Estimated: `29435`
		// Minimum execution time: 83_456_000 picoseconds.
		Weight::from_parts(86_182_000, 29435)
