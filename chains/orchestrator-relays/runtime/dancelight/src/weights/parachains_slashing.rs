...
//! Autogenerated weights for parachains_slashing
//!
...
// raw.json
// --output
// tmp/dancelight_weights/parachains_slashing.rs
...
/// Weights for parachains_slashing using the Substrate node and recommended hardware.
pub struct SubstrateWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> parachains_slashing::WeightInfo for SubstrateWeight<T> {
	...
	fn report_dispute_lost_unsigned(n: u32, ) -> Weight {
		...
		//  Measured:  `1183`
		//  Estimated: `4687`
		// Minimum execution time: 92_766_000 picoseconds.
		Weight::from_parts(131_483_161, 4687)
			// Standard Error: 36_105
			.saturating_add(Weight::from_parts(387_903, 0).saturating_mul(n.into()))
