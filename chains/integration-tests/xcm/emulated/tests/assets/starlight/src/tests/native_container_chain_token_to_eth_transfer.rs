...
use {
    ...
    sp_core::H160,
    starlight_emulated_chain::{genesis::INITIAL_BALANCE, StarlightRelayPallet},
...
fn check_if_container_chain_router_is_working_for_eth_transfer_frontier() {
    ...
    let fees_account = starlight_runtime::SnowbridgeFeesAccount::get();
    ...
    Starlight::execute_with(|| {
        ...
        let fees_balance_before =
            <Starlight as StarlightRelayPallet>::System::account(fees_account.clone())
                .data
                .free;
        ...
        assert_ok!(
            <Starlight as StarlightRelayPallet>::EthereumTokenTransfers::set_token_transfer_channel(
                root_origin,
                ChannelId::new([5u8; 32]),
                AgentId::from_low_u64_be(10),
                3000u32.into()
            )
        );
    });
    ...
    Starlight::execute_with(|| {
        ...
        let fees_balance_after = <Starlight as StarlightRelayPallet>::System::account(fees_account)
            .data
            .free;
