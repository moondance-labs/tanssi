...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		...
		Weight::from_parts(12_837_801, 3593)
			// Standard Error: 745
			.saturating_add(Weight::from_parts(26_369, 0).saturating_mul(p.into()))
	...
	fn check_status() -> Weight {
		...
		Weight::from_parts(9_878_000, 3534)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Treasury::Spends` (r:1 w:1)
	...
	fn void_spend() -> Weight {
		...
		Weight::from_parts(9_328_000, 3534)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}