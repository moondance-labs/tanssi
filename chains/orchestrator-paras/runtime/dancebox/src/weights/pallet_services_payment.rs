...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(36_890_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(9_487_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_332_768, 990)
			// Standard Error: 12_713
			.saturating_add(Weight::from_parts(13_388_685, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(30_097_000, 3593)
