...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(37_411_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(9_678_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_757_237, 990)
			// Standard Error: 13_060
			.saturating_add(Weight::from_parts(13_769_925, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(31_469_000, 3593)
