...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(40_386_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_870_000, 3517)
	...
	fn set_max_core_price() -> Weight {
		...
		Weight::from_parts(10_690_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `299 + n * (132 ±0)`
		//  Estimated: `990 + n * (2603 ±0)`
		// Minimum execution time: 19_166_000 picoseconds.
		Weight::from_parts(8_192_748, 990)
			// Standard Error: 8_906
			.saturating_add(Weight::from_parts(14_493_440, 0).saturating_mul(n.into()))
