...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(39_104_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(9_899_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_928_193, 990)
			// Standard Error: 10_588
			.saturating_add(Weight::from_parts(14_310_528, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(32_211_000, 3593)
