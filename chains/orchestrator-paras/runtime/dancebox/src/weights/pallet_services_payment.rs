...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(59_898_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(17_909_000, 3517)
	...
	fn set_max_core_price() -> Weight {
		...
		Weight::from_parts(17_722_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(8_826_054, 990)
			// Standard Error: 11_875
			.saturating_add(Weight::from_parts(21_537_308, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `3593`
		// Minimum execution time: 51_553_000 picoseconds.
		Weight::from_parts(52_368_000, 3593)
