...
impl<T: frame_system::Config> pallet_multiblock_migrations::WeightInfo for SubstrateWeight<T> {
	...
	fn onboard_new_mbms() -> Weight {
		...
		Weight::from_parts(5_891_000, 67035)
	...
	fn exec_migration_completed() -> Weight {
		...
		Weight::from_parts(4_880_000, 3528)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(18_154_000, 3731)
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(10_440_000, 3834)
			// Standard Error: 12_081
			.saturating_add(Weight::from_parts(1_042_665, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		...
		Weight::from_parts(60_997_029, 720)
			// Standard Error: 6_548
			.saturating_add(Weight::from_parts(556_561, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
