...
impl<T: frame_system::Config> pallet_multiblock_migrations::WeightInfo for SubstrateWeight<T> {
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(18_875_000, 3731)
	...
	fn force_onboard_mbms() -> Weight {
		...
		Weight::from_parts(4_629_000, 67035)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(10_138_456, 3834)
			// Standard Error: 1_690
			.saturating_add(Weight::from_parts(967_041, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		...
		Weight::from_parts(18_629_230, 720)
			// Standard Error: 2_339
			.saturating_add(Weight::from_parts(582_933, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
