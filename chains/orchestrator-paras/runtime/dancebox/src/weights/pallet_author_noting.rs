...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(17_897_066, 1791)
			// Standard Error: 3_396
			.saturating_add(Weight::from_parts(5_276_627, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 166_683_000 picoseconds.
		Weight::from_parts(167_124_000, 6287)
			// Standard Error: 1_138_261
			.saturating_add(Weight::from_parts(140_636_469, 0).saturating_mul(x.into()))
