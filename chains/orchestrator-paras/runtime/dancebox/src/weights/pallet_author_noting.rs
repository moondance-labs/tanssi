...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_818_000, 2160)
			// Standard Error: 133_987
			.saturating_add(Weight::from_parts(18_258_760, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(63_555_087, 8799)
			// Standard Error: 10_950
			.saturating_add(Weight::from_parts(17_392_126, 0).saturating_mul(x.into()))
