...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(16_973_089, 1791)
			// Standard Error: 3_370
			.saturating_add(Weight::from_parts(5_255_325, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 165_079_000 picoseconds.
		Weight::from_parts(166_012_000, 6287)
			// Standard Error: 838_824
			.saturating_add(Weight::from_parts(134_032_838, 0).saturating_mul(x.into()))
