...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(16_766_676, 1791)
			// Standard Error: 3_145
			.saturating_add(Weight::from_parts(4_956_978, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 157_777_000 picoseconds.
		Weight::from_parts(158_919_000, 6287)
			// Standard Error: 1_051_442
			.saturating_add(Weight::from_parts(132_170_035, 0).saturating_mul(x.into()))
