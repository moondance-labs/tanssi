...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(49_539_000, 2160)
			// Standard Error: 193_226
			.saturating_add(Weight::from_parts(27_653_830, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 142_653_000 picoseconds.
		Weight::from_parts(123_762_562, 8799)
			// Standard Error: 23_501
			.saturating_add(Weight::from_parts(24_918_260, 0).saturating_mul(x.into()))
