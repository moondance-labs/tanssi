...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_045_000, 2160)
			// Standard Error: 127_122
			.saturating_add(Weight::from_parts(17_680_418, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(71_840_610, 8799)
			// Standard Error: 9_547
			.saturating_add(Weight::from_parts(15_683_330, 0).saturating_mul(x.into()))
