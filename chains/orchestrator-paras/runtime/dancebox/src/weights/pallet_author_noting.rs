...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_542_000, 2160)
			// Standard Error: 126_761
			.saturating_add(Weight::from_parts(17_448_087, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(70_214_276, 8799)
			// Standard Error: 7_009
			.saturating_add(Weight::from_parts(15_236_035, 0).saturating_mul(x.into()))
