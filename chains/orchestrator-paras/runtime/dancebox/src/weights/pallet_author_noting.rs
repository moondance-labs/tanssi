...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(46_899_000, 2160)
			// Standard Error: 151_404
			.saturating_add(Weight::from_parts(22_944_111, 0).saturating_mul(x.into()))
	...
	fn set_author() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 9_163_000 picoseconds.
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 132_947_000 picoseconds.
		Weight::from_parts(119_118_147, 8799)
			// Standard Error: 16_771
			.saturating_add(Weight::from_parts(22_621_290, 0).saturating_mul(x.into()))
