...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(18_445_351, 1791)
			// Standard Error: 3_536
			.saturating_add(Weight::from_parts(5_232_790, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 164_418_000 picoseconds.
		Weight::from_parts(166_843_000, 6287)
			// Standard Error: 1_233_577
			.saturating_add(Weight::from_parts(137_338_708, 0).saturating_mul(x.into()))
