...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_896_000, 2160)
			// Standard Error: 134_841
			.saturating_add(Weight::from_parts(18_438_452, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(48_806_621, 8799)
			// Standard Error: 342_514
			.saturating_add(Weight::from_parts(18_065_992, 0).saturating_mul(x.into()))
