...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_978_812, 1791)
			// Standard Error: 3_629
			.saturating_add(Weight::from_parts(4_970_013, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 157_615_000 picoseconds.
		Weight::from_parts(159_047_000, 6287)
			// Standard Error: 1_008_328
			.saturating_add(Weight::from_parts(133_989_535, 0).saturating_mul(x.into()))
