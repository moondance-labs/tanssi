...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(51_431_000, 2139)
			// Standard Error: 149_665
			.saturating_add(Weight::from_parts(22_968_965, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 133_844_000 picoseconds.
		Weight::from_parts(117_365_478, 8799)
			// Standard Error: 20_310
			.saturating_add(Weight::from_parts(23_690_748, 0).saturating_mul(x.into()))
