...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(26_951_000, 2160)
			// Standard Error: 132_213
			.saturating_add(Weight::from_parts(17_826_694, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(59_424_837, 8799)
			// Standard Error: 10_263
			.saturating_add(Weight::from_parts(17_669_704, 0).saturating_mul(x.into()))
