...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(26_981_000, 2160)
			// Standard Error: 232_633
			.saturating_add(Weight::from_parts(17_904_678, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(97_628_154, 8799)
			// Standard Error: 317_553
			.saturating_add(Weight::from_parts(14_826_325, 0).saturating_mul(x.into()))
