...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_906_000, 2160)
			// Standard Error: 239_110
			.saturating_add(Weight::from_parts(20_345_523, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 88_146_000 picoseconds.
		Weight::from_parts(149_294_760, 8799)
			// Standard Error: 248_467
			.saturating_add(Weight::from_parts(14_547_657, 0).saturating_mul(x.into()))
