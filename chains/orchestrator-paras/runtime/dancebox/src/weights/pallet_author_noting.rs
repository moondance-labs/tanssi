...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_853_000, 2160)
			// Standard Error: 114_478
			.saturating_add(Weight::from_parts(17_431_191, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(69_300_212, 8799)
			// Standard Error: 6_879
			.saturating_add(Weight::from_parts(14_827_452, 0).saturating_mul(x.into()))
