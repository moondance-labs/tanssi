...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_183_000, 2160)
			// Standard Error: 133_005
			.saturating_add(Weight::from_parts(18_111_527, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(59_684_356, 8799)
			// Standard Error: 10_720
			.saturating_add(Weight::from_parts(17_697_425, 0).saturating_mul(x.into()))
