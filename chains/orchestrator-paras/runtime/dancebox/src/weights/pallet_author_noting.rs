...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_678_000, 2160)
			// Standard Error: 131_244
			.saturating_add(Weight::from_parts(18_188_571, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 84_469_000 picoseconds.
		Weight::from_parts(62_542_009, 8799)
			// Standard Error: 13_119
			.saturating_add(Weight::from_parts(17_990_103, 0).saturating_mul(x.into()))
