...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_472_000, 2160)
			// Standard Error: 216_502
			.saturating_add(Weight::from_parts(18_454_774, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 84_378_000 picoseconds.
		Weight::from_parts(66_633_402, 8799)
			// Standard Error: 463_602
			.saturating_add(Weight::from_parts(18_834_341, 0).saturating_mul(x.into()))
