...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(31_399_000, 2160)
			// Standard Error: 215_837
			.saturating_add(Weight::from_parts(19_545_505, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(61_922_798, 8799)
			// Standard Error: 14_522
			.saturating_add(Weight::from_parts(17_327_609, 0).saturating_mul(x.into()))
