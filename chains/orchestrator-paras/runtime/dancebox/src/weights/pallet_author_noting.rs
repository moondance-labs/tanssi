...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_928_000, 2139)
			// Standard Error: 126_371
			.saturating_add(Weight::from_parts(17_415_888, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(71_465_972, 8799)
			// Standard Error: 7_701
			.saturating_add(Weight::from_parts(16_331_766, 0).saturating_mul(x.into()))
