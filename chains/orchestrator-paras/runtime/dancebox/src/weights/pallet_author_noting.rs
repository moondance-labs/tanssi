...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(43_314_000, 1978)
			// Standard Error: 158_979
			.saturating_add(Weight::from_parts(23_476_696, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 121_383_000 picoseconds.
		Weight::from_parts(103_829_686, 8799)
			// Standard Error: 16_235
			.saturating_add(Weight::from_parts(22_347_753, 0).saturating_mul(x.into()))
