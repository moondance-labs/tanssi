...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(46_998_000, 2160)
			// Standard Error: 118_956
			.saturating_add(Weight::from_parts(16_897_764, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(147_696_111, 8799)
			// Standard Error: 329_474
			.saturating_add(Weight::from_parts(13_630_377, 0).saturating_mul(x.into()))
