...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(26_399_000, 2160)
			// Standard Error: 452_309
			.saturating_add(Weight::from_parts(20_426_881, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(66_590_364, 8799)
			// Standard Error: 19_401
			.saturating_add(Weight::from_parts(13_952_692, 0).saturating_mul(x.into()))
