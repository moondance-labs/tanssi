...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(26_900_000, 2160)
			// Standard Error: 189_958
			.saturating_add(Weight::from_parts(17_962_602, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(67_577_312, 8799)
			// Standard Error: 10_045
			.saturating_add(Weight::from_parts(14_769_576, 0).saturating_mul(x.into()))
