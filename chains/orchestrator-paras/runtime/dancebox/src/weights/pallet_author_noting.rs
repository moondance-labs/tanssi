...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_092_000, 2160)
			// Standard Error: 153_357
			.saturating_add(Weight::from_parts(18_608_917, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 81_382_000 picoseconds.
		Weight::from_parts(10_290_803, 8799)
			// Standard Error: 415_363
			.saturating_add(Weight::from_parts(21_567_814, 0).saturating_mul(x.into()))
