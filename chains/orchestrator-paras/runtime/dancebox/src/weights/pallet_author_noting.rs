...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_842_000, 2160)
			// Standard Error: 252_708
			.saturating_add(Weight::from_parts(18_488_344, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(102_900_936, 8799)
			// Standard Error: 132_918
			.saturating_add(Weight::from_parts(13_919_007, 0).saturating_mul(x.into()))
