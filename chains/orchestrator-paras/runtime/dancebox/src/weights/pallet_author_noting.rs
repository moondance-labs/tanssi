...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_772_000, 2160)
			// Standard Error: 121_032
			.saturating_add(Weight::from_parts(16_675_543, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(69_325_740, 8799)
			// Standard Error: 13_547
			.saturating_add(Weight::from_parts(14_438_068, 0).saturating_mul(x.into()))
