...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_253_000, 2160)
			// Standard Error: 127_806
			.saturating_add(Weight::from_parts(17_559_214, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 82_536_000 picoseconds.
		Weight::from_parts(72_667_920, 8799)
			// Standard Error: 10_764
			.saturating_add(Weight::from_parts(15_254_189, 0).saturating_mul(x.into()))
