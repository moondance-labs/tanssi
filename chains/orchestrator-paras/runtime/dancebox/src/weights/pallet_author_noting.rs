...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Measured:  `654 + x * (37 ±0)`
		//  Estimated: `2139 + x * (2539 ±0)`
		// Minimum execution time: 29_966_000 picoseconds.
		Weight::from_parts(30_707_000, 2139)
			// Standard Error: 121_206
			.saturating_add(Weight::from_parts(16_966_174, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1196 + x * (132 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 81_903_000 picoseconds.
		Weight::from_parts(69_532_693, 8799)
			// Standard Error: 8_745
			.saturating_add(Weight::from_parts(15_566_415, 0).saturating_mul(x.into()))
