...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_273_000, 2160)
			// Standard Error: 262_939
			.saturating_add(Weight::from_parts(20_225_777, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(108_868_697, 8799)
			// Standard Error: 61_858
			.saturating_add(Weight::from_parts(13_977_925, 0).saturating_mul(x.into()))
