...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(15_980_487, 1791)
			// Standard Error: 4_539
			.saturating_add(Weight::from_parts(4_980_845, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 155_651_000 picoseconds.
		Weight::from_parts(157_375_000, 6287)
			// Standard Error: 1_202_533
			.saturating_add(Weight::from_parts(134_132_312, 0).saturating_mul(x.into()))
