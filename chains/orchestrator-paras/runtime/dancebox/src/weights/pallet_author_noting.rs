...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_732_000, 2160)
			// Standard Error: 234_463
			.saturating_add(Weight::from_parts(19_878_110, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(70_965_666, 8799)
			// Standard Error: 7_444
			.saturating_add(Weight::from_parts(14_974_732, 0).saturating_mul(x.into()))
