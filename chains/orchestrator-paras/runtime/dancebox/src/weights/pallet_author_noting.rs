...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_193_000, 2160)
			// Standard Error: 124_827
			.saturating_add(Weight::from_parts(17_175_651, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(68_281_343, 8799)
			// Standard Error: 8_402
			.saturating_add(Weight::from_parts(14_811_302, 0).saturating_mul(x.into()))
