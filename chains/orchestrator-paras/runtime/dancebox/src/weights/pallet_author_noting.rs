...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_722_000, 2160)
			// Standard Error: 111_131
			.saturating_add(Weight::from_parts(16_875_489, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(65_049_659, 8799)
			// Standard Error: 8_067
			.saturating_add(Weight::from_parts(13_963_091, 0).saturating_mul(x.into()))
