...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		//  Measured:  `314 + x * (37 ±0)`
		//  Estimated: `1903 + x * (2539 ±0)`
		// Minimum execution time: 38_229_000 picoseconds.
		Weight::from_parts(39_760_000, 1903)
			// Standard Error: 152_722
			.saturating_add(Weight::from_parts(22_872_659, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `856 + x * (132 ±0)`
		//  Estimated: `8799 + x * (2603 ±0)`
		// Minimum execution time: 124_381_000 picoseconds.
		Weight::from_parts(107_769_506, 8799)
			// Standard Error: 14_980
			.saturating_add(Weight::from_parts(22_679_833, 0).saturating_mul(x.into()))
