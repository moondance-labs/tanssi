...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(47_157_000, 2160)
			// Standard Error: 151_294
			.saturating_add(Weight::from_parts(23_219_410, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 134_305_000 picoseconds.
		Weight::from_parts(105_468_775, 8799)
			// Standard Error: 16_825
			.saturating_add(Weight::from_parts(27_816_191, 0).saturating_mul(x.into()))
