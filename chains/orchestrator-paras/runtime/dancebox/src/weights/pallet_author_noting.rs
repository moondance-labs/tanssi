...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(15_333_762, 1791)
			// Standard Error: 7_990
			.saturating_add(Weight::from_parts(5_189_870, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 163_747_000 picoseconds.
		Weight::from_parts(165_340_000, 6287)
			// Standard Error: 1_060_071
			.saturating_add(Weight::from_parts(136_544_744, 0).saturating_mul(x.into()))
