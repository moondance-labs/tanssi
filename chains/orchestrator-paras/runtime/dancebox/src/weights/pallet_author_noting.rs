...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_064_000, 2160)
			// Standard Error: 134_986
			.saturating_add(Weight::from_parts(18_709_818, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(73_744_885, 8799)
			// Standard Error: 7_975
			.saturating_add(Weight::from_parts(16_222_337, 0).saturating_mul(x.into()))
