...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(55_545_000, 2160)
			// Standard Error: 139_807
			.saturating_add(Weight::from_parts(18_302_866, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(78_654_783, 8799)
			// Standard Error: 16_406
			.saturating_add(Weight::from_parts(16_207_953, 0).saturating_mul(x.into()))
