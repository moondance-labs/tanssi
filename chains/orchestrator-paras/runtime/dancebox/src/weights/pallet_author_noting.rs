...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(31_409_000, 2139)
			// Standard Error: 118_492
			.saturating_add(Weight::from_parts(17_796_584, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(70_387_098, 8799)
			// Standard Error: 9_437
			.saturating_add(Weight::from_parts(15_690_104, 0).saturating_mul(x.into()))
