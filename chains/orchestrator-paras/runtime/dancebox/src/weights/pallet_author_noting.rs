...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_556_000, 2160)
			// Standard Error: 132_713
			.saturating_add(Weight::from_parts(18_564_878, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 84_689_000 picoseconds.
		Weight::from_parts(66_932_161, 8799)
			// Standard Error: 58_218
			.saturating_add(Weight::from_parts(16_042_325, 0).saturating_mul(x.into()))
