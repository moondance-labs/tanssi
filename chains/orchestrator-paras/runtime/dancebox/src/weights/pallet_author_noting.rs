...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_404_000, 2160)
			// Standard Error: 134_426
			.saturating_add(Weight::from_parts(17_620_809, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 83_586_000 picoseconds.
		Weight::from_parts(71_857_053, 8799)
			// Standard Error: 7_454
			.saturating_add(Weight::from_parts(15_220_330, 0).saturating_mul(x.into()))
