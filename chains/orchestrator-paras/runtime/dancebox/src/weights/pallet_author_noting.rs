...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_611_000, 2160)
			// Standard Error: 180_628
			.saturating_add(Weight::from_parts(17_294_778, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(67_565_382, 8799)
			// Standard Error: 13_421
			.saturating_add(Weight::from_parts(14_927_906, 0).saturating_mul(x.into()))
