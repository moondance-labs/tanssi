...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(32_270_000, 2160)
			// Standard Error: 133_516
			.saturating_add(Weight::from_parts(18_725_389, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 87_804_000 picoseconds.
		Weight::from_parts(49_406_660, 8799)
			// Standard Error: 304_161
			.saturating_add(Weight::from_parts(19_885_269, 0).saturating_mul(x.into()))
