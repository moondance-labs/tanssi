...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_493_000, 2160)
			// Standard Error: 211_653
			.saturating_add(Weight::from_parts(18_942_449, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(70_812_002, 8799)
			// Standard Error: 7_345
			.saturating_add(Weight::from_parts(14_981_438, 0).saturating_mul(x.into()))
