...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(62_918_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		//  Measured:  `1534`
		//  Estimated: `4999`
		// Minimum execution time: 58_480_000 picoseconds.
		Weight::from_parts(59_231_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(20_118_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(13_706_000, 3497)
			// Standard Error: 2_815
			.saturating_add(Weight::from_parts(4_401_639, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_461_000, 3485)
			// Standard Error: 1_749
			.saturating_add(Weight::from_parts(3_060_878, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
