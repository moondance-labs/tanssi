...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		//  Measured:  `1604`
		//  Estimated: `5069`
		// Minimum execution time: 73_528_000 picoseconds.
		Weight::from_parts(95_950_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(77_245_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(28_854_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(15_439_000, 3497)
			// Standard Error: 5_403
			.saturating_add(Weight::from_parts(4_816_468, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_383_000, 3485)
			// Standard Error: 23_812
			.saturating_add(Weight::from_parts(3_433_136, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
