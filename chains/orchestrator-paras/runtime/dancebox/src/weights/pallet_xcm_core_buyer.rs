...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(67_136_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		//  Measured:  `1534`
		//  Estimated: `4999`
		// Minimum execution time: 62_127_000 picoseconds.
		Weight::from_parts(63_048_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(21_650_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_858_000, 3497)
			// Standard Error: 2_188
			.saturating_add(Weight::from_parts(4_652_857, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_113_000, 3485)
			// Standard Error: 2_005
			.saturating_add(Weight::from_parts(3_194_824, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
