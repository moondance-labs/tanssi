...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(101_240_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(96_882_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(30_367_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_798_000, 3497)
			// Standard Error: 7_517
			.saturating_add(Weight::from_parts(4_779_237, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_202_000, 3485)
			// Standard Error: 3_247
			.saturating_add(Weight::from_parts(3_222_424, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
