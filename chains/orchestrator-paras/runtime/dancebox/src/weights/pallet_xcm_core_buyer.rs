...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(108_834_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		//  Measured:  `1604`
		//  Estimated: `5069`
		// Minimum execution time: 92_243_000 picoseconds.
		Weight::from_parts(101_030_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(29_115_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_778_000, 3497)
			// Standard Error: 6_266
			.saturating_add(Weight::from_parts(4_865_761, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_193_000, 3485)
			// Standard Error: 25_958
			.saturating_add(Weight::from_parts(3_453_935, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
