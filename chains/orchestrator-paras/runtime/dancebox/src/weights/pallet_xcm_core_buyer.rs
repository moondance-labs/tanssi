...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(94_076_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(89_487_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(25_768_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_557_000, 3497)
			// Standard Error: 4_945
			.saturating_add(Weight::from_parts(4_633_671, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_902_000, 3485)
			// Standard Error: 3_238
			.saturating_add(Weight::from_parts(3_137_212, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
