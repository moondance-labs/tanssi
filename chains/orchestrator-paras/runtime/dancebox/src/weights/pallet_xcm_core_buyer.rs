...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(67_306_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		//  Measured:  `1604`
		//  Estimated: `5069`
		// Minimum execution time: 61_906_000 picoseconds.
		Weight::from_parts(62_998_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(20_308_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_518_000, 3497)
			// Standard Error: 2_841
			.saturating_add(Weight::from_parts(4_470_954, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_853_000, 3485)
			// Standard Error: 1_825
			.saturating_add(Weight::from_parts(3_074_748, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
