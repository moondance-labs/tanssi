...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		//  Measured:  `1604`
		//  Estimated: `5069`
		// Minimum execution time: 124_030_000 picoseconds.
		Weight::from_parts(125_418_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		//  Measured:  `1604`
		//  Estimated: `5069`
		// Minimum execution time: 119_478_000 picoseconds.
		Weight::from_parts(121_380_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(40_510_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(26_136_000, 3497)
			// Standard Error: 5_013
			.saturating_add(Weight::from_parts(7_298_599, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_996_000, 3485)
			// Standard Error: 2_724
			.saturating_add(Weight::from_parts(5_047_338, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
