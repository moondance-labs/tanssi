...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(120_349_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		//  Measured:  `1534`
		//  Estimated: `4999`
		// Minimum execution time: 112_869_000 picoseconds.
		Weight::from_parts(124_098_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(41_296_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(24_623_000, 3497)
			// Standard Error: 5_506
			.saturating_add(Weight::from_parts(6_780_632, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_525_000, 3485)
			// Standard Error: 2_609
			.saturating_add(Weight::from_parts(4_693_082, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
