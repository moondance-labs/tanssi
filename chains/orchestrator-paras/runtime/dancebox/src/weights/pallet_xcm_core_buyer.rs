...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(96_101_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(80_402_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(24_346_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_377_000, 3497)
			// Standard Error: 6_262
			.saturating_add(Weight::from_parts(4_655_136, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_132_000, 3485)
			// Standard Error: 2_835
			.saturating_add(Weight::from_parts(3_179_315, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
