...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(88_927_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(80_731_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(20_869_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_307_000, 3497)
			// Standard Error: 4_832
			.saturating_add(Weight::from_parts(4_474_011, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_621_000, 3485)
			// Standard Error: 3_519
			.saturating_add(Weight::from_parts(3_096_191, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
