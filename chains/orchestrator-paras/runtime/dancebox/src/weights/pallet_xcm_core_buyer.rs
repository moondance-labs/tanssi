...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(66_525_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(61_806_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(21_130_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_538_000, 3497)
			// Standard Error: 2_047
			.saturating_add(Weight::from_parts(4_661_789, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_922_000, 3485)
			// Standard Error: 2_073
			.saturating_add(Weight::from_parts(3_206_686, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
