...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		//  Measured:  `1534`
		//  Estimated: `4999`
		// Minimum execution time: 63_659_000 picoseconds.
		Weight::from_parts(64_521_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(59_321_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(20_549_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(13_836_000, 3497)
			// Standard Error: 2_761
			.saturating_add(Weight::from_parts(4_451_593, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_512_000, 3485)
			// Standard Error: 1_812
			.saturating_add(Weight::from_parts(3_052_110, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
