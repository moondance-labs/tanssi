...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(121_800_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(113_148_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(40_247_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(25_432_000, 3497)
			// Standard Error: 5_448
			.saturating_add(Weight::from_parts(7_435_957, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_402_000, 3485)
			// Standard Error: 2_387
			.saturating_add(Weight::from_parts(5_078_712, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
