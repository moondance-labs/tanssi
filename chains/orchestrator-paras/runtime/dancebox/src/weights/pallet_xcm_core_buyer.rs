...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(67_756_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(63_468_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(21_781_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_867_000, 3497)
			// Standard Error: 6_364
			.saturating_add(Weight::from_parts(4_866_288, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_203_000, 3485)
			// Standard Error: 1_697
			.saturating_add(Weight::from_parts(3_162_611, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
