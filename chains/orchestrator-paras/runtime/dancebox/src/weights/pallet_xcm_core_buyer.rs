...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(60_864_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(57_448_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(19_768_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(13_575_000, 3497)
			// Standard Error: 2_532
			.saturating_add(Weight::from_parts(4_252_397, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(10_921_000, 3485)
			// Standard Error: 2_504
			.saturating_add(Weight::from_parts(2_991_850, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
