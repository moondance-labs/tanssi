...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(67_596_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(64_131_000, 4999)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(15_028_000, 3497)
			// Standard Error: 5_670
			.saturating_add(Weight::from_parts(4_896_936, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_213_000, 3485)
			// Standard Error: 1_663
			.saturating_add(Weight::from_parts(3_151_916, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
