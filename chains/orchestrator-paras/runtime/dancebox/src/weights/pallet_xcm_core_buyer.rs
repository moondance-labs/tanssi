...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(91_942_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(89_028_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(26_660_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_587_000, 3497)
			// Standard Error: 4_162
			.saturating_add(Weight::from_parts(4_661_169, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_192_000, 3485)
			// Standard Error: 1_865
			.saturating_add(Weight::from_parts(3_160_929, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
