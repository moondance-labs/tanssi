...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(63_058_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(58_830_000, 4999)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(13_996_000, 3497)
			// Standard Error: 2_672
			.saturating_add(Weight::from_parts(4_418_575, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_511_000, 3485)
			// Standard Error: 1_708
			.saturating_add(Weight::from_parts(3_042_438, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
