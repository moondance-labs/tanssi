...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(95_729_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(82_404_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(26_379_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_527_000, 3497)
			// Standard Error: 6_845
			.saturating_add(Weight::from_parts(4_594_876, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_682_000, 3485)
			// Standard Error: 3_340
			.saturating_add(Weight::from_parts(3_128_187, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
