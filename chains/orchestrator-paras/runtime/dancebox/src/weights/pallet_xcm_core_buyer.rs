...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(92_484_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(73_157_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(25_288_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(15_159_000, 3497)
			// Standard Error: 4_551
			.saturating_add(Weight::from_parts(4_818_870, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_494_000, 3485)
			// Standard Error: 20_775
			.saturating_add(Weight::from_parts(3_420_335, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
