...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		//  Measured:  `1534`
		//  Estimated: `4999`
		// Minimum execution time: 120_443_000 picoseconds.
		Weight::from_parts(122_011_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(117_653_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(41_167_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(25_392_000, 3497)
			// Standard Error: 9_868
			.saturating_add(Weight::from_parts(7_391_490, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_290_000, 3485)
			// Standard Error: 2_523
			.saturating_add(Weight::from_parts(4_819_582, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
