...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(67_236_000, 5069)
	...
	fn force_buy_core() -> Weight {
		...
		//  Measured:  `1604`
		//  Estimated: `5069`
		// Minimum execution time: 62_367_000 picoseconds.
		Weight::from_parts(63_378_000, 5069)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(20_187_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(14_327_000, 3497)
			// Standard Error: 2_693
			.saturating_add(Weight::from_parts(4_404_636, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_672_000, 3485)
			// Standard Error: 1_867
			.saturating_add(Weight::from_parts(3_038_918, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
