...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(62_447_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(59_332_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(20_378_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(13_736_000, 3497)
			// Standard Error: 3_547
			.saturating_add(Weight::from_parts(4_435_092, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_632_000, 3485)
			// Standard Error: 1_722
			.saturating_add(Weight::from_parts(3_051_361, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
