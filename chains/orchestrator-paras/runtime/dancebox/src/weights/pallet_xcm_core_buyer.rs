...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		//  Measured:  `1534`
		//  Estimated: `4999`
		// Minimum execution time: 66_835_000 picoseconds.
		Weight::from_parts(67_897_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		Weight::from_parts(64_130_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(21_801_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(15_048_000, 3497)
			// Standard Error: 6_167
			.saturating_add(Weight::from_parts(4_947_379, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_413_000, 3485)
			// Standard Error: 1_792
			.saturating_add(Weight::from_parts(3_206_071, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
