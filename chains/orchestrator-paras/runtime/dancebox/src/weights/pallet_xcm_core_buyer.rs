...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		Weight::from_parts(117_036_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		//  Measured:  `1534`
		//  Estimated: `4999`
		// Minimum execution time: 111_396_000 picoseconds.
		Weight::from_parts(112_325_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(40_076_000, 3485)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(24_260_000, 3497)
			// Standard Error: 5_186
			.saturating_add(Weight::from_parts(6_692_174, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_408_000, 3485)
			// Standard Error: 2_670
			.saturating_add(Weight::from_parts(4_682_098, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
