...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(15_672_498, 3997)
			// Standard Error: 41
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(26_529_824, 6811)
			// Standard Error: 2_997
			.saturating_add(Weight::from_parts(76_545, 0).saturating_mul(s.into()))
			// Standard Error: 29
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(14_799_999, 6811)
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(44_012_416, 6811)
			// Standard Error: 19_781
			.saturating_add(Weight::from_parts(148_290, 0).saturating_mul(s.into()))
			// Standard Error: 193
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_650_535, 6811)
			// Standard Error: 413
			.saturating_add(Weight::from_parts(73_584, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(12_352_939, 6811)
			// Standard Error: 1_743
			.saturating_add(Weight::from_parts(73_168, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_674_850, 6811)
			// Standard Error: 689
			.saturating_add(Weight::from_parts(67_491, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_191_369, 6811)
			// Standard Error: 3_126
			.saturating_add(Weight::from_parts(93_035, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}