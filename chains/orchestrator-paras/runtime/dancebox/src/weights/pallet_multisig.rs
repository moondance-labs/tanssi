...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(15_190_798, 3997)
			// Standard Error: 35
			.saturating_add(Weight::from_parts(158, 0).saturating_mul(z.into()))
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(25_213_765, 6811)
			// Standard Error: 3_030
			.saturating_add(Weight::from_parts(66_847, 0).saturating_mul(s.into()))
			// Standard Error: 29
			.saturating_add(Weight::from_parts(953, 0).saturating_mul(z.into()))
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(13_215_449, 6811)
			// Standard Error: 1_104
			.saturating_add(Weight::from_parts(61_184, 0).saturating_mul(s.into()))
			// Standard Error: 10
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(24_289_979, 6811)
			// Standard Error: 20_278
			.saturating_add(Weight::from_parts(174_458, 0).saturating_mul(s.into()))
			// Standard Error: 198
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_528_351, 6811)
			// Standard Error: 385
			.saturating_add(Weight::from_parts(66_521, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(11_656_663, 6811)
			// Standard Error: 306
			.saturating_add(Weight::from_parts(62_675, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_461_308, 6811)
			// Standard Error: 533
			.saturating_add(Weight::from_parts(70_292, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(21_230_979, 6811)
			// Standard Error: 320
			.saturating_add(Weight::from_parts(63_787, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}