...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(18_984_103, 3997)
			// Standard Error: 42
			.saturating_add(Weight::from_parts(970, 0).saturating_mul(z.into()))
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(27_715_118, 6811)
			// Standard Error: 2_888
			.saturating_add(Weight::from_parts(58_122, 0).saturating_mul(s.into()))
			// Standard Error: 28
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(12_455_594, 6811)
			// Standard Error: 1_302
			.saturating_add(Weight::from_parts(62_852, 0).saturating_mul(s.into()))
			// Standard Error: 12
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(32_132_154, 6811)
			// Standard Error: 3_740
			.saturating_add(Weight::from_parts(92_484, 0).saturating_mul(s.into()))
			// Standard Error: 36
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_435_013, 6811)
			// Standard Error: 744
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(12_208_877, 6811)
			// Standard Error: 1_219
			.saturating_add(Weight::from_parts(60_543, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_480_524, 6811)
			// Standard Error: 687
			.saturating_add(Weight::from_parts(63_923, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(21_996_329, 6811)
			// Standard Error: 1_725
			.saturating_add(Weight::from_parts(70_087, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}