...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(19_104_679, 3997)
			// Standard Error: 31
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(25_320_237, 6811)
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(12_825_919, 6811)
			// Standard Error: 1_623
			.saturating_add(Weight::from_parts(62_504, 0).saturating_mul(s.into()))
			// Standard Error: 15
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(29_010_685, 6811)
			// Standard Error: 3_634
			.saturating_add(Weight::from_parts(112_089, 0).saturating_mul(s.into()))
			// Standard Error: 35
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_414_448, 6811)
			// Standard Error: 1_077
			.saturating_add(Weight::from_parts(73_023, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(11_842_305, 6811)
			// Standard Error: 1_364
			.saturating_add(Weight::from_parts(69_329, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_454_707, 6811)
			// Standard Error: 2_121
			.saturating_add(Weight::from_parts(75_271, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_556_096, 6811)
			// Standard Error: 671
			.saturating_add(Weight::from_parts(61_076, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}