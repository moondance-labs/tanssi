...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(45_749_119, 4209)
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_694_127, 4209)
			// Standard Error: 88
			.saturating_add(Weight::from_parts(473, 0).saturating_mul(x.into()))
			// Standard Error: 1_847
			.saturating_add(Weight::from_parts(47_382, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(45_627_880, 4209)
			// Standard Error: 184
			.saturating_add(Weight::from_parts(1_384, 0).saturating_mul(x.into()))
			// Standard Error: 3_837
			.saturating_add(Weight::from_parts(33_423, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(39_707_550, 4209)
			// Standard Error: 7_366
			.saturating_add(Weight::from_parts(44_513, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(36_238_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(18_996_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(13_806_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}