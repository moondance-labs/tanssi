...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `109`
		//  Estimated: `4209`
		// Minimum execution time: 64_124_000 picoseconds.
		Weight::from_parts(65_404_748, 4209)
			// Standard Error: 227
			.saturating_add(Weight::from_parts(505, 0).saturating_mul(x.into()))
			// Standard Error: 4_736
			.saturating_add(Weight::from_parts(67_393, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(16_679_493, 4209)
			// Standard Error: 99
			.saturating_add(Weight::from_parts(1_269, 0).saturating_mul(x.into()))
			// Standard Error: 2_081
			.saturating_add(Weight::from_parts(71_398, 0).saturating_mul(y.into()))
	...
	fn update_profile(_x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `4209`
		// Minimum execution time: 68_931_000 picoseconds.
		Weight::from_parts(70_339_802, 4209)
			// Standard Error: 4_511
			.saturating_add(Weight::from_parts(46_642, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(57_935_541, 4209)
			// Standard Error: 179
			.saturating_add(Weight::from_parts(1_386, 0).saturating_mul(x.into()))
			// Standard Error: 3_743
			.saturating_add(Weight::from_parts(64_248, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `4209`
		// Minimum execution time: 56_307_000 picoseconds.
		Weight::from_parts(57_098_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(56_664_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(31_371_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		//  Measured:  `430`
		//  Estimated: `4209`
		// Minimum execution time: 33_178_000 picoseconds.
		Weight::from_parts(33_737_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(23_330_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}