...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(40_200_277, 4209)
			// Standard Error: 4_219
			.saturating_add(Weight::from_parts(35_064, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(8_784_433, 4209)
			// Standard Error: 1_351
			.saturating_add(Weight::from_parts(41_853, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(48_275_597, 4209)
			// Standard Error: 5_237
			.saturating_add(Weight::from_parts(17_052, 0).saturating_mul(x.into()))
	...
	fn force_update_profile(_x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(55_957_210, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(33_994_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(33_683_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(17_073_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(18_695_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(12_744_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}