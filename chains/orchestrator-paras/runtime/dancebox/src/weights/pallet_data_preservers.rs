...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(46_442_154, 6029)
			// Standard Error: 317
			.saturating_add(Weight::from_parts(86, 0).saturating_mul(x.into()))
			// Standard Error: 6_614
			.saturating_add(Weight::from_parts(39_655, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_387_659, 6029)
			// Standard Error: 83
			.saturating_add(Weight::from_parts(2_141, 0).saturating_mul(x.into()))
			// Standard Error: 1_737
			.saturating_add(Weight::from_parts(58_105, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(38_352_000, 6029)
			// Standard Error: 4_953
			.saturating_add(Weight::from_parts(85_054, 0).saturating_mul(x.into()))
			// Standard Error: 99_589
			.saturating_add(Weight::from_parts(1_435_690, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(54_946_080, 6029)
			// Standard Error: 7_362
			.saturating_add(Weight::from_parts(32_925, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(75_872_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(73_969_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(47_018_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(42_680_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(30_507_000, 6029)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		//  Measured:  `2720`
		//  Estimated: `6029`
		// Minimum execution time: 114_796_000 picoseconds.
		Weight::from_parts(124_173_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}