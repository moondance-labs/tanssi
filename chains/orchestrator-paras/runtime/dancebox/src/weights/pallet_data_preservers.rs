...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(44_785_464, 4209)
			// Standard Error: 6_078
			.saturating_add(Weight::from_parts(45_037, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_753_982, 4209)
			// Standard Error: 78
			.saturating_add(Weight::from_parts(298, 0).saturating_mul(x.into()))
			// Standard Error: 1_629
			.saturating_add(Weight::from_parts(47_756, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(46_638_492, 4209)
			// Standard Error: 230
			.saturating_add(Weight::from_parts(587, 0).saturating_mul(x.into()))
			// Standard Error: 4_803
			.saturating_add(Weight::from_parts(63_127, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(37_884_756, 4209)
			// Standard Error: 253
			.saturating_add(Weight::from_parts(6_504, 0).saturating_mul(x.into()))
			// Standard Error: 5_291
			.saturating_add(Weight::from_parts(49_637, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(37_410_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(37_390_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(14_447_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}