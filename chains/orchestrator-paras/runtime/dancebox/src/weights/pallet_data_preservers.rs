...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(59_455_259, 4209)
			// Standard Error: 6_723
			.saturating_add(Weight::from_parts(25_661, 0).saturating_mul(x.into()))
	...
	fn force_create_profile(_x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(20_495_913, 4209)
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(43_328_785, 4209)
			// Standard Error: 232
			.saturating_add(Weight::from_parts(3_353, 0).saturating_mul(x.into()))
			// Standard Error: 4_855
			.saturating_add(Weight::from_parts(5_913, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(34_709_366, 4209)
			// Standard Error: 4_916
			.saturating_add(Weight::from_parts(130_419, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(34_544_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(33_904_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(17_613_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(19_597_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
