...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(44_505_531, 6029)
			// Standard Error: 278
			.saturating_add(Weight::from_parts(589, 0).saturating_mul(x.into()))
			// Standard Error: 5_804
			.saturating_add(Weight::from_parts(33_447, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_066_198, 6029)
			// Standard Error: 136
			.saturating_add(Weight::from_parts(1_719, 0).saturating_mul(x.into()))
			// Standard Error: 2_844
			.saturating_add(Weight::from_parts(58_643, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(39_196_979, 6029)
			// Standard Error: 1_323
			.saturating_add(Weight::from_parts(12_635, 0).saturating_mul(x.into()))
			// Standard Error: 27_583
			.saturating_add(Weight::from_parts(791_284, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(38_213_024, 6029)
			// Standard Error: 164
			.saturating_add(Weight::from_parts(3_229, 0).saturating_mul(x.into()))
			// Standard Error: 3_420
			.saturating_add(Weight::from_parts(45_985, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(37_090_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		//  Estimated: `6029`
		// Minimum execution time: 36_468_000 picoseconds.
		Weight::from_parts(36_959_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(19_216_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(14_246_000, 6029)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(51_707_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}