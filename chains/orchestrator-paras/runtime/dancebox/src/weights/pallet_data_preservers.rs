...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(65_742_842, 4209)
			// Standard Error: 347
			.saturating_add(Weight::from_parts(454, 0).saturating_mul(x.into()))
			// Standard Error: 7_244
			.saturating_add(Weight::from_parts(84_874, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(16_768_374, 4209)
			// Standard Error: 104
			.saturating_add(Weight::from_parts(1_033, 0).saturating_mul(x.into()))
			// Standard Error: 2_187
			.saturating_add(Weight::from_parts(80_033, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `4209`
		// Minimum execution time: 68_726_000 picoseconds.
		Weight::from_parts(70_012_411, 4209)
			// Standard Error: 210
			.saturating_add(Weight::from_parts(1_062, 0).saturating_mul(x.into()))
			// Standard Error: 4_392
			.saturating_add(Weight::from_parts(71_094, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `4209`
		// Minimum execution time: 56_508_000 picoseconds.
		Weight::from_parts(58_102_407, 4209)
			// Standard Error: 203
			.saturating_add(Weight::from_parts(1_166, 0).saturating_mul(x.into()))
			// Standard Error: 4_240
			.saturating_add(Weight::from_parts(73_181, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(57_348_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `4209`
		// Minimum execution time: 55_721_000 picoseconds.
		Weight::from_parts(56_837_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(32_542_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(35_301_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(24_209_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}