...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(41_269_400, 4209)
			// Standard Error: 233
			.saturating_add(Weight::from_parts(170, 0).saturating_mul(x.into()))
			// Standard Error: 4_875
			.saturating_add(Weight::from_parts(51_143, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_334_092, 4209)
			// Standard Error: 102
			.saturating_add(Weight::from_parts(976, 0).saturating_mul(x.into()))
			// Standard Error: 2_127
			.saturating_add(Weight::from_parts(45_594, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(43_591_966, 4209)
			// Standard Error: 183
			.saturating_add(Weight::from_parts(675, 0).saturating_mul(x.into()))
			// Standard Error: 3_817
			.saturating_add(Weight::from_parts(66_368, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(35_531_193, 4209)
			// Standard Error: 134
			.saturating_add(Weight::from_parts(1_365, 0).saturating_mul(x.into()))
			// Standard Error: 2_800
			.saturating_add(Weight::from_parts(54_379, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(34_705_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(18_655_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(20_298_000, 4209)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(13_705_000, 4209)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}