...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(44_857_776, 6029)
			// Standard Error: 4_905
			.saturating_add(Weight::from_parts(11_663, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_835_726, 6029)
			// Standard Error: 83
			.saturating_add(Weight::from_parts(2_399, 0).saturating_mul(x.into()))
			// Standard Error: 1_734
			.saturating_add(Weight::from_parts(51_445, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(38_899_892, 6029)
			// Standard Error: 1_278
			.saturating_add(Weight::from_parts(14_675, 0).saturating_mul(x.into()))
			// Standard Error: 26_651
			.saturating_add(Weight::from_parts(804_955, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `310 + x * (1 ±0)`
		//  Estimated: `6029`
		// Minimum execution time: 37_581_000 picoseconds.
		Weight::from_parts(38_440_562, 6029)
			// Standard Error: 221
			.saturating_add(Weight::from_parts(3_289, 0).saturating_mul(x.into()))
			// Standard Error: 4_617
			.saturating_add(Weight::from_parts(32_340, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(37_119_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(19_156_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(20_669_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(14_377_000, 6029)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		//  Measured:  `2720`
		//  Estimated: `6029`
		// Minimum execution time: 50_795_000 picoseconds.
		Weight::from_parts(51_757_000, 6029)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}