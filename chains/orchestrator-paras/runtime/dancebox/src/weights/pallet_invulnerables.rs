...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(23_978_563, 4687)
			// Standard Error: 1_373
			.saturating_add(Weight::from_parts(125_455, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_871_025, 4687)
			// Standard Error: 759
			.saturating_add(Weight::from_parts(82_021, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_451_245, 4687)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(28_322_150, 4687)
			// Standard Error: 1_127
			.saturating_add(Weight::from_parts(97_251, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}