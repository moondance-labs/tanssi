...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_629_526, 4687)
			// Standard Error: 2_525
			.saturating_add(Weight::from_parts(59_061, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(6_947_577, 4687)
			// Standard Error: 5_012
			.saturating_add(Weight::from_parts(58_731, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(6_462_660, 4687)
			// Standard Error: 590
			.saturating_add(Weight::from_parts(45_427, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Invulnerables::Invulnerables` (r:1 w:0)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_379_577, 4687)
			// Standard Error: 538
			.saturating_add(Weight::from_parts(47_413, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}