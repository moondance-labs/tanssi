...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_681_296, 4687)
			// Standard Error: 3_301
			.saturating_add(Weight::from_parts(74_209, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(7_861_967, 4687)
			// Standard Error: 389
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(7_641_607, 4687)
			// Standard Error: 1_476
			.saturating_add(Weight::from_parts(40_547, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Invulnerables::Invulnerables` (r:1 w:0)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_798_023, 4687)
			// Standard Error: 3_635
			.saturating_add(Weight::from_parts(45_888, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}