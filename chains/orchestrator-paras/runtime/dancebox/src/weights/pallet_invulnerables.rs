...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_937_560, 4687)
			// Standard Error: 795
			.saturating_add(Weight::from_parts(74_800, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(7_297_490, 4687)
			// Standard Error: 3_303
			.saturating_add(Weight::from_parts(58_601, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(11_084_788, 4687)
			// Standard Error: 11_737
			.saturating_add(Weight::from_parts(109_935, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Invulnerables::Invulnerables` (r:1 w:0)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_539_560, 4687)
			// Standard Error: 3_461
			.saturating_add(Weight::from_parts(63_361, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}