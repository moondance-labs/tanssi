...
// --output=tmp/dancebox_weights/pallet_foreign_asset_creator.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_foreign_asset_creator::WeightInfo for SubstrateWeight<T> {
	...
	fn change_existing_asset_type() -> Weight {
		...
		Weight::from_parts(12_183_000, 3654)
	...
	fn remove_existing_asset_type() -> Weight {
		...
		Weight::from_parts(10_770_000, 3654)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn destroy_foreign_asset() -> Weight {
		...
		Weight::from_parts(16_361_000, 3894)
