...
// --output=tmp/dancebox_weights/pallet_session.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_session::WeightInfo for SubstrateWeight<T> {
	...
	fn set_keys() -> Weight {
		...
		//  Measured:  `397`
		//  Estimated: `3862`
		// Minimum execution time: 23_629_000 picoseconds.
		Weight::from_parts(24_546_000, 3862)
	...
	fn purge_keys() -> Weight {
		...
		Weight::from_parts(17_396_000, 3811)
