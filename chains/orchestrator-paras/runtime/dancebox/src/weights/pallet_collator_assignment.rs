...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 151_791_000 picoseconds.
		Weight::from_parts(34_798_218, 4687)
			// Standard Error: 14_585
			.saturating_add(Weight::from_parts(440_498, 0).saturating_mul(x.into()))
			// Standard Error: 148_507
			.saturating_add(Weight::from_parts(31_486_157, 0).saturating_mul(y.into()))
