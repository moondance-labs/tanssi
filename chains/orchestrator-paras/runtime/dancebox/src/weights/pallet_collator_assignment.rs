...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 97_593_000 picoseconds.
		Weight::from_parts(20_365_840, 4687)
			// Standard Error: 9_368
			.saturating_add(Weight::from_parts(280_780, 0).saturating_mul(x.into()))
			// Standard Error: 95_390
			.saturating_add(Weight::from_parts(20_269_566, 0).saturating_mul(y.into()))
