...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(16_132_418, 4687)
			// Standard Error: 10_103
			.saturating_add(Weight::from_parts(274_641, 0).saturating_mul(x.into()))
			// Standard Error: 102_878
			.saturating_add(Weight::from_parts(21_195_170, 0).saturating_mul(y.into()))
