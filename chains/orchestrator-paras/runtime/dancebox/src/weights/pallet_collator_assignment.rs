...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 100_868_000 picoseconds.
		Weight::from_parts(23_170_449, 4687)
			// Standard Error: 9_916
			.saturating_add(Weight::from_parts(288_416, 0).saturating_mul(x.into()))
			// Standard Error: 100_972
			.saturating_add(Weight::from_parts(20_610_209, 0).saturating_mul(y.into()))
