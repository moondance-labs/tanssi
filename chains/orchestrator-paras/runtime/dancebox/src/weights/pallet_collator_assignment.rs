...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(104_164_000, 4687)
			// Standard Error: 21_386
			.saturating_add(Weight::from_parts(45_145, 0).saturating_mul(x.into()))
			// Standard Error: 214_352
			.saturating_add(Weight::from_parts(20_284_232, 0).saturating_mul(y.into()))
