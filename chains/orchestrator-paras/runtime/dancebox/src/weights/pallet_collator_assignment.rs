...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(13_962_732, 4687)
			// Standard Error: 9_666
			.saturating_add(Weight::from_parts(245_110, 0).saturating_mul(x.into()))
			// Standard Error: 98_419
			.saturating_add(Weight::from_parts(20_696_255, 0).saturating_mul(y.into()))
