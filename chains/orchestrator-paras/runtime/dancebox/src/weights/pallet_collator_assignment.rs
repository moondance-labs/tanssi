...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 112_872_000 picoseconds.
		Weight::from_parts(65_789_505, 4687)
			// Standard Error: 32_772
			.saturating_add(Weight::from_parts(315_900, 0).saturating_mul(x.into()))
			// Standard Error: 333_688
			.saturating_add(Weight::from_parts(17_427_290, 0).saturating_mul(y.into()))
