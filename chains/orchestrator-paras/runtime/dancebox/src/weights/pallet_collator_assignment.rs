...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(18_703_253, 4687)
			// Standard Error: 9_374
			.saturating_add(Weight::from_parts(241_979, 0).saturating_mul(x.into()))
			// Standard Error: 95_447
			.saturating_add(Weight::from_parts(20_074_181, 0).saturating_mul(y.into()))
