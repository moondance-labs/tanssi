...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 159_862_000 picoseconds.
		Weight::from_parts(37_127_309, 4687)
			// Standard Error: 16_293
			.saturating_add(Weight::from_parts(442_775, 0).saturating_mul(x.into()))
			// Standard Error: 165_896
			.saturating_add(Weight::from_parts(34_562_300, 0).saturating_mul(y.into()))
