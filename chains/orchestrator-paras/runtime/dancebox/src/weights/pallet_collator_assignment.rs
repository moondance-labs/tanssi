...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(22_504_006, 4687)
			// Standard Error: 9_130
			.saturating_add(Weight::from_parts(281_920, 0).saturating_mul(x.into()))
			// Standard Error: 92_969
			.saturating_add(Weight::from_parts(20_042_245, 0).saturating_mul(y.into()))
