...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(_x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 86_933_000 picoseconds.
		Weight::from_parts(139_713_132, 4687)
			// Standard Error: 694_182
			.saturating_add(Weight::from_parts(20_302_468, 0).saturating_mul(y.into()))
