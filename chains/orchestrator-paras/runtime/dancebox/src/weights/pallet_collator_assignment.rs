...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 95_379_000 picoseconds.
		Weight::from_parts(96_641_000, 4687)
			// Standard Error: 24_172
			.saturating_add(Weight::from_parts(201_301, 0).saturating_mul(x.into()))
			// Standard Error: 242_281
			.saturating_add(Weight::from_parts(19_100_762, 0).saturating_mul(y.into()))
