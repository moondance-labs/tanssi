...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 145_889_000 picoseconds.
		Weight::from_parts(26_257_182, 4687)
			// Standard Error: 15_015
			.saturating_add(Weight::from_parts(439_586, 0).saturating_mul(x.into()))
			// Standard Error: 152_886
			.saturating_add(Weight::from_parts(31_922_175, 0).saturating_mul(y.into()))
