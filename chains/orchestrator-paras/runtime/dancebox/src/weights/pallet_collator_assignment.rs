...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(36_723_142, 4687)
			// Standard Error: 14_540
			.saturating_add(Weight::from_parts(435_229, 0).saturating_mul(x.into()))
			// Standard Error: 148_054
			.saturating_add(Weight::from_parts(31_436_596, 0).saturating_mul(y.into()))
