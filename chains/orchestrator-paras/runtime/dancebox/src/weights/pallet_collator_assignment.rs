...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(_x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 88_607_000 picoseconds.
		Weight::from_parts(51_392_290, 4687)
			// Standard Error: 729_433
			.saturating_add(Weight::from_parts(26_665_829, 0).saturating_mul(y.into()))
