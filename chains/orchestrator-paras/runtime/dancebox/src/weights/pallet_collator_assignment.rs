...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(21_443_524, 4687)
			// Standard Error: 9_281
			.saturating_add(Weight::from_parts(292_983, 0).saturating_mul(x.into()))
			// Standard Error: 94_502
			.saturating_add(Weight::from_parts(20_356_937, 0).saturating_mul(y.into()))
