...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 105_318_000 picoseconds.
		Weight::from_parts(24_513_088, 4687)
			// Standard Error: 10_208
			.saturating_add(Weight::from_parts(303_760, 0).saturating_mul(x.into()))
			// Standard Error: 103_937
			.saturating_add(Weight::from_parts(21_539_858, 0).saturating_mul(y.into()))
