...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(25_405_818, 4687)
			// Standard Error: 9_570
			.saturating_add(Weight::from_parts(261_870, 0).saturating_mul(x.into()))
			// Standard Error: 97_441
			.saturating_add(Weight::from_parts(20_506_376, 0).saturating_mul(y.into()))
