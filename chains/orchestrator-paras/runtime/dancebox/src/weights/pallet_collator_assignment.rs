...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 94_137_000 picoseconds.
		Weight::from_parts(95_930_000, 4687)
			// Standard Error: 25_544
			.saturating_add(Weight::from_parts(1_947, 0).saturating_mul(x.into()))
			// Standard Error: 256_035
			.saturating_add(Weight::from_parts(21_436_962, 0).saturating_mul(y.into()))
