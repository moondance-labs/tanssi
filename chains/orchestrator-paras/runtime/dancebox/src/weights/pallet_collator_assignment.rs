...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(28_722_133, 4687)
			// Standard Error: 50_455
			.saturating_add(Weight::from_parts(159_729, 0).saturating_mul(x.into()))
			// Standard Error: 513_740
			.saturating_add(Weight::from_parts(22_808_254, 0).saturating_mul(y.into()))
