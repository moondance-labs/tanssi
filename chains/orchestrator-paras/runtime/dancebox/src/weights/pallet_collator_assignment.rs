...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(19_928_932, 4687)
			// Standard Error: 9_627
			.saturating_add(Weight::from_parts(263_039, 0).saturating_mul(x.into()))
			// Standard Error: 98_025
			.saturating_add(Weight::from_parts(20_850_497, 0).saturating_mul(y.into()))
