...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(93_936_000, 4687)
			// Standard Error: 27_020
			.saturating_add(Weight::from_parts(268_303, 0).saturating_mul(x.into()))
			// Standard Error: 270_828
			.saturating_add(Weight::from_parts(18_801_209, 0).saturating_mul(y.into()))
