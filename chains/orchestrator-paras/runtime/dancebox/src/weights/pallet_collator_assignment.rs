...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(_x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 87_615_000 picoseconds.
		Weight::from_parts(162_745_470, 4687)
			// Standard Error: 741_369
			.saturating_add(Weight::from_parts(23_379_625, 0).saturating_mul(y.into()))
