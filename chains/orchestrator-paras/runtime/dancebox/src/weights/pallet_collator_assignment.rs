...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(15_707_612, 4687)
			// Standard Error: 9_309
			.saturating_add(Weight::from_parts(253_861, 0).saturating_mul(x.into()))
			// Standard Error: 94_786
			.saturating_add(Weight::from_parts(20_220_773, 0).saturating_mul(y.into()))
