...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(19_523_122, 4687)
			// Standard Error: 9_136
			.saturating_add(Weight::from_parts(221_305, 0).saturating_mul(x.into()))
			// Standard Error: 93_029
			.saturating_add(Weight::from_parts(19_267_958, 0).saturating_mul(y.into()))
