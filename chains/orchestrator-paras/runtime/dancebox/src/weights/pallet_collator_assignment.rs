...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(19_405_166, 4687)
			// Standard Error: 9_449
			.saturating_add(Weight::from_parts(234_345, 0).saturating_mul(x.into()))
			// Standard Error: 96_214
			.saturating_add(Weight::from_parts(20_152_913, 0).saturating_mul(y.into()))
