...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(17_400_035, 4687)
			// Standard Error: 8_802
			.saturating_add(Weight::from_parts(238_093, 0).saturating_mul(x.into()))
			// Standard Error: 89_629
			.saturating_add(Weight::from_parts(19_047_643, 0).saturating_mul(y.into()))
