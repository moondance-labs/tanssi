...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(28_556_193, 4687)
			// Standard Error: 36_946
			.saturating_add(Weight::from_parts(383_296, 0).saturating_mul(x.into()))
			// Standard Error: 376_190
			.saturating_add(Weight::from_parts(20_316_654, 0).saturating_mul(y.into()))
