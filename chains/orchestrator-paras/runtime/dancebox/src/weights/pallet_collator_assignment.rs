...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(89_818_000, 4687)
			// Standard Error: 22_857
			.saturating_add(Weight::from_parts(55_204, 0).saturating_mul(x.into()))
			// Standard Error: 229_102
			.saturating_add(Weight::from_parts(19_587_314, 0).saturating_mul(y.into()))
