...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(20_621_698, 4687)
			// Standard Error: 9_322
			.saturating_add(Weight::from_parts(246_447, 0).saturating_mul(x.into()))
			// Standard Error: 94_922
			.saturating_add(Weight::from_parts(20_496_164, 0).saturating_mul(y.into()))
