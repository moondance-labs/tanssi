...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(14_267_387, 4687)
			// Standard Error: 41_636
			.saturating_add(Weight::from_parts(477_932, 0).saturating_mul(x.into()))
			// Standard Error: 423_938
			.saturating_add(Weight::from_parts(21_103_970, 0).saturating_mul(y.into()))
