...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(12_985_194, 4687)
			// Standard Error: 9_651
			.saturating_add(Weight::from_parts(252_396, 0).saturating_mul(x.into()))
			// Standard Error: 98_272
			.saturating_add(Weight::from_parts(20_588_665, 0).saturating_mul(y.into()))
