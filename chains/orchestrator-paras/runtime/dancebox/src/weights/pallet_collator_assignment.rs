...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(88_215_000, 4687)
			// Standard Error: 16_988
			.saturating_add(Weight::from_parts(127_902, 0).saturating_mul(x.into()))
			// Standard Error: 170_275
			.saturating_add(Weight::from_parts(18_389_721, 0).saturating_mul(y.into()))
