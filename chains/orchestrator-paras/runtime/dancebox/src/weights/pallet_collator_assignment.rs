...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 82_324_000 picoseconds.
		Weight::from_parts(17_652_306, 4687)
			// Standard Error: 30_210
			.saturating_add(Weight::from_parts(395_830, 0).saturating_mul(x.into()))
			// Standard Error: 307_603
			.saturating_add(Weight::from_parts(20_045_660, 0).saturating_mul(y.into()))
