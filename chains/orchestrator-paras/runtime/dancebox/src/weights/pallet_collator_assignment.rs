...
// --output=tmp/dancebox_weights/pallet_collator_assignment.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(110_497_000, 4687)
			// Standard Error: 31_443
			.saturating_add(Weight::from_parts(283_452, 0).saturating_mul(x.into()))
			// Standard Error: 315_159
			.saturating_add(Weight::from_parts(17_805_593, 0).saturating_mul(y.into()))
