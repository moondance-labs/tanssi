...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(24_241_360, 4687)
			// Standard Error: 9_923
			.saturating_add(Weight::from_parts(241_917, 0).saturating_mul(x.into()))
			// Standard Error: 101_043
			.saturating_add(Weight::from_parts(21_226_651, 0).saturating_mul(y.into()))
