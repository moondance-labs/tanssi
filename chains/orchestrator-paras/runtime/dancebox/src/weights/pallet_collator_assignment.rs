...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 144_520_000 picoseconds.
		Weight::from_parts(26_681_860, 4687)
			// Standard Error: 15_054
			.saturating_add(Weight::from_parts(444_911, 0).saturating_mul(x.into()))
			// Standard Error: 153_279
			.saturating_add(Weight::from_parts(31_358_308, 0).saturating_mul(y.into()))
