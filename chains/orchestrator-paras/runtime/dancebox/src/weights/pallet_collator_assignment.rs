...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 147_476_000 picoseconds.
		Weight::from_parts(29_414_268, 4687)
			// Standard Error: 14_798
			.saturating_add(Weight::from_parts(442_761, 0).saturating_mul(x.into()))
			// Standard Error: 150_679
			.saturating_add(Weight::from_parts(31_589_084, 0).saturating_mul(y.into()))
