...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(18_597_678, 4687)
			// Standard Error: 9_066
			.saturating_add(Weight::from_parts(236_271, 0).saturating_mul(x.into()))
			// Standard Error: 92_315
			.saturating_add(Weight::from_parts(19_435_873, 0).saturating_mul(y.into()))
