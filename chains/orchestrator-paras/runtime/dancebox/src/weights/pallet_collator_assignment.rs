...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(29_767_410, 4687)
			// Standard Error: 9_279
			.saturating_add(Weight::from_parts(178_802, 0).saturating_mul(x.into()))
			// Standard Error: 94_481
			.saturating_add(Weight::from_parts(19_734_808, 0).saturating_mul(y.into()))
