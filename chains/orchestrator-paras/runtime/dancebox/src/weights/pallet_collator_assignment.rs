...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 152_061_000 picoseconds.
		Weight::from_parts(32_888_282, 4687)
			// Standard Error: 14_293
			.saturating_add(Weight::from_parts(448_590, 0).saturating_mul(x.into()))
			// Standard Error: 145_540
			.saturating_add(Weight::from_parts(31_053_729, 0).saturating_mul(y.into()))
