...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(17_934_781, 3997)
			// Standard Error: 96
	...
	fn as_multi_create(_s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(42_990_372, 6811)
			// Standard Error: 129
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(14_027_930, 6811)
			// Standard Error: 9_655
			.saturating_add(Weight::from_parts(90_854, 0).saturating_mul(s.into()))
			// Standard Error: 94
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(29_597_588, 6811)
			// Standard Error: 10_474
			.saturating_add(Weight::from_parts(129_550, 0).saturating_mul(s.into()))
			// Standard Error: 102
			.saturating_add(Weight::from_parts(1_091, 0).saturating_mul(z.into()))
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_449_982, 6811)
			// Standard Error: 411
			.saturating_add(Weight::from_parts(69_382, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(11_542_472, 6811)
			// Standard Error: 275
			.saturating_add(Weight::from_parts(61_729, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_642_286, 6811)
			// Standard Error: 688
			.saturating_add(Weight::from_parts(67_138, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(21_175_414, 6811)
			// Standard Error: 414
			.saturating_add(Weight::from_parts(66_633, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}