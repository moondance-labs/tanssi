...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(15_032_661, 3997)
			// Standard Error: 2
			.saturating_add(Weight::from_parts(219, 0).saturating_mul(z.into()))
	...
	fn as_multi_create(_s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(29_912_318, 6811)
			// Standard Error: 132
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(10_372_233, 6811)
			// Standard Error: 9_456
			.saturating_add(Weight::from_parts(91_077, 0).saturating_mul(s.into()))
			// Standard Error: 92
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(19_561_273, 6811)
			// Standard Error: 13_089
			.saturating_add(Weight::from_parts(175_699, 0).saturating_mul(s.into()))
			// Standard Error: 128
			.saturating_add(Weight::from_parts(2_238, 0).saturating_mul(z.into()))
	...
	fn approve_as_multi_create(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_085_483, 6811)
			// Standard Error: 877
			.saturating_add(Weight::from_parts(83_393, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, ) -> Weight {
		...
		Weight::from_parts(12_074_075, 6811)
			// Standard Error: 395
			.saturating_add(Weight::from_parts(64_454, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, ) -> Weight {
		...
		Weight::from_parts(23_515_134, 6811)
			// Standard Error: 389
			.saturating_add(Weight::from_parts(70_067, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn poke_deposit(s: u32, ) -> Weight {
		...
		Weight::from_parts(21_954_924, 6811)
			// Standard Error: 384
			.saturating_add(Weight::from_parts(71_226, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}