...
impl<T: frame_system::Config> pallet_multisig::WeightInfo for SubstrateWeight<T> {
	...
	fn as_multi_threshold_1(z: u32, ) -> Weight {
		...
		Weight::from_parts(16_706_859, 3997)
			// Standard Error: 1
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(23_936_332, 6811)
			// Standard Error: 15_736
			.saturating_add(Weight::from_parts(174_854, 0).saturating_mul(s.into()))
			// Standard Error: 154
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(9_160_128, 6811)
			// Standard Error: 7_582
			.saturating_add(Weight::from_parts(128_300, 0).saturating_mul(s.into()))
			// Standard Error: 74
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(43_666_748, 6811)
			// Standard Error: 171
	...
	fn approve_as_multi_create(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(23_715_981, 6811)
			// Standard Error: 7_304
			.saturating_add(Weight::from_parts(106_735, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn approve_as_multi_approve(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(16_194_178, 6811)
			// Standard Error: 5_651
			.saturating_add(Weight::from_parts(85_970, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Multisig::Multisigs` (r:1 w:1)
	...
	fn cancel_as_multi(s: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(28_840_635, 6811)
			// Standard Error: 8_944
			.saturating_add(Weight::from_parts(108_066, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}