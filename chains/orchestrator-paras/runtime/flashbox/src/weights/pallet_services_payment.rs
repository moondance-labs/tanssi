...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		//  Measured:  `155`
		//  Estimated: `6196`
		// Minimum execution time: 58_909_000 picoseconds.
		Weight::from_parts(59_438_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(18_325_000, 3517)
	...
	fn set_max_core_price() -> Weight {
		...
		Weight::from_parts(17_836_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(12_622_339, 990)
			// Standard Error: 11_727
			.saturating_add(Weight::from_parts(20_803_873, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(51_344_000, 3593)
