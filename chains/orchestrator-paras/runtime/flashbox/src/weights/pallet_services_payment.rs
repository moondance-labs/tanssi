...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(36_408_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_219_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(7_570_739, 990)
			// Standard Error: 8_565
			.saturating_add(Weight::from_parts(13_586_992, 0).saturating_mul(n.into()))
