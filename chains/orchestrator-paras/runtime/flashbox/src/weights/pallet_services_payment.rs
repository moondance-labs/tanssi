...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(39_003_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_028_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_137_288, 990)
			// Standard Error: 5_905
			.saturating_add(Weight::from_parts(14_100_928, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(31_750_000, 3593)
