...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(35_897_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(9_127_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(51_002_055, 990)
			// Standard Error: 78_918
			.saturating_add(Weight::from_parts(11_851_808, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(29_345_000, 3593)
