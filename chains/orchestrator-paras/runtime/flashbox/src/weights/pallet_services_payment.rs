...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(35_346_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(9_347_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(2_841_725, 990)
			// Standard Error: 6_134
			.saturating_add(Weight::from_parts(13_037_200, 0).saturating_mul(n.into()))
