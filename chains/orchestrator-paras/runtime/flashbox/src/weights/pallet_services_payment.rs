...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(37_580_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(9_758_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(37_530_768, 990)
			// Standard Error: 517_149
			.saturating_add(Weight::from_parts(16_575_214, 0).saturating_mul(n.into()))
