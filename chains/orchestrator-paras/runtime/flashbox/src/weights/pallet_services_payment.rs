...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(40_025_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_389_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(9_066_449, 990)
			// Standard Error: 16_232
			.saturating_add(Weight::from_parts(14_508_367, 0).saturating_mul(n.into()))
