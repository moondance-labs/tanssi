...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(38_623_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(10_099_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(14_967_848, 990)
			// Standard Error: 315_908
			.saturating_add(Weight::from_parts(15_768_678, 0).saturating_mul(n.into()))
	...
	fn on_collators_assigned() -> Weight {
		...
		Weight::from_parts(32_811_000, 3593)
