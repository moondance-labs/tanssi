...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(39_515_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(9_988_000, 3517)
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_809_751, 990)
			// Standard Error: 12_291
			.saturating_add(Weight::from_parts(14_499_884, 0).saturating_mul(n.into()))
