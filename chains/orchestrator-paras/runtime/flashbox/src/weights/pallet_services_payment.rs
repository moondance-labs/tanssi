...
// --output=tmp/flashbox_weights/pallet_services_payment.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_services_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn purchase_credits() -> Weight {
		...
		Weight::from_parts(40_435_000, 6196)
	...
	fn set_refund_address() -> Weight {
		...
		Weight::from_parts(9_788_000, 3517)
	...
	fn set_max_core_price() -> Weight {
		...
		Weight::from_parts(9_598_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn on_container_authors_noted(n: u32, ) -> Weight {
		...
		Weight::from_parts(6_973_807, 990)
			// Standard Error: 21_872
			.saturating_add(Weight::from_parts(14_097_549, 0).saturating_mul(n.into()))
