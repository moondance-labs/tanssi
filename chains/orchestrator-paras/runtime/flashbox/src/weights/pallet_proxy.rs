...
impl<T: frame_system::Config> pallet_proxy::WeightInfo for SubstrateWeight<T> {
	...
	fn proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(13_316_803, 4706)
			// Standard Error: 1_048
			.saturating_add(Weight::from_parts(38_810, 0).saturating_mul(p.into()))
	...
	fn proxy_announced(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(31_782_302, 5698)
			// Standard Error: 2_337
			.saturating_add(Weight::from_parts(123_848, 0).saturating_mul(a.into()))
			// Standard Error: 2_415
			.saturating_add(Weight::from_parts(11_308, 0).saturating_mul(p.into()))
	...
	fn remove_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(18_106_180, 5698)
			// Standard Error: 1_169
			.saturating_add(Weight::from_parts(123_800, 0).saturating_mul(a.into()))
			// Standard Error: 1_207
			.saturating_add(Weight::from_parts(2_936, 0).saturating_mul(p.into()))
	...
	fn reject_announcement(a: u32, p: u32, ) -> Weight {
		...
		Weight::from_parts(13_644_917, 5698)
			// Standard Error: 11_761
			.saturating_add(Weight::from_parts(234_437, 0).saturating_mul(a.into()))
			// Standard Error: 12_151
			.saturating_add(Weight::from_parts(110_123, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:0)
	...
	fn announce(_a: u32, _p: u32, ) -> Weight {
		...
		Weight::from_parts(29_561_415, 5698)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn add_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(20_180_342, 4706)
			// Standard Error: 34_808
			.saturating_add(Weight::from_parts(227_694, 0).saturating_mul(p.into()))
	...
	fn remove_proxy(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_387_582, 4706)
			// Standard Error: 27_158
			.saturating_add(Weight::from_parts(150_479, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn remove_proxies(_p: u32, ) -> Weight {
		...
		Weight::from_parts(26_941_446, 4706)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn create_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(18_415_466, 4706)
			// Standard Error: 1_347
			.saturating_add(Weight::from_parts(24_113, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn kill_pure(p: u32, ) -> Weight {
		...
		Weight::from_parts(16_300_538, 4706)
			// Standard Error: 1_520
			.saturating_add(Weight::from_parts(46_109, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Proxy::Proxies` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(32_822_000, 5698)
			.saturating_add(T::DbWeight::get().reads(3_u64))
