...
impl<T: frame_system::Config> pallet_stream_payment::WeightInfo for SubstrateWeight<T> {
	...
	fn open_stream() -> Weight {
		...
		Weight::from_parts(96_860_000, 3593)
	...
	fn close_stream() -> Weight {
		...
		//  Measured:  `615`
		//  Estimated: `6196`
		// Minimum execution time: 147_688_000 picoseconds.
		Weight::from_parts(152_092_000, 6196)
	...
	fn perform_payment() -> Weight {
		...
		//  Measured:  `615`
		//  Estimated: `6196`
		// Minimum execution time: 86_384_000 picoseconds.
		Weight::from_parts(88_368_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn request_change_immediate() -> Weight {
		...
		Weight::from_parts(126_179_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn request_change_delayed() -> Weight {
		...
		Weight::from_parts(15_085_000, 3728)
	...
	fn accept_requested_change() -> Weight {
		...
		//  Measured:  `653`
		//  Estimated: `6196`
		// Minimum execution time: 115_896_000 picoseconds.
		Weight::from_parts(118_495_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn cancel_change_request() -> Weight {
		...
		Weight::from_parts(11_505_000, 3766)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `StreamPayment::Streams` (r:1 w:1)
	...
	fn immediately_change_deposit() -> Weight {
		...
		//  Measured:  `615`
		//  Estimated: `6196`
		// Minimum execution time: 116_137_000 picoseconds.
		Weight::from_parts(119_246_000, 6196)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
}