...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(65_414_676, 4609)
			// Standard Error: 240
			.saturating_add(Weight::from_parts(627, 0).saturating_mul(x.into()))
			// Standard Error: 5_005
			.saturating_add(Weight::from_parts(74_414, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(16_962_346, 4609)
			// Standard Error: 88
			.saturating_add(Weight::from_parts(1_244, 0).saturating_mul(x.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `4609`
		// Minimum execution time: 68_273_000 picoseconds.
		Weight::from_parts(70_040_583, 4609)
			// Standard Error: 207
			.saturating_add(Weight::from_parts(348, 0).saturating_mul(x.into()))
			// Standard Error: 4_316
			.saturating_add(Weight::from_parts(57_579, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(57_391_630, 4609)
			// Standard Error: 213
			.saturating_add(Weight::from_parts(2_080, 0).saturating_mul(x.into()))
			// Standard Error: 4_452
			.saturating_add(Weight::from_parts(90_601, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(56_530_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(55_902_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(31_547_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(34_227_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(23_615_000, 4609)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(76_560_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}