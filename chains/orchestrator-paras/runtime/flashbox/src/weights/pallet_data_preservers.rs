...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(42_840_753, 4609)
			// Standard Error: 234
			.saturating_add(Weight::from_parts(829, 0).saturating_mul(x.into()))
			// Standard Error: 4_894
			.saturating_add(Weight::from_parts(53_108, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_185_562, 4609)
			// Standard Error: 74
			.saturating_add(Weight::from_parts(470, 0).saturating_mul(x.into()))
			// Standard Error: 1_557
			.saturating_add(Weight::from_parts(48_263, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(45_823_628, 4609)
			// Standard Error: 215
			.saturating_add(Weight::from_parts(3_730, 0).saturating_mul(x.into()))
			// Standard Error: 4_489
			.saturating_add(Weight::from_parts(80_624, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(38_324_022, 4609)
			// Standard Error: 267
			.saturating_add(Weight::from_parts(882, 0).saturating_mul(x.into()))
			// Standard Error: 5_568
			.saturating_add(Weight::from_parts(48_104, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(37_230_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(37_711_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(20_569_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(13_806_000, 4609)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}