...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(41_378_901, 4609)
			// Standard Error: 4_481
			.saturating_add(Weight::from_parts(55_291, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_063_053, 4609)
			// Standard Error: 76
			.saturating_add(Weight::from_parts(972, 0).saturating_mul(x.into()))
			// Standard Error: 1_596
			.saturating_add(Weight::from_parts(55_047, 0).saturating_mul(y.into()))
	...
	fn update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(44_500_765, 4609)
			// Standard Error: 3_514
			.saturating_add(Weight::from_parts(33_001, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(35_964_736, 4609)
			// Standard Error: 129
			.saturating_add(Weight::from_parts(706, 0).saturating_mul(x.into()))
			// Standard Error: 2_707
			.saturating_add(Weight::from_parts(53_296, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `4609`
		// Minimum execution time: 34_796_000 picoseconds.
		Weight::from_parts(35_366_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(35_196_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(17_974_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(19_667_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(13_315_000, 4609)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}