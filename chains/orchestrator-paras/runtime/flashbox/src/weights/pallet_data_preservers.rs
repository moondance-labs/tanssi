...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(41_546_049, 6429)
			// Standard Error: 3_471
			.saturating_add(Weight::from_parts(55_188, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_196_173, 6429)
			// Standard Error: 83
			.saturating_add(Weight::from_parts(2_164, 0).saturating_mul(x.into()))
			// Standard Error: 1_733
			.saturating_add(Weight::from_parts(48_881, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(37_203_763, 6429)
			// Standard Error: 1_224
			.saturating_add(Weight::from_parts(11_516, 0).saturating_mul(x.into()))
			// Standard Error: 25_523
			.saturating_add(Weight::from_parts(740_578, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(36_518_470, 6429)
			// Standard Error: 183
			.saturating_add(Weight::from_parts(1_131, 0).saturating_mul(x.into()))
			// Standard Error: 3_821
			.saturating_add(Weight::from_parts(40_196, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(35_316_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(35_155_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(17_482_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(19_246_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(13_115_000, 6429)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		//  Measured:  `3120`
		//  Estimated: `6429`
		// Minimum execution time: 50_734_000 picoseconds.
		Weight::from_parts(51_877_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}