...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(41_933_945, 6429)
			// Standard Error: 166
			.saturating_add(Weight::from_parts(1_076, 0).saturating_mul(x.into()))
			// Standard Error: 3_473
			.saturating_add(Weight::from_parts(51_686, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_479_808, 6429)
			// Standard Error: 87
			.saturating_add(Weight::from_parts(2_139, 0).saturating_mul(x.into()))
			// Standard Error: 1_833
			.saturating_add(Weight::from_parts(50_942, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(37_616_995, 6429)
			// Standard Error: 1_194
			.saturating_add(Weight::from_parts(12_476, 0).saturating_mul(x.into()))
			// Standard Error: 24_897
			.saturating_add(Weight::from_parts(730_166, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(36_298_396, 6429)
			// Standard Error: 140
			.saturating_add(Weight::from_parts(3_667, 0).saturating_mul(x.into()))
			// Standard Error: 2_936
			.saturating_add(Weight::from_parts(64_485, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(35_497_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(35_076_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(18_214_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(13_536_000, 6429)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(52_048_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}