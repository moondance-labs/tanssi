...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(41_271_795, 4609)
			// Standard Error: 210
			.saturating_add(Weight::from_parts(288, 0).saturating_mul(x.into()))
			// Standard Error: 4_383
			.saturating_add(Weight::from_parts(44_053, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_157_773, 4609)
			// Standard Error: 75
			.saturating_add(Weight::from_parts(686, 0).saturating_mul(x.into()))
			// Standard Error: 1_574
			.saturating_add(Weight::from_parts(44_626, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(44_192_564, 4609)
			// Standard Error: 189
			.saturating_add(Weight::from_parts(1_175, 0).saturating_mul(x.into()))
			// Standard Error: 3_943
			.saturating_add(Weight::from_parts(63_417, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(36_034_374, 4609)
			// Standard Error: 3_551
			.saturating_add(Weight::from_parts(51_452, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(34_666_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(34_776_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(17_844_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(19_367_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(13_225_000, 4609)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}