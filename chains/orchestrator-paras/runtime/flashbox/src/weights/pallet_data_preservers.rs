...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `109`
		//  Estimated: `4609`
		// Minimum execution time: 61_918_000 picoseconds.
		Weight::from_parts(63_824_434, 4609)
			// Standard Error: 4_681
			.saturating_add(Weight::from_parts(59_992, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(16_044_004, 4609)
			// Standard Error: 84
			.saturating_add(Weight::from_parts(855, 0).saturating_mul(x.into()))
			// Standard Error: 1_769
			.saturating_add(Weight::from_parts(75_233, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `315`
		//  Estimated: `4609`
		// Minimum execution time: 67_726_000 picoseconds.
		Weight::from_parts(68_699_447, 4609)
			// Standard Error: 184
			.saturating_add(Weight::from_parts(1_402, 0).saturating_mul(x.into()))
			// Standard Error: 3_854
			.saturating_add(Weight::from_parts(81_380, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(56_651_968, 4609)
			// Standard Error: 182
			.saturating_add(Weight::from_parts(1_273, 0).saturating_mul(x.into()))
			// Standard Error: 3_802
			.saturating_add(Weight::from_parts(77_748, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(55_599_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(55_312_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(30_518_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		//  Measured:  `430`
		//  Estimated: `4609`
		// Minimum execution time: 32_708_000 picoseconds.
		Weight::from_parts(33_249_000, 4609)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(22_687_000, 4609)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(54_000_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}