...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(44_598_464, 6429)
			// Standard Error: 3_996
			.saturating_add(Weight::from_parts(33_477, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(9_781_535, 6429)
			// Standard Error: 92
			.saturating_add(Weight::from_parts(2_159, 0).saturating_mul(x.into()))
			// Standard Error: 1_924
			.saturating_add(Weight::from_parts(50_912, 0).saturating_mul(y.into()))
	...
	fn update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(39_034_033, 6429)
			// Standard Error: 1_295
			.saturating_add(Weight::from_parts(12_949, 0).saturating_mul(x.into()))
			// Standard Error: 27_019
			.saturating_add(Weight::from_parts(765_803, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(37_943_973, 6429)
			// Standard Error: 147
			.saturating_add(Weight::from_parts(1_660, 0).saturating_mul(x.into()))
			// Standard Error: 3_067
			.saturating_add(Weight::from_parts(56_840, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(36_940_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(36_478_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(18_695_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(20_489_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(14_056_000, 6429)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(54_072_000, 6429)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}