...
impl<T: frame_system::Config> pallet_multiblock_migrations::WeightInfo for SubstrateWeight<T> {
	...
	fn onboard_new_mbms() -> Weight {
		...
		Weight::from_parts(6_683_000, 67035)
	...
	fn progress_mbms_none() -> Weight {
		...
		Weight::from_parts(2_445_000, 67035)
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(15_409_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(7_638_567, 3834)
			// Standard Error: 1_619
			.saturating_add(Weight::from_parts(972_327, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
