...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_560_000, 2303)
			// Standard Error: 127_711
			.saturating_add(Weight::from_parts(17_285_248, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_025_689, 7887)
			// Standard Error: 10_321
			.saturating_add(Weight::from_parts(13_449_965, 0).saturating_mul(x.into()))
