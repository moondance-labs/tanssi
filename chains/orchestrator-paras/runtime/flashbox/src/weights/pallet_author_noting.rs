...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_929_000, 2303)
			// Standard Error: 126_908
			.saturating_add(Weight::from_parts(17_147_176, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_989_384, 7887)
			// Standard Error: 7_480
			.saturating_add(Weight::from_parts(13_078_419, 0).saturating_mul(x.into()))
