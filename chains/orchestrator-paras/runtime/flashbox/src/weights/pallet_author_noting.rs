...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_641_000, 2303)
			// Standard Error: 123_227
			.saturating_add(Weight::from_parts(16_463_179, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_819_601, 7887)
			// Standard Error: 6_369
			.saturating_add(Weight::from_parts(12_575_814, 0).saturating_mul(x.into()))
