...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_308_000, 2303)
			// Standard Error: 121_547
			.saturating_add(Weight::from_parts(16_460_384, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_898_211, 7887)
			// Standard Error: 6_018
			.saturating_add(Weight::from_parts(12_732_044, 0).saturating_mul(x.into()))
