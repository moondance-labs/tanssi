...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_280_000, 2303)
			// Standard Error: 122_373
			.saturating_add(Weight::from_parts(16_766_232, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_597_695, 7887)
			// Standard Error: 6_243
			.saturating_add(Weight::from_parts(13_500_372, 0).saturating_mul(x.into()))
