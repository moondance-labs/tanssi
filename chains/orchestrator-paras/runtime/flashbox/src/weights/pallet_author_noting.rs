...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_909_000, 2303)
			// Standard Error: 130_924
			.saturating_add(Weight::from_parts(17_028_464, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_010_424, 7887)
			// Standard Error: 7_851
			.saturating_add(Weight::from_parts(13_142_444, 0).saturating_mul(x.into()))
