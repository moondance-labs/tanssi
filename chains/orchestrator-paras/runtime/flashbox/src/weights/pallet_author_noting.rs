...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		// Minimum execution time: 37_865_000 picoseconds.
		Weight::from_parts(38_411_000, 2303)
			// Standard Error: 149_509
			.saturating_add(Weight::from_parts(22_594_135, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(54_196_208, 7887)
			// Standard Error: 16_500
			.saturating_add(Weight::from_parts(20_658_821, 0).saturating_mul(x.into()))
