...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_458_000, 2303)
			// Standard Error: 113_374
			.saturating_add(Weight::from_parts(15_514_065, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_228_396, 7887)
			// Standard Error: 16_741
			.saturating_add(Weight::from_parts(12_483_788, 0).saturating_mul(x.into()))
