...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(23_224_000, 2303)
			// Standard Error: 133_102
			.saturating_add(Weight::from_parts(18_164_452, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_928_122, 7887)
			// Standard Error: 7_097
			.saturating_add(Weight::from_parts(14_795_282, 0).saturating_mul(x.into()))
