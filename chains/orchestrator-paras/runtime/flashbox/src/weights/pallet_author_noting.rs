...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(36_298_000, 2303)
			// Standard Error: 151_122
			.saturating_add(Weight::from_parts(22_644_885, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 66_215_000 picoseconds.
		Weight::from_parts(51_405_058, 7887)
			// Standard Error: 14_947
			.saturating_add(Weight::from_parts(20_431_201, 0).saturating_mul(x.into()))
