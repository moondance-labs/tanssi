...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(23_043_000, 2303)
			// Standard Error: 128_468
			.saturating_add(Weight::from_parts(17_972_156, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_128_287, 7887)
			// Standard Error: 5_806
			.saturating_add(Weight::from_parts(14_363_829, 0).saturating_mul(x.into()))
