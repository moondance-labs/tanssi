...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_759_000, 2303)
			// Standard Error: 121_283
			.saturating_add(Weight::from_parts(16_566_231, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_035_472, 7887)
			// Standard Error: 6_617
			.saturating_add(Weight::from_parts(13_252_289, 0).saturating_mul(x.into()))
