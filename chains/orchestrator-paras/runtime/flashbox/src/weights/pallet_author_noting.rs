...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(15_302_585, 1791)
			// Standard Error: 5_449
			.saturating_add(Weight::from_parts(5_028_603, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(582_083, 7887)
			// Standard Error: 22_909
			.saturating_add(Weight::from_parts(28_361_020, 0).saturating_mul(x.into()))
