...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_660_000, 2303)
			// Standard Error: 127_318
			.saturating_add(Weight::from_parts(17_300_370, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_630_979, 7887)
			// Standard Error: 6_905
			.saturating_add(Weight::from_parts(13_187_732, 0).saturating_mul(x.into()))
