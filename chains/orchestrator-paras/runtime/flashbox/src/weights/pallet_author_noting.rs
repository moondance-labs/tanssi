...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(22_773_000, 2303)
			// Standard Error: 130_416
			.saturating_add(Weight::from_parts(17_622_764, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_253_770, 7887)
			// Standard Error: 6_722
			.saturating_add(Weight::from_parts(13_976_824, 0).saturating_mul(x.into()))
