...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(22_792_000, 2303)
			// Standard Error: 131_103
			.saturating_add(Weight::from_parts(17_984_766, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_022_656, 7887)
			// Standard Error: 9_932
			.saturating_add(Weight::from_parts(14_069_963, 0).saturating_mul(x.into()))
