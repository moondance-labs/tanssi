...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(18_467_098, 1791)
			// Standard Error: 3_311
			.saturating_add(Weight::from_parts(5_152_336, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(32_631_000, 7887)
			// Standard Error: 29_200
			.saturating_add(Weight::from_parts(28_608_940, 0).saturating_mul(x.into()))
