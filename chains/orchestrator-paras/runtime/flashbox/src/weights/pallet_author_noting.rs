...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_070_000, 2303)
			// Standard Error: 124_447
			.saturating_add(Weight::from_parts(16_742_254, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_786_367, 7887)
			// Standard Error: 7_021
			.saturating_add(Weight::from_parts(13_076_654, 0).saturating_mul(x.into()))
