...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(22_362_000, 2303)
			// Standard Error: 132_053
			.saturating_add(Weight::from_parts(17_890_705, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_506_270, 7887)
			// Standard Error: 8_115
			.saturating_add(Weight::from_parts(14_256_972, 0).saturating_mul(x.into()))
