...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(22_613_000, 2303)
			// Standard Error: 122_398
			.saturating_add(Weight::from_parts(16_981_995, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(31_065_722, 7887)
			// Standard Error: 8_135
			.saturating_add(Weight::from_parts(13_188_344, 0).saturating_mul(x.into()))
