...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(17_585_324, 1791)
			// Standard Error: 3_390
			.saturating_add(Weight::from_parts(5_187_961, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(32_722_000, 7887)
			// Standard Error: 28_860
			.saturating_add(Weight::from_parts(28_559_106, 0).saturating_mul(x.into()))
