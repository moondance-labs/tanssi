...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(16_851_771, 1791)
			// Standard Error: 3_293
			.saturating_add(Weight::from_parts(5_197_245, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(32_451_000, 7887)
			// Standard Error: 29_437
			.saturating_add(Weight::from_parts(28_739_337, 0).saturating_mul(x.into()))
