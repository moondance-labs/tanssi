...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(17_841_728, 1791)
			// Standard Error: 3_420
			.saturating_add(Weight::from_parts(5_099_015, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(32_371_000, 7887)
			// Standard Error: 28_287
			.saturating_add(Weight::from_parts(28_526_963, 0).saturating_mul(x.into()))
