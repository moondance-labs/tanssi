...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(36_357_000, 2303)
			// Standard Error: 150_895
			.saturating_add(Weight::from_parts(22_960_801, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(50_789_070, 7887)
			// Standard Error: 13_269
			.saturating_add(Weight::from_parts(20_573_552, 0).saturating_mul(x.into()))
