...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_991_000, 2303)
			// Standard Error: 122_254
			.saturating_add(Weight::from_parts(16_728_076, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_042_732, 7887)
			// Standard Error: 11_163
			.saturating_add(Weight::from_parts(13_641_629, 0).saturating_mul(x.into()))
