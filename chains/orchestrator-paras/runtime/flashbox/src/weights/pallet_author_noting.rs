...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(39_297_000, 2303)
			// Standard Error: 149_760
			.saturating_add(Weight::from_parts(22_803_905, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(54_468_929, 7887)
			// Standard Error: 14_734
			.saturating_add(Weight::from_parts(21_111_279, 0).saturating_mul(x.into()))
