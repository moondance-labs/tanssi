...
// --output=tmp/flashbox_weights/pallet_author_noting.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(15_723_643, 1791)
			// Standard Error: 4_469
			.saturating_add(Weight::from_parts(4_927_074, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `220 + x * (140 ±0)`
		//  Estimated: `7887 + x * (2499 ±3)`
		// Minimum execution time: 30_648_000 picoseconds.
		Weight::from_parts(31_289_000, 7887)
			// Standard Error: 26_607
			.saturating_add(Weight::from_parts(27_252_278, 0).saturating_mul(x.into()))
