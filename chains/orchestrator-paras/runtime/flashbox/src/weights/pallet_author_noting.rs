...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(24_796_000, 2303)
			// Standard Error: 127_386
			.saturating_add(Weight::from_parts(17_534_828, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(32_051_666, 7887)
			// Standard Error: 7_712
			.saturating_add(Weight::from_parts(13_708_712, 0).saturating_mul(x.into()))
