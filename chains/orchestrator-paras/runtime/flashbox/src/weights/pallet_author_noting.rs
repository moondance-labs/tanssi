...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_450_000, 2303)
			// Standard Error: 133_361
			.saturating_add(Weight::from_parts(17_547_510, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(28_772_462, 7887)
			// Standard Error: 14_327
			.saturating_add(Weight::from_parts(13_634_932, 0).saturating_mul(x.into()))
