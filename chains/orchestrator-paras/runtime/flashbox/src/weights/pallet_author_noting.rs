...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_420_000, 2303)
			// Standard Error: 127_311
			.saturating_add(Weight::from_parts(17_304_968, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_951_375, 7887)
			// Standard Error: 7_176
			.saturating_add(Weight::from_parts(13_144_003, 0).saturating_mul(x.into()))
