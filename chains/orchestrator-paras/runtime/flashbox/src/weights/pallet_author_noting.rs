...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(16_905_130, 1791)
			// Standard Error: 2_595
			.saturating_add(Weight::from_parts(4_963_889, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		//  Estimated: `7887 + x * (2499 ±0)`
		// Minimum execution time: 31_159_000 picoseconds.
		Weight::from_parts(31_520_000, 7887)
			// Standard Error: 27_298
			.saturating_add(Weight::from_parts(27_518_389, 0).saturating_mul(x.into()))
