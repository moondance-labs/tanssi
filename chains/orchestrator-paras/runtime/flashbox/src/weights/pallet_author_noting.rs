...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_079_000, 2303)
			// Standard Error: 122_138
			.saturating_add(Weight::from_parts(16_578_247, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_640_252, 7887)
			// Standard Error: 5_950
			.saturating_add(Weight::from_parts(13_047_892, 0).saturating_mul(x.into()))
