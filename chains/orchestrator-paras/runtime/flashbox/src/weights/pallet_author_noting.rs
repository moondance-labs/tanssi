...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(15_714_003, 1791)
			// Standard Error: 2_609
			.saturating_add(Weight::from_parts(4_932_330, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(31_278_000, 7887)
			// Standard Error: 27_509
			.saturating_add(Weight::from_parts(28_004_704, 0).saturating_mul(x.into()))
