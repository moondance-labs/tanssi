...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_611_000, 2303)
			// Standard Error: 125_605
			.saturating_add(Weight::from_parts(17_153_898, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_846_922, 7887)
			// Standard Error: 6_404
			.saturating_add(Weight::from_parts(13_785_317, 0).saturating_mul(x.into()))
