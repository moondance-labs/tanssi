...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_771_000, 2303)
			// Standard Error: 134_567
			.saturating_add(Weight::from_parts(17_914_303, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(31_362_462, 7887)
			// Standard Error: 9_166
			.saturating_add(Weight::from_parts(13_607_915, 0).saturating_mul(x.into()))
