...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_100_000, 2303)
			// Standard Error: 128_380
			.saturating_add(Weight::from_parts(17_280_563, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(27_934_589, 7887)
			// Standard Error: 6_801
			.saturating_add(Weight::from_parts(13_160_121, 0).saturating_mul(x.into()))
