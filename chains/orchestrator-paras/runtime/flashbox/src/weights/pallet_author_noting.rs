...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(23_424_000, 2303)
			// Standard Error: 119_655
			.saturating_add(Weight::from_parts(16_850_648, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(31_632_010, 7887)
			// Standard Error: 7_590
			.saturating_add(Weight::from_parts(13_619_432, 0).saturating_mul(x.into()))
