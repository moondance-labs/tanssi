...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(23_274_000, 2303)
			// Standard Error: 124_062
			.saturating_add(Weight::from_parts(17_367_677, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(32_780_158, 7887)
			// Standard Error: 7_765
			.saturating_add(Weight::from_parts(13_952_871, 0).saturating_mul(x.into()))
