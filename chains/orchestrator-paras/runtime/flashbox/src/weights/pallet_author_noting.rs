...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(38_436_000, 2303)
			// Standard Error: 192_411
			.saturating_add(Weight::from_parts(27_449_861, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(52_105_509, 7887)
			// Standard Error: 14_858
			.saturating_add(Weight::from_parts(22_738_023, 0).saturating_mul(x.into()))
