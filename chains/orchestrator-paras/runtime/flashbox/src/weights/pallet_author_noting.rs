...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(24_045_000, 2303)
			// Standard Error: 132_292
			.saturating_add(Weight::from_parts(17_990_991, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(31_189_362, 7887)
			// Standard Error: 10_532
			.saturating_add(Weight::from_parts(13_924_145, 0).saturating_mul(x.into()))
