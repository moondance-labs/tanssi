...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_400_000, 2303)
			// Standard Error: 117_740
			.saturating_add(Weight::from_parts(16_457_119, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_694_315, 7887)
			// Standard Error: 10_620
			.saturating_add(Weight::from_parts(13_595_814, 0).saturating_mul(x.into()))
