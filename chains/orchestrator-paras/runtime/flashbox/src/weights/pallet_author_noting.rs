...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(36_964_000, 2303)
			// Standard Error: 145_168
			.saturating_add(Weight::from_parts(22_208_020, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		// Minimum execution time: 67_593_000 picoseconds.
		Weight::from_parts(51_376_393, 7887)
			// Standard Error: 14_570
			.saturating_add(Weight::from_parts(20_829_680, 0).saturating_mul(x.into()))
