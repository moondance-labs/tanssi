...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(22_974_000, 2303)
			// Standard Error: 134_531
			.saturating_add(Weight::from_parts(18_422_961, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_745_227, 7887)
			// Standard Error: 6_100
			.saturating_add(Weight::from_parts(14_223_152, 0).saturating_mul(x.into()))
