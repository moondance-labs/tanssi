...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_811_000, 2303)
			// Standard Error: 128_347
			.saturating_add(Weight::from_parts(17_303_174, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_620_474, 7887)
			// Standard Error: 5_963
			.saturating_add(Weight::from_parts(13_774_086, 0).saturating_mul(x.into()))
