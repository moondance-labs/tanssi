...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_300_000, 2303)
			// Standard Error: 127_717
			.saturating_add(Weight::from_parts(17_049_024, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_319_328, 7887)
			// Standard Error: 7_300
			.saturating_add(Weight::from_parts(13_212_042, 0).saturating_mul(x.into()))
