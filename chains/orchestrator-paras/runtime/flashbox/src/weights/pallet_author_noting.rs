...
impl<T: frame_system::Config> pallet_author_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_author_data(x: u32, ) -> Weight {
		...
		Weight::from_parts(24_035_000, 2303)
			// Standard Error: 125_061
			.saturating_add(Weight::from_parts(17_161_754, 0).saturating_mul(x.into()))
	...
	fn on_container_authors_noted(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_327_109, 7887)
			// Standard Error: 8_169
			.saturating_add(Weight::from_parts(13_830_317, 0).saturating_mul(x.into()))
