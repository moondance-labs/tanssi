...
// --output=tmp/flashbox_weights/pallet_utility.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(22_625_919, 3997)
			// Standard Error: 1_959
			.saturating_add(Weight::from_parts(4_054_779, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(8_276_000, 3997)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	/// Storage: `MaintenanceMode::MaintenanceMode` (r:1 w:0)
	/// Proof: `MaintenanceMode::MaintenanceMode` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(9_510_190, 3997)
			// Standard Error: 1_376
			.saturating_add(Weight::from_parts(4_304_433, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_361_305, 3997)
			// Standard Error: 1_332
			.saturating_add(Weight::from_parts(4_039_307, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn if_else() -> Weight {
		...
		Weight::from_parts(13_024_000, 7004)
