...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(856_676_698, 3731)
			// Standard Error: 17
			.saturating_add(Weight::from_parts(673, 0).saturating_mul(x.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(126_837_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(58_660_000, 3493)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6379`
		//  Estimated: `7864`
		// Minimum execution time: 132_578_000 picoseconds.
		Weight::from_parts(137_898_000, 7864)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(49_653_000, 3527)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(48_651_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(78_718_272, 3731)
			// Standard Error: 0
			.saturating_add(Weight::from_parts(667, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(50_745_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
