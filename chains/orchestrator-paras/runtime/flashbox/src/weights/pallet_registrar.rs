...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(57_789_000, 3731)
			// Standard Error: 13
			.saturating_add(Weight::from_parts(869, 0).saturating_mul(x.into()))
			// Standard Error: 4_070_317
			.saturating_add(Weight::from_parts(21_764_569, 0).saturating_mul(z.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		//  Measured:  `2884`
		//  Estimated: `6196`
		// Minimum execution time: 118_002_000 picoseconds.
		Weight::from_parts(122_099_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(53_390_000, 3493)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		Weight::from_parts(132_630_000, 7864)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(44_994_000, 3527)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(49_253_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(12_065_700, 3731)
			// Standard Error: 2
			.saturating_add(Weight::from_parts(862, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(45_656_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(9_918_000, 3533)
