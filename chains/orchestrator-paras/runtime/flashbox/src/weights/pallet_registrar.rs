...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(54_653_000, 3731)
			// Standard Error: 10
			.saturating_add(Weight::from_parts(851, 0).saturating_mul(x.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(123_200_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(59_321_000, 3493)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6379`
		//  Estimated: `7864`
		// Minimum execution time: 134_452_000 picoseconds.
		Weight::from_parts(140_033_000, 7864)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(47_299_000, 3527)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(48_451_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(361_278_093, 3731)
			// Standard Error: 7
			.saturating_add(Weight::from_parts(708, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(49_904_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(10_240_000, 3533)
