...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(54_341_000, 3731)
			// Standard Error: 12
			.saturating_add(Weight::from_parts(930, 0).saturating_mul(x.into()))
			// Standard Error: 3_736_758
			.saturating_add(Weight::from_parts(11_680_326, 0).saturating_mul(z.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(121_819_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(57_488_000, 3493)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6379`
		//  Estimated: `7864`
		// Minimum execution time: 123_282_000 picoseconds.
		Weight::from_parts(134_673_000, 7864)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(46_327_000, 3527)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(48_141_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(58_561_802, 3731)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(750, 0).saturating_mul(x.into()))
			// Standard Error: 345_188
			.saturating_add(Weight::from_parts(1_329_503, 0).saturating_mul(z.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(46_578_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(10_169_000, 3533)
