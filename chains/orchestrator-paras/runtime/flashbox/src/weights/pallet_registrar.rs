...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(54_052_000, 3731)
			// Standard Error: 12
			.saturating_add(Weight::from_parts(963, 0).saturating_mul(x.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(119_455_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(53_000_000, 3493)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		Weight::from_parts(132_048_000, 7864)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(44_213_000, 3527)
	...
	fn unpause_container_chain() -> Weight {
		...
		//  Measured:  `2042`
		//  Estimated: `3527`
		// Minimum execution time: 45_135_000 picoseconds.
		Weight::from_parts(48_411_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(102_102_000, 3731)
			// Standard Error: 8
			.saturating_add(Weight::from_parts(1_035, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(45_065_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(9_678_000, 3533)
