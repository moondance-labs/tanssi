...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(849_096_799, 3731)
			// Standard Error: 19
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(116_929_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		//  Measured:  `1250`
		//  Estimated: `3493`
		// Minimum execution time: 54_523_000 picoseconds.
		Weight::from_parts(55_925_000, 3493)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6379`
		//  Estimated: `7864`
		// Minimum execution time: 127_429_000 picoseconds.
		Weight::from_parts(130_585_000, 7864)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(45_555_000, 3527)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(46_306_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(760_979, 3731)
			// Standard Error: 7
			.saturating_add(Weight::from_parts(827, 0).saturating_mul(x.into()))
			// Standard Error: 2_441_941
			.saturating_add(Weight::from_parts(13_170_032, 0).saturating_mul(z.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(46_487_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
