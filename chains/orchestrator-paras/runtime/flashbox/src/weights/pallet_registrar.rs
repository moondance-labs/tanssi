...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(51_596_000, 3731)
			// Standard Error: 8
			.saturating_add(Weight::from_parts(914, 0).saturating_mul(x.into()))
			// Standard Error: 2_681_716
			.saturating_add(Weight::from_parts(12_181_156, 0).saturating_mul(z.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(116_579_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(51_597_000, 3493)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6379`
		//  Estimated: `7864`
		// Minimum execution time: 123_001_000 picoseconds.
		Weight::from_parts(127_540_000, 7864)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(46_387_000, 3527)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(47_239_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(17_393_605, 3731)
			// Standard Error: 2
			.saturating_add(Weight::from_parts(952, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(46_718_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(9_227_000, 3533)
