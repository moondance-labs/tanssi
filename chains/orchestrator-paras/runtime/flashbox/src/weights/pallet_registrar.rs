...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(226_151_795, 3731)
			// Standard Error: 18
	...
	fn deregister_immediate() -> Weight {
		...
		Weight::from_parts(122_940_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		Weight::from_parts(56_917_000, 3493)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		//  Measured:  `6379`
		//  Estimated: `7864`
		// Minimum execution time: 128_030_000 picoseconds.
		Weight::from_parts(131_536_000, 7864)
	...
	fn pause_container_chain() -> Weight {
		...
		Weight::from_parts(44_934_000, 3527)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(46_127_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(28_575_702, 3731)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(842, 0).saturating_mul(x.into()))
			// Standard Error: 466_361
			.saturating_add(Weight::from_parts(4_403_631, 0).saturating_mul(z.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(46_356_000, 3493)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(9_608_000, 3533)
