...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(13_460_117, 7887)
			// Standard Error: 4_686
			.saturating_add(Weight::from_parts(76_806, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(7_809_618, 7887)
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(10_461_034, 7887)
			// Standard Error: 2_216
			.saturating_add(Weight::from_parts(10_525, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Invulnerables::Invulnerables` (r:1 w:0)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_778_496, 7887)
			// Standard Error: 516
			.saturating_add(Weight::from_parts(36_532, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}