...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(13_930_286, 7887)
			// Standard Error: 484
			.saturating_add(Weight::from_parts(40_433, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(8_153_664, 7887)
			// Standard Error: 292
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(7_552_606, 7887)
			// Standard Error: 435
			.saturating_add(Weight::from_parts(31_018, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Invulnerables::Invulnerables` (r:1 w:0)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_367_164, 7887)
			// Standard Error: 2_251
			.saturating_add(Weight::from_parts(52_378, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}