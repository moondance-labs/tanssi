...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(25_859_696, 7887)
			// Standard Error: 1_056
			.saturating_add(Weight::from_parts(84_388, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_964_432, 7887)
			// Standard Error: 703
			.saturating_add(Weight::from_parts(60_575, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(15_012_199, 7887)
			// Standard Error: 831
			.saturating_add(Weight::from_parts(59_196, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Invulnerables::Invulnerables` (r:1 w:0)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(29_701_607, 7887)
			// Standard Error: 764
			.saturating_add(Weight::from_parts(72_024, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}