...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_037_266, 7887)
			// Standard Error: 3_835
			.saturating_add(Weight::from_parts(90_596, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(13_204_499, 7887)
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(7_512_638, 7887)
			// Standard Error: 375
			.saturating_add(Weight::from_parts(29_594, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Invulnerables::Invulnerables` (r:1 w:0)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_668_929, 7887)
			// Standard Error: 378
			.saturating_add(Weight::from_parts(39_014, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}