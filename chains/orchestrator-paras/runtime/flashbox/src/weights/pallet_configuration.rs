...
// --output=tmp/flashbox_weights/pallet_configuration.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_configuration::WeightInfo for SubstrateWeight<T> {
	...
	/// Proof: `Configuration::BypassConsistencyCheck` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	...
	fn set_config_with_u32() -> Weight {
		...
		Weight::from_parts(8_245_000, 1758)
