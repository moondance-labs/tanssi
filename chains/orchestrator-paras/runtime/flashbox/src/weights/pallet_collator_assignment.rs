...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(18_249_273, 7887)
			// Standard Error: 9_912
			.saturating_add(Weight::from_parts(216_881, 0).saturating_mul(x.into()))
			// Standard Error: 100_932
			.saturating_add(Weight::from_parts(20_099_783, 0).saturating_mul(y.into()))
