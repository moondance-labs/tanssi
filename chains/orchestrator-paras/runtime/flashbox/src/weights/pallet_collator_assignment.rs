...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(64_157_541, 7887)
			// Standard Error: 50_270
			.saturating_add(Weight::from_parts(220_655, 0).saturating_mul(x.into()))
			// Standard Error: 511_854
			.saturating_add(Weight::from_parts(19_031_642, 0).saturating_mul(y.into()))
