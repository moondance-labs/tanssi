...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(21_696_759, 7887)
			// Standard Error: 9_004
			.saturating_add(Weight::from_parts(278_858, 0).saturating_mul(x.into()))
			// Standard Error: 91_682
			.saturating_add(Weight::from_parts(19_789_744, 0).saturating_mul(y.into()))
