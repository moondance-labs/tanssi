...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(15_211_360, 7887)
			// Standard Error: 8_990
			.saturating_add(Weight::from_parts(239_804, 0).saturating_mul(x.into()))
			// Standard Error: 91_544
			.saturating_add(Weight::from_parts(19_534_995, 0).saturating_mul(y.into()))
