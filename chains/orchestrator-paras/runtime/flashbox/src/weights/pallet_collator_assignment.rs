...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 93_865_000 picoseconds.
		Weight::from_parts(18_173_816, 7887)
			// Standard Error: 8_963
			.saturating_add(Weight::from_parts(281_482, 0).saturating_mul(x.into()))
			// Standard Error: 91_267
			.saturating_add(Weight::from_parts(19_771_119, 0).saturating_mul(y.into()))
