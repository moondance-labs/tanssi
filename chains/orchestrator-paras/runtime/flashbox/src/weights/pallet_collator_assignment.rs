...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 135_586_000 picoseconds.
		Weight::from_parts(22_919_313, 7887)
			// Standard Error: 14_324
			.saturating_add(Weight::from_parts(416_130, 0).saturating_mul(x.into()))
			// Standard Error: 145_855
			.saturating_add(Weight::from_parts(30_551_923, 0).saturating_mul(y.into()))
