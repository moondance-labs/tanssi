...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 138_131_000 picoseconds.
		Weight::from_parts(28_774_026, 7887)
			// Standard Error: 13_797
			.saturating_add(Weight::from_parts(410_513, 0).saturating_mul(x.into()))
			// Standard Error: 140_481
			.saturating_add(Weight::from_parts(30_282_646, 0).saturating_mul(y.into()))
