...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 79_057_000 picoseconds.
		Weight::from_parts(12_509_234, 7887)
			// Standard Error: 9_154
			.saturating_add(Weight::from_parts(233_457, 0).saturating_mul(x.into()))
			// Standard Error: 93_208
			.saturating_add(Weight::from_parts(19_955_646, 0).saturating_mul(y.into()))
