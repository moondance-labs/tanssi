...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(8_527_992, 7887)
			// Standard Error: 9_115
			.saturating_add(Weight::from_parts(249_538, 0).saturating_mul(x.into()))
			// Standard Error: 92_818
			.saturating_add(Weight::from_parts(20_095_186, 0).saturating_mul(y.into()))
