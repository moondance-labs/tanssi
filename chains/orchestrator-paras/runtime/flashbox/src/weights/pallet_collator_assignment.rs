...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 152_471_000 picoseconds.
		Weight::from_parts(35_421_794, 7887)
			// Standard Error: 14_429
			.saturating_add(Weight::from_parts(435_190, 0).saturating_mul(x.into()))
			// Standard Error: 146_919
			.saturating_add(Weight::from_parts(31_099_377, 0).saturating_mul(y.into()))
