...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(12_643_363, 7887)
			// Standard Error: 8_439
			.saturating_add(Weight::from_parts(238_442, 0).saturating_mul(x.into()))
			// Standard Error: 85_928
			.saturating_add(Weight::from_parts(18_411_999, 0).saturating_mul(y.into()))
