...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_585_756, 7887)
			// Standard Error: 8_511
			.saturating_add(Weight::from_parts(241_568, 0).saturating_mul(x.into()))
			// Standard Error: 86_658
			.saturating_add(Weight::from_parts(18_546_144, 0).saturating_mul(y.into()))
