...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 148_831_000 picoseconds.
		Weight::from_parts(34_270_356, 7887)
			// Standard Error: 13_780
			.saturating_add(Weight::from_parts(435_928, 0).saturating_mul(x.into()))
			// Standard Error: 140_313
			.saturating_add(Weight::from_parts(30_314_668, 0).saturating_mul(y.into()))
