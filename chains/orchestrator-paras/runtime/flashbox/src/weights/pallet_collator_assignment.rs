...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `781 + y * (59 ±0)`
		//  Estimated: `7887 + y * (2535 ±0)`
		// Minimum execution time: 111_663_000 picoseconds.
		Weight::from_parts(49_049_181, 7887)
			// Standard Error: 8_721
			.saturating_add(Weight::from_parts(252_230, 0).saturating_mul(x.into()))
			// Standard Error: 88_800
			.saturating_add(Weight::from_parts(16_468_893, 0).saturating_mul(y.into()))
