...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 81_082_000 picoseconds.
		Weight::from_parts(15_142_886, 7887)
			// Standard Error: 8_577
			.saturating_add(Weight::from_parts(235_420, 0).saturating_mul(x.into()))
			// Standard Error: 87_335
			.saturating_add(Weight::from_parts(19_078_842, 0).saturating_mul(y.into()))
