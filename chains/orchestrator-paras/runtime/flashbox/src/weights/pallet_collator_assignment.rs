...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(22_062_318, 7887)
			// Standard Error: 8_883
			.saturating_add(Weight::from_parts(192_148, 0).saturating_mul(x.into()))
			// Standard Error: 90_454
			.saturating_add(Weight::from_parts(18_119_719, 0).saturating_mul(y.into()))
