...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(17_253_662, 7887)
			// Standard Error: 9_335
			.saturating_add(Weight::from_parts(245_319, 0).saturating_mul(x.into()))
			// Standard Error: 95_056
			.saturating_add(Weight::from_parts(20_563_556, 0).saturating_mul(y.into()))
