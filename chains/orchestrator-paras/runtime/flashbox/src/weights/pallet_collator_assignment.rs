...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(13_647_926, 7887)
			// Standard Error: 8_711
			.saturating_add(Weight::from_parts(238_847, 0).saturating_mul(x.into()))
			// Standard Error: 88_696
			.saturating_add(Weight::from_parts(18_852_237, 0).saturating_mul(y.into()))
