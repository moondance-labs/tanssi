...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 96_281_000 picoseconds.
		Weight::from_parts(22_616_146, 7887)
			// Standard Error: 9_113
			.saturating_add(Weight::from_parts(271_454, 0).saturating_mul(x.into()))
			// Standard Error: 92_796
			.saturating_add(Weight::from_parts(20_054_629, 0).saturating_mul(y.into()))
