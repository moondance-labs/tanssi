...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(22_773_859, 7887)
			// Standard Error: 8_651
			.saturating_add(Weight::from_parts(264_612, 0).saturating_mul(x.into()))
			// Standard Error: 88_091
			.saturating_add(Weight::from_parts(19_617_004, 0).saturating_mul(y.into()))
