...
// --output=tmp/flashbox_weights/pallet_collator_assignment.rs
// --heap-pages=4096
// --no-storage-info
// --no-min-squares
// --no-median-slopes
...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		//  Measured:  `641 + y * (59 ±0)`
		//  Estimated: `7887 + y * (2511 ±0)`
		// Minimum execution time: 151_906_000 picoseconds.
		Weight::from_parts(31_347_457, 7887)
			// Standard Error: 15_857
			.saturating_add(Weight::from_parts(433_440, 0).saturating_mul(x.into()))
			// Standard Error: 161_456
			.saturating_add(Weight::from_parts(33_838_197, 0).saturating_mul(y.into()))
