...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(25_276_837, 7887)
			// Standard Error: 9_735
			.saturating_add(Weight::from_parts(226_358, 0).saturating_mul(x.into()))
			// Standard Error: 99_126
			.saturating_add(Weight::from_parts(21_145_175, 0).saturating_mul(y.into()))
