...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(10_372_744, 7887)
			// Standard Error: 8_887
			.saturating_add(Weight::from_parts(268_596, 0).saturating_mul(x.into()))
			// Standard Error: 90_490
			.saturating_add(Weight::from_parts(19_776_290, 0).saturating_mul(y.into()))
