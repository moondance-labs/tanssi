...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 91_902_000 picoseconds.
		Weight::from_parts(17_857_528, 7887)
			// Standard Error: 8_851
			.saturating_add(Weight::from_parts(272_799, 0).saturating_mul(x.into()))
			// Standard Error: 90_128
			.saturating_add(Weight::from_parts(19_881_842, 0).saturating_mul(y.into()))
