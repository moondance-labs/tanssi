...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(_x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 135_541_000 picoseconds.
		Weight::from_parts(676_633_428, 7887)
			// Standard Error: 748_515
			.saturating_add(Weight::from_parts(23_658_254, 0).saturating_mul(y.into()))
