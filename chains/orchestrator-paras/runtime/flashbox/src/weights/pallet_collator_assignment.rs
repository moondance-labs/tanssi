...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(14_907_022, 7887)
			// Standard Error: 8_710
			.saturating_add(Weight::from_parts(229_273, 0).saturating_mul(x.into()))
			// Standard Error: 88_693
			.saturating_add(Weight::from_parts(19_634_010, 0).saturating_mul(y.into()))
