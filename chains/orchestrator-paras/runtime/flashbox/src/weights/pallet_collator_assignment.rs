...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(11_902_027, 7887)
			// Standard Error: 8_735
			.saturating_add(Weight::from_parts(249_779, 0).saturating_mul(x.into()))
			// Standard Error: 88_940
			.saturating_add(Weight::from_parts(19_189_594, 0).saturating_mul(y.into()))
