...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(11_993_397, 7887)
			// Standard Error: 9_047
			.saturating_add(Weight::from_parts(264_509, 0).saturating_mul(x.into()))
			// Standard Error: 92_119
			.saturating_add(Weight::from_parts(20_167_341, 0).saturating_mul(y.into()))
