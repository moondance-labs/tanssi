...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(16_977_252, 7887)
			// Standard Error: 9_016
			.saturating_add(Weight::from_parts(227_592, 0).saturating_mul(x.into()))
			// Standard Error: 91_806
			.saturating_add(Weight::from_parts(19_163_237, 0).saturating_mul(y.into()))
