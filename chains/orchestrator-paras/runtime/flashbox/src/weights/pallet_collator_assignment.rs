...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(18_395_835, 7887)
			// Standard Error: 9_728
			.saturating_add(Weight::from_parts(277_113, 0).saturating_mul(x.into()))
			// Standard Error: 99_051
			.saturating_add(Weight::from_parts(20_955_326, 0).saturating_mul(y.into()))
