...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(18_256_614, 7887)
			// Standard Error: 9_755
			.saturating_add(Weight::from_parts(238_687, 0).saturating_mul(x.into()))
			// Standard Error: 99_330
			.saturating_add(Weight::from_parts(21_193_896, 0).saturating_mul(y.into()))
