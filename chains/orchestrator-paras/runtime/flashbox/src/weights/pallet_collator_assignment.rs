...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(14_420_241, 7887)
			// Standard Error: 8_654
			.saturating_add(Weight::from_parts(234_697, 0).saturating_mul(x.into()))
			// Standard Error: 88_120
			.saturating_add(Weight::from_parts(18_967_448, 0).saturating_mul(y.into()))
