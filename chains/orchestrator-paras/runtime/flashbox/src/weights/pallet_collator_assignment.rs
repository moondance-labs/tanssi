...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 98_815_000 picoseconds.
		Weight::from_parts(22_192_525, 7887)
			// Standard Error: 8_932
			.saturating_add(Weight::from_parts(284_456, 0).saturating_mul(x.into()))
			// Standard Error: 90_949
			.saturating_add(Weight::from_parts(20_053_571, 0).saturating_mul(y.into()))
