...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(21_457_483, 7887)
			// Standard Error: 8_934
			.saturating_add(Weight::from_parts(196_354, 0).saturating_mul(x.into()))
			// Standard Error: 90_971
			.saturating_add(Weight::from_parts(19_206_155, 0).saturating_mul(y.into()))
