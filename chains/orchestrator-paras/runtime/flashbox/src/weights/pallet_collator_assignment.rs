...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(59_458_802, 7887)
			// Standard Error: 80_589
			.saturating_add(Weight::from_parts(181_765, 0).saturating_mul(x.into()))
			// Standard Error: 820_562
			.saturating_add(Weight::from_parts(23_742_380, 0).saturating_mul(y.into()))
