...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(14_301_304, 7887)
			// Standard Error: 8_971
			.saturating_add(Weight::from_parts(242_334, 0).saturating_mul(x.into()))
			// Standard Error: 91_348
			.saturating_add(Weight::from_parts(19_459_849, 0).saturating_mul(y.into()))
