...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 87_244_000 picoseconds.
		Weight::from_parts(26_367_128, 7887)
			// Standard Error: 9_333
			.saturating_add(Weight::from_parts(210_549, 0).saturating_mul(x.into()))
			// Standard Error: 95_036
			.saturating_add(Weight::from_parts(20_144_524, 0).saturating_mul(y.into()))
