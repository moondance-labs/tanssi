...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(35_282_466, 7887)
			// Standard Error: 66_026
			.saturating_add(Weight::from_parts(528_837, 0).saturating_mul(x.into()))
			// Standard Error: 672_278
			.saturating_add(Weight::from_parts(20_589_536, 0).saturating_mul(y.into()))
