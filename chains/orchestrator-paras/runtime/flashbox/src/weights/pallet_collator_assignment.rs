...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(18_594_990, 7887)
			// Standard Error: 8_939
			.saturating_add(Weight::from_parts(249_467, 0).saturating_mul(x.into()))
			// Standard Error: 91_018
			.saturating_add(Weight::from_parts(19_253_154, 0).saturating_mul(y.into()))
