...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(20_758_377, 7887)
			// Standard Error: 8_880
			.saturating_add(Weight::from_parts(272_835, 0).saturating_mul(x.into()))
			// Standard Error: 90_417
			.saturating_add(Weight::from_parts(19_587_497, 0).saturating_mul(y.into()))
