    ...
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        balances: {
            ...
            holds: AugmentedQuery<
                ...
                (arg: AccountId32 | string | Uint8Array) => Observable<
                    Vec<
                        {
                            readonly id: StarlightRuntimeRuntimeHoldReason;
        ...
        ethereumSystem: {
            ...
            foreignToNativeId: AugmentedQuery<
                ApiType,
                (arg: H256 | string | Uint8Array) => Observable<Option<StagingXcmV5Location>>,
                [H256]
            > &
                QueryableStorageEntry<ApiType, [H256]>;
            /**
        ...
        paraInherent: {
            ...
            onChainVotes: AugmentedQuery<
                ApiType,
                () => Observable<Option<PolkadotPrimitivesVstagingScrapedOnChainVotes>>,
                []
            > &
                QueryableStorageEntry<ApiType, []>;
            /**
        ...
        parameters: {
            ...
            parameters: AugmentedQuery<
                ApiType,
                (
                    arg: StarlightRuntimeRuntimeParametersKey | { Preimage: any } | string | Uint8Array
                ) => Observable<Option<StarlightRuntimeRuntimeParametersValue>>,
                [StarlightRuntimeRuntimeParametersKey]
            > &
                QueryableStorageEntry<ApiType, [StarlightRuntimeRuntimeParametersKey]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        paraScheduler: {
            ...
            claimQueue: AugmentedQuery<
                ApiType,
                () => Observable<BTreeMap<u32, Vec<PolkadotRuntimeParachainsSchedulerCommonAssignment>>>,
                []
            > &
                QueryableStorageEntry<ApiType, []>;
            /**
        ...
        session: {
            ...
            nextKeys: AugmentedQuery<
                ApiType,
                (arg: AccountId32 | string | Uint8Array) => Observable<Option<StarlightRuntimeSessionKeys>>,
                [AccountId32]
            > &
                QueryableStorageEntry<ApiType, [AccountId32]>;
            /**
            ...
            queuedKeys: AugmentedQuery<
                ApiType,
                () => Observable<Vec<ITuple<[AccountId32, StarlightRuntimeSessionKeys]>>>,
                []
            > &
                QueryableStorageEntry<ApiType, []>;
            /**
