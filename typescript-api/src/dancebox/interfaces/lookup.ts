...
export default {
    ...
    /** Lookup285: tp_traits::ParathreadParams */
    ...
    /** Lookup288: pallet_collator_assignment::pallet::Call<T> */
    PalletCollatorAssignmentCall: "Null",
    /** Lookup289: pallet_author_noting::pallet::Call<T> */
    ...
    /** Lookup290: tp_author_noting_inherent::OwnParachainInherentData */
    TpAuthorNotingInherentOwnParachainInherentData: {
        relayStorageProof: "SpTrieStorageProof",
    },
    /** Lookup291: pallet_authority_assignment::pallet::Call<T> */
    PalletAuthorityAssignmentCall: "Null",
    /** Lookup292: pallet_services_payment::pallet::Call<T> */
    ...
    /** Lookup293: pallet_data_preservers::pallet::Call<T> */
    ...
    /** Lookup297: pallet_data_preservers::pallet::Profile<T> */
    PalletDataPreserversProfile: {
        url: "Bytes",
        paraIds: "PalletDataPreserversParaIdsFilter",
        mode: "PalletDataPreserversProfileMode",
    },
    /** Lookup298: pallet_data_preservers::pallet::ParaIdsFilter<T> */
    ...
    /** Lookup300: pallet_data_preservers::pallet::ProfileMode */
    ...
    /** Lookup301: pallet_invulnerables::pallet::Call<T> */
    ...
    /** Lookup303: dancebox_runtime::SessionKeys */
    DanceboxRuntimeSessionKeys: {
        nimbus: "NimbusPrimitivesNimbusCryptoPublic",
    },
    /** Lookup304: nimbus_primitives::nimbus_crypto::Public */
    NimbusPrimitivesNimbusCryptoPublic: "SpCoreSr25519Public",
    /** Lookup305: sp_core::sr25519::Public */
    SpCoreSr25519Public: "[u8;32]",
    /** Lookup306: pallet_author_inherent::pallet::Call<T> */
    PalletAuthorInherentCall: {
        _enum: ["kick_off_authorship_validation"],
    },
    /** Lookup307: pallet_pooled_staking::pallet::Call<T> */
    ...
    /** Lookup308: pallet_pooled_staking::pallet::AllTargetPool */
    PalletPooledStakingAllTargetPool: {
        _enum: ["Joining", "AutoCompounding", "ManualRewards", "Leaving"],
    },
    /** Lookup310: pallet_pooled_staking::pallet::PendingOperationQuery<sp_core::crypto::AccountId32, J, L> */
    PalletPooledStakingPendingOperationQuery: {
        delegator: "AccountId32",
        operation: "PalletPooledStakingPendingOperationKey",
    },
    /** Lookup311: pallet_pooled_staking::pallet::PendingOperationKey<sp_core::crypto::AccountId32, J, L> */
    ...
    /** Lookup312: pallet_pooled_staking::pallet::SharesOrStake<T> */
    ...
    /** Lookup317: cumulus_pallet_dmp_queue::pallet::Call<T> */
    ...
    /** Lookup339: pallet_assets::pallet::Call<T, I> */
    PalletAssetsCall: {
        _enum: {
            create: {
                id: "u16",
    ...
    /** Lookup340: pallet_foreign_asset_creator::pallet::Call<T> */
    ...
    /** Lookup341: pallet_asset_rate::pallet::Call<T> */
    PalletAssetRateCall: {
        _enum: {
            create: {
                assetKind: "u16",
    ...
    /** Lookup343: pallet_xcm_core_buyer::pallet::Call<T> */
    ...
    /** Lookup344: tp_xcm_core_buyer::BuyCoreCollatorProof<nimbus_primitives::nimbus_crypto::Public> */
    ...
    /** Lookup351: pallet_sudo::pallet::Error<T> */
    PalletSudoError: {
        _enum: ["RequireSudo"],
    },
    ...
    /** Lookup355: pallet_proxy::ProxyDefinition<sp_core::crypto::AccountId32, dancebox_runtime::ProxyType, BlockNumber> */
    PalletProxyProxyDefinition: {
        delegate: "AccountId32",
        proxyType: "DanceboxRuntimeProxyType",
        delay: "u32",
    },
    /** Lookup359: pallet_proxy::Announcement<sp_core::crypto::AccountId32, primitive_types::H256, BlockNumber> */
    PalletProxyAnnouncement: {
        real: "AccountId32",
        callHash: "H256",
        height: "u32",
    },
    /** Lookup361: pallet_proxy::pallet::Error<T> */
    PalletProxyError: {
        _enum: [
            "TooMany",
            "NotFound",
    ...
    /** Lookup373: pallet_balances::types::IdAmount<dancebox_runtime::RuntimeHoldReason, Balance> */
    PalletBalancesIdAmountRuntimeHoldReason: {
        id: "DanceboxRuntimeRuntimeHoldReason",
        amount: "u128",
    },
    /** Lookup374: dancebox_runtime::RuntimeHoldReason */
    ...
    /** Lookup375: pallet_stream_payment::pallet::HoldReason */
    PalletStreamPaymentHoldReason: {
        _enum: ["StreamPayment", "StreamOpened"],
    },
    /** Lookup376: pallet_data_preservers::pallet::HoldReason */
    PalletDataPreserversHoldReason: {
        _enum: ["ProfileDeposit"],
    },
    /** Lookup377: pallet_pooled_staking::pallet::HoldReason */
    PalletPooledStakingHoldReason: {
        _enum: ["PooledStake"],
    },
    /** Lookup380: pallet_balances::types::IdAmount<dancebox_runtime::RuntimeFreezeReason, Balance> */
    PalletBalancesIdAmountRuntimeFreezeReason: {
        id: "DanceboxRuntimeRuntimeFreezeReason",
        amount: "u128",
    },
    /** Lookup381: dancebox_runtime::RuntimeFreezeReason */
    ...
    /** Lookup382: pallet_stream_payment::pallet::FreezeReason */
    PalletStreamPaymentFreezeReason: {
        _enum: ["StreamPayment"],
    },
    /** Lookup384: pallet_balances::pallet::Error<T, I> */
    PalletBalancesError: {
        _enum: [
            "VestingBalance",
    ...
    /**
     * Lookup386: pallet_stream_payment::pallet::Stream<sp_core::crypto::AccountId32, dancebox_runtime::TimeUnit,
     * dancebox_runtime::StreamPaymentAssetId, Balance>
     */
    ...
    /**
     * Lookup388: pallet_stream_payment::pallet::ChangeRequest<dancebox_runtime::TimeUnit,
     * dancebox_runtime::StreamPaymentAssetId, Balance>
     */
    ...
    /** Lookup390: pallet_stream_payment::pallet::Error<T> */
    ...
    /** Lookup392: pallet_identity::types::Registration<Balance, MaxJudgements, pallet_identity::legacy::IdentityInfo<FieldLimit>> */
    PalletIdentityRegistration: {
        judgements: "Vec<(u32,PalletIdentityJudgement)>",
        deposit: "u128",
        info: "PalletIdentityLegacyIdentityInfo",
    },
    /** Lookup401: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32, IdField> */
    PalletIdentityRegistrarInfo: {
        account: "AccountId32",
        fee: "u128",
        fields: "u64",
    },
    /** Lookup403: pallet_identity::types::AuthorityProperties<bounded_collections::bounded_vec::BoundedVec<T, S>> */
    PalletIdentityAuthorityProperties: {
        suffix: "Bytes",
        allocation: "u32",
    },
    /** Lookup406: pallet_identity::pallet::Error<T> */
    PalletIdentityError: {
        _enum: [
            "TooManySubAccounts",
            "NotFound",
    ...
    /** Lookup418: pallet_registrar::pallet::DepositInfo<T> */
    PalletRegistrarDepositInfo: {
        creator: "AccountId32",
        deposit: "u128",
    },
    /** Lookup419: pallet_registrar::pallet::Error<T> */
    ...
    /** Lookup420: pallet_configuration::HostConfiguration */
    ...
    /** Lookup424: dp_collator_assignment::AssignedCollators<sp_core::crypto::AccountId32> */
    DpCollatorAssignmentAssignedCollatorsAccountId32: {
        orchestratorChain: "Vec<AccountId32>",
        containerChains: "BTreeMap<u32, Vec<AccountId32>>",
    },
    /** Lookup429: tp_traits::ContainerChainBlockInfo<sp_core::crypto::AccountId32> */
    TpTraitsContainerChainBlockInfo: {
        blockNumber: "u32",
        author: "AccountId32",
        latestSlotNumber: "u64",
    },
    /** Lookup430: pallet_author_noting::pallet::Error<T> */
    ...
    /** Lookup431: dp_collator_assignment::AssignedCollators<nimbus_primitives::nimbus_crypto::Public> */
    ...
    /** Lookup445: sp_core::crypto::KeyTypeId */
    SpCoreCryptoKeyTypeId: "[u8;4]",
    /** Lookup446: pallet_session::pallet::Error<T> */
    PalletSessionError: {
        _enum: ["InvalidProof", "NoAssociatedValidatorId", "DuplicatedKey", "NoKeys", "NoAccount"],
    },
    /** Lookup450: pallet_author_inherent::pallet::Error<T> */
    PalletAuthorInherentError: {
        _enum: ["AuthorAlreadySet", "NoAccountId", "CannotBeAuthor"],
    },
    /** Lookup452: pallet_pooled_staking::candidate::EligibleCandidate<sp_core::crypto::AccountId32, S> */
    PalletPooledStakingCandidateEligibleCandidate: {
        candidate: "AccountId32",
        stake: "u128",
    },
    /** Lookup455: pallet_pooled_staking::pallet::PoolsKey<sp_core::crypto::AccountId32> */
    ...
    /** Lookup457: pallet_pooled_staking::pallet::Error<T> */
    ...
    /** Lookup458: pallet_inflation_rewards::pallet::ChainsToRewardValue<T> */
    PalletInflationRewardsChainsToRewardValue: {
        paraIds: "Vec<u32>",
        rewardsPerChain: "u128",
    },
    /** Lookup459: pallet_treasury::Proposal<sp_core::crypto::AccountId32, Balance> */
    ...
    /** Lookup461: pallet_treasury::SpendStatus<AssetKind, AssetBalance, sp_core::crypto::AccountId32, BlockNumber, PaymentId> */
    ...
    /** Lookup462: pallet_treasury::PaymentState<Id> */
    ...
    /** Lookup474: cumulus_pallet_dmp_queue::pallet::MigrationState */
    ...
    /** Lookup477: pallet_xcm::pallet::QueryStatus<BlockNumber> */
    ...
    /** Lookup481: xcm::VersionedResponse */
    ...
    /** Lookup487: pallet_xcm::pallet::VersionMigrationStage */
    ...
    /** Lookup489: xcm::VersionedAssetId */
    XcmVersionedAssetId: {
        _enum: {
            __Unused0: "Null",
            __Unused1: "Null",
    ...
    /** Lookup498: pallet_assets::types::AssetDetails<Balance, sp_core::crypto::AccountId32, DepositBalance> */
    ...
    /** Lookup499: pallet_assets::types::AssetStatus */
    PalletAssetsAssetStatus: {
        _enum: ["Live", "Frozen", "Destroying"],
    },
    /** Lookup501: pallet_assets::types::AssetAccount<Balance, DepositBalance, Extra, sp_core::crypto::AccountId32> */
    ...
    /** Lookup502: pallet_assets::types::AccountStatus */
    PalletAssetsAccountStatus: {
        _enum: ["Liquid", "Frozen", "Blocked"],
    },
    /** Lookup503: pallet_assets::types::ExistenceReason<Balance, sp_core::crypto::AccountId32> */
    ...
    /** Lookup505: pallet_assets::types::Approval<Balance, DepositBalance> */
    PalletAssetsApproval: {
        amount: "u128",
        deposit: "u128",
    },
    /** Lookup506: pallet_assets::types::AssetMetadata<DepositBalance, bounded_collections::bounded_vec::BoundedVec<T, S>> */
    ...
    /** Lookup508: pallet_assets::pallet::Error<T, I> */
    PalletAssetsError: {
        _enum: [
            "BalanceLow",
            "NoAccount",
    ...
    /** Lookup509: pallet_foreign_asset_creator::pallet::Error<T> */
    PalletForeignAssetCreatorError: {
        _enum: ["AssetAlreadyExists", "AssetDoesNotExist"],
    },
    /** Lookup510: pallet_asset_rate::pallet::Error<T> */
    PalletAssetRateError: {
        _enum: ["UnknownAssetKind", "AlreadyExists", "Overflow"],
    },
    /** Lookup511: pallet_message_queue::BookState<cumulus_primitives_core::AggregateMessageOrigin> */
    ...
    /** Lookup513: pallet_message_queue::Neighbours<cumulus_primitives_core::AggregateMessageOrigin> */
    PalletMessageQueueNeighbours: {
        prev: "CumulusPrimitivesCoreAggregateMessageOrigin",
        next: "CumulusPrimitivesCoreAggregateMessageOrigin",
    },
    /** Lookup515: pallet_message_queue::Page<Size, HeapSize> */
    ...
    /** Lookup517: pallet_message_queue::pallet::Error<T> */
    ...
    /** Lookup518: pallet_xcm_core_buyer::InFlightCoreBuyingOrder<BN> */
    PalletXcmCoreBuyerInFlightCoreBuyingOrder: {
        paraId: "u32",
        queryId: "u64",
        ttl: "u32",
    },
    /** Lookup519: pallet_xcm_core_buyer::pallet::Error<T> */
    ...
    /** Lookup524: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T> */
    FrameSystemExtensionsCheckNonZeroSender: "Null",
    /** Lookup525: frame_system::extensions::check_spec_version::CheckSpecVersion<T> */
    FrameSystemExtensionsCheckSpecVersion: "Null",
    /** Lookup526: frame_system::extensions::check_tx_version::CheckTxVersion<T> */
    FrameSystemExtensionsCheckTxVersion: "Null",
    /** Lookup527: frame_system::extensions::check_genesis::CheckGenesis<T> */
    FrameSystemExtensionsCheckGenesis: "Null",
    /** Lookup530: frame_system::extensions::check_nonce::CheckNonce<T> */
    FrameSystemExtensionsCheckNonce: "Compact<u32>",
    /** Lookup531: frame_system::extensions::check_weight::CheckWeight<T> */
    FrameSystemExtensionsCheckWeight: "Null",
    /** Lookup532: pallet_transaction_payment::ChargeTransactionPayment<T> */
    PalletTransactionPaymentChargeTransactionPayment: "Compact<u128>",
    /** Lookup533: dancebox_runtime::Runtime */
