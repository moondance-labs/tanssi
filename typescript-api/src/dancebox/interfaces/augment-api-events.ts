...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetRate: {
      ...
      AssetRateUpdated: AugmentedEvent<ApiType, [assetKind: u16, old: u128, new_: u128], { assetKind: u16, old: u128, new_: u128 }>;
      /**
       * Generic event
       **/
    ...
    authorNoting: {
       ...
       **/
      LatestAuthorChanged: AugmentedEvent<ApiType, [paraId: u32, blockNumber: u32, newAuthor: AccountId32, latestSlotNumber: u64], { paraId: u32, blockNumber: u32, newAuthor: AccountId32, latestSlotNumber: u64 }>;
      /**
       * Removed author data
       **/
    ...
    collatorAssignment: {
      NewPendingAssignment: AugmentedEvent<ApiType, [randomSeed: U8aFixed, fullRotation: bool, targetSession: u32, fullRotationMode: TpTraitsFullRotationModes], { randomSeed: U8aFixed, fullRotation: bool, targetSession: u32, fullRotationMode: TpTraitsFullRotationModes }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    dataPreservers: {
      ...
      ProfileCreated: AugmentedEvent<ApiType, [account: AccountId32, profileId: u64, deposit: u128], { account: AccountId32, profileId: u64, deposit: u128 }>;
      ProfileDeleted: AugmentedEvent<ApiType, [profileId: u64, releasedDeposit: u128], { profileId: u64, releasedDeposit: u128 }>;
      ProfileUpdated: AugmentedEvent<ApiType, [profileId: u64, oldDeposit: u128, newDeposit: u128], { profileId: u64, oldDeposit: u128, newDeposit: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    foreignAssets: {
       ...
       **/
      AccountsDestroyed: AugmentedEvent<ApiType, [assetId: u16, accountsDestroyed: u32, accountsRemaining: u32], { assetId: u16, accountsDestroyed: u32, accountsRemaining: u32 }>;
      /**
       * An approval for account `delegate` was cancelled by `owner`.
       **/
      ApprovalCancelled: AugmentedEvent<ApiType, [assetId: u16, owner: AccountId32, delegate: AccountId32], { assetId: u16, owner: AccountId32, delegate: AccountId32 }>;
      /**
       * Approvals were destroyed for given asset.
       **/
      ApprovalsDestroyed: AugmentedEvent<ApiType, [assetId: u16, approvalsDestroyed: u32, approvalsRemaining: u32], { assetId: u16, approvalsDestroyed: u32, approvalsRemaining: u32 }>;
      /**
       * (Additional) funds have been approved for transfer to a destination account.
       **/
      ApprovedTransfer: AugmentedEvent<ApiType, [assetId: u16, source: AccountId32, delegate: AccountId32, amount: u128], { assetId: u16, source: AccountId32, delegate: AccountId32, amount: u128 }>;
      /**
       ...
       **/
      AssetMinBalanceChanged: AugmentedEvent<ApiType, [assetId: u16, newMinBalance: u128], { assetId: u16, newMinBalance: u128 }>;
      /**
       ...
       **/
      Burned: AugmentedEvent<ApiType, [assetId: u16, owner: AccountId32, balance: u128], { assetId: u16, owner: AccountId32, balance: u128 }>;
      /**
       * Some asset class was created.
       **/
      Created: AugmentedEvent<ApiType, [assetId: u16, creator: AccountId32, owner: AccountId32], { assetId: u16, creator: AccountId32, owner: AccountId32 }>;
      /**
       * Some assets were deposited (e.g. for transaction fees).
       **/
      Deposited: AugmentedEvent<ApiType, [assetId: u16, who: AccountId32, amount: u128], { assetId: u16, who: AccountId32, amount: u128 }>;
      /**
       ...
       **/
      ForceCreated: AugmentedEvent<ApiType, [assetId: u16, owner: AccountId32], { assetId: u16, owner: AccountId32 }>;
      /**
       ...
       **/
      Issued: AugmentedEvent<ApiType, [assetId: u16, owner: AccountId32, amount: u128], { assetId: u16, owner: AccountId32, amount: u128 }>;
      /**
       ...
       **/
      MetadataSet: AugmentedEvent<ApiType, [assetId: u16, name: Bytes, symbol_: Bytes, decimals: u8, isFrozen: bool], { assetId: u16, name: Bytes, symbol: Bytes, decimals: u8, isFrozen: bool }>;
      /**
       * The owner changed.
       **/
      OwnerChanged: AugmentedEvent<ApiType, [assetId: u16, owner: AccountId32], { assetId: u16, owner: AccountId32 }>;
      /**
       * The management team changed.
       **/
      TeamChanged: AugmentedEvent<ApiType, [assetId: u16, issuer: AccountId32, admin: AccountId32, freezer: AccountId32], { assetId: u16, issuer: AccountId32, admin: AccountId32, freezer: AccountId32 }>;
      /**
       ...
       **/
      Touched: AugmentedEvent<ApiType, [assetId: u16, who: AccountId32, depositor: AccountId32], { assetId: u16, who: AccountId32, depositor: AccountId32 }>;
      /**
       * Some assets were transferred.
       **/
      Transferred: AugmentedEvent<ApiType, [assetId: u16, from: AccountId32, to: AccountId32, amount: u128], { assetId: u16, from: AccountId32, to: AccountId32, amount: u128 }>;
      /**
       * An `amount` was transferred in its entirety from `owner` to `destination` by
       * the approved `delegate`.
       **/
      TransferredApproved: AugmentedEvent<ApiType, [assetId: u16, owner: AccountId32, delegate: AccountId32, destination: AccountId32, amount: u128], { assetId: u16, owner: AccountId32, delegate: AccountId32, destination: AccountId32, amount: u128 }>;
      /**
       * Some assets were withdrawn from the account (e.g. for transaction fees).
       **/
      Withdrawn: AugmentedEvent<ApiType, [assetId: u16, who: AccountId32, amount: u128], { assetId: u16, who: AccountId32, amount: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    foreignAssetsCreator: {
       ...
       **/
      ForeignAssetCreated: AugmentedEvent<ApiType, [assetId: u16, foreignAsset: StagingXcmV5Location], { assetId: u16, foreignAsset: StagingXcmV5Location }>;
      /**
       * Removed all information related to an assetId and destroyed asset
       **/
      ForeignAssetDestroyed: AugmentedEvent<ApiType, [assetId: u16, foreignAsset: StagingXcmV5Location], { assetId: u16, foreignAsset: StagingXcmV5Location }>;
      /**
       * Removed all information related to an assetId
       **/
      ForeignAssetRemoved: AugmentedEvent<ApiType, [assetId: u16, foreignAsset: StagingXcmV5Location], { assetId: u16, foreignAsset: StagingXcmV5Location }>;
      /**
       * Changed the xcm type mapping for a given asset id
       **/
      ForeignAssetTypeChanged: AugmentedEvent<ApiType, [assetId: u16, newForeignAsset: StagingXcmV5Location], { assetId: u16, newForeignAsset: StagingXcmV5Location }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    inflationRewards: {
       ...
       **/
      RewardedContainer: AugmentedEvent<ApiType, [accountId: AccountId32, paraId: u32, balance: u128], { accountId: AccountId32, paraId: u32, balance: u128 }>;
      /**
       * Rewarding orchestrator author
       **/
      RewardedOrchestrator: AugmentedEvent<ApiType, [accountId: AccountId32, balance: u128], { accountId: AccountId32, balance: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    pooledStaking: {
       ...
       **/
      ClaimedManualRewards: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, rewards: u128], { candidate: AccountId32, delegator: AccountId32, rewards: u128 }>;
      /**
       * Stake of that Candidate decreased.
       **/
      DecreasedStake: AugmentedEvent<ApiType, [candidate: AccountId32, stakeDiff: u128], { candidate: AccountId32, stakeDiff: u128 }>;
      /**
       ...
       * `released`.
       **/
      ExecutedDelegate: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, pool: PalletPooledStakingTargetPool, staked: u128, released: u128], { candidate: AccountId32, delegator: AccountId32, pool: PalletPooledStakingTargetPool, staked: u128, released: u128 }>;
      /**
       * Undelegation request was executed.
       **/
      ExecutedUndelegate: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, released: u128], { candidate: AccountId32, delegator: AccountId32, released: u128 }>;
      /**
       * Stake of that Candidate increased.
       **/
      IncreasedStake: AugmentedEvent<ApiType, [candidate: AccountId32, stakeDiff: u128], { candidate: AccountId32, stakeDiff: u128 }>;
      /**
       * User requested to delegate towards a candidate.
       **/
      RequestedDelegate: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, pool: PalletPooledStakingTargetPool, pending: u128], { candidate: AccountId32, delegator: AccountId32, pool: PalletPooledStakingTargetPool, pending: u128 }>;
      /**
       ...
       **/
      RequestedUndelegate: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, from: PalletPooledStakingTargetPool, pending: u128, released: u128], { candidate: AccountId32, delegator: AccountId32, from: PalletPooledStakingTargetPool, pending: u128, released: u128 }>;
      /**
       * Collator has been rewarded.
       **/
      RewardedCollator: AugmentedEvent<ApiType, [collator: AccountId32, autoCompoundingRewards: u128, manualClaimRewards: u128], { collator: AccountId32, autoCompoundingRewards: u128, manualClaimRewards: u128 }>;
      /**
       * Delegators have been rewarded.
       **/
      RewardedDelegators: AugmentedEvent<ApiType, [collator: AccountId32, autoCompoundingRewards: u128, manualClaimRewards: u128], { collator: AccountId32, autoCompoundingRewards: u128, manualClaimRewards: u128 }>;
      /**
       * Delegator staked towards a Candidate for AutoCompounding Shares.
       **/
      StakedAutoCompounding: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, shares: u128, stake: u128], { candidate: AccountId32, delegator: AccountId32, shares: u128, stake: u128 }>;
      /**
       * Delegator staked towards a candidate for ManualRewards Shares.
       **/
      StakedManualRewards: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, shares: u128, stake: u128], { candidate: AccountId32, delegator: AccountId32, shares: u128, stake: u128 }>;
      /**
       * Swapped between AutoCompounding and ManualReward shares
       **/
      SwappedPool: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, sourcePool: PalletPooledStakingTargetPool, sourceShares: u128, sourceStake: u128, targetShares: u128, targetStake: u128, pendingLeaving: u128, released: u128], { candidate: AccountId32, delegator: AccountId32, sourcePool: PalletPooledStakingTargetPool, sourceShares: u128, sourceStake: u128, targetShares: u128, targetStake: u128, pendingLeaving: u128, released: u128 }>;
      /**
       * Delegator unstaked towards a candidate with AutoCompounding Shares.
       **/
      UnstakedAutoCompounding: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, shares: u128, stake: u128], { candidate: AccountId32, delegator: AccountId32, shares: u128, stake: u128 }>;
      /**
       * Delegator unstaked towards a candidate with ManualRewards Shares.
       **/
      UnstakedManualRewards: AugmentedEvent<ApiType, [candidate: AccountId32, delegator: AccountId32, shares: u128, stake: u128], { candidate: AccountId32, delegator: AccountId32, shares: u128, stake: u128 }>;
      /**
       * Stake of the candidate has changed, which may have modified its
       * position in the eligible candidates list.
       **/
      UpdatedCandidatePosition: AugmentedEvent<ApiType, [candidate: AccountId32, stake: u128, selfDelegation: u128, before: Option<u32>, after: Option<u32>], { candidate: AccountId32, stake: u128, selfDelegation: u128, before: Option<u32>, after: Option<u32> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: DanceboxRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: DanceboxRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: DanceboxRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: DanceboxRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: DanceboxRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: DanceboxRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    registrar: {
       ...
       **/
      ParaManagerChanged: AugmentedEvent<ApiType, [paraId: u32, managerAddress: AccountId32], { paraId: u32, managerAddress: AccountId32 }>;
      /**
    ...
    servicesPayment: {
      BlockProductionCreditBurned: AugmentedEvent<ApiType, [paraId: u32, creditsRemaining: u32], { paraId: u32, creditsRemaining: u32 }>;
      BlockProductionCreditsSet: AugmentedEvent<ApiType, [paraId: u32, credits: u32], { paraId: u32, credits: u32 }>;
      CollatorAssignmentCreditBurned: AugmentedEvent<ApiType, [paraId: u32, creditsRemaining: u32], { paraId: u32, creditsRemaining: u32 }>;
      CollatorAssignmentCreditsSet: AugmentedEvent<ApiType, [paraId: u32, credits: u32], { paraId: u32, credits: u32 }>;
      CollatorAssignmentTipCollected: AugmentedEvent<ApiType, [paraId: u32, payer: AccountId32, tip: u128], { paraId: u32, payer: AccountId32, tip: u128 }>;
      CreditsPurchased: AugmentedEvent<ApiType, [paraId: u32, payer: AccountId32, credit: u128], { paraId: u32, payer: AccountId32, credit: u128 }>;
      MaxCorePriceUpdated: AugmentedEvent<ApiType, [paraId: u32, maxCorePrice: Option<u128>], { paraId: u32, maxCorePrice: Option<u128> }>;
      RefundAddressUpdated: AugmentedEvent<ApiType, [paraId: u32, refundAddress: Option<AccountId32>], { paraId: u32, refundAddress: Option<AccountId32> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    streamPayment: {
      ...
      StreamConfigChanged: AugmentedEvent<ApiType, [streamId: u64, oldConfig: PalletStreamPaymentStreamConfig, newConfig: PalletStreamPaymentStreamConfig, depositChange: Option<PalletStreamPaymentDepositChange>], { streamId: u64, oldConfig: PalletStreamPaymentStreamConfig, newConfig: PalletStreamPaymentStreamConfig, depositChange: Option<PalletStreamPaymentDepositChange> }>;
      StreamConfigChangeRequested: AugmentedEvent<ApiType, [streamId: u64, requestNonce: u32, requester: PalletStreamPaymentParty, oldConfig: PalletStreamPaymentStreamConfig, newConfig: PalletStreamPaymentStreamConfig], { streamId: u64, requestNonce: u32, requester: PalletStreamPaymentParty, oldConfig: PalletStreamPaymentStreamConfig, newConfig: PalletStreamPaymentStreamConfig }>;
      StreamOpened: AugmentedEvent<ApiType, [streamId: u64], { streamId: u64 }>;
      StreamPayment: AugmentedEvent<ApiType, [streamId: u64, source: AccountId32, target: AccountId32, amount: u128, stalled: bool], { streamId: u64, source: AccountId32, target: AccountId32, amount: u128, stalled: bool }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    xcmCoreBuyer: {
       ...
       **/
      BuyCoreXcmSent: AugmentedEvent<ApiType, [paraId: u32, transactionStatusQueryId: u64], { paraId: u32, transactionStatusQueryId: u64 }>;
      /**
       ...
       **/
      ReceivedBuyCoreXCMResult: AugmentedEvent<ApiType, [paraId: u32, response: StagingXcmV5Response], { paraId: u32, response: StagingXcmV5Response }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
