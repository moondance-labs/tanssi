...
declare module "@polkadot/types/lookup" {
  ...
  /** @name PalletAuthorNotingEvent (44) */
  ...
  /** @name PolkadotPrimitivesV4PersistedValidationData (73) */
  ...
  /** @name PolkadotPrimitivesV4UpgradeRestriction (76) */
  interface PolkadotPrimitivesV4UpgradeRestriction extends Enum {
    readonly isPresent: boolean;
    readonly type: "Present";
  }

  /** @name SpTrieStorageProof (77) */
  interface SpTrieStorageProof extends Struct {
    readonly trieNodes: BTreeSet<Bytes>;
  }

  /** @name CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot (79) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotRelayDispachQueueSize (80) */
  ...
  /** @name PolkadotPrimitivesV4AbridgedHrmpChannel (83) */
  ...
  /** @name PolkadotPrimitivesV4AbridgedHostConfiguration (85) */
  ...
  /** @name PolkadotCorePrimitivesOutboundHrmpMessage (91) */
  interface PolkadotCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemCodeUpgradeAuthorization (92) */
  ...
  /** @name PolkadotCorePrimitivesInboundDownwardMessage (96) */
  interface PolkadotCorePrimitivesInboundDownwardMessage extends Struct {
    readonly sentAt: u32;
    readonly msg: Bytes;
  }

  /** @name PolkadotCorePrimitivesInboundHrmpMessage (99) */
  interface PolkadotCorePrimitivesInboundHrmpMessage extends Struct {
    readonly sentAt: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemError (102) */
  ...
  /** @name DanceboxRuntimeOriginCaller (109) */
  ...
  /** @name FrameSupportDispatchRawOrigin (110) */
  ...
  /** @name TpContainerChainGenesisDataContainerChainGenesisData (120) */
  ...
  /** @name TpContainerChainGenesisDataContainerChainGenesisDataItem (122) */
  ...
  /** @name TpContainerChainGenesisDataProperties (124) */
  ...
  /** @name TpContainerChainGenesisDataTokenMetadata (125) */
  ...
  /** @name PalletConfigurationCall (130) */
  ...
  /** @name PalletCollatorAssignmentCall (131) */
  ...
  /** @name DanceboxRuntimeSessionKeys (137) */
  ...
  /** @name SpCoreSr25519Public (139) */
  interface SpCoreSr25519Public extends U8aFixed {}

  /** @name PalletAuthorInherentCall (140) */
  ...
  /** @name PalletRootTestingCall (141) */
  ...
  /** @name PalletProxyProxyDefinition (147) */
  ...
  /** @name PalletProxyAnnouncement (151) */
  ...
  /** @name PalletBalancesIdAmount (162) */
  ...
  /** @name PalletRegistrarDepositInfo (169) */
  interface PalletRegistrarDepositInfo extends Struct {
    readonly creator: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletRegistrarError (170) */
  ...
  /** @name PalletConfigurationHostConfiguration (171) */
  ...
  /** @name PalletConfigurationError (174) */
  interface PalletConfigurationError extends Enum {
    readonly isInvalidNewValue: boolean;
    readonly type: "InvalidNewValue";
  }

  /** @name TpCollatorAssignmentAssignedCollatorsAccountId32 (175) */
  ...
  /** @name PalletInitializerBufferedSessionChange (180) */
  ...
  /** @name PalletAuthorNotingError (183) */
  ...
  /** @name TpCollatorAssignmentAssignedCollatorsPublic (184) */
  ...
  /** @name PalletCollatorSelectionCandidateInfo (191) */
  ...
  /** @name PalletAuthorInherentError (203) */
  ...
  /** @name FrameSystemExtensionsCheckNonZeroSender (212) */
  type FrameSystemExtensionsCheckNonZeroSender = Null;

  /** @name FrameSystemExtensionsCheckSpecVersion (213) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (214) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (215) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (218) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (219) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name DanceboxRuntimeRuntime (220) */
