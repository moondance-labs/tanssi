...
declare module "@polkadot/rpc-core/types/jsonrpc" {
    interface RpcInterface {
        ...
        contracts: {
            /** @deprecated Use the runtime interface `api.call.contractsApi.call` instead Executes a call to a contract */
            call: AugmentedRpc<
                (
                    callRequest:
                        | ContractCallRequest
            ...
            >;
            /**
             * @deprecated Use the runtime interface `api.call.contractsApi.getStorage` instead Returns the value under a
            ...
            >;
            /** @deprecated Use the runtime interface `api.call.contractsApi.instantiate` instead Instantiate a new contract */
            ...
            >;
            /**
             * @deprecated Not available in newer versions of the contracts interfaces Returns the projected time a given
             *   contract will be able to sustain paying its rent
             */
            ...
            >;
            /**
             * @deprecated Use the runtime interface `api.call.contractsApi.uploadCode` instead Upload new code without
        ...
        payment: {
            /**
             * @deprecated Use `api.call.transactionPaymentApi.queryFeeDetails` instead Query the detailed fee of a given
             *   encoded extrinsic
             */
        ...
        state: {
            ...
            >;
            /** @deprecated Use `api.rpc.state.getKeysPaged` to retrieve keys Retrieves the keys with a certain prefix */
            getKeys: AugmentedRpc<
                (
                    key: StorageKey | string | Uint8Array | any,
                    at?: BlockHash | string | Uint8Array
            ...
            /**
             * @deprecated Use `api.rpc.state.getKeysPaged` to retrieve keys Returns the keys with prefix, leave empty to get
             *   all the keys (deprecated: Use getKeysPaged)
             */
