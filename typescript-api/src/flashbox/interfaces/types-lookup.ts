...
declare module '@polkadot/types/lookup' {
  ...
  interface FlashboxRuntimeProxyType extends Enum {
    ...
    readonly type: 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'Registrar' | 'SudoRegistrar';
  }
  ...
  /** @name FlashboxRuntimeTimeUnit (53) */
  ...
  /** @name FlashboxRuntimeStreamPaymentAssetId (54) */
  ...
  /** @name PalletRootTestingEvent (76) */
  ...
  /** @name FrameSystemCodeUpgradeAuthorization (85) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentAncestor (104) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentUsedBandwidth (105) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentHrmpChannelUpdate (107) */
  interface CumulusPalletParachainSystemUnincludedSegmentHrmpChannelUpdate extends Struct {
    readonly msgCount: u32;
    readonly totalBytes: u32;
  }

  /** @name PolkadotPrimitivesV8UpgradeGoAhead (112) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentSegmentTracker (113) */
  ...
  /** @name PolkadotPrimitivesV8PersistedValidationData (115) */
  ...
  /** @name PolkadotPrimitivesV8UpgradeRestriction (118) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot (121) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotRelayDispatchQueueRemainingCapacity (122) */
  interface CumulusPalletParachainSystemRelayStateSnapshotRelayDispatchQueueRemainingCapacity extends Struct {
    readonly remainingCount: u32;
    readonly remainingSize: u32;
  }

  /** @name PolkadotPrimitivesV8AbridgedHrmpChannel (125) */
  ...
  /** @name PolkadotPrimitivesV8AbridgedHostConfiguration (126) */
  ...
  /** @name PolkadotPrimitivesV8AsyncBackingAsyncBackingParams (127) */
  ...
  /** @name StagingParachainInfoCall (146) */
  ...
  /** @name FlashboxRuntimeOriginCaller (151) */
  ...
  /** @name PalletMaintenanceModeCall (159) */
  ...
  /** @name PalletStreamPaymentCall (165) */
  ...
  /** @name PalletStreamPaymentChangeKind (166) */
  ...
  /** @name PalletIdentityLegacyIdentityInfo (168) */
  ...
  /** @name DpContainerChainGenesisDataContainerChainGenesisData (213) */
  ...
  /** @name DpContainerChainGenesisDataContainerChainGenesisDataItem (215) */
  interface DpContainerChainGenesisDataContainerChainGenesisDataItem extends Struct {
    readonly key: Bytes;
    readonly value: Bytes;
  }

  /** @name DpContainerChainGenesisDataProperties (217) */
  ...
  /** @name DpContainerChainGenesisDataTokenMetadata (218) */
  ...
  /** @name TpTraitsSlotFrequency (221) */
  interface TpTraitsSlotFrequency extends Struct {
    readonly min: u32;
    readonly max: u32;
  }

  /** @name TpTraitsParathreadParams (223) */
  interface TpTraitsParathreadParams extends Struct {
    readonly slotFrequency: TpTraitsSlotFrequency;
  }

  /** @name PalletConfigurationCall (224) */
  ...
  /** @name PalletCollatorAssignmentCall (227) */
  type PalletCollatorAssignmentCall = Null;

  /** @name PalletAuthorNotingCall (228) */
  ...
  /** @name TpAuthorNotingInherentOwnParachainInherentData (229) */
  interface TpAuthorNotingInherentOwnParachainInherentData extends Struct {
    readonly relayStorageProof: SpTrieStorageProof;
  }

  /** @name PalletAuthorityAssignmentCall (230) */
  type PalletAuthorityAssignmentCall = Null;

  /** @name PalletServicesPaymentCall (231) */
  ...
  /** @name PalletDataPreserversCall (232) */
  ...
  /** @name PalletDataPreserversProfile (233) */
  ...
  /** @name PalletDataPreserversParaIdsFilter (235) */
  ...
  /** @name PalletDataPreserversProfileMode (239) */
  ...
  /** @name FlashboxRuntimePreserversAssignementPaymentRequest (240) */
  ...
  /** @name FlashboxRuntimePreserversAssignementPaymentExtra (241) */
  ...
  /** @name FlashboxRuntimePreserversAssignementPaymentWitness (242) */
  ...
  /** @name PalletInvulnerablesCall (243) */
  ...
  /** @name PalletRootTestingCall (249) */
  ...
  /** @name PalletMigrationsError (261) */
  ...
  /** @name PalletMaintenanceModeError (262) */
  ...
  /** @name FrameSupportTokensMiscIdAmountRuntimeHoldReason (272) */
  interface FrameSupportTokensMiscIdAmountRuntimeHoldReason extends Struct {
    readonly id: FlashboxRuntimeRuntimeHoldReason;
    readonly amount: u128;
  }

  /** @name FlashboxRuntimeRuntimeHoldReason (273) */
  ...
  /** @name PalletStreamPaymentHoldReason (274) */
  ...
  /** @name PalletStreamPaymentFreezeReason (281) */
  ...
  /** @name PalletStreamPaymentStream (285) */
  ...
  /** @name PalletStreamPaymentChangeRequest (287) */
  ...
  /** @name PalletStreamPaymentError (289) */
  ...
  /** @name PalletIdentityRegistration (290) */
  ...
  /** @name PalletMultisigMultisig (307) */
  ...
  /** @name PalletRegistrarDepositInfo (318) */
  interface PalletRegistrarDepositInfo extends Struct {
    readonly creator: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletRegistrarError (319) */
  ...
  /** @name PalletConfigurationHostConfiguration (320) */
  ...
  /** @name PalletConfigurationError (323) */
  interface PalletConfigurationError extends Enum {
    readonly isInvalidNewValue: boolean;
    readonly type: 'InvalidNewValue';
  }

  /** @name DpCollatorAssignmentAssignedCollatorsAccountId32 (324) */
  ...
  /** @name TpTraitsContainerChainBlockInfo (329) */
  ...
  /** @name PalletAuthorNotingError (330) */
  ...
  /** @name DpCollatorAssignmentAssignedCollatorsPublic (331) */
  ...
  /** @name PalletServicesPaymentError (336) */
  ...
  /** @name PalletDataPreserversRegisteredProfile (337) */
  ...
  /** @name PalletDataPreserversError (343) */
  ...
  /** @name PalletInvulnerablesError (345) */
  ...
  /** @name SpCoreCryptoKeyTypeId (350) */
  interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (351) */
  ...
  /** @name PalletAuthorInherentError (355) */
  ...
  /** @name PalletInflationRewardsChainsToRewardValue (356) */
  ...
  /** @name PalletTreasurySpendStatus (359) */
  ...
  /** @name PalletTreasuryPaymentState (360) */
  ...
  /** @name CumulusPrimitivesStorageWeightReclaimStorageWeightReclaim (377) */
  type CumulusPrimitivesStorageWeightReclaimStorageWeightReclaim = Null;

  /** @name FlashboxRuntimeRuntime (378) */
