...
import type { FlashboxRuntimeProxyType, FrameSupportTokensMiscBalanceStatus, FrameSystemDispatchEventInfo, PalletMultisigTimepoint, PalletStreamPaymentDepositChange, PalletStreamPaymentParty, PalletStreamPaymentStreamConfig, SpRuntimeDispatchError, SpWeightsWeightV2Weight, TpTraitsFullRotationModes } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: FlashboxRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: FlashboxRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: FlashboxRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: FlashboxRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: FlashboxRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: FlashboxRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
