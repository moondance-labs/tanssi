...
import type { BTreeMap, BTreeSet, BitVec, Bytes, Compact, Enum, Null, Option, Result, Struct, Text, U256, U8aFixed, Vec, bool, i32, i64, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletRegistrarEvent extends Enum {
    ...
    readonly type: 'ParaIdRegistered' | 'ParaIdDeregistered' | 'ParaIdValidForCollating' | 'ParaIdPaused' | 'ParaIdUnpaused' | 'ParathreadParamsChanged' | 'ParaManagerChanged';
  }
  ...
  interface PalletServicesPaymentEvent extends Enum {
    ...
    readonly type: 'CreditsPurchased' | 'BlockProductionCreditBurned' | 'CollatorAssignmentCreditBurned' | 'CollatorAssignmentTipCollected' | 'BlockProductionCreditsSet' | 'RefundAddressUpdated' | 'MaxCorePriceUpdated' | 'CollatorAssignmentCreditsSet';
  }
  ...
  interface PalletDataPreserversEvent extends Enum {
    ...
    readonly type: 'BootNodesChanged' | 'ProfileCreated' | 'ProfileUpdated' | 'ProfileDeleted' | 'AssignmentStarted' | 'AssignmentStopped';
  }
  ...
  interface SnowbridgePalletSystemEvent extends Enum {
    ...
    readonly type: 'Upgrade' | 'CreateAgent' | 'CreateChannel' | 'UpdateChannel' | 'SetOperatingMode' | 'TransferNativeFromAgent' | 'SetTokenTransferFees' | 'PricingParametersChanged' | 'RegisterToken';
  }
  ...
  /** @name SpConsensusGrandpaAppPublic (120) */
  interface SpConsensusGrandpaAppPublic extends U8aFixed {}

  /** @name PalletInflationRewardsEvent (121) */
  ...
  /** @name PalletPooledStakingEvent (122) */
  interface PalletPooledStakingEvent extends Enum {
    ...
    readonly type: 'UpdatedCandidatePosition' | 'RequestedDelegate' | 'ExecutedDelegate' | 'RequestedUndelegate' | 'ExecutedUndelegate' | 'IncreasedStake' | 'DecreasedStake' | 'StakedAutoCompounding' | 'UnstakedAutoCompounding' | 'StakedManualRewards' | 'UnstakedManualRewards' | 'RewardedCollator' | 'RewardedDelegators' | 'ClaimedManualRewards' | 'SwappedPool';
  }

  /** @name PalletPooledStakingTargetPool (124) */
  ...
  /** @name PalletConvictionVotingEvent (127) */
  ...
  /** @name PalletConvictionVotingVoteAccountVote (128) */
  ...
  /** @name PalletBalancesAdjustmentDirection (151) */
  ...
  /** @name DancelightRuntimeRuntimeParameters (153) */
  ...
  /** @name DancelightRuntimeDynamicParamsPreimageParameters (154) */
  ...
  interface PalletRegistrarCall extends Enum {
    ...
    readonly type: 'Register' | 'Deregister' | 'MarkValidForCollating' | 'PauseContainerChain' | 'UnpauseContainerChain' | 'RegisterParathread' | 'SetParathreadParams' | 'SetParaManager' | 'RegisterWithRelayProof' | 'DeregisterWithRelayProof';
  }

  /** @name DpContainerChainGenesisDataContainerChainGenesisData (156) */
  ...
  /** @name DpContainerChainGenesisDataContainerChainGenesisDataItem (158) */
  interface DpContainerChainGenesisDataContainerChainGenesisDataItem extends Struct {
    readonly key: Bytes;
    readonly value: Bytes;
  }

  /** @name DpContainerChainGenesisDataProperties (160) */
  ...
  /** @name DpContainerChainGenesisDataTokenMetadata (161) */
  ...
  /** @name TpTraitsSlotFrequency (165) */
  interface TpTraitsSlotFrequency extends Struct {
    readonly min: u32;
    readonly max: u32;
  }

  /** @name TpTraitsParathreadParams (167) */
  ...
  /** @name PalletConfigurationCall (173) */
  interface PalletConfigurationCall extends Enum {
    ...
    readonly type: 'SetMaxCollators' | 'SetMinOrchestratorCollators' | 'SetMaxOrchestratorCollators' | 'SetCollatorsPerContainer' | 'SetFullRotationPeriod' | 'SetCollatorsPerParathread' | 'SetParathreadsPerCollator' | 'SetTargetContainerChainFullness' | 'SetMaxParachainCoresPercentage' | 'SetFullRotationMode' | 'SetBypassConsistencyCheck';
  }

  /** @name PalletInvulnerablesCall (176) */
  ...
  /** @name PalletCollatorAssignmentCall (177) */
  type PalletCollatorAssignmentCall = Null;

  /** @name PalletAuthorityAssignmentCall (178) */
  type PalletAuthorityAssignmentCall = Null;

  /** @name PalletAuthorNotingCall (179) */
  ...
  /** @name PalletServicesPaymentCall (180) */
  interface PalletServicesPaymentCall extends Enum {
    ...
    readonly type: 'PurchaseCredits' | 'SetBlockProductionCredits' | 'SetGivenFreeCredits' | 'SetRefundAddress' | 'SetCollatorAssignmentCredits' | 'SetMaxCorePrice' | 'SetMaxTip';
  }

  /** @name PalletDataPreserversCall (181) */
  interface PalletDataPreserversCall extends Enum {
    ...
    readonly type: 'CreateProfile' | 'UpdateProfile' | 'DeleteProfile' | 'ForceCreateProfile' | 'ForceUpdateProfile' | 'ForceDeleteProfile' | 'StartAssignment' | 'StopAssignment' | 'ForceStartAssignment';
  }

  /** @name PalletDataPreserversProfile (182) */
  ...
  /** @name PalletDataPreserversParaIdsFilter (184) */
  ...
  /** @name PalletDataPreserversProfileMode (188) */
  ...
  interface PalletExternalValidatorsCall extends Enum {
    ...
    readonly type: 'SkipExternalValidators' | 'AddWhitelisted' | 'RemoveWhitelisted' | 'ForceEra' | 'SetExternalValidators';
  }

  /** @name PalletExternalValidatorSlashesCall (193) */
  ...
  /** @name SnowbridgePalletOutboundQueueCall (195) */
  ...
  /** @name SnowbridgePalletInboundQueueCall (196) */
  ...
  /** @name SnowbridgeCoreInboundMessage (197) */
  ...
  /** @name SnowbridgeCoreInboundLog (198) */
  ...
  /** @name SnowbridgeCoreInboundProof (200) */
  ...
  /** @name SnowbridgeBeaconPrimitivesExecutionProof (202) */
  ...
  /** @name SnowbridgeBeaconPrimitivesBeaconHeader (203) */
  ...
  /** @name SnowbridgeBeaconPrimitivesAncestryProof (205) */
  ...
  /** @name SnowbridgeBeaconPrimitivesVersionedExecutionPayloadHeader (206) */
  ...
  /** @name SnowbridgeBeaconPrimitivesExecutionPayloadHeader (207) */
  ...
  /** @name SnowbridgeBeaconPrimitivesDenebExecutionPayloadHeader (208) */
  ...
  /** @name SnowbridgePalletSystemCall (209) */
  interface SnowbridgePalletSystemCall extends Enum {
    ...
    readonly type: 'Upgrade' | 'SetOperatingMode' | 'SetPricingParameters' | 'CreateAgent' | 'CreateChannel' | 'UpdateChannel' | 'ForceUpdateChannel' | 'TransferNativeFromAgent' | 'ForceTransferNativeFromAgent' | 'SetTokenTransferFees' | 'RegisterToken';
  }

  /** @name SnowbridgeCoreOutboundV1Initializer (211) */
  interface SnowbridgeCoreOutboundV1Initializer extends Struct {
    readonly params: Bytes;
    readonly maximumRequiredGas: u64;
  }

  /** @name SnowbridgeCoreAssetMetadata (212) */
  ...
  /** @name DancelightRuntimeSessionKeys (215) */
  ...
  /** @name PolkadotPrimitivesV8ValidatorAppPublic (216) */
  interface PolkadotPrimitivesV8ValidatorAppPublic extends U8aFixed {}

  /** @name PolkadotPrimitivesV8AssignmentAppPublic (217) */
  ...
  /** @name SpConsensusBeefyEcdsaCryptoPublic (219) */
  interface SpConsensusBeefyEcdsaCryptoPublic extends U8aFixed {}

  /** @name NimbusPrimitivesNimbusCryptoPublic (221) */
  ...
  /** @name PalletPooledStakingCall (232) */
  interface PalletPooledStakingCall extends Enum {
    ...
    readonly type: 'RebalanceHold' | 'RequestDelegate' | 'ExecutePendingOperations' | 'RequestUndelegate' | 'ClaimManualRewards' | 'UpdateCandidatePosition' | 'SwapPool';
  }

  /** @name PalletPooledStakingAllTargetPool (233) */
  ...
  /** @name PalletPooledStakingPendingOperationQuery (235) */
  ...
  /** @name PalletPooledStakingPendingOperationKey (236) */
  ...
  /** @name PalletPooledStakingSharesOrStake (237) */
  ...
  /** @name DancelightRuntimeOriginCaller (245) */
  ...
  /** @name FrameSupportDispatchRawOrigin (246) */
  ...
  /** @name DancelightRuntimeGovernanceOriginsPalletCustomOriginsOrigin (247) */
  ...
  /** @name PolkadotRuntimeParachainsOriginPalletOrigin (248) */
  ...
  /** @name FrameSupportScheduleDispatchTime (251) */
  ...
  /** @name PalletRankedCollectiveCall (252) */
  ...
  /** @name PolkadotRuntimeParachainsConfigurationPalletCall (255) */
  ...
  /** @name PolkadotPrimitivesV8PvfPrepKind (260) */
  ...
  /** @name PolkadotPrimitivesV8PvfExecKind (261) */
  ...
  /** @name PolkadotRuntimeParachainsSharedPalletCall (264) */
  type PolkadotRuntimeParachainsSharedPalletCall = Null;

  /** @name PolkadotRuntimeParachainsInclusionPalletCall (265) */
  ...
  /** @name PolkadotPrimitivesVstagingInherentData (267) */
  ...
  /** @name PolkadotPrimitivesV8SignedUncheckedSigned (269) */
  ...
  /** @name BitvecOrderLsb0 (272) */
  type BitvecOrderLsb0 = Null;

  /** @name PolkadotPrimitivesV8ValidatorAppSignature (274) */
  interface PolkadotPrimitivesV8ValidatorAppSignature extends U8aFixed {}

  /** @name PolkadotPrimitivesVstagingBackedCandidate (276) */
  ...
  /** @name PolkadotPrimitivesVstagingCommittedCandidateReceiptV2 (277) */
  ...
  /** @name PolkadotPrimitivesVstagingCandidateDescriptorV2 (278) */
  ...
  /** @name PolkadotPrimitivesV8CandidateCommitments (282) */
  ...
  /** @name PolkadotPrimitivesV8ValidityAttestation (290) */
  ...
  /** @name PolkadotPrimitivesV8DisputeStatementSet (292) */
  ...
  /** @name PolkadotPrimitivesV8DisputeStatement (296) */
  ...
  /** @name PolkadotPrimitivesV8ValidDisputeStatementKind (297) */
  ...
  /** @name PolkadotPrimitivesV8InvalidDisputeStatementKind (299) */
  interface PolkadotPrimitivesV8InvalidDisputeStatementKind extends Enum {
    readonly isExplicit: boolean;
    readonly type: 'Explicit';
  }

  /** @name PolkadotRuntimeParachainsParasPalletCall (300) */
  ...
  /** @name PolkadotPrimitivesV8PvfCheckStatement (301) */
  ...
  /** @name PolkadotRuntimeParachainsInitializerPalletCall (302) */
  ...
  /** @name PolkadotRuntimeParachainsHrmpPalletCall (303) */
  ...
  /** @name PolkadotParachainPrimitivesPrimitivesHrmpChannelId (304) */
  interface PolkadotParachainPrimitivesPrimitivesHrmpChannelId extends Struct {
    readonly sender: u32;
    readonly recipient: u32;
  }

  /** @name PolkadotRuntimeParachainsDisputesPalletCall (305) */
  ...
  /** @name PolkadotRuntimeParachainsDisputesSlashingPalletCall (306) */
  ...
  /** @name PolkadotPrimitivesV8SlashingDisputeProof (307) */
  ...
  /** @name PolkadotPrimitivesV8SlashingDisputesTimeSlot (308) */
  interface PolkadotPrimitivesV8SlashingDisputesTimeSlot extends Struct {
    readonly sessionIndex: u32;
    readonly candidateHash: H256;
  }

  /** @name PolkadotPrimitivesV8SlashingSlashingOffenceKind (309) */
  ...
  /** @name DancelightRuntimeAggregateMessageOrigin (311) */
  ...
  /** @name PolkadotRuntimeParachainsInclusionUmpQueueId (312) */
  ...
  /** @name PolkadotRuntimeParachainsOnDemandPalletCall (313) */
  ...
  /** @name PolkadotRuntimeCommonParasRegistrarPalletCall (314) */
  ...
  /** @name DancelightRuntimeProxyType (361) */
  interface DancelightRuntimeProxyType extends Enum {
    ...
    readonly type: 'Any' | 'NonTransfer' | 'Governance' | 'IdentityJudgement' | 'CancelProxy' | 'Auction' | 'OnDemandOrdering' | 'SudoRegistrar' | 'SudoValidatorManagement' | 'SessionKeyManagement' | 'Staking';
  }
  ...
  /** @name PalletMultisigTimepoint (364) */
  interface PalletMultisigTimepoint extends Struct {
    readonly height: u32;
    readonly index: u32;
  }

  /** @name PalletPreimageCall (365) */
  ...
  /** @name XcmV3MultiassetMultiAssets (372) */
  interface XcmV3MultiassetMultiAssets extends Vec<XcmV3MultiAsset> {}

  /** @name XcmV3MultiAsset (374) */
  interface XcmV3MultiAsset extends Struct {
    readonly id: XcmV3MultiassetAssetId;
    readonly fun: XcmV3MultiassetFungibility;
  }

  /** @name XcmV3MultiassetAssetId (375) */
  ...
  /** @name XcmV3MultiassetFungibility (376) */
  ...
  /** @name XcmV3MultiassetAssetInstance (377) */
  ...
  /** @name XcmV3QueryResponseInfo (391) */
  ...
  /** @name XcmV3MultiassetMultiAssetFilter (392) */
  ...
  /** @name XcmV3MultiassetWildMultiAsset (393) */
  ...
  /** @name XcmV3MultiassetWildFungibility (394) */
  ...
  /** @name StagingXcmV4AssetAssetInstance (404) */
  ...
  /** @name StagingXcmV4PalletInfo (407) */
  ...
  /** @name StagingXcmV4QueryResponseInfo (411) */
  ...
  /** @name StagingXcmV4AssetAssetFilter (412) */
  ...
  /** @name StagingXcmV4AssetWildAsset (413) */
  ...
  /** @name StagingXcmV4AssetWildFungibility (414) */
  ...
  /** @name StagingXcmV5AssetAssetInstance (423) */
  ...
  /** @name StagingXcmV5PalletInfo (429) */
  ...
  /** @name StagingXcmV5QueryResponseInfo (434) */
  ...
  /** @name StagingXcmV5AssetAssetFilter (435) */
  ...
  /** @name StagingXcmV5AssetWildAsset (436) */
  ...
  /** @name StagingXcmV5AssetWildFungibility (437) */
  ...
  /** @name StagingXcmV5AssetAssetTransferFilter (439) */
  ...
  /** @name StagingXcmExecutorAssetTransferTransferType (457) */
  ...
  /** @name PalletMigrationsMigrationCursor (461) */
  ...
  /** @name PalletMigrationsActiveCursor (463) */
  ...
  /** @name PalletMigrationsHistoricCleanupSelector (465) */
  ...
  /** @name SpConsensusBeefyDoubleVotingProof (469) */
  ...
  /** @name SpConsensusBeefyEcdsaCryptoSignature (470) */
  interface SpConsensusBeefyEcdsaCryptoSignature extends U8aFixed {}

  /** @name SpConsensusBeefyVoteMessage (471) */
  ...
  /** @name SpConsensusBeefyCommitment (472) */
  ...
  /** @name SpConsensusBeefyPayload (473) */
  interface SpConsensusBeefyPayload extends Vec<ITuple<[U8aFixed, Bytes]>> {}

  /** @name SpConsensusBeefyForkVotingProof (476) */
  ...
  /** @name SpMmrPrimitivesAncestryProof (477) */
  ...
  /** @name SpConsensusBeefyFutureBlockVotingProof (480) */
  interface SpConsensusBeefyFutureBlockVotingProof extends Struct {
    readonly vote: SpConsensusBeefyVoteMessage;
  }

  /** @name SnowbridgePalletEthereumClientCall (481) */
  ...
  /** @name SnowbridgeBeaconPrimitivesUpdatesCheckpointUpdate (482) */
  ...
  /** @name SnowbridgeBeaconPrimitivesSyncCommittee (483) */
  ...
  /** @name SnowbridgeBeaconPrimitivesPublicKey (485) */
  interface SnowbridgeBeaconPrimitivesPublicKey extends U8aFixed {}

  /** @name SnowbridgeBeaconPrimitivesUpdatesUpdate (487) */
  ...
  /** @name SnowbridgeBeaconPrimitivesSyncAggregate (488) */
  ...
  /** @name SnowbridgeBeaconPrimitivesSignature (489) */
  interface SnowbridgeBeaconPrimitivesSignature extends U8aFixed {}

  /** @name SnowbridgeBeaconPrimitivesUpdatesNextSyncCommitteeUpdate (492) */
  ...
  /** @name PolkadotRuntimeCommonParasSudoWrapperPalletCall (493) */
  ...
  /** @name PolkadotRuntimeParachainsParasParaGenesisArgs (494) */
  ...
  /** @name PalletRootTestingCall (495) */
  ...
  /** @name SpRuntimeBlakeTwo256 (497) */
  type SpRuntimeBlakeTwo256 = Null;

  /** @name PalletConvictionVotingTally (499) */
  ...
  /** @name PalletRankedCollectiveEvent (500) */
  ...
  /** @name PalletRankedCollectiveVoteRecord (501) */
  ...
  /** @name PalletRankedCollectiveTally (502) */
  ...
  /** @name PolkadotPrimitivesVstagingCandidateReceiptV2 (509) */
  interface PolkadotPrimitivesVstagingCandidateReceiptV2 extends Struct {
    readonly descriptor: PolkadotPrimitivesVstagingCandidateDescriptorV2;
    readonly commitmentsHash: H256;
  }

  /** @name PolkadotRuntimeParachainsParasPalletEvent (512) */
  ...
  /** @name PolkadotRuntimeParachainsHrmpPalletEvent (513) */
  ...
  /** @name PolkadotRuntimeParachainsDisputesPalletEvent (514) */
  ...
  /** @name PolkadotRuntimeParachainsDisputesDisputeLocation (515) */
  ...
  /** @name PolkadotRuntimeParachainsDisputesDisputeResult (516) */
  ...
  /** @name PalletMessageQueueEvent (517) */
  ...
  /** @name FrameSupportMessagesProcessMessageError (518) */
  ...
  /** @name PolkadotRuntimeParachainsOnDemandPalletEvent (519) */
  ...
  /** @name PolkadotRuntimeCommonParasRegistrarPalletEvent (520) */
  ...
  /** @name StagingXcmV5TraitsOutcome (531) */
  ...
  /** @name PalletMigrationsEvent (532) */
  ...
  /** @name SnowbridgePalletEthereumClientEvent (534) */
  ...
  /** @name FrameSystemLastRuntimeUpgradeInfo (539) */
  interface FrameSystemLastRuntimeUpgradeInfo extends Struct {
    readonly specVersion: Compact<u32>;
    readonly specName: Text;
  }

  /** @name FrameSystemCodeUpgradeAuthorization (542) */
  interface FrameSystemCodeUpgradeAuthorization extends Struct {
    readonly codeHash: H256;
    readonly checkVersion: bool;
  }

  /** @name FrameSystemLimitsBlockWeights (543) */
  ...
  /** @name FrameSupportDispatchPerDispatchClassWeightsPerClass (544) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (545) */
  ...
  /** @name FrameSystemLimitsBlockLength (546) */
  interface FrameSystemLimitsBlockLength extends Struct {
    readonly max: FrameSupportDispatchPerDispatchClassU32;
  }

  /** @name FrameSupportDispatchPerDispatchClassU32 (547) */
  ...
  /** @name SpWeightsRuntimeDbWeight (548) */
  interface SpWeightsRuntimeDbWeight extends Struct {
    readonly read: u64;
    readonly write: u64;
  }

  /** @name SpVersionRuntimeVersion (549) */
  ...
  /** @name SpConsensusBabeDigestsPreDigest (560) */
  ...
  /** @name SpConsensusBabeDigestsPrimaryPreDigest (561) */
  ...
  /** @name SpCoreSr25519VrfVrfSignature (562) */
  interface SpCoreSr25519VrfVrfSignature extends Struct {
    readonly preOutput: U8aFixed;
    readonly proof: U8aFixed;
  }

  /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (563) */
  interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
    readonly authorityIndex: u32;
    readonly slot: u64;
  }

  /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (564) */
  ...
  /** @name SpConsensusBabeBabeEpochConfiguration (565) */
  interface SpConsensusBabeBabeEpochConfiguration extends Struct {
    readonly c: ITuple<[u64, u64]>;
    readonly allowedSlots: SpConsensusBabeAllowedSlots;
  }

  /** @name PalletBabeError (569) */
  ...
  /** @name DancelightRuntimeRuntimeHoldReason (579) */
  ...
  /** @name FrameSupportTokensMiscIdAmount (586) */
  ...
  /** @name PalletTransactionPaymentReleases (589) */
  ...
  interface PalletInvulnerablesError extends Enum {
    ...
    readonly type: 'TooManyInvulnerables' | 'AlreadyInvulnerable' | 'NotInvulnerable' | 'NoKeysRegistered' | 'UnableToDeriveCollatorId';
  }

  /** @name DpCollatorAssignmentAssignedCollatorsAccountId32 (610) */
  ...
  /** @name DpCollatorAssignmentAssignedCollatorsPublic (615) */
  ...
  /** @name TpTraitsContainerChainBlockInfo (623) */
  ...
  /** @name PalletAuthorNotingError (624) */
  interface PalletAuthorNotingError extends Enum {
    ...
    readonly type: 'FailedReading' | 'FailedDecodingHeader' | 'AuraDigestFirstItem' | 'AsPreRuntimeError' | 'NonDecodableSlot' | 'AuthorNotFound' | 'NonAuraDigest';
  }

  /** @name PalletServicesPaymentError (625) */
  ...
  /** @name PalletDataPreserversRegisteredProfile (626) */
  ...
  /** @name PalletDataPreserversError (632) */
  interface PalletDataPreserversError extends Enum {
    ...
    readonly type: 'NoBootNodes' | 'UnknownProfileId' | 'NextProfileIdShouldBeAvailable' | 'AssignmentPaymentRequestParameterMismatch' | 'ProfileAlreadyAssigned' | 'ProfileNotAssigned' | 'ProfileIsNotElligibleForParaId' | 'WrongParaId' | 'MaxAssignmentsPerParaIdReached' | 'CantDeleteAssignedProfile';
  }

  /** @name TpTraitsActiveEraInfo (635) */
  interface TpTraitsActiveEraInfo extends Struct {
    readonly index: u32;
    readonly start: Option<u64>;
  }

  /** @name PalletExternalValidatorsError (637) */
  interface PalletExternalValidatorsError extends Enum {
    ...
    readonly type: 'TooManyWhitelisted' | 'AlreadyWhitelisted' | 'NotWhitelisted' | 'NoKeysRegistered' | 'UnableToDeriveValidatorId';
  }

  /** @name PalletExternalValidatorSlashesSlash (642) */
  ...
  /** @name PalletExternalValidatorSlashesError (643) */
  interface PalletExternalValidatorSlashesError extends Enum {
    ...
    readonly type: 'EmptyTargets' | 'InvalidSlashIndex' | 'NotSortedAndUnique' | 'ProvidedFutureEra' | 'ProvidedNonSlashableEra' | 'DeferPeriodIsOver' | 'ErrorComputingSlash' | 'EthereumValidateFail' | 'EthereumDeliverFail';
  }

  /** @name PalletExternalValidatorsRewardsEraRewardPoints (644) */
  interface PalletExternalValidatorsRewardsEraRewardPoints extends Struct {
    readonly total: u32;
    readonly individual: BTreeMap<AccountId32, u32>;
  }

  /** @name SnowbridgePalletOutboundQueueCommittedMessage (649) */
  ...
  /** @name SnowbridgePalletOutboundQueueError (650) */
  ...
  /** @name SnowbridgePalletInboundQueueError (651) */
  interface SnowbridgePalletInboundQueueError extends Enum {
    ...
    readonly type: 'InvalidGateway' | 'InvalidEnvelope' | 'InvalidNonce' | 'InvalidPayload' | 'InvalidChannel' | 'MaxNonceReached' | 'InvalidAccountConversion' | 'Halted' | 'Verification' | 'Send' | 'ConvertMessage';
  }

  /** @name SnowbridgeCoreInboundVerificationError (652) */
  ...
  /** @name SnowbridgePalletInboundQueueSendError (653) */
  interface SnowbridgePalletInboundQueueSendError extends Enum {
    ...
    readonly type: 'NotApplicable' | 'NotRoutable' | 'Transport' | 'DestinationUnsupported' | 'ExceedsMaxMessageSize' | 'MissingArgument' | 'Fees';
  }

  /** @name SnowbridgeRouterPrimitivesInboundConvertMessageError (654) */
  interface SnowbridgeRouterPrimitivesInboundConvertMessageError extends Enum {
    ...
    readonly type: 'UnsupportedVersion' | 'InvalidDestination' | 'InvalidToken' | 'UnsupportedFeeAsset' | 'CannotReanchor';
  }

  /** @name SnowbridgeCoreChannel (655) */
  interface SnowbridgeCoreChannel extends Struct {
    readonly agentId: H256;
    readonly paraId: u32;
  }

  /** @name SnowbridgePalletSystemError (656) */
  interface SnowbridgePalletSystemError extends Enum {
    ...
    readonly type: 'LocationConversionFailed' | 'AgentAlreadyCreated' | 'NoAgent' | 'ChannelAlreadyCreated' | 'NoChannel' | 'UnsupportedLocationVersion' | 'InvalidLocation' | 'Send' | 'InvalidTokenTransferFees' | 'InvalidPricingParameters' | 'InvalidUpgradeParameters';
  }

  /** @name SnowbridgeCoreOutboundSendError (657) */
  ...
  /** @name SpCoreCryptoKeyTypeId (661) */
  interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (662) */
  ...
  /** @name PalletConvictionVotingVoteVoting (685) */
  ...
  /** @name PalletConvictionVotingVoteCasting (686) */
  ...
  /** @name PalletConvictionVotingDelegations (690) */
  interface PalletConvictionVotingDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletConvictionVotingVotePriorLock (691) */
  interface PalletConvictionVotingVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletConvictionVotingVoteDelegating (692) */
  ...
  /** @name PalletConvictionVotingError (696) */
  ...
  /** @name PalletReferendaReferendumInfoConvictionVotingTally (697) */
  ...
  /** @name PalletReferendaReferendumStatusConvictionVotingTally (698) */
  ...
  /** @name PalletReferendaReferendumInfoRankedCollectiveTally (720) */
  ...
  /** @name PalletReferendaReferendumStatusRankedCollectiveTally (721) */
  ...
  /** @name PolkadotRuntimeParachainsConfigurationHostConfiguration (725) */
  ...
  /** @name PolkadotRuntimeParachainsConfigurationPalletError (728) */
  interface PolkadotRuntimeParachainsConfigurationPalletError extends Enum {
    readonly isInvalidNewValue: boolean;
    readonly type: 'InvalidNewValue';
  }

  /** @name PolkadotRuntimeParachainsSharedAllowedRelayParentsTracker (731) */
  ...
  /** @name PolkadotRuntimeParachainsSharedRelayParentInfo (733) */
  ...
  /** @name PolkadotRuntimeParachainsInclusionCandidatePendingAvailability (743) */
  ...
  /** @name PolkadotRuntimeParachainsInclusionPalletError (744) */
  ...
  /** @name PolkadotPrimitivesVstagingScrapedOnChainVotes (745) */
  ...
  /** @name PolkadotRuntimeParachainsParasInherentPalletError (750) */
  ...
  /** @name PolkadotRuntimeParachainsSchedulerCommonAssignment (754) */
  ...
  /** @name PolkadotRuntimeParachainsParasPvfCheckActiveVoteState (757) */
  ...
  /** @name PolkadotRuntimeParachainsParasPvfCheckCause (759) */
  ...
  /** @name PolkadotRuntimeParachainsParasUpgradeStrategy (760) */
  ...
  /** @name PolkadotRuntimeParachainsParasPalletError (770) */
  ...
  /** @name PolkadotRuntimeParachainsInitializerBufferedSessionChange (772) */
  ...
  /** @name PolkadotCorePrimitivesInboundDownwardMessage (774) */
  interface PolkadotCorePrimitivesInboundDownwardMessage extends Struct {
    readonly sentAt: u32;
    readonly msg: Bytes;
  }

  /** @name PolkadotRuntimeParachainsHrmpHrmpOpenChannelRequest (775) */
  ...
  /** @name PolkadotRuntimeParachainsHrmpHrmpChannel (777) */
  ...
  /** @name PolkadotCorePrimitivesInboundHrmpMessage (779) */
  interface PolkadotCorePrimitivesInboundHrmpMessage extends Struct {
    readonly sentAt: u32;
    readonly data: Bytes;
  }

  /** @name PolkadotRuntimeParachainsHrmpPalletError (782) */
  ...
  /** @name PolkadotPrimitivesV8SessionInfo (784) */
  ...
  /** @name PolkadotRuntimeParachainsDisputesPalletError (790) */
  ...
  /** @name PolkadotPrimitivesV8SlashingPendingSlashes (791) */
  ...
  /** @name PolkadotRuntimeParachainsDisputesSlashingPalletError (795) */
  ...
  /** @name PalletMessageQueueBookState (796) */
  ...
  /** @name PalletMessageQueueNeighbours (798) */
  ...
  /** @name PolkadotRuntimeParachainsOnDemandTypesCoreAffinityCount (803) */
  interface PolkadotRuntimeParachainsOnDemandTypesCoreAffinityCount extends Struct {
    readonly coreIndex: u32;
    readonly count: u32;
  }

  /** @name PolkadotRuntimeParachainsOnDemandTypesQueueStatusType (804) */
  ...
  /** @name PolkadotRuntimeCommonParasRegistrarParaInfo (815) */
  ...
  /** @name PolkadotRuntimeCommonParasRegistrarPalletError (817) */
  ...
  /** @name PalletIdentityRegistrarInfo (827) */
  ...
  /** @name PalletSchedulerScheduled (837) */
  ...
  /** @name PalletSchedulerRetryConfig (839) */
  ...
  /** @name PalletProxyProxyDefinition (843) */
  ...
  /** @name PalletProxyAnnouncement (847) */
  ...
  /** @name PalletMultisigMultisig (851) */
  ...
  /** @name PalletPreimageOldRequestStatus (854) */
  ...
  /** @name PalletPreimageRequestStatus (857) */
  ...
  /** @name PalletXcmVersionMigrationStage (874) */
  ...
  /** @name PalletXcmRemoteLockedFungibleRecord (876) */
  ...
  /** @name SpConsensusBeefyMmrBeefyAuthoritySet (889) */
  ...
  /** @name SnowbridgeBeaconPrimitivesCompactBeaconState (890) */
  interface SnowbridgeBeaconPrimitivesCompactBeaconState extends Struct {
    readonly slot: Compact<u64>;
    readonly blockRootsRoot: H256;
  }

  /** @name SnowbridgeBeaconPrimitivesSyncCommitteePrepared (891) */
  ...
  /** @name SnowbridgeBeaconPrimitivesFork (900) */
  interface SnowbridgeBeaconPrimitivesFork extends Struct {
    readonly version: U8aFixed;
    readonly epoch: u64;
  }

  /** @name SnowbridgePalletEthereumClientError (901) */
  ...
  /** @name SnowbridgeBeaconPrimitivesBlsBlsError (902) */
  interface SnowbridgeBeaconPrimitivesBlsBlsError extends Enum {
    ...
    readonly type: 'InvalidSignature' | 'InvalidPublicKey' | 'InvalidAggregatePublicKeys' | 'SignatureVerificationFailed';
  }

  /** @name PolkadotRuntimeCommonParasSudoWrapperPalletError (903) */
  interface PolkadotRuntimeCommonParasSudoWrapperPalletError extends Enum {
    ...
    readonly type: 'ParaDoesntExist' | 'ParaAlreadyExists' | 'ExceedsMaxMessageSize' | 'CouldntCleanup' | 'NotParathread' | 'NotParachain' | 'CannotUpgrade' | 'CannotDowngrade' | 'TooManyCores';
  }

  /** @name PalletSudoError (904) */
  interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name FrameSystemExtensionsCheckNonZeroSender (907) */
  type FrameSystemExtensionsCheckNonZeroSender = Null;

  /** @name FrameSystemExtensionsCheckSpecVersion (908) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (909) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (910) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (913) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (914) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (915) */
  interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name FrameMetadataHashExtensionCheckMetadataHash (916) */
  interface FrameMetadataHashExtensionCheckMetadataHash extends Struct {
    readonly mode: FrameMetadataHashExtensionMode;
  }

  /** @name FrameMetadataHashExtensionMode (917) */
  ...
  /** @name DancelightRuntimeRuntime (918) */
