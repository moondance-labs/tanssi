...
import type { BinaryHeapEnqueuedOrder, DancelightRuntimeAggregateMessageOrigin, DancelightRuntimeRuntimeHoldReason, DancelightRuntimeRuntimeParametersKey, DancelightRuntimeRuntimeParametersValue, DancelightRuntimeSessionKeys, DpCollatorAssignmentAssignedCollatorsAccountId32, DpCollatorAssignmentAssignedCollatorsPublic, DpContainerChainGenesisDataContainerChainGenesisData, FrameSupportDispatchPerDispatchClassWeight, FrameSupportTokensMiscIdAmount, FrameSystemAccountInfo, FrameSystemCodeUpgradeAuthorization, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, NimbusPrimitivesNimbusCryptoPublic, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReserveData, PalletConfigurationHostConfiguration, PalletConvictionVotingVoteVoting, PalletDataPreserversRegisteredProfile, PalletExternalValidatorSlashesSlash, PalletExternalValidatorsForcing, PalletExternalValidatorsRewardsEraRewardPoints, PalletGrandpaStoredPendingChange, PalletGrandpaStoredState, PalletIdentityAuthorityProperties, PalletIdentityProvider, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletIdentityUsernameInformation, PalletInflationRewardsChainsToRewardValue, PalletMessageQueueBookState, PalletMessageQueuePage, PalletMigrationsMigrationCursor, PalletMultisigMultisig, PalletPooledStakingCandidateEligibleCandidate, PalletPooledStakingPendingOperationKey, PalletPooledStakingPoolsKey, PalletPreimageOldRequestStatus, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletRankedCollectiveMemberRecord, PalletRankedCollectiveVoteRecord, PalletReferendaReferendumInfoConvictionVotingTally, PalletReferendaReferendumInfoRankedCollectiveTally, PalletRegistrarDepositInfo, PalletSchedulerRetryConfig, PalletSchedulerScheduled, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletTreasurySpendStatus, PalletXcmQueryStatus, PalletXcmRemoteLockedFungibleRecord, PalletXcmVersionMigrationStage, PolkadotCorePrimitivesInboundDownwardMessage, PolkadotCorePrimitivesInboundHrmpMessage, PolkadotParachainPrimitivesPrimitivesHrmpChannelId, PolkadotPrimitivesV8AssignmentAppPublic, PolkadotPrimitivesV8DisputeState, PolkadotPrimitivesV8ExecutorParams, PolkadotPrimitivesV8SessionInfo, PolkadotPrimitivesV8SlashingPendingSlashes, PolkadotPrimitivesV8UpgradeGoAhead, PolkadotPrimitivesV8UpgradeRestriction, PolkadotPrimitivesV8ValidatorAppPublic, PolkadotPrimitivesVstagingScrapedOnChainVotes, PolkadotRuntimeCommonParasRegistrarParaInfo, PolkadotRuntimeParachainsConfigurationHostConfiguration, PolkadotRuntimeParachainsHrmpHrmpChannel, PolkadotRuntimeParachainsHrmpHrmpOpenChannelRequest, PolkadotRuntimeParachainsInclusionCandidatePendingAvailability, PolkadotRuntimeParachainsInitializerBufferedSessionChange, PolkadotRuntimeParachainsOnDemandTypesCoreAffinityCount, PolkadotRuntimeParachainsOnDemandTypesEnqueuedOrder, PolkadotRuntimeParachainsOnDemandTypesQueueStatusType, PolkadotRuntimeParachainsParasParaGenesisArgs, PolkadotRuntimeParachainsParasParaLifecycle, PolkadotRuntimeParachainsParasParaPastCodeMeta, PolkadotRuntimeParachainsParasPvfCheckActiveVoteState, PolkadotRuntimeParachainsSchedulerCommonAssignment, PolkadotRuntimeParachainsSharedAllowedRelayParentsTracker, SnowbridgeBeaconPrimitivesCompactBeaconState, SnowbridgeBeaconPrimitivesSyncCommitteePrepared, SnowbridgeCoreChannel, SnowbridgeCoreChannelId, SnowbridgeCoreOperatingModeBasicOperatingMode, SnowbridgeCorePricingPricingParameters, SnowbridgePalletOutboundQueueCommittedMessage, SpAuthorityDiscoveryAppPublic, SpConsensusBabeAppPublic, SpConsensusBabeBabeEpochConfiguration, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusBabeDigestsPreDigest, SpConsensusBeefyEcdsaCryptoPublic, SpConsensusBeefyMmrBeefyAuthoritySet, SpConsensusGrandpaAppPublic, SpCoreCryptoKeyTypeId, SpRuntimeDigest, SpStakingOffenceOffenceDetails, SpWeightsWeightV2Weight, StagingXcmV5Instruction, StagingXcmV5Location, StagingXcmV5Xcm, TpTraitsActiveEraInfo, TpTraitsContainerChainBlockInfo, TpTraitsParathreadParams, XcmVersionedAssetId, XcmVersionedLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetRate: {
       ...
       **/
      conversionRateToNative: AugmentedQuery<ApiType, (arg: Null | null) => Observable<Option<u128>>, [Null]> & QueryableStorageEntry<ApiType, [Null]>;
      /**
       * Generic query
       **/
    ...
    authorNoting: {
       ...
       **/
      didSetContainerAuthorData: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      latestAuthor: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<TpTraitsContainerChainBlockInfo>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    collatorConfiguration: {
       ...
       **/
      activeConfig: AugmentedQuery<ApiType, () => Observable<PalletConfigurationHostConfiguration>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      pendingConfigs: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, PalletConfigurationHostConfiguration]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    containerRegistrar: {
       ...
       * place yet.
       **/
      bufferedParasToDeregister: AugmentedQuery<ApiType, () => Observable<Vec<u32>>, []> & QueryableStorageEntry<ApiType, []>;
      paraGenesisData: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<DpContainerChainGenesisDataContainerChainGenesisData>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      paraManager: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<AccountId32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      parathreadParams: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<TpTraitsParathreadParams>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      paused: AugmentedQuery<ApiType, () => Observable<Vec<u32>>, []> & QueryableStorageEntry<ApiType, []>;
      pendingParaIds: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, Vec<u32>]>>>, []> & QueryableStorageEntry<ApiType, []>;
      pendingParathreadParams: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, Vec<ITuple<[u32, TpTraitsParathreadParams]>>]>>>, []> & QueryableStorageEntry<ApiType, []>;
      pendingPaused: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, Vec<u32>]>>>, []> & QueryableStorageEntry<ApiType, []>;
      pendingToRemove: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, Vec<u32>]>>>, []> & QueryableStorageEntry<ApiType, []>;
      pendingVerification: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<Null>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      registeredParaIds: AugmentedQuery<ApiType, () => Observable<Vec<u32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Registrar deposits, a mapping from paraId to a struct
       * holding the creator (from which the deposit was reserved) and
       * the deposit amount
       **/
      registrarDeposit: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletRegistrarDepositInfo>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    dataPreservers: {
      assignments: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<BTreeSet<u64>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      nextProfileId: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      profiles: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PalletDataPreserversRegisteredProfile>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    ethereumBeaconClient: {
       ...
       **/
      currentSyncCommittee: AugmentedQuery<ApiType, () => Observable<SnowbridgeBeaconPrimitivesSyncCommitteePrepared>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Beacon state by finalized block root
       **/
      finalizedBeaconState: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<SnowbridgeBeaconPrimitivesCompactBeaconState>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Finalized Headers: Current position in ring buffer
       **/
      finalizedBeaconStateIndex: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Finalized Headers: Mapping of ring buffer index to a pruning candidate
       **/
      finalizedBeaconStateMapping: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<H256>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Latest imported checkpoint root
       **/
      initialCheckpointRoot: AugmentedQuery<ApiType, () => Observable<H256>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Latest imported finalized block root
       **/
      latestFinalizedBlockRoot: AugmentedQuery<ApiType, () => Observable<H256>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The last period where the next sync committee was updated for free.
       **/
      latestSyncCommitteeUpdatePeriod: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Sync committee for next period
       **/
      nextSyncCommittee: AugmentedQuery<ApiType, () => Observable<SnowbridgeBeaconPrimitivesSyncCommitteePrepared>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The current operating mode of the pallet.
       **/
      operatingMode: AugmentedQuery<ApiType, () => Observable<SnowbridgeCoreOperatingModeBasicOperatingMode>, []> & QueryableStorageEntry<ApiType, []>;
    ...
    ethereumInboundQueue: {
       ...
       **/
      nonce: AugmentedQuery<ApiType, (arg: SnowbridgeCoreChannelId | string | Uint8Array) => Observable<u64>, [SnowbridgeCoreChannelId]> & QueryableStorageEntry<ApiType, [SnowbridgeCoreChannelId]>;
      /**
       * The current operating mode of the pallet.
       **/
      operatingMode: AugmentedQuery<ApiType, () => Observable<SnowbridgeCoreOperatingModeBasicOperatingMode>, []> & QueryableStorageEntry<ApiType, []>;
    ...
    ethereumOutboundQueue: {
       ...
       **/
      messageLeaves: AugmentedQuery<ApiType, () => Observable<Vec<H256>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      messages: AugmentedQuery<ApiType, () => Observable<Vec<SnowbridgePalletOutboundQueueCommittedMessage>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    ethereumSystem: {
       ...
       **/
      agents: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<Null>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * The set of registered channels
       **/
      channels: AugmentedQuery<ApiType, (arg: SnowbridgeCoreChannelId | string | Uint8Array) => Observable<Option<SnowbridgeCoreChannel>>, [SnowbridgeCoreChannelId]> & QueryableStorageEntry<ApiType, [SnowbridgeCoreChannelId]>;
      /**
       * Lookup table for foreign token ID to native location relative to ethereum
       **/
      foreignToNativeId: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<StagingXcmV5Location>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Lookup table for native location relative to ethereum to foreign token ID
       **/
      nativeToForeignId: AugmentedQuery<ApiType, (arg: StagingXcmV5Location | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<H256>>, [StagingXcmV5Location]> & QueryableStorageEntry<ApiType, [StagingXcmV5Location]>;
      pricingParameters: AugmentedQuery<ApiType, () => Observable<SnowbridgeCorePricingPricingParameters>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    externalValidators: {
       ...
       **/
      activeEra: AugmentedQuery<ApiType, () => Observable<Option<TpTraitsActiveEraInfo>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      currentExternalIndex: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      externalValidators: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Mode of era forcing.
       **/
      forceEra: AugmentedQuery<ApiType, () => Observable<PalletExternalValidatorsForcing>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Pending external index to be applied in the upcoming era
       **/
      pendingExternalIndex: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Allow to disable external validators.
       **/
      skipExternalValidators: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Fixed validators set by root/governance. Have priority over the external validators.
       **/
      whitelistedValidators: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Copy of `WhitelistedValidators` at the start of this active era.
       * Used to check which validators we don't need to reward.
       **/
      whitelistedValidatorsActiveEra: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      whitelistedValidatorsActiveEraPending: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    externalValidatorSlashes: {
       ...
       **/
      bondedEras: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, u32, u64]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      slashes: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<PalletExternalValidatorSlashesSlash>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * All unreported slashes that will be processed in the future.
       **/
      unreportedSlashesQueue: AugmentedQuery<ApiType, () => Observable<Vec<PalletExternalValidatorSlashesSlash>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * All slashing events on validators, mapped by era to the highest slash proportion
       * and slash value of the era.
       **/
      validatorSlashInEra: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<Perbill>>, [u32, AccountId32]> & QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    externalValidatorsRewards: {
       ...
       **/
      rewardPointsForEra: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<PalletExternalValidatorsRewardsEraRewardPoints>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    inflationRewards: {
       ...
       **/
      chainsToReward: AugmentedQuery<ApiType, () => Observable<Option<PalletInflationRewardsChainsToRewardValue>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    messageQueue: {
       ...
       **/
      bookStateFor: AugmentedQuery<ApiType, (arg: DancelightRuntimeAggregateMessageOrigin | { Ump: any } | { Snowbridge: any } | { SnowbridgeTanssi: any } | string | Uint8Array) => Observable<PalletMessageQueueBookState>, [DancelightRuntimeAggregateMessageOrigin]> & QueryableStorageEntry<ApiType, [DancelightRuntimeAggregateMessageOrigin]>;
      /**
       * The map of page indices to pages.
       **/
      pages: AugmentedQuery<ApiType, (arg1: DancelightRuntimeAggregateMessageOrigin | { Ump: any } | { Snowbridge: any } | { SnowbridgeTanssi: any } | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletMessageQueuePage>>, [DancelightRuntimeAggregateMessageOrigin, u32]> & QueryableStorageEntry<ApiType, [DancelightRuntimeAggregateMessageOrigin, u32]>;
      /**
       * The origin at which we should begin servicing.
       **/
      serviceHead: AugmentedQuery<ApiType, () => Observable<Option<DancelightRuntimeAggregateMessageOrigin>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    outboundMessageCommitmentRecorder: {
       ...
       **/
      recordedCommitment: AugmentedQuery<ApiType, () => Observable<Option<H256>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    parameters: {
       ...
       * Stored parameters.
       **/
      parameters: AugmentedQuery<ApiType, (arg: DancelightRuntimeRuntimeParametersKey | { Preimage: any } | string | Uint8Array) => Observable<Option<DancelightRuntimeRuntimeParametersValue>>, [DancelightRuntimeRuntimeParametersKey]> & QueryableStorageEntry<ApiType, [DancelightRuntimeRuntimeParametersKey]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    pooledStaking: {
       ...
       * `MaxCollatorSetSize`.
       **/
      sortedEligibleCandidates: AugmentedQuery<ApiType, () => Observable<Vec<PalletPooledStakingCandidateEligibleCandidate>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    servicesPayment: {
      blockProductionCredits: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      collatorAssignmentCredits: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * List of para ids that have already been given free credits
       **/
      givenFreeCredits: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<Null>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Max core price for parathread in relay chain currency
       **/
      maxCorePrice: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u128>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Max tip for collator assignment on congestion
       **/
      maxTip: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u128>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Refund address
       **/
      refundAddress: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<AccountId32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<DancelightRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, DancelightRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    tanssiAuthorityAssignment: {
      collatorContainerChain: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<DpCollatorAssignmentAssignedCollatorsPublic>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    tanssiAuthorityMapping: {
      authorityIdMapping: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<BTreeMap<NimbusPrimitivesNimbusCryptoPublic, AccountId32>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    tanssiCollatorAssignment: {
      collatorContainerChain: AugmentedQuery<ApiType, () => Observable<DpCollatorAssignmentAssignedCollatorsAccountId32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Ratio of assigned collators to max collators.
       **/
      collatorFullnessRatio: AugmentedQuery<ApiType, () => Observable<Option<Perbill>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Pending configuration changes.
       * 
       * This is a list of configuration changes, each with a session index at which it should
       ...
       * 2 items: for the next session and for the `scheduled_session`.
       **/
      pendingCollatorContainerChain: AugmentedQuery<ApiType, () => Observable<Option<DpCollatorAssignmentAssignedCollatorsAccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
