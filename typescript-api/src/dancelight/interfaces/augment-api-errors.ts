...
declare module "@polkadot/api-base/types/errors" {
    interface AugmentedErrors<ApiType extends ApiTypes> {
        ...
        convictionVoting: {
            ...
            /**
             * The account currently has votes attached to it and the operation cannot succeed until these are removed through
             * `remove_vote`.
             */
        ...
        paraInclusion: {
            /**
             * The candidate's relay-parent was not allowed. Either it was not recent enough or it didn't advance based on the
             * last parachain block.
             */
            ...
            /**
             * Failed to compute group index for the core: either it's out of bounds or the relay parent doesn't belong to the
             * current session.
             */
        ...
        paraInherent: {
            /** A candidate was filtered during inherent execution. This should have only been done during creation. */
        ...
        parasSudoWrapper: {
            ...
            /** A DMP message couldn't be sent because it exceeds the maximum size allowed for a downward message. */
        ...
        registrar: {
            ...
            CannotDowngrade: AugmentedError<ApiType>;
            /**
             * Cannot perform a parachain slot / lifecycle swap. Check that the state of both paras are correct for the swap
             * to work.
             */
