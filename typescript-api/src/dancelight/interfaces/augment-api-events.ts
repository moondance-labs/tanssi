...
import type { DancelightRuntimeAggregateMessageOrigin, DancelightRuntimeProxyType, DancelightRuntimeRuntimeParametersKey, DancelightRuntimeRuntimeParametersValue, FrameSupportDispatchPostDispatchInfo, FrameSupportMessagesProcessMessageError, FrameSupportPreimagesBounded, FrameSupportTokensMiscBalanceStatus, FrameSystemDispatchEventInfo, PalletConvictionVotingTally, PalletConvictionVotingVoteAccountVote, PalletExternalValidatorsForcing, PalletMultisigTimepoint, PalletPooledStakingTargetPool, PalletRankedCollectiveTally, PalletRankedCollectiveVoteRecord, PolkadotParachainPrimitivesPrimitivesHrmpChannelId, PolkadotPrimitivesVstagingCandidateReceiptV2, PolkadotRuntimeParachainsDisputesDisputeLocation, PolkadotRuntimeParachainsDisputesDisputeResult, SnowbridgeCoreChannelId, SnowbridgeCoreOperatingModeBasicOperatingMode, SnowbridgeCoreOutboundV1OperatingMode, SnowbridgeCorePricingPricingParameters, SpConsensusGrandpaAppPublic, SpRuntimeDispatchError, SpRuntimeDispatchErrorWithPostInfo, SpWeightsWeightV2Weight, StagingXcmV5AssetAssets, StagingXcmV5Location, StagingXcmV5Response, StagingXcmV5TraitsOutcome, StagingXcmV5Xcm, TpBridgeCommand, TpTraitsFullRotationModes, XcmV5TraitsError, XcmVersionedAssets, XcmVersionedLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetRate: {
      ...
      AssetRateUpdated: AugmentedEvent<ApiType, [assetKind: Null, old: u128, new_: u128], { assetKind: Null, old: u128, new_: u128 }>;
      /**
       * Generic event
       **/
    ...
    ethereumBeaconClient: {
       ...
       * Set OperatingMode
       **/
      OperatingModeChanged: AugmentedEvent<ApiType, [mode: SnowbridgeCoreOperatingModeBasicOperatingMode], { mode: SnowbridgeCoreOperatingModeBasicOperatingMode }>;
    ...
    ethereumInboundQueue: {
       ...
       **/
      MessageReceived: AugmentedEvent<ApiType, [channelId: SnowbridgeCoreChannelId, nonce: u64, messageId: U8aFixed, feeBurned: u128], { channelId: SnowbridgeCoreChannelId, nonce: u64, messageId: U8aFixed, feeBurned: u128 }>;
      /**
       * Set OperatingMode
       **/
      OperatingModeChanged: AugmentedEvent<ApiType, [mode: SnowbridgeCoreOperatingModeBasicOperatingMode], { mode: SnowbridgeCoreOperatingModeBasicOperatingMode }>;
    ...
    ethereumSystem: {
       ...
       **/
      CreateAgent: AugmentedEvent<ApiType, [location: StagingXcmV5Location, agentId: H256], { location: StagingXcmV5Location, agentId: H256 }>;
      /**
       * An CreateChannel message was sent to the Gateway
       **/
      CreateChannel: AugmentedEvent<ApiType, [channelId: SnowbridgeCoreChannelId, agentId: H256], { channelId: SnowbridgeCoreChannelId, agentId: H256 }>;
      PricingParametersChanged: AugmentedEvent<ApiType, [params: SnowbridgeCorePricingPricingParameters], { params: SnowbridgeCorePricingPricingParameters }>;
      /**
       * Register Polkadot-native token as a wrapped ERC20 token on Ethereum
       **/
      RegisterToken: AugmentedEvent<ApiType, [location: XcmVersionedLocation, foreignTokenId: H256], { location: XcmVersionedLocation, foreignTokenId: H256 }>;
      /**
       * An SetOperatingMode message was sent to the Gateway
       **/
      SetOperatingMode: AugmentedEvent<ApiType, [mode: SnowbridgeCoreOutboundV1OperatingMode], { mode: SnowbridgeCoreOutboundV1OperatingMode }>;
      /**
       * A SetTokenTransferFees message was sent to the Gateway
       **/
      SetTokenTransferFees: AugmentedEvent<ApiType, [createAssetXcm: u128, transferAssetXcm: u128, registerToken: U256], { createAssetXcm: u128, transferAssetXcm: u128, registerToken: U256 }>;
      /**
       * An TransferNativeFromAgent message was sent to the Gateway
       **/
      TransferNativeFromAgent: AugmentedEvent<ApiType, [agentId: H256, recipient: H160, amount: u128], { agentId: H256, recipient: H160, amount: u128 }>;
      /**
       * An UpdateChannel message was sent to the Gateway
       **/
      UpdateChannel: AugmentedEvent<ApiType, [channelId: SnowbridgeCoreChannelId, mode: SnowbridgeCoreOutboundV1OperatingMode], { channelId: SnowbridgeCoreChannelId, mode: SnowbridgeCoreOutboundV1OperatingMode }>;
      /**
       * An Upgrade message was sent to the Gateway
       **/
      Upgrade: AugmentedEvent<ApiType, [implAddress: H160, implCodeHash: H256, initializerParamsHash: Option<H256>], { implAddress: H160, implCodeHash: H256, initializerParamsHash: Option<H256> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    externalValidators: {
       ...
       **/
      ForceEra: AugmentedEvent<ApiType, [mode: PalletExternalValidatorsForcing], { mode: PalletExternalValidatorsForcing }>;
      /**
    ...
    messageQueue: {
       ...
       **/
      OverweightEnqueued: AugmentedEvent<ApiType, [id: U8aFixed, origin: DancelightRuntimeAggregateMessageOrigin, pageIndex: u32, messageIndex: u32], { id: U8aFixed, origin: DancelightRuntimeAggregateMessageOrigin, pageIndex: u32, messageIndex: u32 }>;
      /**
       * This page was reaped.
       **/
      PageReaped: AugmentedEvent<ApiType, [origin: DancelightRuntimeAggregateMessageOrigin, index: u32], { origin: DancelightRuntimeAggregateMessageOrigin, index: u32 }>;
      /**
       * Message is processed.
       **/
      Processed: AugmentedEvent<ApiType, [id: H256, origin: DancelightRuntimeAggregateMessageOrigin, weightUsed: SpWeightsWeightV2Weight, success: bool], { id: H256, origin: DancelightRuntimeAggregateMessageOrigin, weightUsed: SpWeightsWeightV2Weight, success: bool }>;
      /**
       * Message discarded due to an error in the `MessageProcessor` (usually a format error).
       **/
      ProcessingFailed: AugmentedEvent<ApiType, [id: H256, origin: DancelightRuntimeAggregateMessageOrigin, error: FrameSupportMessagesProcessMessageError], { id: H256, origin: DancelightRuntimeAggregateMessageOrigin, error: FrameSupportMessagesProcessMessageError }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    parameters: {
       ...
       **/
      Updated: AugmentedEvent<ApiType, [key: DancelightRuntimeRuntimeParametersKey, oldValue: Option<DancelightRuntimeRuntimeParametersValue>, newValue: Option<DancelightRuntimeRuntimeParametersValue>], { key: DancelightRuntimeRuntimeParametersKey, oldValue: Option<DancelightRuntimeRuntimeParametersValue>, newValue: Option<DancelightRuntimeRuntimeParametersValue> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: DancelightRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: DancelightRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: DancelightRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: DancelightRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: DancelightRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: DancelightRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
