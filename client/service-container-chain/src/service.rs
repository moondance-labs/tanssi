...
use {
    ...
    cumulus_client_service::{
        ...
        DARecoveryProfile, ParachainHostFunctions, StartRelayChainTasksParams,
    },
    ...
    sc_telemetry::{TelemetryHandle, TelemetryWorker},
    ...
    GRB: GenerateRpcBuilder<RuntimeApi> + 'static,
{
    pub async fn run(self) -> sc_cli::Result<TaskManager> {
        ...
        // Spawn assignment watcher
        {
            ...
            let container_chain_spawner = crate::spawner::ContainerChainSpawner {
                params: crate::spawner::ContainerChainSpawnParams {
                    orchestrator_chain_interface,
                    container_chain_cli,
            ...
            task_manager.spawn_essential_handle().spawn(
                ...
                None,
                crate::data_preservers::task_watch_assignment(
            ...
            task_manager.spawn_essential_handle().spawn(
                ...
                None,
                crate::monitor::monitor_task(state),
            );
        }
