...
) -> std::pin::Pin<Box<dyn std::future::Future<Output = sc_service::error::Result<(
    TaskManager,
...
)>>+ Send>>
{
    Box::pin(
        ...
        let node_builder = node_builder
            ...
            .await?;
        log::info!("BEFORE force");

        let force_authoring = parachain_config.force_authoring;
        log::info!("BEFORE prometheus_registry");

        let prometheus_registry = parachain_config.prometheus_registry().cloned();

        log::info!("BEFORE rpc_builder");
        ...
        log::info!("BEFORE spawn_common_tasks");
        ...
        log::info!("BEFORE STARTING rel TASKSS");
        ...
        if let Some(collation_params) = collation_params {
            ...
            log::info!("BEFORE STARTING CONSENSUS");
        ...
        log::info!("BEFORE STARTING NETWORK");
