...
use crate::{
    collators::{self as collator_util, SlotClaim, tanssi_claim_slot}, consensus_orchestrator::RetrieveAuthoritiesFromOrchestrator,
...
where
	Client: ProvideRuntimeApi<Block>,
	Client::Api: UnincludedSegmentApi<Block>,//AuraApi<Block, P::Public>, //+ AuraUnincludedSegmentApi<Block>,
	P: Pair + Send + Sync + 'static,
	P::Public: Codec + std::fmt::Debug,
	P::Signature: Codec,
{
	let runtime_api = client.runtime_api();
	let slot_claim = tanssi_claim_slot::<P, Block>(aux_data, &parent_header, slot, force_authoring, keystore);
