...
// raw.json
// --output
// tmp/starlight_weights/pallet_babe.rs
...
impl<T: frame_system::Config> pallet_babe::WeightInfo for SubstrateWeight<T> {
	...
	fn check_equivocation_proof(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 86_667_000 picoseconds.
		Weight::from_parts(87_285_230, 0)
			// Standard Error: 33_455
			.saturating_add(Weight::from_parts(93_369, 0).saturating_mul(x.into()))
	}
}