...
//! DATE: 2024-12-16, STEPS: `16`, REPEAT: `1`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(39_320_277, 4151)
			// Standard Error: 175_044
			.saturating_add(Weight::from_parts(11_607, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(11_086_685, 4151)
			// Standard Error: 12_345
			.saturating_add(Weight::from_parts(4_751, 0).saturating_mul(x.into()))
	...
	fn update_profile(_x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(45_003_732, 4151)
	...
	fn force_update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(34_471_667, 4151)
			// Standard Error: 212_646
			.saturating_add(Weight::from_parts(159_656, 0).saturating_mul(y.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(33_000_000, 4151)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
