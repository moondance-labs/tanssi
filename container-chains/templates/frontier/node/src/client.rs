...
// Local
use container_chain_template_frontier_runtime::{opaque::Block, AccountId, Balance, Index};
...
pub type Client = FullClient<container_chain_template_frontier_runtime::RuntimeApi, TemplateRuntimeExecutor>;
