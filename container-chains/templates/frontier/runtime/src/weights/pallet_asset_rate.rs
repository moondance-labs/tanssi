...
// raw.json
// --output
// container-chains/templates/frontier/runtime/src/weights/pallet_asset_rate.rs
...
impl<T: frame_system::Config> pallet_asset_rate::WeightInfo for SubstrateWeight<T> {
	...
	fn create() -> Weight {
		...
		Weight::from_parts(8_945_000, 3499)
	...
	fn update() -> Weight {
		...
		Weight::from_parts(9_344_000, 3499)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `AssetRate::ConversionRateToNative` (r:1 w:1)
	...
	fn remove() -> Weight {
		...
		Weight::from_parts(9_765_000, 3499)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}