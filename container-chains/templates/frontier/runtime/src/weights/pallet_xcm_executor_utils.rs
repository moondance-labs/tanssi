...
// raw.json
// --output
// container-chains/templates/frontier/runtime/src/weights/pallet_xcm_executor_utils.rs
...
impl<T: frame_system::Config> pallet_xcm_executor_utils::weights::WeightInfo for SubstrateWeight<T> {
	...
	fn remove_reserve_policy() -> Weight {
		...
		Weight::from_parts(9_616_000, 607086)
	...
	fn remove_teleport_policy() -> Weight {
		...
		Weight::from_parts(10_082_000, 607086)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}