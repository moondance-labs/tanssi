...
use {
    ...
    sp_std::prelude::*,
    xcm::{latest::prelude::*, DoubleEncoded},
};
...
/// Types of asset supported by the Mozart runtime.
pub enum AssetTypes {
...
// Mozart only knows about one asset, the balances pallet.
...
impl WeighAssets for AssetFilter {
    fn weigh_assets(&self, balances_weight: Weight) -> Weight {
        match self {
            ...
            // We don't support any NFTs on Mozart, so these two variants will always match
...
pub struct MozartXcmWeight<RuntimeCall>(core::marker::PhantomData<RuntimeCall>);
impl<RuntimeCall> XcmWeightInfo<RuntimeCall> for MozartXcmWeight<RuntimeCall> {
    ...
    fn exchange_asset(_give: &AssetFilter, _receive: &Assets, _maximal: &bool) -> Weight {
        // Mozart does not currently support exchange asset operations
        Weight::MAX
    }
    ...
    fn universal_origin(_: &Junction) -> Weight {
        // Mozart does not currently support universal origin operations
        Weight::MAX
    }
    fn export_message(_: &NetworkId, _: &Junctions, _: &Xcm<()>) -> Weight {
        // Mozart relay should not support export message operations
        Weight::MAX
    }
    fn lock_asset(_: &Asset, _: &Location) -> Weight {
        // Mozart does not currently support asset locking operations
        Weight::MAX
    }
