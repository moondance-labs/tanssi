...
use frame_support::{
	...
	parameter_types,
	traits::{ConstU32, ConstU64, EitherOf, Everything, OneSessionHandler},
	weights::{
		constants::{
...
pub const KILO_UNIT: Balance = 1000 * UNIT;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		// Staking
		StakingOrigins: staking::pallet_custom_origins::{Origin} = 50,
		Staking: pallet_staking::{Pallet, Call, Storage, Config<T>, Event<T>} = 51,
	}
);
