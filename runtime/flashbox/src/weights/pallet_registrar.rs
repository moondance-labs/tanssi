...
impl<T: frame_system::Config> pallet_registrar::WeightInfo for SubstrateWeight<T> {
	...
	fn register(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(71_331_527, 3731)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(1_266, 0).saturating_mul(x.into()))
	...
	fn deregister_immediate() -> Weight {
		...
		//  Measured:  `2377`
		//  Estimated: `6196`
		// Minimum execution time: 137_859_000 picoseconds.
		Weight::from_parts(141_959_000, 6196)
	...
	fn deregister_scheduled() -> Weight {
		...
		//  Measured:  `1222`
		//  Estimated: `4687`
		// Minimum execution time: 70_658_000 picoseconds.
		Weight::from_parts(74_075_000, 4687)
	...
	fn mark_valid_for_collating() -> Weight {
		...
		Weight::from_parts(160_709_000, 9421)
	...
	fn pause_container_chain() -> Weight {
		...
		//  Measured:  `2042`
		//  Estimated: `3527`
		// Minimum execution time: 62_516_000 picoseconds.
		Weight::from_parts(63_762_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::PendingParaIds` (r:1 w:1)
	...
	fn unpause_container_chain() -> Weight {
		...
		Weight::from_parts(64_517_000, 3527)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn register_parathread(x: u32, _z: u32, ) -> Weight {
		...
		Weight::from_parts(12_138_816, 3731)
			// Standard Error: 1
	...
	fn set_parathread_params() -> Weight {
		...
		Weight::from_parts(64_365_000, 5235)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_para_manager() -> Weight {
		...
		Weight::from_parts(14_985_000, 3702)
