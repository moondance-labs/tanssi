...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		// Minimum execution time: 112_212_000 picoseconds.
		Weight::from_parts(47_272_390, 7887)
			// Standard Error: 8_897
			.saturating_add(Weight::from_parts(258_025, 0).saturating_mul(x.into()))
			// Standard Error: 90_594
			.saturating_add(Weight::from_parts(16_705_812, 0).saturating_mul(y.into()))
