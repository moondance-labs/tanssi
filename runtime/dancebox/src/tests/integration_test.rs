...
use {
    ...
    crate::{RewardsCollatorCommission, StreamPayment, StreamPaymentAssetId, TimeUnit},
...
fn test_paras_registered_but_not_enough_credits() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            let credits_1001 = crate::Period::get() * 2 - 1;
            assert_ok!(ServicesPayment::set_block_production_credits(
                root_origin(),
                1001.into(),
                credits_1001
...
fn test_paras_registered_but_only_credits_for_1_session() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            let credits_1001 = crate::Period::get() * 2;
            assert_ok!(ServicesPayment::set_block_production_credits(
                root_origin(),
                1001.into(),
                credits_1001
...
#[test]
fn test_ed_plus_two_block_credit_sessions_purchase_works() {
    ExtBuilder::default()
        .with_balances(vec![
            // Alice gets 10k extra tokens for her mapping deposit
            (AccountId::from(ALICE), 210_000 * UNIT),
...
#[test]
fn test_ed_plus_two_block_credit_sessions_minus_1_purchase_fails() {
    ExtBuilder::default()
        .with_balances(vec![
            // Alice gets 10k extra tokens for her mapping deposit
            (AccountId::from(ALICE), 210_000 * UNIT),
...
fn test_block_credits_with_purchase_can_be_combined() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            let credits_1001 =
                block_credits_to_required_balance(crate::Period::get(), 1001.into())
                    + crate::EXISTENTIAL_DEPOSIT;
...
fn test_migration_services_collator_assignment_payment() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_eq!(
                credits_1001,
                crate::FreeCollatorAssignmentCredits::get()
            );
            let credits_1002 = pallet_services_payment::CollatorAssignmentCredits::<Runtime>::get(
                &ParaId::from(1002),
            )
