...
impl<T: frame_system::Config> pallet_xcm_core_buyer::WeightInfo for SubstrateWeight<T> {
	...
	fn buy_core() -> Weight {
		...
		//  Measured:  `1534`
		//  Estimated: `4999`
		// Minimum execution time: 105_774_000 picoseconds.
		Weight::from_parts(109_865_000, 4999)
	...
	fn force_buy_core() -> Weight {
		...
		//  Measured:  `1534`
		//  Estimated: `4999`
		// Minimum execution time: 99_751_000 picoseconds.
		Weight::from_parts(104_547_000, 4999)
	...
	fn query_response() -> Weight {
		...
		Weight::from_parts(34_566_000, 4686)
	...
	fn clean_up_expired_in_flight_orders(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_245_000, 3684)
			// Standard Error: 8_912
			.saturating_add(Weight::from_parts(6_474_156, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn clean_up_expired_pending_blocks(x: u32, ) -> Weight {
		...
		Weight::from_parts(17_700_000, 3627)
			// Standard Error: 2_079
			.saturating_add(Weight::from_parts(4_093_372, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(x.into())))
