...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn set_invulnerables(b: u32, ) -> Weight {
		...
		Weight::from_parts(13_080_063, 1274)
			// Standard Error: 5_075
			.saturating_add(Weight::from_parts(3_784_538, 0).saturating_mul(b.into()))
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(22_737_173, 4687)
			// Standard Error: 1_655
			.saturating_add(Weight::from_parts(153_854, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(14_177_631, 4687)
			// Standard Error: 1_008
			.saturating_add(Weight::from_parts(108_913, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(12_408_285, 4687)
			// Standard Error: 2_238
			.saturating_add(Weight::from_parts(151_513, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Invulnerables::Invulnerables` (r:1 w:0)
