...
impl<T: frame_system::Config> pallet_invulnerables::WeightInfo for SubstrateWeight<T> {
	...
	fn add_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(22_324_780, 4687)
			// Standard Error: 1_680
			.saturating_add(Weight::from_parts(122_929, 0).saturating_mul(b.into()))
	...
	fn remove_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(13_380_963, 4687)
			// Standard Error: 1_179
			.saturating_add(Weight::from_parts(88_258, 0).saturating_mul(b.into()))
	...
	fn new_session(r: u32, ) -> Weight {
		...
		Weight::from_parts(13_291_988, 4687)
	...
	fn reward_invulnerable(b: u32, ) -> Weight {
		...
		Weight::from_parts(26_110_454, 4687)
			// Standard Error: 1_209
			.saturating_add(Weight::from_parts(91_936, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}