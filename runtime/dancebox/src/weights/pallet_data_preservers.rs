...
impl<T: frame_system::Config> pallet_data_preservers::WeightInfo for SubstrateWeight<T> {
	...
	fn create_profile(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(46_311_573, 3694)
			// Standard Error: 3_581
			.saturating_add(Weight::from_parts(17_139, 0).saturating_mul(x.into()))
			// Standard Error: 75_554
			.saturating_add(Weight::from_parts(54_063, 0).saturating_mul(y.into()))
	...
	fn force_create_profile(x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(17_465_030, 3471)
			// Standard Error: 4_730
			.saturating_add(Weight::from_parts(4_020, 0).saturating_mul(x.into()))
	...
	fn update_profile(_x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(49_891_338, 3780)
			// Standard Error: 525_006
			.saturating_add(Weight::from_parts(557_617, 0).saturating_mul(y.into()))
	...
	fn force_update_profile(_x: u32, _y: u32, ) -> Weight {
		...
		Weight::from_parts(50_339_107, 3780)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn delete_profile() -> Weight {
		...
		Weight::from_parts(41_313_000, 3780)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_delete_profile() -> Weight {
		...
		Weight::from_parts(40_879_000, 3780)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn start_assignment() -> Weight {
		...
		Weight::from_parts(28_179_000, 3838)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Registrar::ParaManager` (r:1 w:0)
	...
	fn stop_assignment() -> Weight {
		...
		Weight::from_parts(26_201_000, 3895)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `DataPreservers::Profiles` (r:1 w:1)
	...
	fn force_start_assignment() -> Weight {
		...
		Weight::from_parts(18_474_000, 3618)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}