...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(119_185_000, 4687)
			// Standard Error: 9_195
			.saturating_add(Weight::from_parts(157_508, 0).saturating_mul(x.into()))
			// Standard Error: 92_161
			.saturating_add(Weight::from_parts(11_347_540, 0).saturating_mul(y.into()))
