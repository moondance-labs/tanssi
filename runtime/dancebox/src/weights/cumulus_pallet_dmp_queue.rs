...
impl<T: frame_system::Config> cumulus_pallet_dmp_queue::WeightInfo for SubstrateWeight<T> {
	...
	fn on_idle_good_msg() -> Weight {
		...
		Weight::from_parts(127_599_000, 69126)
	...
	fn on_idle_large_msg() -> Weight {
		...
		Weight::from_parts(75_549_000, 69125)
	...
	fn on_idle_overweight_good_msg() -> Weight {
		...
		//  Measured:  `65691`
		//  Estimated: `69156`
		// Minimum execution time: 120_462_000 picoseconds.
		Weight::from_parts(123_002_000, 69156)
	...
	fn on_idle_overweight_large_msg() -> Weight {
		...
		Weight::from_parts(69_462_000, 69155)
