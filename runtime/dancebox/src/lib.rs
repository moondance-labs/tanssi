...
impl pallet_initializer::ApplyNewSession<Runtime> for OwnApplySession {
    fn apply_new_session(
        ...
        let random_seed = match session_index {
            1 => [
                29, 200, 110, 219, 124, 225, 239, 107, 218, 231, 160, 108, 251, 109, 37, 229, 19,
                62, 202, 118, 12, 1, 157, 85, 119, 237, 26, 15, 154, 255, 63, 246,
            ],
            2 => [
                84, 44, 234, 18, 195, 111, 223, 207, 97, 84, 67, 58, 222, 144, 143, 35, 191, 200,
                210, 167, 157, 32, 68, 122, 40, 72, 174, 114, 8, 132, 158, 196,
            ],
            3 => [
                64, 121, 243, 25, 201, 106, 244, 248, 15, 179, 110, 224, 117, 251, 126, 221, 136,
                123, 209, 51, 191, 54, 114, 75, 154, 130, 13, 15, 104, 149, 34, 207,
            ],
            4 => [
                185, 26, 51, 210, 96, 190, 204, 173, 155, 184, 156, 217, 148, 114, 226, 98, 91,
                133, 9, 201, 21, 109, 97, 76, 219, 188, 251, 114, 37, 198, 141, 96,
            ],
            _ => random_seed,
        };
